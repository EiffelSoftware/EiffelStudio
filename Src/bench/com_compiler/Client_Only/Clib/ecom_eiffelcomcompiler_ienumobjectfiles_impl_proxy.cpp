...
#include "ecom_EiffelComCompiler_IEnumObjectFiles_impl_proxy.h"
...
-----------------------------------------------------------*/
{
	...
	tmp_pbstr_object_file = (BSTR *)grt_ec_ISE_c.ccom_ec_pointed_cell_227 (eif_access (pbstr_object_file), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_227 ((BSTR *)tmp_pbstr_object_file, pbstr_object_file);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pul_fetched, pul_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_227 (tmp_pbstr_object_file);
grt_ce_ISE_c.ccom_free_memory_pointed_228 (tmp_pul_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ienum_object_files = (ecom_EiffelComCompiler::IEnumObjectFiles * *)grt_ec_ISE_c.ccom_ec_pointed_cell_222 (eif_access (pp_ienum_object_files), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_222 ((ecom_EiffelComCompiler::IEnumObjectFiles * *)tmp_pp_ienum_object_files, pp_ienum_object_files);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_222 (tmp_pp_ienum_object_files);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_pbstr_object_file = 0;
	tmp_pbstr_object_file = (BSTR *)grt_ec_ISE_c.ccom_ec_pointed_cell_229 (eif_access (pbstr_object_file), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_229 ((BSTR *)tmp_pbstr_object_file, pbstr_object_file);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_229 (tmp_pbstr_object_file);
