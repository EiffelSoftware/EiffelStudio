	...
	add_object_test_locals
		...
		do
			...
			loop
				...
				context.add_object_test_locals (precondition_list.item.object_test_locals, precondition_body_indices.item, True)
				precondition_forth
			end
			...
			loop
				...
				context.add_object_test_locals (postcondition_list.item.object_test_locals, postcondition_body_indices.item, False)
				postcondition_forth
			end
			restore_current_context
		end
