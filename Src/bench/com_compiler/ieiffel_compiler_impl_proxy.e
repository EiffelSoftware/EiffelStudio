...
feature {NONE}  -- Externals
	...
	ccom_compile (cpp_obj: POINTER; mode: INTEGER) is
			-- Compile.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompiler_impl_proxy_s.h%"](EIF_INTEGER)"
		end

	ccom_compile_to_pipe (cpp_obj: POINTER; mode: INTEGER; bstr_pipe_name: STRING) is
			-- Compile to an already established named pipe.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompiler_impl_proxy_s.h%"](EIF_INTEGER,EIF_OBJECT)"
		end
