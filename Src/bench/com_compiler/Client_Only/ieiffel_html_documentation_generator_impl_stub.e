...
feature {NONE}  -- Externals
	...
	ccom_create_item (eif_object: IEIFFEL_HTML_DOCUMENTATION_GENERATOR_IMPL_STUB): POINTER is
			-- Initialize `item'
		external
			"C++ [new ecom_EiffelComCompiler::IEiffelHtmlDocumentationGenerator_impl_stub %"ecom_EiffelComCompiler_IEiffelHtmlDocumentationGenerator_impl_stub.h%"](EIF_OBJECT)"
		end
