...
feature
    ...
    get_value (index : INTEGER) : CORBA_VALUEDEF is
    ...
    set_value (value : CORBA_VALUEDEF; index : INTEGER) is
    ...
    sequence_from_any (ca : CORBA_ANY) is 
        ...
        do
            ...
            until
                i > n
            loop
                o := ca.get_object ("ValueDef")
                x := CORBA_ValueDef_narrow (o)
                store.put (x, i)
                i := i + 1
            end
            ca.seq_get_end
