...
feature
    ...
    get_value (index : INTEGER) : CORBA_VALUEMEMBER is
    ...
    set_value (value : CORBA_VALUEMEMBER; index : INTEGER) is
...
feature { ANY }
    ...
    type_name : STRING is
        ...
        do
            result := "ValueMemberSeq"
        end

end -- class CORBA_VALUEMEMBERSEQ
