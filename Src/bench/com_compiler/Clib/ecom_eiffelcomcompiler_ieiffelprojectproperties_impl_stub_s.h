...
#ifndef __ECOM_EIFFELCOMCOMPILER_IEIFFELPROJECTPROPERTIES_IMPL_STUB_S_H__
#define __ECOM_EIFFELCOMCOMPILER_IEIFFELPROJECTPROPERTIES_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
public:
	...
	-----------------------------------------------------------*/
	STDMETHODIMP TargetClrVersion(  /* [out, retval] */ BSTR * pbstr_version );


	/*-----------------------------------------------------------
	Version of CLR compiler should target
	-----------------------------------------------------------*/
	STDMETHODIMP set_TargetClrVersion(  /* [in] */ BSTR pbstr_version );
