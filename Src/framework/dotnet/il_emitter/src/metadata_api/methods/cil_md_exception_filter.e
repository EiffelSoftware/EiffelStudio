...
feature -- Status report
	...
	flags: INTEGER_16
		...
		do
			Result := {CIL_MD_METHOD_CONSTANTS}.clause_filter
		ensure then
			definition: Result = {CIL_MD_METHOD_CONSTANTS}.clause_filter
		end

feature -- Access

	filter_offset: INTEGER
			-- Offset in bytes for filter-based exception handler in associated CIL_MD_METHOD_BODY
