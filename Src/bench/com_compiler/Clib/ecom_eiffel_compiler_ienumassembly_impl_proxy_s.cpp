...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelAssemblyProperties * *)grt_ec_ISE.ccom_ec_pointed_cell_207 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_207 ((ecom_eiffel_compiler::IEiffelAssemblyProperties * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_207 (tmp_rgelt);
grt_ce_ISE.ccom_free_memory_pointed_227 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumAssembly * *)grt_ec_ISE.ccom_ec_pointed_cell_218 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_218 ((ecom_eiffel_compiler::IEnumAssembly * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_218 (tmp_ppenum);
