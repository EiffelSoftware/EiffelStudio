...
#define WEBKIT_DOM_CSS_STYLE_DECLARATION_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_CSS_STYLE_DECLARATION, WebKitDOMCSSStyleDeclarationClass)
#define WEBKIT_DOM_IS_CSS_STYLE_DECLARATION(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_CSS_STYLE_DECLARATION))
#define WEBKIT_DOM_IS_CSS_STYLE_DECLARATION_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_CSS_STYLE_DECLARATION))
