note
	description: "Manifest array explicit type is separate."
	legal: "See notice at end of class."
	status: "See notice at end of class."
	date: "$Date$"
	revision: "$Revision$"

class VWMA_SEPARATE_ARRAY
...
feature -- Output
	...
	trace_single_line (t: TEXT_FORMATTER)
			-- <Precursor>
		do
			message.format (t, locale.translation_in_context ("Manifest array type {1} is separate.", "compiler.error"),
