...
feature -- Comparison
	...
	infix "<" (other: INTEGER_16): BOOLEAN
			-- Is current integer less than `other'?
		do
			Result := Precursor (other)
		end
...
feature -- Basic operations
	...
	infix "+" (other: INTEGER_16): INTEGER_16
			-- Sum with `other'
		do
			Result := Precursor (other)
		end
	...
	infix "/" (other: INTEGER_16): REAL_64
			-- Division by `other'
		do
			Result := Precursor (other)
		end
...
feature -- Bit operations
	...
	bit_and (i: INTEGER_16): INTEGER_16
			-- Bitwise and between Current' and `i'.
		do
			Result := Precursor (i)
		end

	bit_or (i: INTEGER_16): INTEGER_16
	...
	bit_shift_left (n: INTEGER): INTEGER_16
			-- Shift Current from `n' position to left.
		do
			Result := Precursor (n)
		end

	bit_shift_right (n: INTEGER): INTEGER_16
