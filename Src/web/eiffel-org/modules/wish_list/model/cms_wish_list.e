note
	description: "Summary description for {CMS_WISH_LIST}."
	date: "$Date$"
	revision: "$Revision$"
...
feature -- Access
	...
	status: detachable CMS_WISH_LIST_STATUS
			-- Wish list status.

	contact: detachable CMS_USER
			-- User who submit the wishlist
...
feature -- Element change
	...
	set_wish_list_category (a_category: CMS_WISH_LIST_CATEGORY)
...
feature -- Filled data
	...
	interactions: detachable LIST [CMS_WISH_LIST_INTERACTION]
			-- Wishlist interactions

	attachments: detachable LIST [CMS_WISH_FILE]
