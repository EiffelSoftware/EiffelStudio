...
feature {NONE}  -- Externals
	...
	ccom_save_object (cpp_obj: POINTER)
			-- No description available.
		external
	...
	ccom_get_container (cpp_obj: POINTER; pp_container: CELL [IOLE_CONTAINER_INTERFACE])
			-- No description available.
		external
			"C++ [ecom_control_library::IOleClientSite_impl_proxy %"ecom_control_library_IOleClientSite_impl_proxy_s.h%"](EIF_OBJECT)"
		end

	ccom_show_object (cpp_obj: POINTER)
			-- No description available.
		external
			"C++ [ecom_control_library::IOleClientSite_impl_proxy %"ecom_control_library_IOleClientSite_impl_proxy_s.h%"]()"
		end

	ccom_on_show_window (cpp_obj: POINTER; f_show: INTEGER)
			-- No description available.
		external
			"C++ [ecom_control_library::IOleClientSite_impl_proxy %"ecom_control_library_IOleClientSite_impl_proxy_s.h%"](EIF_INTEGER)"
		end

	ccom_request_new_object_layout (cpp_obj: POINTER)
			-- No description available.
		external
			"C++ [ecom_control_library::IOleClientSite_impl_proxy %"ecom_control_library_IOleClientSite_impl_proxy_s.h%"]()"
		end

	ccom_delete_iole_client_site_impl_proxy (a_pointer: POINTER)
			-- Release resource
		external
			"C++ [delete ecom_control_library::IOleClientSite_impl_proxy %"ecom_control_library_IOleClientSite_impl_proxy_s.h%"]()"
		end

	ccom_create_iole_client_site_impl_proxy_from_pointer (a_pointer: POINTER): POINTER
			-- Create from pointer
		external
