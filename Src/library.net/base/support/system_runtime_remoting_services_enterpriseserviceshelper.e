...
feature -- Basic Operations
	...
	frozen wrap_i_unknown_with_com_object (punk: POINTER): ANY is
		external
	...
	frozen create_construction_return_message (ctorMsg: SYSTEM_RUNTIME_REMOTING_ACTIVATION_ICONSTRUCTIONCALLMESSAGE; retObj: SYSTEM_MARSHALBYREFOBJECT): SYSTEM_RUNTIME_REMOTING_ACTIVATION_ICONSTRUCTIONRETURNMESSAGE is
		external
