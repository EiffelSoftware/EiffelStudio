...
class
	EV_GRID_RICH_LABEL_ITEM_LAYOUT
...
feature -- Access
	...
	grid_rich_line_item: EV_GRID_RICH_LABEL_ITEM
		-- Associated EV_GRID_RICH_LINE_ITEM to which the properties of `Current' are applied.
...
feature -- Status Setting
	...
	set_pixmap_x (a_pixmap_x: INTEGER)
	...
	set_pixmap_y (a_pixmap_y: INTEGER)
...
feature {EV_ANY_I} -- Implementation
	...
	set_grid_rich_line_item (a_grid_rich_line_item: EV_GRID_RICH_LABEL_ITEM)
			-- Assign `a_grid_label_item' to `grid_rich_line_item'.
		do
			grid_rich_line_item := a_grid_rich_line_item
		ensure
			grid_rich_line_item_set: grid_rich_line_item =  a_grid_rich_line_item
		end
