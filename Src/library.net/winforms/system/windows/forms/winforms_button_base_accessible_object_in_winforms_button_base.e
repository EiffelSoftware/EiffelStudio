...
create
	make_winforms_button_base_accessible_object_in_winforms_button_base

feature {NONE} -- Initialization

	frozen make_winforms_button_base_accessible_object_in_winforms_button_base (owner: WINFORMS_CONTROL) is
		external
...
end -- class WINFORMS_BUTTON_BASE_ACCESSIBLE_OBJECT_IN_WINFORMS_BUTTON_BASE
