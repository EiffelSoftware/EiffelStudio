...
feature {NONE} -- Initialization
	...
	frozen make_3 (user_token: POINTER; type: STRING; acct_type: SYSTEM_SECURITY_PRINCIPAL_WINDOWSACCOUNTTYPE; is_authenticated: BOOLEAN) is
		external
	...
	frozen make_2 (user_token: POINTER; type: STRING; acct_type: SYSTEM_SECURITY_PRINCIPAL_WINDOWSACCOUNTTYPE) is
		external
