...
feature {NONE}  -- Externals
	...
	ccom_name (cpp_obj: POINTER): STRING is
			-- Feature name.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelFeatureDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelFeatureDescriptor_impl_proxy.h%"](): EIF_REFERENCE"
		end
	...
	ccom_feature_location (cpp_obj: POINTER; pbstr_path: CELL [STRING]; pul_line: INTEGER_REF) is
			-- Feature location, full path to file and line number
		external
			"C++ [ecom_EiffelComCompiler::IEiffelFeatureDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelFeatureDescriptor_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT)"
		end
	...
	ccom_all_callers_count (cpp_obj: POINTER): INTEGER is
			-- Number of all callers.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelFeatureDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelFeatureDescriptor_impl_proxy.h%"](): EIF_INTEGER"
		end
	...
	ccom_exported_to_all (cpp_obj: POINTER): BOOLEAN is
			-- Is feature exported to all classes?
		external
			"C++ [ecom_EiffelComCompiler::IEiffelFeatureDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelFeatureDescriptor_impl_proxy.h%"](): EIF_BOOLEAN"
		end
	...
	ccom_delete_ieiffel_feature_descriptor_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_EiffelComCompiler::IEiffelFeatureDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelFeatureDescriptor_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_feature_descriptor_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_EiffelComCompiler::IEiffelFeatureDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelFeatureDescriptor_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_EiffelComCompiler::IEiffelFeatureDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelFeatureDescriptor_impl_proxy.h%"]():EIF_POINTER"
		end
