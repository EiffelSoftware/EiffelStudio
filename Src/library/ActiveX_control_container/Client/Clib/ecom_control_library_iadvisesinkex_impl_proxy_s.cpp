...
void ecom_control_library::IAdviseSinkEx_impl_proxy::ccom_on_data_change(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc,  /* [in] */ EIF_OBJECT p_stgmed )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IAdviseSinkEx->OnDataChange(p_formatetc,tmp_p_stgmed);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSinkEx_impl_proxy::ccom_on_view_change(  /* [in] */ EIF_INTEGER dw_aspect,  /* [in] */ EIF_INTEGER lindex )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IAdviseSinkEx->OnViewChange(tmp_dw_aspect,tmp_lindex);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSinkEx_impl_proxy::ccom_on_rename(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IAdviseSinkEx->OnRename(pmk);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSinkEx_impl_proxy::ccom_on_save()
...
void ecom_control_library::IAdviseSinkEx_impl_proxy::ccom_on_close()
...
void ecom_control_library::IAdviseSinkEx_impl_proxy::ccom_on_view_status_change(  /* [in] */ EIF_INTEGER dw_view_status )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IAdviseSinkEx->OnViewStatusChange(tmp_dw_view_status);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
