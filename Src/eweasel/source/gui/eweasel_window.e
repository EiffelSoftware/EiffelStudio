...
feature {NONE} -- Implementation (GUI)
	...
	output_control: EWEASEL_GRAPHICAL_OUTPUT is
			-- Output interface
		once
...
feature {NONE} -- Implementation
	...
	save_tests (a_filename: STRING) is
			-- Save SELECTED tests into a new catalog.
		local
