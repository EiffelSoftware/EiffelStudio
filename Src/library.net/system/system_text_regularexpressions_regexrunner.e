...
deferred external class
	SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER
...
feature {NONE} -- Implementation
	...
	frozen scan (regex: SYSTEM_TEXT_REGULAREXPRESSIONS_REGEX; text: STRING; textbeg: INTEGER; textend: INTEGER; textstart: INTEGER; prevlen: INTEGER; quick: BOOLEAN): SYSTEM_TEXT_REGULAREXPRESSIONS_MATCH is
		external
	...
	frozen char_in_set (ch: CHARACTER; set: STRING; category: STRING): BOOLEAN is
		external
...
end -- class SYSTEM_TEXT_REGULAREXPRESSIONS_REGEXRUNNER
