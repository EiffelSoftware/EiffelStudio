...
feature {NONE} -- Implementation
	...
	test_make is
		...
		do
			...
			check_boolean ("make", s.count = 0)
			check_boolean ("make", s.capacity >= 2)
				-- Extra check that there are no aliasing within a STRING creation
			check_boolean ("make", s.area /= p)
		end	
	...
	test_same_type is
		do
			check_boolean ("same_type", ("").same_type (create {STRING}.make_empty))
			check_boolean ("same_type", ("").same_type (create {STRING}.make (10)))
