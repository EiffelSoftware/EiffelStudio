...
feature -- Type anchors
	...
	FIXED_ANY_ARRAY_TYPE: FIXED_ARRAY [ANY] is do end
	FIXED_BOOLEAN_ARRAY_TYPE: FIXED_ARRAY [BOOLEAN] is do end
	FIXED_CHARACTER_ARRAY_TYPE: FIXED_ARRAY [CHARACTER] is do end
	FIXED_INTEGER_ARRAY_TYPE: FIXED_ARRAY [INTEGER] is do end
	FIXED_STRING_ARRAY_TYPE: FIXED_ARRAY [STRING] is do end
