...
feature {NONE}  -- Externals
	...
	ccom_in_place_deactivate (cpp_obj: POINTER)
			-- No description available.
		external
			"C++ [ecom_control_library::IOleInPlaceObject_impl_proxy %"ecom_control_library_IOleInPlaceObject_impl_proxy_s.h%"]()"
		end

	ccom_uideactivate (cpp_obj: POINTER)
			-- No description available.
		external
			"C++ [ecom_control_library::IOleInPlaceObject_impl_proxy %"ecom_control_library_IOleInPlaceObject_impl_proxy_s.h%"]()"
		end

	ccom_set_object_rects (cpp_obj: POINTER; lprc_pos_rect: POINTER; lprc_clip_rect: POINTER)
			-- No description available.
		external
	...
	ccom_reactivate_and_undo (cpp_obj: POINTER)
			-- No description available.
		external
			"C++ [ecom_control_library::IOleInPlaceObject_impl_proxy %"ecom_control_library_IOleInPlaceObject_impl_proxy_s.h%"]()"
		end

	ccom_delete_iole_in_place_object_impl_proxy (a_pointer: POINTER)
			-- Release resource
		external
			"C++ [delete ecom_control_library::IOleInPlaceObject_impl_proxy %"ecom_control_library_IOleInPlaceObject_impl_proxy_s.h%"]()"
		end

	ccom_create_iole_in_place_object_impl_proxy_from_pointer (a_pointer: POINTER): POINTER
			-- Create from pointer
		external
