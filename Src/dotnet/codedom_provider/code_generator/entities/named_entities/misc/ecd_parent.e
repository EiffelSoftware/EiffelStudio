...
feature	-- Access
	...
	rename_clauses: LINKED_LIST [ECD_RENAME_CLAUSE]
			-- Rename inheritance clauses

	undefine_clauses: LINKED_LIST [ECD_UNDEFINE_CLAUSE]
			-- Rename inheritance clauses

	redefine_clauses: LINKED_LIST [ECD_REDEFINE_CLAUSE]
			-- Rename inheritance clauses

	select_clauses: LINKED_LIST [ECD_SELECT_CLAUSE]
			-- Rename inheritance clauses

	export_clauses: LINKED_LIST [ECD_EXPORT_CLAUSE]
			-- Rename inheritance clauses
...
feature -- Status Setting Inheritance Clauses
	...
	add_rename_clause (a_clause: ECD_RENAME_CLAUSE) is
	...
	add_undefine_clause (a_clause: ECD_UNDEFINE_CLAUSE) is
			-- Add `a_clause' to `inheritance_clauses' for parent `a_parent'.
		require
			non_void_inheritance_clause: a_clause /= Void
		do
	...
	add_redefine_clause (a_clause: ECD_REDEFINE_CLAUSE) is
			-- Add `a_clause' to `inheritance_clauses' for parent `a_parent'.
		require
			non_void_inheritance_clause: a_clause /= Void
		do
	...
	add_select_clause (a_clause: ECD_SELECT_CLAUSE) is
			-- Add `a_clause' to `inheritance_clauses' for parent `a_parent'.
		require
			non_void_inheritance_clause: a_clause /= Void
		do
	...
	add_export_clause (a_clause: ECD_EXPORT_CLAUSE) is
			-- Add `a_clause' to `inheritance_clauses' for parent `a_parent'.
		require
			non_void_inheritance_clause: a_clause /= Void
		do
...
feature {NONE} -- Implementation
	...
	generate_clauses (a_list: LINKED_LIST [ECD_INHERITANCE_CLAUSE]; keyword: STRING): STRING is
			-- 
		require
