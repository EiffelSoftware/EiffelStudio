...
class
	TARGET_OBJECT_EXTERNALS_SECTION
...
feature -- Access
	...
	name: STRING is
			-- Name of the section.
		once
			Result := conf_interface_names.external_object_tree
		end

	icon: EV_PIXMAP is
			-- Icon of the section.
		once
			Result := pixmaps.icon_pixmaps.project_settings_object_file_icon
		end
...
feature -- Element update
	...
	add_external is
			-- Add a new external.
		local
			l_external: CONF_EXTERNAL_OBJECT
...
feature {NONE} -- Implementation
	...
	update_toolbar_sensitivity is
		...
		do
			...
			toolbar.add_object_button.select_actions.extend (agent add_external)
