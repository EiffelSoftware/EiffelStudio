...
feature{NONE} -- Status report
	...
	is_archive_node_recalculatable (a_archive_node: EB_METRIC_ARCHIVE_NODE): BOOLEAN
	...
	should_archive_be_shown (a_archive_node: EB_METRIC_ARCHIVE_NODE; a_time: DATE_TIME): BOOLEAN
...
feature -- Actions
	...
	on_stop_archive_recalculation (a_item: QL_ITEM)
	...
	on_hide_old_item_change_from_outside
	...
	on_item_age_change_from_outside
	...
	on_background_color_preference_change
...
feature{NONE} -- Implementation/Data
	...
	grid_rebind_level: INTEGER = 1
	grid_update_level: INTEGER = 2
	grid_up_to_date_level: INTEGER = 3
	grid_switch_level: INTEGER = 4
...
feature{NONE} -- Implementation
	...
	merge_archive (a_source_archive_node, a_new_archive_node: EB_METRIC_ARCHIVE_NODE)
	...
	recalculation_task (a_selected_archives: LINEAR [EB_METRIC_ARCHIVE_NODE]): LINKED_LIST [TUPLE [EB_METRIC, EB_METRIC_DOMAIN, BOOLEAN, BOOLEAN, EB_METRIC_VALUE_TESTER]]
	...
	remove_archive_node (a_archive_node: EB_METRIC_ARCHIVE_NODE)
	...
	remove_detailed_result (a_archive_node: EB_METRIC_ARCHIVE_NODE)
	...
	set_grid_refresh_level (a_level: INTEGER)
	...
	is_grid_refresh_level_valid (a_level: INTEGER): BOOLEAN
	...
	clear_grid (a_grid: EB_METRIC_HISTORY_GRID)
