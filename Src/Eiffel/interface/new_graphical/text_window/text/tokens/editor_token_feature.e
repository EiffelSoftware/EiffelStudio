...
feature -- Visitor
	...
	process (a_visitor: EIFFEL_TOKEN_VISITOR)
			-- Visitor
		do
			a_visitor.process_editor_token_feature (Current)
		end
...
feature -- Color
	...
	text_color_id: INTEGER
		do
			Result := feature_text_color_id
		end

	background_color_id: INTEGER
		do
			Result := feature_background_color_id
		end
...
feature {NONE} -- Implementation
	...
	editor_preferences: EB_EDITOR_DATA
			--
		once
			Result := {like editor_preferences} /editor_preferences_cell.item
		end
