...
feature {ECD_CONSUMER_FACTORY} -- Visitor features.
	...
	generate_array_create_expression (a_source: SYSTEM_DLL_CODE_ARRAY_CREATE_EXPRESSION) is
		...
		local
			an_array_create_expression: ECD_ARRAY_CREATE_EXPRESSION
		do
	...
	generate_array_indexer_expression (a_source: SYSTEM_DLL_CODE_ARRAY_INDEXER_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			an_array_indexer_expression: ECD_ARRAY_INDEXER_EXPRESSION
		do
...
feature {NONE} -- Implementation
	...
	initialize_array_create_expression (a_source: SYSTEM_DLL_CODE_ARRAY_CREATE_EXPRESSION; an_array_create_expression: ECD_ARRAY_CREATE_EXPRESSION) is
	...
	generate_initializers (a_source: SYSTEM_DLL_CODE_ARRAY_CREATE_EXPRESSION; an_array_create_expression: ECD_ARRAY_CREATE_EXPRESSION) is
		...
		local
			...
			l_dictionary: ECD_DICTIONARY
			
			a_feature: ECD_SNIPPET_FEATURE
	...
	initialize_array_indexer_expression (a_source: SYSTEM_DLL_CODE_ARRAY_INDEXER_EXPRESSION; an_array_indexer_expression: ECD_ARRAY_INDEXER_EXPRESSION) is
	...
	generate_indices (a_source: SYSTEM_DLL_CODE_ARRAY_INDEXER_EXPRESSION; an_array_indexer_expression: ECD_ARRAY_INDEXER_EXPRESSION) is
...
end -- class ECD_ARRAY_EXPRESSION_FACTORY
