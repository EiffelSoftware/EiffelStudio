...
feature {NONE}  -- Externals
	...
	ccom_load (cpp_obj: POINTER; pstm: POINTER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IPersistStreamInit_impl_proxy %"ecom_control_library_IPersistStreamInit_impl_proxy_s.h%"](ecom_control_library::IStream *)"
		end

	ccom_save (cpp_obj: POINTER; pstm: POINTER; f_clear_dirty: INTEGER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IPersistStreamInit_impl_proxy %"ecom_control_library_IPersistStreamInit_impl_proxy_s.h%"](ecom_control_library::IStream *,EIF_INTEGER)"
		end

	ccom_get_size_max (cpp_obj: POINTER; pcb_size: POINTER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IPersistStreamInit_impl_proxy %"ecom_control_library_IPersistStreamInit_impl_proxy_s.h%"](ecom_control_library::_ULARGE_INTEGER *)"
		end
