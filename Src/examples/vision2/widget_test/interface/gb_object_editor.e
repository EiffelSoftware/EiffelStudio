note
	description: "Vision2 tour version of GB_OBJECT_EDITOR necessary for compilation and building purposes."
...
feature {EV_ANY} -- Initialization
	...
	initialize
		...
		do
			...
			control_holder.resize_actions.extend (agent (x, y, w, h: INTEGER_32) do update_scroll_bar end)
			viewport.resize_actions.extend (agent (x, y, w, h: INTEGER_32) do update_scroll_bar end)
