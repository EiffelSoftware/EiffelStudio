...
feature {ES_TESTING_TOOL_PANEL} -- Implementation
	...
	pixmap: EV_PIXMAP is
		...
		do
			Result := pixmaps.icon_pixmaps.testing_next_failed_test_icon
		end

	pixel_buffer: EV_PIXEL_BUFFER is
			-- Pixel buffer representing the command.
		do
			Result := pixmaps.icon_pixmaps.testing_next_failed_test_icon_buffer
		end
	...
	name: STRING_GENERAL is
			...
			-- preferences.
		do
			Result := "Next_failed_test"
		end

	tooltip: STRING_GENERAL is
			-- Tooltip for the toolbar button.
		do
			Result := interface_names.t_Next_failed_test
		end
