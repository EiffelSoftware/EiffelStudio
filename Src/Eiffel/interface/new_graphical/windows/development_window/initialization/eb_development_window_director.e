...
feature -- Command
	...
	construct is
		...
		do
			...
			if not develop_window.development_window_data.is_force_debug_mode or l_debugger_manager = Void or not develop_window.docking_manager.is_config_data_valid (develop_window.docking_config_tools_file) then
