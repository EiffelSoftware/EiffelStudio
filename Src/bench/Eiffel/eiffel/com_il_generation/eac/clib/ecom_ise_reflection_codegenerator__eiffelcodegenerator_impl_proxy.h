...
#ifndef __ECOM_ISE_REFLECTION_CODEGENERATOR__EIFFELCODEGENERATOR_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_CODEGENERATOR__EIFFELCODEGENERATOR_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
class _EiffelCodeGenerator_impl_proxy;
}
...
{
public:
	_EiffelCodeGenerator_impl_proxy (IUnknown * a_pointer);
	virtual ~_EiffelCodeGenerator_impl_proxy ();
