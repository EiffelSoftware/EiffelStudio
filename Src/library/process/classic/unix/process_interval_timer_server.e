...
class PROCESS_INTERVAL_TIMER_SERVER
...
feature {NONE} -- Creation
	...
	make is
		...
		do
			...
			create {ARRAYED_LIST [PROCESS_INTERVAL_TIMER]} timers.make (5);
			timers.compare_objects
		end

feature -- Operations

	set_new_timer (timer: PROCESS_INTERVAL_TIMER; t: DOUBLE) is
	...
	release_expired_timer (t: PROCESS_INTERVAL_TIMER) is
	...
	release_cleared_timer (t: PROCESS_INTERVAL_TIMER) is
			-- Release virtual interval timer `t' which has
			-- been cleared
		do
			timers.prune_all (t)
...
feature {NONE} -- Implementation
	...
	start_next_timer is
		...
		local
			...
			next_timer: PROCESS_INTERVAL_TIMER
		do
			min_time := 1.0E22;
			next_timer := Void
	...
	start_timer (t: PROCESS_INTERVAL_TIMER) is
...
end -- class PROCESS_INTERVAL_TIMER_SERVER
