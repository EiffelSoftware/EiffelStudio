...
public:
	...
	Project Clusters.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP clusters(  /* [out, retval] */ ecom_EiffelComCompiler::IEiffelSystemClusters * * return_value ) = 0;


	/*-----------------------------------------------------------
	Externals.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP externals(  /* [out, retval] */ ecom_EiffelComCompiler::IEiffelSystemExternals * * return_value ) = 0;


	/*-----------------------------------------------------------
	Assemblies.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP assemblies(  /* [out, retval] */ ecom_EiffelComCompiler::IEiffelSystemAssemblies * * return_value ) = 0;
