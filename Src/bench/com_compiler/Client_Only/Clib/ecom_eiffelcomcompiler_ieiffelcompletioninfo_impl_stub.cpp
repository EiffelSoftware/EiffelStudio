...
#include "ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	if (pvar_names != NULL)
	{
		tmp_pvar_names = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_record_231 (pvar_names));
	}
	EIF_OBJECT tmp_pvar_signatures = NULL;
	if (pvar_signatures != NULL)
	{
		tmp_pvar_signatures = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_record_232 (pvar_signatures));
	}
	EIF_OBJECT tmp_pvar_image_indexes = NULL;
	if (pvar_image_indexes != NULL)
	{
		tmp_pvar_image_indexes = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_record_233 (pvar_image_indexes));
	}
