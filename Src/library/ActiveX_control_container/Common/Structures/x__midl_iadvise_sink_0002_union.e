...
class
	X__MIDL_IADVISE_SINK_0002_UNION
...
feature -- Basic Operations
	...
	set_h_generic (a_h_generic: X_USER_HGLOBAL_RECORD) is
	...
	set_h_palette (a_h_palette: X_USER_HPALETTE_RECORD) is
	...
	set_h_bitmap (a_h_bitmap: X_USER_HBITMAP_RECORD) is
...
feature {NONE}  -- Externals
	...
	ccom_x__midl_iadvise_sink_0002_h_generic (a_pointer: POINTER): X_USER_HGLOBAL_RECORD is
			-- No description available.
		external
	...
	ccom_x__midl_iadvise_sink_0002_h_palette (a_pointer: POINTER): X_USER_HPALETTE_RECORD is
			-- No description available.
		external
			"C++ [macro %"ecom_control_library___MIDL_IAdviseSink_0002_s_impl.h%"](ecom_control_library::__MIDL_IAdviseSink_0002 *):EIF_REFERENCE"
		end
	...
	ccom_x__midl_iadvise_sink_0002_h_bitmap (a_pointer: POINTER): X_USER_HBITMAP_RECORD is
			-- No description available.
		external
			"C++ [macro %"ecom_control_library___MIDL_IAdviseSink_0002_s_impl.h%"](ecom_control_library::__MIDL_IAdviseSink_0002 *):EIF_REFERENCE"
		end
...
end -- X__MIDL_IADVISE_SINK_0002_UNION
