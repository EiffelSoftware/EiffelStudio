...
inherit
	...
	INSTRUCTION_TABLES
		export
			{CATALOG_IF_INST} test_catalog_command_table
			{NONE} all
		end
...
feature -- Status
	...
	last_catalog: EIFFEL_TEST_CATALOG;
...
feature {NONE} -- Implementation
	...
	tests: LINKED_LIST [NAMED_EIFFEL_TEST];
...
feature {CATALOG_INSTRUCTION} -- Modification
	...
	set_last_test (t: NAMED_EIFFEL_TEST) is
		do
			last_test := t;
		end;


feature {CATALOG_INSTRUCTION} -- State
