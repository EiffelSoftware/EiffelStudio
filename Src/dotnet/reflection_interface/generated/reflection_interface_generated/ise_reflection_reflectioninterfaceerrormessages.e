...
create
	make_reflectioninterfaceerrormessages

feature {NONE} -- Initialization

	frozen make_reflectioninterfaceerrormessages is
		external
			"IL creator use ISE.Reflection.ReflectionInterfaceErrorMessages"
		end
