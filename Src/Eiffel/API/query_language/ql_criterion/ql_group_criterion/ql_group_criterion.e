...
feature -- Logic operations
	...
	infix "and" (other: QL_GROUP_CRITERION): QL_GROUP_CRITERION is
			-- Boolean conjunction with `other'
		do
			create {QL_GROUP_AND_CRITERION}Result.make (Current, other)
		end

	prefix "not": QL_GROUP_CRITERION is
			-- Negation
		do
			create {QL_GROUP_NOT_CRITERION}Result.make (Current)
		end

	infix "or" (other: QL_GROUP_CRITERION): QL_GROUP_CRITERION is
...
feature -- Access
	...
	compiled_criterion: QL_GROUP_CRITERION is
