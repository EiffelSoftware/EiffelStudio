...
#ifndef __ECOM_MS_TASKSCHED_LIB_CTASKSCHEDULER_H__
#define __ECOM_MS_TASKSCHED_LIB_CTASKSCHEDULER_H__

#include "decl_ecom_MS_TaskSched_lib_CTaskScheduler.h"
...
public:
	CTaskScheduler ();
	CTaskScheduler (IUnknown * a_pointer);
