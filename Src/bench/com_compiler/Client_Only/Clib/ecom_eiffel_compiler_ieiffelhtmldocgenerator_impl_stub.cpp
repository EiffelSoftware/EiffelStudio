...
-----------------------------------------------------------*/
{
	...
	{
		tmp_new_callback = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_interface_246 (new_callback));
		new_callback->AddRef ();
	}
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_old_callback = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_interface_246 (old_callback));
		old_callback->AddRef ();
	}
