...
#ifndef __ECOM_EIFFEL_COMPILER_IENUMCLASS_IMPL_STUB_S_H__
#define __ECOM_EIFFEL_COMPILER_IENUMCLASS_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_eiffel_compiler
{
class IEnumClass_impl_stub : public ecom_eiffel_compiler::IEnumClass
{
public:
	IEnumClass_impl_stub (EIF_OBJECT eif_obj);
	virtual ~IEnumClass_impl_stub ();
	...
	No description available.
	-----------------------------------------------------------*/
	STDMETHODIMP Clone(  /* [out] */ ecom_eiffel_compiler::IEnumClass * * ppenum );
