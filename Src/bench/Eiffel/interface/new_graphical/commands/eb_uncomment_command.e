...
feature {NONE} -- Implementation
	...
	menu_name: STRING is
		...
		do
			Result := Interface_names.m_Uncomment
		end

	name: STRING is "Uncomment selection"
...
--|FIXME Etienne : Wrong icon
	...
	tooltip: STRING is
		...
		do
			Result := Interface_names.f_Uncomment
		end
...
end -- class EB_UNCOMMENT_COMMAND
