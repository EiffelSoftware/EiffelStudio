...
feature -- Access
	...
	frozen current_era: INTEGER is
		external
			"IL static_field signature :System.Int32 use System.Globalization.Calendar"
		alias
			"CurrentEra"
		end
...
feature -- Basic Operations
	...
	get_day_of_week (time: SYSTEM_DATETIME): INTEGER is
		external
			"IL deferred signature (System.DateTime): enum System.DayOfWeek use System.Globalization.Calendar"
		alias
			"GetDayOfWeek"
		ensure
	...
	get_week_of_year (time: SYSTEM_DATETIME; rule: INTEGER; first_day_of_week: INTEGER): INTEGER is
			-- Valid values for `first_day_of_week' are:
			-- Sunday = 0
			-- Monday = 1
			-- Tuesday = 2
			-- Wednesday = 3
			...
			-- Saturday = 6
		require
			valid_day_of_week: first_day_of_week = 0 or first_day_of_week = 1 or first_day_of_week = 2 or first_day_of_week = 3 or first_day_of_week = 4 or first_day_of_week = 5 or first_day_of_week = 6
		external
			"IL signature (System.DateTime, enum System.Globalization.CalendarWeekRule, enum System.DayOfWeek): System.Int32 use System.Globalization.Calendar"
		alias
			"GetWeekOfYear"
		end
