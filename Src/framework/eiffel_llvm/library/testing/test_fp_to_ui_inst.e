...
feature -- Test routines
	...
	test_fp_to_ui_inst_1
		...
		do
			...
			m.print (s)
			s_result := s.string
			assert ("test_fp_to_ui_inst_1", s_result ~ test_fp_to_ui_inst_1_expected)
		end

	test_fp_to_ui_inst_1_expected: STRING_8 =
"[
; ModuleID = 'test'

define i32 @main() {
  %1 = fptoui double 4.700000e+00 to i32
}
