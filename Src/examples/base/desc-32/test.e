...
feature
	...
	testdesc is
		local
			...
			r1, r2: REAL
		do
			!! dll.make ("testdesc.dll")
				-- Create a DLL_32 object

			!! routine.make_by_name (dll, "Sum",
