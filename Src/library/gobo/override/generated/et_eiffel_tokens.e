...
feature -- Token codes
	...
	E_ATTRIBUTE: INTEGER is 307
	E_CONVERT: INTEGER is 308
	E_RECAST: INTEGER is 309
	E_ASSIGN: INTEGER is 310
	E_AGENT: INTEGER is 311
	E_PRECURSOR: INTEGER is 312
	E_ARROW: INTEGER is 313
	E_DOTDOT: INTEGER is 314
	E_LARRAY: INTEGER is 315
	E_RARRAY: INTEGER is 316
	E_ASSIGN_SYMBOL: INTEGER is 317
	E_REVERSE: INTEGER is 318
	E_UNKNOWN: INTEGER is 319
	E_BIT: INTEGER is 320
	E_FALSE: INTEGER is 321
	E_TRUE: INTEGER is 322
	E_BREAK: INTEGER is 323
	E_CHARACTER: INTEGER is 324
	E_CURRENT: INTEGER is 325
	E_FREEOP: INTEGER is 326
	E_IDENTIFIER: INTEGER is 327
	E_BITTYPE: INTEGER is 328
	E_TUPLE: INTEGER is 329
	E_INTEGER: INTEGER is 330
	E_AND: INTEGER is 331
	E_OR: INTEGER is 332
	E_XOR: INTEGER is 333
	E_NOT: INTEGER is 334
	E_IMPLIES: INTEGER is 335
	E_STRPLUS: INTEGER is 336
	E_STRMINUS: INTEGER is 337
	E_STRSTAR: INTEGER is 338
	E_STRSLASH: INTEGER is 339
	E_STRDIV: INTEGER is 340
	E_STRMOD: INTEGER is 341
	E_STRPOWER: INTEGER is 342
	E_STRLT: INTEGER is 343
	E_STRLE: INTEGER is 344
	E_STRGT: INTEGER is 345
	E_STRGE: INTEGER is 346
	E_STRAND: INTEGER is 347
	E_STROR: INTEGER is 348
	E_STRXOR: INTEGER is 349
	E_STRANDTHEN: INTEGER is 350
	E_STRORELSE: INTEGER is 351
	E_STRDOTDOT: INTEGER is 352
	E_STRBRACKET: INTEGER is 353
	E_STRIMPLIES: INTEGER is 354
	E_STRFREEOP: INTEGER is 355
	E_STRNOT: INTEGER is 356
	E_STRING: INTEGER is 357
	E_REAL: INTEGER is 358
	E_RESULT: INTEGER is 359
	E_RETRY: INTEGER is 360
	E_DIV: INTEGER is 361
	E_GE: INTEGER is 362
	E_LE: INTEGER is 363
	E_MOD: INTEGER is 364
	E_VOID: INTEGER is 365
	E_CHARERR: INTEGER is 366
	E_STRERR: INTEGER is 367
	E_INTERR: INTEGER is 368
	E_OLD: INTEGER is 369
	E_NE: INTEGER is 370
	E_NOT_TILDE: INTEGER is 371
