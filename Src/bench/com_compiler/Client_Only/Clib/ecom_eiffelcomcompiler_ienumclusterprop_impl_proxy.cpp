...
#include "ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h"
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ieiffel_cluster_properties = (ecom_EiffelComCompiler::IEiffelClusterProperties * *)grt_ec_ISE_c.ccom_ec_pointed_cell_187 (eif_access (pp_ieiffel_cluster_properties), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_187 ((ecom_EiffelComCompiler::IEiffelClusterProperties * *)tmp_pp_ieiffel_cluster_properties, pp_ieiffel_cluster_properties);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pul_fetched, pul_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_187 (tmp_pp_ieiffel_cluster_properties);
grt_ce_ISE_c.ccom_free_memory_pointed_190 (tmp_pul_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ienum_cluster_prop = (ecom_EiffelComCompiler::IEnumClusterProp * *)grt_ec_ISE_c.ccom_ec_pointed_cell_183 (eif_access (pp_ienum_cluster_prop), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_183 ((ecom_EiffelComCompiler::IEnumClusterProp * *)tmp_pp_ienum_cluster_prop, pp_ienum_cluster_prop);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_183 (tmp_pp_ienum_cluster_prop);
