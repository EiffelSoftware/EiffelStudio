...
feature -- Access
	...
	qs_key: INTEGER is 0x0001
			-- A WM_KEYUP, WM_KEYDOWN, WM_SYSKEYUP, or WM_SYSKEYDOWN message is in the queue.

	qs_mouse: INTEGER is 0x0006
