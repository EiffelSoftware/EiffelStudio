...
feature -- Access
	...
	frozen min_value: INTEGER is
		external
			"IL static_field signature :System.Int32 use System.Int32"
		alias
			"MinValue"
		end

	frozen max_value: INTEGER is
		external
			"IL static_field signature :System.Int32 use System.Int32"
		alias
			"MaxValue"
...
feature -- Basic Operations
	...
	frozen get_type_code: INTEGER is
		external
			"IL signature (): enum System.TypeCode use System.Int32"
		alias
			"GetTypeCode"
		ensure
	...
	frozen parse_string_number_styles (s: STRING; style: INTEGER): INTEGER is
		...
		external
			"IL static signature (System.String, enum System.Globalization.NumberStyles): System.Int32 use System.Int32"
		alias
			"Parse"
		end
	...
	frozen parse_string_number_styles_iformat_provider (s: STRING; style: INTEGER; provider: SYSTEM_IFORMATPROVIDER): INTEGER is
			-- Valid values for `style' are a combination of the following values:
			-- None = 0
			-- AllowLeadingWhite = 1
			-- AllowTrailingWhite = 2
		...
		require
			valid_number_styles: (0 + 1 + 2 + 4 + 8 + 16 + 32 + 64 + 128 + 256 + 512 + 7 + 515 + 111 + 167 + 383 + 511) & style = 0 + 1 + 2 + 4 + 8 + 16 + 32 + 64 + 128 + 256 + 512 + 7 + 515 + 111 + 167 + 383 + 511
		external
			"IL static signature (System.String, enum System.Globalization.NumberStyles, System.IFormatProvider): System.Int32 use System.Int32"
		alias
			"Parse"
		end
