indexing
	description: "Representation of a 8, 16 or 32-bit manifest natural constant."
...
feature -- IL code generation
	...
	generate_il_subtract (is_included: BOOLEAN) is
		...
		do
			...
			if i /= 0 then
				il_generator.put_natural_32_constant (i)
...
feature {TYPED_INTERVAL_B} -- IL code generation
	...
	il_load_value is
		...
		do
			il_generator.put_natural_32_constant (value)
		end

	il_load_difference (other: like Current) is
			-- Load a difference between current and `other' to IL stack.
		do
			il_generator.put_natural_32_constant (value - other.value)
		end
