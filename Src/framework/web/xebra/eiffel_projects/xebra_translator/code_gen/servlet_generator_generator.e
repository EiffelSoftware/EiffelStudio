...
feature {NONE} -- Initialization
	...
	make (a_servlet_name, a_controller_type: STRING; a_stateful: BOOLEAN; a_root_tag: TAG_ELEMENT; a_path: STRING)
...
feature -- Basic functionality
	...
	generate (a_path: STRING)
		...
		local
			...
			servlet_generator_class: CLASS_ELEMENT
...
feature {NONE} -- Implementation
	...
	build_generate_for_servlet_generator: FEATURE_ELEMENT
