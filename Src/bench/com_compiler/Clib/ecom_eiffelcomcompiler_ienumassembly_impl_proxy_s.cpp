...
void ecom_EiffelComCompiler::IEnumAssembly_impl_proxy::ccom_next(  /* [out] */ EIF_OBJECT rgelt,  /* [out] */ EIF_OBJECT pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	ecom_EiffelComCompiler::IEiffelAssemblyProperties * * tmp_rgelt = 0;
	tmp_rgelt = (ecom_EiffelComCompiler::IEiffelAssemblyProperties * *)grt_ec_ISE.ccom_ec_pointed_cell_140 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_140 ((ecom_EiffelComCompiler::IEiffelAssemblyProperties * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_140 (tmp_rgelt);
grt_ce_ISE.ccom_free_memory_pointed_141 (tmp_pcelt_fetched);

};
/*----------------------------------------------------------------------------------------------------------------------*/

void ecom_EiffelComCompiler::IEnumAssembly_impl_proxy::ccom_skip(  /* [in] */ EIF_INTEGER celt )
...
void ecom_EiffelComCompiler::IEnumAssembly_impl_proxy::ccom_clone1(  /* [out] */ EIF_OBJECT ppenum )
...
-----------------------------------------------------------*/
{
	...
	ecom_EiffelComCompiler::IEnumAssembly * * tmp_ppenum = 0;
	tmp_ppenum = (ecom_EiffelComCompiler::IEnumAssembly * *)grt_ec_ISE.ccom_ec_pointed_cell_47 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_47 ((ecom_EiffelComCompiler::IEnumAssembly * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_47 (tmp_ppenum);

};
/*----------------------------------------------------------------------------------------------------------------------*/

void ecom_EiffelComCompiler::IEnumAssembly_impl_proxy::ccom_ith_item(  /* [in] */ EIF_INTEGER an_index,  /* [out] */ EIF_OBJECT rgelt )
