...
feature {NONE}  -- Externals
	...
	ccom_on_window_message (cpp_obj: POINTER; msg: INTEGER; w_param: INTEGER; l_param: INTEGER; pl_result: INTEGER_REF)
			-- No description available.
		external
	...
	ccom_get_drop_target (cpp_obj: POINTER; pp_drop_target: CELL [IDROP_TARGET_INTERFACE])
			-- No description available.
		external
			"C++ [ecom_control_library::IOleInPlaceObjectWindowless_impl_proxy %"ecom_control_library_IOleInPlaceObjectWindowless_impl_proxy_s.h%"](EIF_OBJECT)"
		end

	ccom_delete_iole_in_place_object_windowless_impl_proxy (a_pointer: POINTER)
			-- Release resource
		external
	...
	ccom_create_iole_in_place_object_windowless_impl_proxy_from_pointer (a_pointer: POINTER): POINTER
			-- Create from pointer
		external
