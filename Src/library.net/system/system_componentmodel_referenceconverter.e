...
create
	make_referenceconverter

feature {NONE} -- Initialization

	frozen make_referenceconverter (type: SYSTEM_TYPE) is
		external
...
feature {NONE} -- Implementation
	...
	is_value_allowed (context: SYSTEM_COMPONENTMODEL_ITYPEDESCRIPTORCONTEXT; value: ANY): BOOLEAN is
		external
...
end -- class SYSTEM_COMPONENTMODEL_REFERENCECONVERTER
