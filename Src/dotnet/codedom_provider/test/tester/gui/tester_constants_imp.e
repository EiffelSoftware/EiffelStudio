...
feature -- Access
	...
	compile_compile_unit_label: STRING
	...
	generator_tab_title: STRING
			-- `Result' is STRING constant named `generator_tab_title'.
		once
			Result := "Generator"
		end

	generate_type_label: STRING
