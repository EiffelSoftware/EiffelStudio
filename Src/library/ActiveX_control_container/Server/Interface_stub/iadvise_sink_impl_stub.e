...
feature {NONE}  -- Externals
	...
	ccom_create_item (eif_object: IADVISE_SINK_IMPL_STUB): POINTER is
			-- Initialize `item'
		external
			"C++ [new ecom_control_library::IAdviseSink_impl_stub %"ecom_control_library_IAdviseSink_impl_stub_s.h%"](EIF_OBJECT)"
		end

end -- IADVISE_SINK_IMPL_STUB
