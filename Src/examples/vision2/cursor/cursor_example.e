...
feature -- Initialization
	...
	prepare is
		...
		do
			...
			a_menu_item.select_actions.extend (~on_exit)
			...
			a_button.select_actions.extend (~on_apply)
			a_hb2.extend (a_button)

			create a_button
			a_button.set_text (" Exit ")
			a_button.select_actions.extend (~on_exit)
			a_hb2.extend (a_button)
			...
			create my_label
			my_label.set_text ("Select a cursor in the list, and then%Npress the 'Apply' button to set the cursor")
