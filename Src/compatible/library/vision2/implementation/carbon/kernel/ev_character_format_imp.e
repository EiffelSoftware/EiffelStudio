...
feature {EV_RICH_TEXT_IMP} -- Implementation
	...
	family_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	size_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	style_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	weight_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	foreground_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	background_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	foreground_gdk_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	background_gdk_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	underline_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	strikethrough_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end

	rise_string: EV_CARBON_CF_STRING
			-- String optimization
		once
		end
