...
class
	ECD_PROPERTY_EXPRESSION_FACTORY
...
feature {ECD_CONSUMER_FACTORY} -- Visitor features.
	...
	generate_property_reference_expression (a_source: SYSTEM_DLL_CODE_PROPERTY_REFERENCE_EXPRESSION) is
		...
		local
			a_property_reference_expression: ECD_PROPERTY_REFERENCE_EXPRESSION
		do
	...
	generate_property_set_value_reference_expression (a_source: SYSTEM_DLL_CODE_PROPERTY_SET_VALUE_REFERENCE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_property_set_value_reference_expression: ECD_PROPERTY_SET_VALUE_REFERENCE_EXPRESSION
		do
...
feature {NONE} -- Implementation
	...
	initialize_property_reference_expression (a_source: SYSTEM_DLL_CODE_PROPERTY_REFERENCE_EXPRESSION; a_property_reference_expression: ECD_PROPERTY_REFERENCE_EXPRESSION) is
	...
	initialize_property_set_value_reference_expression (a_source: SYSTEM_DLL_CODE_PROPERTY_SET_VALUE_REFERENCE_EXPRESSION;
															a_property_set_value_reference_expression: ECD_PROPERTY_SET_VALUE_REFERENCE_EXPRESSION) is
			-- Generate Eiffel code from `a_source'.
