...
feature -- Token codes
	...
	TE_OLD: INTEGER = 293
	TE_DOT: INTEGER = 294
	TE_LPARAN: INTEGER = 295
	TE_BLOCK_OPEN: INTEGER = 296
	TE_ID: INTEGER = 297
	TE_TUPLE: INTEGER = 298
	TE_INTEGER: INTEGER = 299
	TE_REAL: INTEGER = 300
	TE_CHAR: INTEGER = 301
	TE_LSQURE: INTEGER = 302
	TE_RSQURE: INTEGER = 303
	TE_ACCEPT: INTEGER = 304
	TE_ADDRESS: INTEGER = 305
	TE_LARRAY: INTEGER = 306
	TE_RARRAY: INTEGER = 307
	TE_RPARAN: INTEGER = 308
	TE_LCURLY: INTEGER = 309
	TE_RCURLY: INTEGER = 310
	TE_SEMICOLON: INTEGER = 311
	TE_COLON: INTEGER = 312
	TE_COMMA: INTEGER = 313
	TE_BAR: INTEGER = 314
	TE_CONSTRAIN: INTEGER = 315
	TE_QUESTION: INTEGER = 316
	TE_BLOCK_CLOSE: INTEGER = 317
	TE_FALSE: INTEGER = 318
	TE_TRUE: INTEGER = 319
	TE_RESULT: INTEGER = 320
	TE_RETRY: INTEGER = 321
	TE_UNIQUE: INTEGER = 322
	TE_CURRENT: INTEGER = 323
	TE_DEFERRED: INTEGER = 324
	TE_VOID: INTEGER = 325
	TE_END: INTEGER = 326
	TE_FROZEN: INTEGER = 327
	TE_PARTIAL_CLASS: INTEGER = 328
	TE_CREATION: INTEGER = 329
	TE_PRECURSOR: INTEGER = 330
	TE_AGENT: INTEGER = 331
	TE_ALIAS: INTEGER = 332
	TE_ALL: INTEGER = 333
	TE_AS: INTEGER = 334
	TE_CHECK: INTEGER = 335
	TE_CLASS: INTEGER = 336
	TE_CONVERT: INTEGER = 337
	TE_CREATE: INTEGER = 338
	TE_DEBUG: INTEGER = 339
	TE_DO: INTEGER = 340
	TE_ELSE: INTEGER = 341
	TE_ELSEIF: INTEGER = 342
	TE_ENSURE: INTEGER = 343
	TE_EXPANDED: INTEGER = 344
	TE_EXPORT: INTEGER = 345
	TE_EXTERNAL: INTEGER = 346
	TE_FEATURE: INTEGER = 347
	TE_FROM: INTEGER = 348
	TE_IF: INTEGER = 349
	TE_INHERIT: INTEGER = 350
	TE_INSPECT: INTEGER = 351
	TE_INVARIANT: INTEGER = 352
	TE_LIKE: INTEGER = 353
	TE_LOCAL: INTEGER = 354
	TE_LOOP: INTEGER = 355
	TE_OBSOLETE: INTEGER = 356
	TE_ONCE: INTEGER = 357
	TE_ONCE_STRING: INTEGER = 358
	TE_REDEFINE: INTEGER = 359
	TE_REFERENCE: INTEGER = 360
	TE_RENAME: INTEGER = 361
	TE_REQUIRE: INTEGER = 362
	TE_RESCUE: INTEGER = 363
	TE_SELECT: INTEGER = 364
	TE_SEPARATE: INTEGER = 365
	TE_THEN: INTEGER = 366
	TE_UNDEFINE: INTEGER = 367
	TE_UNTIL: INTEGER = 368
	TE_VARIANT: INTEGER = 369
	TE_WHEN: INTEGER = 370
	TE_ACROSS: INTEGER = 371
	TE_ASSIGN: INTEGER = 372
	TE_ATTRIBUTE: INTEGER = 373
	TE_ATTACHED: INTEGER = 374
	TE_DETACHABLE: INTEGER = 375
	TE_INDEXING: INTEGER = 376
	TE_IS: INTEGER = 377
	TE_NOTE: INTEGER = 378
	TE_SOME: INTEGER = 379
	TE_STRING: INTEGER = 380
	TE_EMPTY_STRING: INTEGER = 381
	TE_VERBATIM_STRING: INTEGER = 382
	TE_EMPTY_VERBATIM_STRING: INTEGER = 383
	TE_STR_LT: INTEGER = 384
	TE_STR_LE: INTEGER = 385
	TE_STR_GT: INTEGER = 386
	TE_STR_GE: INTEGER = 387
	TE_STR_MINUS: INTEGER = 388
	TE_STR_PLUS: INTEGER = 389
	TE_STR_STAR: INTEGER = 390
	TE_STR_SLASH: INTEGER = 391
	TE_STR_MOD: INTEGER = 392
	TE_STR_DIV: INTEGER = 393
	TE_STR_POWER: INTEGER = 394
	TE_STR_AND: INTEGER = 395
	TE_STR_AND_THEN: INTEGER = 396
	TE_STR_IMPLIES: INTEGER = 397
	TE_STR_OR: INTEGER = 398
	TE_STR_OR_ELSE: INTEGER = 399
	TE_STR_XOR: INTEGER = 400
	TE_STR_NOT: INTEGER = 401
	TE_STR_FREE: INTEGER = 402
	TE_STR_BRACKET: INTEGER = 403
	TE_STR_PARENTHESES: INTEGER = 404
