...
#include "ecom_EiffelComCompiler_IEnumCluster_impl_proxy.h"
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ieiffel_cluster_descriptor = (ecom_EiffelComCompiler::IEiffelClusterDescriptor * *)grt_ec_ISE_c.ccom_ec_pointed_cell_50 (eif_access (pp_ieiffel_cluster_descriptor), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_50 ((ecom_EiffelComCompiler::IEiffelClusterDescriptor * *)tmp_pp_ieiffel_cluster_descriptor, pp_ieiffel_cluster_descriptor);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pul_count, pul_count);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_50 (tmp_pp_ieiffel_cluster_descriptor);
grt_ce_ISE_c.ccom_free_memory_pointed_126 (tmp_pul_count);
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ienum_cluster = (ecom_EiffelComCompiler::IEnumCluster * *)grt_ec_ISE_c.ccom_ec_pointed_cell_43 (eif_access (pp_ienum_cluster), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_43 ((ecom_EiffelComCompiler::IEnumCluster * *)tmp_pp_ienum_cluster, pp_ienum_cluster);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_43 (tmp_pp_ienum_cluster);
