...
#define WEBKIT_DOM_FILE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_FILE, WebKitDOMFileClass)
#define WEBKIT_DOM_IS_FILE(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_FILE))
#define WEBKIT_DOM_IS_FILE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_FILE))
