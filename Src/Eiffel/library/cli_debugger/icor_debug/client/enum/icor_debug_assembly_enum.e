...
class
	ICOR_DEBUG_ASSEMBLY_ENUM

inherit
	ICOR_DEBUG_ENUM_WITH_NEXT [ICOR_DEBUG_ASSEMBLY]
...
--	next (a_celt: INTEGER): ARRAY [ICOR_DEBUG_ASSEMBLY] is
--		require
...
feature {NONE} -- Implementation
	...
	cpp_next (obj: POINTER; a_celt: INTEGER; a_p: POINTER; a_pceltfetched: POINTER): INTEGER is
		external
			"[
				C++ ICorDebugAssemblyEnum signature(ULONG,ICorDebugAssembly**, ULONG*): EIF_INTEGER 
				use "cli_headers.h"
			]"
		alias
			"Next"
...
end -- class ICOR_DEBUG_ASSEMBLY_ENUM
