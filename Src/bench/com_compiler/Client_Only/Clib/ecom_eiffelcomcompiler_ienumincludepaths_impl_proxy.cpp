...
#include "ecom_EiffelComCompiler_IEnumIncludePaths_impl_proxy.h"
...
-----------------------------------------------------------*/
{
	...
	tmp_pbstr_include_path = (BSTR *)grt_ec_ISE_c.ccom_ec_pointed_cell_223 (eif_access (pbstr_include_path), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_223 ((BSTR *)tmp_pbstr_include_path, pbstr_include_path);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pul_fetched, pul_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_223 (tmp_pbstr_include_path);
grt_ce_ISE_c.ccom_free_memory_pointed_224 (tmp_pul_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ienum_include_paths = (ecom_EiffelComCompiler::IEnumIncludePaths * *)grt_ec_ISE_c.ccom_ec_pointed_cell_219 (eif_access (pp_ienum_include_paths), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_219 ((ecom_EiffelComCompiler::IEnumIncludePaths * *)tmp_pp_ienum_include_paths, pp_ienum_include_paths);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_219 (tmp_pp_ienum_include_paths);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_pbstr_include_path = 0;
	tmp_pbstr_include_path = (BSTR *)grt_ec_ISE_c.ccom_ec_pointed_cell_225 (eif_access (pbstr_include_path), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_225 ((BSTR *)tmp_pbstr_include_path, pbstr_include_path);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_225 (tmp_pbstr_include_path);
