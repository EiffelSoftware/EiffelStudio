...
#include "ecom_EiffelComCompiler_IEiffelCompiler_impl_proxy_s.h"
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_compile()
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_finalize()
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_precompile()
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_compile_to_pipe()
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_finalize_to_pipe()
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_precompile_to_pipe()
...
EIF_BOOLEAN ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_is_successful(  )
...
EIF_REFERENCE ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_expand_path(  /* [in] */ EIF_OBJECT a_path )
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_generate_msil_keyfile(  /* [in] */ EIF_OBJECT filename )
...
EIF_REFERENCE ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_output_pipe_name(  )
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_set_output_pipe_name(  /* [in] */ EIF_OBJECT return_value )
...
EIF_BOOLEAN ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_is_output_piped(  )
...
void ecom_EiffelComCompiler::IEiffelCompiler_impl_proxy::ccom_set_display_warnings(  /* [in] */ EIF_BOOLEAN vb_show )
...
-----------------------------------------------------------*/
{
	...
	VARIANT_BOOL tmp_vb_show = 0;
	tmp_vb_show = (VARIANT_BOOL)rt_ec.ccom_ec_boolean (vb_show);
	
	hr = p_IEiffelCompiler->set_display_warnings(tmp_vb_show);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
