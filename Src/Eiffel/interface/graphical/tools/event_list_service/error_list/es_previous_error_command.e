indexing
	description: "[
		A command to navigate to the previous error in the errors and warnings tool list {ES_ERRORS_AND_WARNINGS_TOOL}
	]"
...
feature {NONE} -- Initialization
	...
	make (a_commander: like tool_commander)
		...
		do
			...
			l_shortcut := preferences.misc_shortcut_data.shortcuts.item ("go_to_previous_error")
...
feature -- Access
	...
	pixel_buffer: EV_PIXEL_BUFFER
		...
		once
			Result := pixmaps.icon_pixmaps.errors_and_warnings_previous_error_icon_buffer
		end
...
feature -- Execution
	...
	execute
		...
		do
			tool_commander.go_to_previous_error (True)
		end
