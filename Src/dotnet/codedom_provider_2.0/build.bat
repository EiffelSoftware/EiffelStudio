...
IF EXIST bin\base\EIFGENS\base\F_code\EiffelSoftware.CodeDom.Base2_0.dll GOTO CACHE
...
IF EXIST bin\cache_browser\EIFGENS\cache_browser\F_code\EiffelSoftware.CodeDom.CacheBrowser2_0.dll GOTO PROVIDER
...
IF EXIST bin\codedom_provider\EIFGENS\%TARGET%\F_code\EiffelSoftware.CodeDom2_0.dll GOTO VISION2
...
IF EXIST bin\vision2\EIFGENS\vision2\F_code\EiffelSoftware.CodeDom.Vision2_0.dll GOTO MANAGER
...
IF EXIST bin\manager\EIFGENS\%TARGET%\F_code\ecdpman2_0.exe GOTO SPLITTER
...
IF EXIST bin\esplit\EIFGENS\graphical_%TARGET%\F_code\esplitter2_0.exe GOTO SPLIT
...
IF EXIST bin\esplit\EIFGENS\console_%TARGET%\F_code\esplit2_0.exe GOTO NMAP
