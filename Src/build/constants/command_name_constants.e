indexing
	description: "Names given for undoable commands inserted %
				%into history list."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature -- Context commands
	...
	Cont_perm_maximize_cmd_name: STRING is "Maximize state"
	Cont_perm_normal_cmd_name: STRING is "Normal state"
	...
	Cont_set_border_width_cmd_name: STRING is "Set border width"
	Cont_set_default_text_cmd_name: STRING is "Set default text"
	Cont_set_expand_cmd_name: STRING is "Expandable"
	Cont_set_homogeneous_cmd_name: STRING is "Set homogeneous"
	Cont_set_horizontal_resize_cmd_name: STRING is "Width sizeable"
	Cont_set_minimum_size_cmd_name: STRING is "Set minimum size"
	Cont_set_position_cmd_name: STRING is "Set position"
	Cont_set_spacing_cmd_name: STRING is "Set spacing"
	Cont_set_size_cmd_name: STRING is "Set size"
	Cont_set_vertical_resize_cmd_name: STRING is "Height sizeable"
	...
	Cont_win_resize_cmd_name: STRING is "Forbid resize"
