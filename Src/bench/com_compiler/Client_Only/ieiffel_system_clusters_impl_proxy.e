...
feature {NONE}  -- Externals
	...
	ccom_cluster_tree (cpp_obj: POINTER): IENUM_CLUSTER_PROP_INTERFACE is
			-- Cluster tree.
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"](): EIF_REFERENCE"
		end
	...
	ccom_store (cpp_obj: POINTER) is
			-- Save changes.
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"]()"
		end

	ccom_add_cluster (cpp_obj: POINTER; cluster_name: STRING; parent_name: STRING; cluster_path: STRING) is
			-- Add a cluster to the project.
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT,EIF_OBJECT)"
		end

	ccom_remove_cluster (cpp_obj: POINTER; cluster_name: STRING) is
			-- Remove a cluster from the project.
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT)"
		end

	ccom_cluster_properties (cpp_obj: POINTER; cluster_name: STRING): IEIFFEL_CLUSTER_PROPERTIES_INTERFACE is
			-- Cluster properties.
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT): EIF_REFERENCE"
		end

	ccom_cluster_properties_by_id (cpp_obj: POINTER; cluster_id: INTEGER): IEIFFEL_CLUSTER_PROPERTIES_INTERFACE is
			-- Cluster properties.
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_INTEGER): EIF_REFERENCE"
		end

	ccom_change_cluster_name (cpp_obj: POINTER; a_name: STRING; a_new_name: STRING) is
			-- Change cluster name.
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT)"
		end

	ccom_is_valid_name (cpp_obj: POINTER; cluster_name: STRING): BOOLEAN is
			-- Checks to see if a cluster name is valid
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT): EIF_BOOLEAN"
		end
	...
	ccom_delete_ieiffel_system_clusters_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_system_clusters_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"]():EIF_POINTER"
		end

	ccom_last_error_code (cpp_obj: POINTER): INTEGER is
			-- Last error code
		external
			"C++ [ecom_eiffel_compiler::IEiffelSystemClusters_impl_proxy %"ecom_eiffel_compiler_IEiffelSystemClusters_impl_proxy.h%"]():EIF_INTEGER"
		end
