...
-----------------------------------------------------------*/
{
	...
	grt_ce_ISE.ccom_free_memory_pointed_105 (tmp_return_value);
...
EIF_REFERENCE ecom_eiffel_compiler::IEiffelFeatureDescriptor_impl_proxy::ccom_parameters(  )
...
-----------------------------------------------------------*/
{
	...
	ecom_eiffel_compiler::IEnumParameter * ret_value = 0;
	...
	EIF_REFERENCE eiffel_result = eif_protect ((EIF_REFERENCE)grt_ce_ISE.ccom_ce_pointed_interface_77 (ret_value));
	return eif_wean (eiffel_result);
};
/*----------------------------------------------------------------------------------------------------------------------*/

EIF_REFERENCE ecom_eiffel_compiler::IEiffelFeatureDescriptor_impl_proxy::ccom_return_type(  )
...
-----------------------------------------------------------*/
{
	...
	tmp_file_path = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_80 (eif_access (file_path), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_80 ((BSTR *)tmp_file_path, file_path);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_line_number, line_number);
	
	grt_ce_ISE.ccom_free_memory_pointed_80 (tmp_file_path);
grt_ce_ISE.ccom_free_memory_pointed_81 (tmp_line_number);
