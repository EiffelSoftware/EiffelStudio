note
	description: "[
			Summary description for {MD_IMPORT}.
			FIXME FIXME FIXME
		]"
	date: "$Date$"
	revision: "$Revision$"
...
feature -- Enumerating collections
	...
	count_enum (a_enum_hdl: POINTER): INTEGER
			...
			-- EnumXXX call (for example, EnumTypeDefs).
		do
			set_last_call_success (cpp_count_enum (item, a_enum_hdl, $Result))
		end
	...
	reset_enum (a_enum_hdl: POINTER; a_pos: INTEGER)
		...
		do
			set_last_call_success (cpp_reset_enum (item, a_enum_hdl, a_pos))
		end
	...
	enum_type_defs (a_enum_hdl: TYPED_POINTER [POINTER]; a_typedef: NATURAL_32; a_max_count: INTEGER): detachable ARRAY [NATURAL_32]
		...
		do
			...
			set_last_call_success (cpp_enum_type_defs (item, a_enum_hdl, l_mp_tokens.item , a_max_count, $l_count))
			if
	...
	enum_interface_impls (a_enum_hdl: TYPED_POINTER [POINTER]; a_typedef: NATURAL_32; a_size: INTEGER): detachable ARRAY [NATURAL_32]
		...
		do
			...
			set_last_call_success (cpp_enum_interface_impls (item, a_enum_hdl, a_typedef, l_mp_tokens.item, a_size, $l_count))
			if
				(last_call_success = 0 or last_call_success = 1 )
				and then l_count > 0
			then
	...
	enum_members (a_enum_hdl: TYPED_POINTER [POINTER]; a_typedef: NATURAL_32; a_max_count: INTEGER): detachable ARRAY [NATURAL_32]
		...
		do
			...
			set_last_call_success (cpp_enum_members (item, a_enum_hdl, a_typedef, l_mp_tokens.item , a_max_count, $l_count))
			if
				(last_call_success = 0 or last_call_success = 1 )
				and then l_count > 0
			then
	...
	enum_methods (a_enum_hdl: TYPED_POINTER [POINTER]; a_typedef: NATURAL_32; a_max_count: INTEGER): detachable ARRAY [NATURAL_32]
		...
		do
			...
			set_last_call_success (cpp_enum_methods (item, a_enum_hdl, a_typedef, l_mp_tokens.item , a_max_count, $l_count))
			if
				(last_call_success = 0 or last_call_success = 1 )
				and then l_count > 0
			then
	...
	enum_fields (a_enum_hdl: TYPED_POINTER [POINTER]; a_typedef: NATURAL_32; a_max_count: INTEGER): detachable ARRAY [NATURAL_32]
		...
		do
			...
			set_last_call_success (cpp_enum_fields (item, a_enum_hdl, a_typedef, l_mp_tokens.item , a_max_count, $l_count))
	...
	enum_properties (a_enum_hdl: TYPED_POINTER [POINTER]; a_typedef: NATURAL_32; a_max_count: INTEGER): detachable ARRAY [NATURAL_32]
		...
		do
			...
			set_last_call_success (cpp_enum_properties (item, a_enum_hdl, a_typedef, l_mp_tokens.item , a_max_count, $l_count))
	...
	enum_params (a_enum_hdl: TYPED_POINTER [POINTER]; a_typedef: NATURAL_32; a_max_count: INTEGER): detachable ARRAY [NATURAL_32]
		...
		do
			...
			set_last_call_success (cpp_enum_params (item, a_enum_hdl, a_typedef, l_mp_tokens.item , a_max_count, $l_count))
			if
				(last_call_success = 0 or last_call_success = 1 )
				and then l_count > 0
			then
...
feature -- Finding specific item in MetaData
	...
	find_type_def_by_name (a_name: STRING; a_encloser_tok: NATURAL_32): NATURAL_32
		...
		do
			...
			set_last_call_success (cpp_find_type_def_by_name (item, l_name.item, a_encloser_tok, $Result))
		end
	...
	find_member (a_typedef: NATURAL_32; a_name: STRING): NATURAL_32
		...
		do
			create l_name.make (a_name)
			set_last_call_success (cpp_find_member (item, a_typedef, l_name.item,
	...
	find_method (a_typedef: NATURAL_32; a_name: STRING): NATURAL_32
		...
		do
			create l_name.make (a_name)
			set_last_call_success (cpp_find_method (item, a_typedef, l_name.item,
					Default_pointer, 0, -- Signature purpose ...
					$Result)
				)
		end
	...
	find_field (a_typedef: NATURAL_32; a_name: STRING): NATURAL_32
		...
		do
			create l_name.make (a_name)
			set_last_call_success (cpp_find_field (item, a_typedef, l_name.item,
					Default_pointer, 0, -- Signature purpose ...
					$Result)
				)
		end
...
feature -- Obtaining Properties of a Specified Object
	...
	get_typedef_props (a_tok: NATURAL_32): detachable STRING_32
		...
		do
			...
			set_last_call_success (cpp_get_typedef_props (item, a_tok, mp_name.item, 255, $l_rsize, l_flag, $l_tkext))
	...
	get_interface_impl_props (a_interface_impl: NATURAL_32): NATURAL_32
		...
		do
			set_last_call_success (cpp_get_interface_impl_props (item, a_interface_impl, $Result, $l_interf_tok))
		end
	...
	get_member_props (a_tok: NATURAL_32): detachable TUPLE [name: STRING_32; flag: INTEGER]
		...
		do
			...
			set_last_call_success (cpp_get_member_props (item, a_tok, $l_r_classtoken, mp_name.item, 255, $l_rsize,
				$l_flag,
				l_sig, $l_sigsize,
				$l_code_rva, l_pdwimpl_flags, l_cplustype_flag, l_cst_ppvalue, $l_pcchvalue)
				)
			if mp_name.item /= Default_pointer then
				Result := [(create {CLI_STRING}.make_by_pointer (mp_name.item)).string_32, l_flag]
			end
		end
	...
	get_method_props (a_tok: NATURAL_32): detachable STRING_32
		...
		do
			...
			set_last_call_success (cpp_get_method_props (item, a_tok, $l_r_classtoken, mp_name.item, 255, $l_rsize,
	...
	get_field_props (a_tok: NATURAL_32): detachable STRING_32
		...
		do
			...
			set_last_call_success (cpp_get_field_props (item, a_tok, $l_r_classtoken, mp_name.item, 255, $l_rsize,
	...
	get_property_props (a_tok: NATURAL_32): detachable TUPLE [name: STRING_32; getter: NATURAL_32; flag: INTEGER]
		...
		do
			...
			create mp_name.make (256 * 2)
			set_last_call_success (cpp_get_property_props (item, a_tok, $l_r_classtoken, mp_name.item, 255, $l_rsize,
			...
			if mp_name.item /= Default_pointer then
				Result := [(create {CLI_STRING}.make_by_pointer (mp_name.item)).string_32, l_getter, last_get_property_flags]
			end
		end
...
feature -- Status
	...
	is_global (a_tok: NATURAL_32): BOOLEAN
		...
		local
			r: INTEGER
		do
			set_last_call_success (cpp_is_global (item, a_tok, $r))
