...
void ecom_control_library::IBindHost_impl_proxy::ccom_create_moniker(  /* [in] */ EIF_OBJECT sz_name,  /* [in] */ ecom_control_library::IBindCtx * pbc,  /* [out] */ EIF_OBJECT ppmk,  /* [in] */ EIF_INTEGER dw_reserved )
...
void ecom_control_library::IBindHost_impl_proxy::ccom_remote_moniker_bind_to_storage(  /* [in] */ ecom_control_library::IMoniker * pmk,  /* [in] */ ecom_control_library::IBindCtx * pbc,  /* [in] */ ecom_control_library::IBindStatusCallback * p_bsc,  /* [in] */ GUID * riid,  /* [out] */ EIF_OBJECT ppv_obj )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IBindHost->RemoteMonikerBindToStorage(pmk,pbc,p_bsc,riid,tmp_ppv_obj);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IBindHost_impl_proxy::ccom_remote_moniker_bind_to_object(  /* [in] */ ecom_control_library::IMoniker * pmk,  /* [in] */ ecom_control_library::IBindCtx * pbc,  /* [in] */ ecom_control_library::IBindStatusCallback * p_bsc,  /* [in] */ GUID * riid,  /* [out] */ EIF_OBJECT ppv_obj )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IBindHost->RemoteMonikerBindToObject(pmk,pbc,p_bsc,riid,tmp_ppv_obj);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
