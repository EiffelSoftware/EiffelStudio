...
feature -- Modification
	...
	register_exception_clause (clause: CIL_MD_EXCEPTION_CLAUSE)
...
feature -- Saving
	...
	write_to_stream (m: MANAGED_POINTER; pos: INTEGER)
		...
		do
			if is_fat then
				kind := {CIL_MD_METHOD_CONSTANTS}.Section_ehtable |
					{CIL_MD_METHOD_CONSTANTS}.Section_fat_format
...
end -- class CIL_MD_METHOD_SECTION_HEADER
