...
feature -- Access
	...
	dotnet_type_name (a_dotnet_feature_name: STRING): STRING is
		...
		do
			...
			elseif Variables.has (a_dotnet_feature_name) then
				...
				(create {ECDP_EVENT_MANAGER}).raise_event (feature {ECDP_EVENTS_IDS}.Missing_feature, [a_dotnet_feature_name, "current type"])
			end
		ensure
	...
	feature_result_type (a_caller_type: TYPE; a_dotnet_feature_name: STRING; a_feature_arguments: LINKED_LIST [ECDP_EXPRESSION]): STRING is
...
end -- class ECDP_ENTITY_NAME_RESOLVER
