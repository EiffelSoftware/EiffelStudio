...
feature -- Access
	...
	view_editor_feature_buffer: EV_PIXEL_BUFFER is
		...
		once
			Result := pixel_buffer_from_coords (8, 14)
		end
	...
	view_clickable_feature_buffer: EV_PIXEL_BUFFER is
		...
		once
			Result := pixel_buffer_from_coords (9, 14)
		end
	...
	view_unmodified_buffer: EV_PIXEL_BUFFER is
		...
		once
			Result := pixel_buffer_from_coords (10, 14)
		end
