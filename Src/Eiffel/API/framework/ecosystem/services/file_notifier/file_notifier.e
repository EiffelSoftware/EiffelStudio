...
feature {NONE} -- Access
	...
	file_records: DS_HASH_TABLE [FILE_NOTIFIER_RECORD, like file_name_key]
	...
	file_modified_callbacks: DS_HASH_TABLE [EVENT_TYPE [TUPLE [modification_type: NATURAL_8]], like file_name_key]
