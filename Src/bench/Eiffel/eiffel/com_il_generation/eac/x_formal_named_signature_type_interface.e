...
feature -- Status Report
	...
	set_generic_parameter_index_user_precondition (an_index: INTEGER): BOOLEAN is
			-- User-defined preconditions for `set_generic_parameter_index'.
			-- Redefine in descendants if needed.
		do
			Result := True
		end

	generic_parameter_index_user_precondition: BOOLEAN is
			-- User-defined preconditions for `generic_parameter_index'.
			-- Redefine in descendants if needed.
		do
			Result := True
		end

	x_internal_generic_parameter_index_user_precondition: BOOLEAN is
			-- User-defined preconditions for `x_internal_generic_parameter_index'.
			-- Redefine in descendants if needed.
		do
			Result := True
		end

	set__internal_generic_parameter_index_user_precondition (p_ret_val: INTEGER): BOOLEAN is
			-- User-defined preconditions for `set__internal_generic_parameter_index'.
			-- Redefine in descendants if needed.
		do
			Result := True
		end
...
feature -- Basic Operations
	...
	set_generic_parameter_index (an_index: INTEGER) is
			...
			-- `an_index' [in].  
		require
			set_generic_parameter_index_user_precondition: set_generic_parameter_index_user_precondition (an_index)
		deferred
	...
	generic_parameter_index: INTEGER is
			-- No description available.
		require
			generic_parameter_index_user_precondition: generic_parameter_index_user_precondition
		deferred
	...
	x_internal_generic_parameter_index: INTEGER is
			-- No description available.
		require
			x_internal_generic_parameter_index_user_precondition: x_internal_generic_parameter_index_user_precondition
		deferred
	...
	set__internal_generic_parameter_index (p_ret_val: INTEGER) is
			...
			-- `p_ret_val' [in].  
		require
			set__internal_generic_parameter_index_user_precondition: set__internal_generic_parameter_index_user_precondition (p_ret_val)
		deferred
...
end -- X_FORMAL_NAMED_SIGNATURE_TYPE_INTERFACE
