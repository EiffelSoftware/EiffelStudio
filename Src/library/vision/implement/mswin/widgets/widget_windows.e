...
feature  -- Status report
	...
	screen_cursor: SCREEN_CURSOR_WINDOWS;
...
feature -- Status setting
	...
	grab (a_cursor: SCREEN_CURSOR) is
		...
		local
			cursor_windows: SCREEN_CURSOR_WINDOWS
		do
			if exists then
				wel_set_capture
			end;
	...
	set_managed (flag: BOOLEAN) is
			...
			-- otherwise.
		local
			cw: COMPOSITE_WINDOWS;
			i: INTEGER;
			c: ARRAY [WIDGET_WINDOWS]
		do
			managed := flag;
...
feature {NONE} -- Implementation
	...
	left_button_down_widget_implementation: CELL [WIDGET_WINDOWS] is
	...
	middle_button_down_widget_implementation: CELL [WIDGET_WINDOWS] is
	...
	right_button_down_widget_implementation: CELL [WIDGET_WINDOWS] is
	...
	grabbed_cursor: SCREEN_CURSOR_WINDOWS is
			-- Grabbed screen cursor
		do
			Result := grabbed_cursor_implementation.item
		end;

	grabbed_cursor_implementation: CELL [SCREEN_CURSOR_WINDOWS] is
