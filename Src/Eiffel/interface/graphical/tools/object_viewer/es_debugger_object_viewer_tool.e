indexing
	description: "[
		Tool descriptor for the debugger's single object viewer tool.
	]"
...
frozen class
	ES_DEBUGGER_OBJECT_VIEWER_TOOL

inherit
	ES_DEBUGGER_TOOL [EB_OBJECT_VIEWERS_TOOL]
...
feature -- Access
	...
	icon: EV_PIXEL_BUFFER
		...
		do
			Result := stock_pixmaps.debugger_object_expand_icon_buffer
		end
	...
	icon_pixmap: EV_PIXMAP
			...
			-- Note: Do not call `tool.icon' as it will create the tool unnecessarly!
		do
			Result := stock_pixmaps.debugger_object_expand_icon
		end
...
feature {NONE} -- Factory
	...
	create_tool: EB_OBJECT_VIEWERS_TOOL
