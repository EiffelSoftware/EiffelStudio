...
feature -- Access
	...
	names: HASH_TABLE [EC_RGB_TRIPLE, STRING] is
	...
	get_color (color_name: STRING): EV_COLOR is
		local
			rgb_triple: EC_RGB_TRIPLE
		do
			rgb_triple := names.item (color_name)
			if rgb_triple /= Void then
				!! Result.make_rgb (rgb_triple.red, rgb_triple.green, rgb_triple.blue)
