note
	description: "EiffelVision Widget ER_CONTEXT_MENU_NODE_WIDGET.%
...
feature {NONE} -- Initialization
	...
	user_create_interface_objects
			-- Create any auxilliary objects needed for ER_CONTEXT_MENU_NODE_WIDGET.
