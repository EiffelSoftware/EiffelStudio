...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelFeatureDescriptor * *)grt_ec_ISE.ccom_ec_pointed_cell_58 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_58 ((ecom_eiffel_compiler::IEiffelFeatureDescriptor * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_58 (tmp_rgelt);
grt_ce_ISE.ccom_free_memory_pointed_86 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumFeature * *)grt_ec_ISE.ccom_ec_pointed_cell_61 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_61 ((ecom_eiffel_compiler::IEnumFeature * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_61 (tmp_ppenum);
