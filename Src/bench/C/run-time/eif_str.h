...
RT_LNK void str_replace(char *str, char *new, int string_length, int new_len, int start, int end);
RT_LNK void str_insert(char *str, char *new, int string_length, int new_len, int idx);
...
RT_LNK void str_take(char *str, char *new, long int start, long int end);
...
RT_LNK void str_append(char *str, char *new, int string_length, int new_len);
RT_LNK void str_rmchar(char *str, int l, int i);
RT_LNK int str_rmall(char *str, char c, int l);
RT_LNK void str_mirror(register char *str, register char *new, register int len);
