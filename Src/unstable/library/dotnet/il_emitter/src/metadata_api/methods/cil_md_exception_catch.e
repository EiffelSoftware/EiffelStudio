...
feature -- Status report
	...
	is_defined: BOOLEAN
		...
		do
			...
			valid_class_token: Result implies
				(class_token & {CIL_MD_TOKEN_TYPES}.md_mask = {CIL_MD_TOKEN_TYPES}.md_type_def or else
				class_token & {CIL_MD_TOKEN_TYPES}.md_mask = {CIL_MD_TOKEN_TYPES}.md_type_ref or else
				class_token & {CIL_MD_TOKEN_TYPES}.md_mask = {CIL_MD_TOKEN_TYPES}.md_type_spec)
	...
	flags: INTEGER_16
		...
		do
			Result := {CIL_MD_METHOD_CONSTANTS}.clause_exception
		ensure then
			definition: Result = {CIL_MD_METHOD_CONSTANTS}.clause_exception
		end
...
feature -- Modification
	...
	set_class_token (token: like class_token)
		...
		require
			valid_token:
				token & {CIL_MD_TOKEN_TYPES}.md_mask = {CIL_MD_TOKEN_TYPES}.md_type_def or else
				token & {CIL_MD_TOKEN_TYPES}.md_mask = {CIL_MD_TOKEN_TYPES}.md_type_ref or else
				token & {CIL_MD_TOKEN_TYPES}.md_mask = {CIL_MD_TOKEN_TYPES}.md_type_spec
		do
			class_token := token
		ensure
