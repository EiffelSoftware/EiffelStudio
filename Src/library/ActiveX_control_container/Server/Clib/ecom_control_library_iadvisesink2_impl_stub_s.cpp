...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::OnDataChange(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc, /* [in] */ ecom_control_library::wireASYNC_STGMEDIUM * p_stgmed )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::OnViewChange(  /* [in] */ ULONG dw_aspect, /* [in] */ LONG lindex )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::OnRename(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::OnSave( void )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::OnClose( void )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::OnLinkSrcChange(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
-----------------------------------------------------------*/
{
  ...
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("on_link_src_change", type_id);
