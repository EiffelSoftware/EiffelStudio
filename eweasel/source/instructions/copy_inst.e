	...
	inst_initialize (line: STRING) is
		...
		do
			...
			if args.count /= 3 then
				...
				source_file := args.i_th (1);
				dest_directory := args.i_th (2);
				dest_file := args.i_th (3);
				init_ok := True;
			end
		end;
...
feature {NONE}  -- Implementation
	...
	copy_file (src: like new_file; env: TEST_ENVIRONMENT; dest: like new_file) is
