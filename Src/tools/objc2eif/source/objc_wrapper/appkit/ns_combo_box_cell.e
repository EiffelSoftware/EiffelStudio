...
feature -- NSComboBoxCell
	...
	completed_string_ (a_string: detachable NS_STRING): detachable NS_STRING
			-- Auto generated Objective-C wrapper.
		local
		...
		do
			...
			result_pointer := objc_completed_string_ (item, a_string__item)
			if result_pointer /= default_pointer then
				if attached objc_get_eiffel_object (result_pointer) as existing_eiffel_object then
					check attached {like completed_string_} existing_eiffel_object as valid_result then
						Result := valid_result
					end
				else
					check attached {like completed_string_} new_eiffel_object (result_pointer, True) as valid_result_pointer then
	...
	data_source: detachable NS_COMBO_BOX_CELL_DATA_SOURCE_PROTOCOL
			-- Auto generated Objective-C wrapper.
		local
			result_pointer: POINTER
		do
	...
	set_data_source_ (a_source: detachable NS_COMBO_BOX_CELL_DATA_SOURCE_PROTOCOL)
			-- Auto generated Objective-C wrapper.
		local
...
feature {NONE} -- NSComboBoxCell Externals
	...
	objc_has_vertical_scroller (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item hasVerticalScroller];
			 ]"
		end
	...
	objc_set_has_vertical_scroller_ (an_item: POINTER; a_flag: BOOLEAN)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item setHasVerticalScroller:$a_flag];
			 ]"
		end
	...
	objc_intercell_spacing (an_item: POINTER; result_pointer: POINTER)
		...
		alias
			"[
				*(NSSize *)$result_pointer = [(NSComboBoxCell *)$an_item intercellSpacing];
			 ]"
		end
	...
	objc_set_intercell_spacing_ (an_item: POINTER; a_size: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item setIntercellSpacing:*((NSSize *)$a_size)];
			 ]"
		end
	...
	objc_item_height (an_item: POINTER): REAL_64
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item itemHeight];
			 ]"
		end
	...
	objc_set_item_height_ (an_item: POINTER; a_item_height: REAL_64)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item setItemHeight:$a_item_height];
			 ]"
		end
	...
	objc_number_of_visible_items (an_item: POINTER): INTEGER_64
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item numberOfVisibleItems];
			 ]"
		end
	...
	objc_set_number_of_visible_items_ (an_item: POINTER; a_visible_items: INTEGER_64)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item setNumberOfVisibleItems:$a_visible_items];
			 ]"
		end
	...
	objc_set_button_bordered_ (an_item: POINTER; a_flag: BOOLEAN)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item setButtonBordered:$a_flag];
			 ]"
		end
	...
	objc_is_button_bordered (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item isButtonBordered];
			 ]"
		end
	...
	objc_reload_data (an_item: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item reloadData];
			 ]"
		end
	...
	objc_note_number_of_items_changed (an_item: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item noteNumberOfItemsChanged];
			 ]"
		end
	...
	objc_set_uses_data_source_ (an_item: POINTER; a_flag: BOOLEAN)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item setUsesDataSource:$a_flag];
			 ]"
		end
	...
	objc_uses_data_source (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item usesDataSource];
			 ]"
		end
	...
	objc_scroll_item_at_index_to_top_ (an_item: POINTER; a_index: INTEGER_64)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item scrollItemAtIndexToTop:$a_index];
			 ]"
		end
	...
	objc_scroll_item_at_index_to_visible_ (an_item: POINTER; a_index: INTEGER_64)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item scrollItemAtIndexToVisible:$a_index];
			 ]"
		end
	...
	objc_select_item_at_index_ (an_item: POINTER; a_index: INTEGER_64)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item selectItemAtIndex:$a_index];
			 ]"
		end
	...
	objc_deselect_item_at_index_ (an_item: POINTER; a_index: INTEGER_64)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item deselectItemAtIndex:$a_index];
			 ]"
		end
	...
	objc_index_of_selected_item (an_item: POINTER): INTEGER_64
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item indexOfSelectedItem];
			 ]"
		end
	...
	objc_number_of_items (an_item: POINTER): INTEGER_64
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item numberOfItems];
			 ]"
		end
	...
	objc_completes (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item completes];
			 ]"
		end
	...
	objc_set_completes_ (an_item: POINTER; a_completes: BOOLEAN)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item setCompletes:$a_completes];
			 ]"
		end

	objc_completed_string_ (an_item: POINTER; a_string: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(NSComboBoxCell *)$an_item completedString:$a_string];
			 ]"
		end
	...
	objc_data_source (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSComboBoxCell *)$an_item dataSource];
			 ]"
		end
	...
	objc_set_data_source_ (an_item: POINTER; a_source: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item setDataSource:$a_source];
			 ]"
		end
	...
	objc_add_item_with_object_value_ (an_item: POINTER; a_object: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item addItemWithObjectValue:$a_object];
			 ]"
		end
	...
	objc_add_items_with_object_values_ (an_item: POINTER; a_objects: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item addItemsWithObjectValues:$a_objects];
			 ]"
		end
	...
	objc_insert_item_with_object_value__at_index_ (an_item: POINTER; a_object: POINTER; a_index: INTEGER_64)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item insertItemWithObjectValue:$a_object atIndex:$a_index];
			 ]"
		end
	...
	objc_remove_item_with_object_value_ (an_item: POINTER; a_object: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item removeItemWithObjectValue:$a_object];
			 ]"
		end
	...
	objc_remove_item_at_index_ (an_item: POINTER; a_index: INTEGER_64)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item removeItemAtIndex:$a_index];
			 ]"
		end
	...
	objc_remove_all_items (an_item: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item removeAllItems];
			 ]"
		end
	...
	objc_select_item_with_object_value_ (an_item: POINTER; a_object: POINTER)
		...
		alias
			"[
				[(NSComboBoxCell *)$an_item selectItemWithObjectValue:$a_object];
			 ]"
		end
	...
	objc_item_object_value_at_index_ (an_item: POINTER; a_index: INTEGER_64): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSComboBoxCell *)$an_item itemObjectValueAtIndex:$a_index];
			 ]"
		end
	...
	objc_object_value_of_selected_item (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSComboBoxCell *)$an_item objectValueOfSelectedItem];
			 ]"
		end
	...
	objc_index_of_item_with_object_value_ (an_item: POINTER; a_object: POINTER): INTEGER_64
		...
		alias
			"[
				return [(NSComboBoxCell *)$an_item indexOfItemWithObjectValue:$a_object];
			 ]"
		end
	...
	objc_object_values (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSComboBoxCell *)$an_item objectValues];
			 ]"
		end
