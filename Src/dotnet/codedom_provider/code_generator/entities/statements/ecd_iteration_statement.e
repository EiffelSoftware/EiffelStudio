...
feature -- Access
	...
	init_statement: ECD_STATEMENT
			-- Initialization statement
			
	test_expression: ECD_EXPRESSION
			-- Test expression
	
	loop_statements: LINKED_LIST [ECD_STATEMENT]
			-- | ARRAY_LIST [ECD_STATEMENT]
			-- Loop statements
			
	increment_statement: ECD_STATEMENT
			-- Increment statement
...
feature -- Status Setting
	...
	add_loop_statement (a_statement: ECD_STATEMENT) is
...
feature {NONE} -- Implementation
	...
	is_statement_ready (a_statement: ECD_STATEMENT): BOOLEAN is
...
end -- class ECD_ITERATION_STATEMENT
