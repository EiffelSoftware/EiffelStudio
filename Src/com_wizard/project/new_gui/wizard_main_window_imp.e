...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			l_ev_vertical_box_1.extend (project_delete_button)
			...
			l_ev_vertical_box_1.disable_item_expand (project_delete_button)
			project_delete_button.disable_sensitive
			project_delete_button.set_text ("Delete")
			project_delete_button.set_minimum_width (100)
			...
			com_server_project_radio_button.set_text ("Create a new COM component from scratch")
			...
			project_delete_button.select_actions.extend (agent on_delete_project)
...
feature -- Access
	...
	in_process_radio_button, out_of_process_radio_button: EV_RADIO_BUTTON
	menu: EV_MENU_BAR
	...
	compile_buttons_box, backup_box: EV_VERTICAL_BOX
	project_outter_box, project_type_buttons_box, component_type_hbox,
	compile_box, backup_inner_box: EV_HORIZONTAL_BOX
	output_box: WIZARD_OUTPUT_BOX
	project_type_label, component_type_label,
	compile_label, backup_label: EV_LABEL
	project_delete_button: EV_BUTTON
	project_frame, project_type_frame,
	general_settings_frame, component_type_frame, generation_options_frame: EV_FRAME
	project_types_padding_cell,
	settings_padding_cell, component_type_padding_cell, compile_padding_cell, backup_padding_cell,
	generation_options_padding_cell: EV_CELL
