...
#ifndef __ECOM_EIFFELCOMCOMPILER_IEIFFELHTMLDOCEVENTS_S_H__
#define __ECOM_EIFFELCOMCOMPILER_IEIFFELHTMLDOCEVENTS_S_H__
#ifdef __cplusplus
extern "C" {
...
#ifdef __cplusplus
extern "C" {
#ifndef __ecom_EiffelComCompiler_IEiffelHTMLDocEvents_INTERFACE_DEFINED__
#define __ecom_EiffelComCompiler_IEiffelHTMLDocEvents_INTERFACE_DEFINED__
namespace ecom_EiffelComCompiler
{
