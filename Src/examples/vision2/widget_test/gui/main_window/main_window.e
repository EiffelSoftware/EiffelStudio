...
feature {NONE} -- Initialization
	...
	user_initialization
		...
		do
			...
			widget_selector_parent.extend (create {GB_TYPE_SELECTOR})
			...
			object_editor_parent.extend (create {GB_OBJECT_EDITOR})
...
feature {NONE} -- Implementation
	...
	update_title (a_widget: EV_WIDGET)
			-- Update `title' based on type of `a_widget'.
		do
			set_title ({STRING_32} "Vision2 Demo - " + a_widget.generating_type.name_32)
		end

	update_text_size (value: INTEGER)
	...
	display_about_dialog
			...
			-- modally to `Current'.
		do
			(create {ABOUT_DIALOG}.make).show_modal_to_window (Current)
		end

	set_window_title (a_widget: EV_WIDGET)
	...
	parent_test_widget (a_widget: EV_WIDGET)
	...
	event_handler: ORDERED_STRING_HANDLER
	...
	remove_first_screen (v: EV_WIDGET)
	...
	update_tool_bar_radio_buttons (selected_button: EV_TOOL_BAR_TOGGLE_BUTTON)
