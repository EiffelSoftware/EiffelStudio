...
-----------------------------------------------------------*/
{
	...
	hr = p_IPersistPropertyBag->IPersist_GetClassID(p_class_id);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IPersistPropertyBag_impl_proxy::ccom_load(  /* [in] */ ecom_control_library::IPropertyBag * p_prop_bag,  /* [in] */ ecom_control_library::IErrorLog * p_error_log )
...
void ecom_control_library::IPersistPropertyBag_impl_proxy::ccom_save(  /* [in] */ ecom_control_library::IPropertyBag * p_prop_bag,  /* [in] */ EIF_INTEGER f_clear_dirty,  /* [in] */ EIF_INTEGER f_save_all_properties )
