...
feature -- Test routines
	...
	test_insert_value_inst_1
		...
		do
			...
			create i.make (array, create {CONSTANT_INT}.make (create {INTEGER_TYPE}.make (ctx, 32), 5), 0)
...
define i32 @main() {
  %1 = insertvalue [1 x i32] [i32 300], i32 5, 0
}
