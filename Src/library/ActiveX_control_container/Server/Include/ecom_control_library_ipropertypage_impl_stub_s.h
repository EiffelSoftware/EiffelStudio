...
#ifndef __ECOM_CONTROL_LIBRARY_IPROPERTYPAGE_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IPROPERTYPAGE_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_control_library
{
class IPropertyPage_impl_stub : public ecom_control_library::IPropertyPage
{
public:
  IPropertyPage_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IPropertyPage_impl_stub ();
