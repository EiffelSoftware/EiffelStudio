...
public:
	...
	-----------------------------------------------------------*/
	void ccom_remote_next(  /* [in] */ EIF_INTEGER celt,  /* [out] */ ecom_control_library::tagSTATSTG * rgelt,  /* [out] */ EIF_OBJECT pcelt_fetched );
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_control_library::IEnumSTATSTG * p_IEnumSTATSTG;
