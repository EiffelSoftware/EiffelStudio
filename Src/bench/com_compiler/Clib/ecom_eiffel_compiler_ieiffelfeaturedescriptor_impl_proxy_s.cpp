...
-----------------------------------------------------------*/
{
	...
	EIF_REFERENCE eiffel_result = eif_protect ((EIF_REFERENCE)grt_ce_ISE.ccom_ce_pointed_interface_83 (ret_value));
	return eif_wean (eiffel_result);
};
/*----------------------------------------------------------------------------------------------------------------------*/
...
-----------------------------------------------------------*/
{
	...
	tmp_file_path = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_86 (eif_access (file_path), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_86 ((BSTR *)tmp_file_path, file_path);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_line_number, line_number);
	
	grt_ce_ISE.ccom_free_memory_pointed_86 (tmp_file_path);
grt_ce_ISE.ccom_free_memory_pointed_87 (tmp_line_number);
