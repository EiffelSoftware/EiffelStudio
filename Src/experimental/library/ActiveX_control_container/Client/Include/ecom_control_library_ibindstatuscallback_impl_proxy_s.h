...
public:
  ...
  -----------------------------------------------------------*/
  void ccom_on_start_binding(  /* [in] */ EIF_INTEGER dw_reserved,  /* [in] */ ::IBinding * pib );
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_get_bind_info(  /* [out] */ EIF_OBJECT grf_bindf,  /* [in, out] */ ecom_control_library::_tagRemBINDINFO * pbindinfo);


  /*-----------------------------------------------------------
  No description available.
  -----------------------------------------------------------*/
  void ccom_on_data_available(  /* [in] */ EIF_INTEGER grf_bscf,  /* [in] */ EIF_INTEGER dw_size,  /* [in] */ ecom_control_library::tagRemFORMATETC * p_formatetc,  /* [in] */ ecom_control_library::tagRemSTGMEDIUM * p_stgmed );
...
private:
  ...
  Interface pointer
  -----------------------------------------------------------*/
  ::IBindStatusCallback * p_IBindStatusCallback;
