deferred class CORBA_REPOSITORY_SKEL
...
feature { NONE }
    ...
    dispatcher : DICTIONARY [COURIER, STRING] is
        ...
        do
            ...
            result.put (cour, "lookup_id")
            create cour.make (void, void, 25)
            result.put (cour, "get_canonical_typecode")
            create cour.make (void, void, 26)
            result.put (cour, "get_primitive")
            create cour.make (void, void, 27)
            result.put (cour, "create_string")
            create cour.make (void, void, 28)
            result.put (cour, "create_wstring")
            create cour.make (void, void, 29)
            result.put (cour, "create_sequence")
            create cour.make (void, void, 30)
            result.put (cour, "create_array")
            create cour.make (void, void, 31)
            result.put (cour, "create_fixed")
        end

end -- class CORBA_REPOSITORY_SKEL
