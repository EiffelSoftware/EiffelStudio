...
feature -- convertion
	...
	to_generator_string (string: STRING ) : STRING is
		indexing
			description: "Converts a STRING to a ISE_REFLECTION_CODE_GENERATOR_STRING"
		require
			string_not_void : string /= void
		do
			Result := string
	...
	from_generator_string (string: STRING ) : STRING is
		indexing
			description: "Converts a ISE_REFLECTION_EIFFEL_CODE_GENERATOR_STRING to a STRING"
		require
			string_not_void : string /= void
		do
			Result := string
...
end -- REFLECTION_INTERFACE_SUPPORT
