...
feature -- Text processing
	...
	process_ace_syntax (text: STRING_GENERAL; a_error: SYNTAX_ERROR) is
...
feature -- Output
	...
	put_cluster (e_cluster: CONF_GROUP; str: STRING_GENERAL) is
	...
	put_class (e_class: CLASS_C; str: STRING_GENERAL) is
	...
	put_classi (class_i: CLASS_I; str: STRING_GENERAL) is
	...
	put_error (error: ERROR; str: STRING_GENERAL) is
	...
	put_feature (feat: E_FEATURE; str: STRING_GENERAL) is
	...
	put_feature_name (f_name: STRING_GENERAL; e_class: CLASS_C) is
	...
	put_exported_feature_name (f_name: STRING_GENERAL; class_c: CLASS_C; alias_name: STRING_GENERAL) is
		require
			valid_f_name: f_name /= Void
		do
			put_string (f_name)
	...
	put_feature_error (feat: E_FEATURE; str: STRING_GENERAL; pos: INTEGER) is
	...
	put_address (address: STRING_GENERAL; a_name: STRING_GENERAL; e_class: CLASS_C) is
	...
	put_ace_syntax (syn: SYNTAX_ERROR; str: STRING_GENERAL) is
	...
	put_comment (str: STRING_GENERAL) is
	...
	put_quoted_comment (str: STRING_GENERAL) is
	...
	put_after_class (e_class: CLASS_C; str: STRING_GENERAL) is
			-- Put `str' as representation of quoted text.
		require
			valid_str: str /= Void
		do
	...
	put_filter_item (construct: STRING_GENERAL; is_before: BOOLEAN) is
			-- Put `str' as representation of quoted text.
		require
	...
	put_symbol (str: STRING_GENERAL) is
			-- Put `str' as representation of quoted text.
		require
			valid_str: str /= Void
		do
	...
	put_keyword (str: STRING_GENERAL) is
			-- Put `str' as representation of quoted text.
		require
			valid_str: str /= Void
		do
	...
	put_operator (str: STRING_GENERAL; e_feature: E_FEATURE; a_is_keyword: BOOLEAN) is
			-- Put `str' as representation of quoted text.
		require
			valid_str: str /= Void
