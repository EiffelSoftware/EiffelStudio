note
	description: "Argument parser that requires a single loose argument to be specified."
...
feature {NONE} -- Internationalization
	...
	e_one_non_switch_only: IMMUTABLE_STRING_32
		once
			create Result.make_from_string_general ("Only one {1} can be specified.")
		end
