...
feature {NONE} -- Event implementation
	...
	figure_on_position (group: EV_MODEL_GROUP; x, y: INTEGER): EV_MODEL is
			-- Figure mouse-cursor is on.
		local
			grp: EV_MODEL_GROUP
			gritem: EV_MODEL
			i: INTEGER
			found_closed_figure, closed_figure: EV_MODEL_CLOSED
		do
	...
	has_focus (a_figure: EV_MODEL): BOOLEAN is
