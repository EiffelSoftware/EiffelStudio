note
	description: "A command line switch that accepts a property setting, e.g property=value."
...
feature {ARGUMENT_BASE_PARSER} -- Factory Functions
	...
	new_value_option (a_value: READABLE_STRING_GENERAL): ARGUMENT_PROPERTY_OPTION
			-- <Precursor>
		do
