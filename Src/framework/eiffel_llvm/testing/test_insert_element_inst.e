...
feature -- Test routines
	...
	test_insert_element_inst_1
		...
		do
			...
			create i.make (vec, create {CONSTANT_INT}.make (create {INTEGER_TYPE}.make (ctx, 32), 5), idx)
			b.inst_list_push_back (i)
			create s.make
			m.print (s)
			s_result := s.string
			assert ("test_insert_element_1", s_result ~ test_insert_element_1_expected)
		end

	test_insert_element_1_expected: STRING_8 =
"[
; ModuleID = 'test'

define i32 @main() {
  %1 = insertelement <1 x i32> <i32 300>, i32 5, i32 0
}
