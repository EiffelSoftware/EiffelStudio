...
class
	G_PROTECTED___RESPONSIBLES___SUBSCRIBERS_SERVLET
...
feature-- Implementation
	...
	render_html_page (request: XH_REQUEST; response: XH_RESPONSE)
		...
		do
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_138)
				-- line: 3 row: 54 of file: ./protected/responsibles/subscribers.xeb
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_140)
				-- line: 7 row: 1 of file: ./protected/responsibles/subscribers.xeb
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_142)
				-- line: 10 row: 1 of file: ./protected/responsibles/subscribers.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_143)
				-- line: 9 row: 3 of file: ./protected/responsibles/subscribers.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_4)
				-- line: 10 row: 1 of file: ./protected/responsibles/subscribers.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_144)
