...
void ecom_EiffelComCompiler::IEnumCluster_impl_proxy::ccom_next(  /* [out] */ EIF_OBJECT rgelt,  /* [out] */ EIF_OBJECT pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	ecom_EiffelComCompiler::IEiffelClusterDescriptor * * tmp_rgelt = 0;
	tmp_rgelt = (ecom_EiffelComCompiler::IEiffelClusterDescriptor * *)grt_ec_ISE.ccom_ec_pointed_cell_51 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_51 ((ecom_EiffelComCompiler::IEiffelClusterDescriptor * *)tmp_rgelt, rgelt);
...
void ecom_EiffelComCompiler::IEnumCluster_impl_proxy::ccom_skip(  /* [in] */ EIF_INTEGER celt )
...
void ecom_EiffelComCompiler::IEnumCluster_impl_proxy::ccom_clone1(  /* [out] */ EIF_OBJECT ppenum )
...
-----------------------------------------------------------*/
{
	...
	ecom_EiffelComCompiler::IEnumCluster * * tmp_ppenum = 0;
	tmp_ppenum = (ecom_EiffelComCompiler::IEnumCluster * *)grt_ec_ISE.ccom_ec_pointed_cell_44 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_44 ((ecom_EiffelComCompiler::IEnumCluster * *)tmp_ppenum, ppenum);
...
void ecom_EiffelComCompiler::IEnumCluster_impl_proxy::ccom_ith_item(  /* [in] */ EIF_INTEGER an_index,  /* [out] */ EIF_OBJECT rgelt )
