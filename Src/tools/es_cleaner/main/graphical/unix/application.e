indexing
	description: "[
		A unix-specific package implementation for the graphical version of escln.
	]"
...
feature {NONE} -- Factory functions
	...
	create_path_provider: UNIX_PATH_PROVIDER is
			-- Create a path provider
		do
			create Result.make (Current)
		end

	create_cleaner: UNIX_CLEANER
	...
	create_backup_manager: UNIX_BACKUP_MANAGER is
