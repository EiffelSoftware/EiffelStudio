...
feature {NONE} -- Implementation
	...
	file_content: STRING
		...
		do
			...
			create l_file.make (eiffel_layout.user_external_command_file_name_8 (ini_file_name))
	...
	file: PLAIN_TEXT_FILE
		...
		do
			create l_text_file.make (eiffel_layout.user_external_command_file_name_8 (ini_file_name))
