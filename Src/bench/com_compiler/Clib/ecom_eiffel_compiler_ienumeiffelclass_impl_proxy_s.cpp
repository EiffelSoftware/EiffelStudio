...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClassDescriptor * *)grt_ec_ISE.ccom_ec_pointed_cell_40 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_40 ((ecom_eiffel_compiler::IEiffelClassDescriptor * *)tmp_rgelt, rgelt);
...
grt_ce_ISE.ccom_free_memory_pointed_47 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumEiffelClass * *)grt_ec_ISE.ccom_ec_pointed_cell_29 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_29 ((ecom_eiffel_compiler::IEnumEiffelClass * *)tmp_ppenum, ppenum);
