...
class
	CIL_MD_TINY_METHOD_HEADER

inherit
	CIL_MD_METHOD_HEADER
...
feature -- Settings
	...
	set_code_size (a_size: INTEGER)
		...
		require
			valid_size: a_size >= 0 and a_size < 64
		do
			internal_data := {CIL_MD_METHOD_CONSTANTS}.tiny_format.to_integer_32 | (a_size |<< 2)
		ensure
			code_size_set: code_size = a_size
		end
...
end -- class CIL_MD_TINY_METHOD_HEADER
