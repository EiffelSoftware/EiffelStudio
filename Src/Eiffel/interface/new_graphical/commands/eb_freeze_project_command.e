...
feature {NONE} -- Implementation
	...
	confirm_and_compile is
		...
		do
			...
			l_confirm.set_button_action (l_confirm.dialog_buttons.ok_button, agent set_c_compilation_and_compile (True))
			l_confirm.set_button_action (l_confirm.dialog_buttons.cancel_button, agent set_c_compilation_and_compile (False))
