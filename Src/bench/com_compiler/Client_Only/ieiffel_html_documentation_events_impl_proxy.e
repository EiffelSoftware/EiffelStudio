...
feature {NONE}  -- Externals
	...
	ccom_notify_initalizing_documentation (cpp_obj: POINTER) is
			-- Notify that documentation generating is initializing
		external
			"C++ [ecom_EiffelComCompiler::IEiffelHtmlDocumentationEvents_impl_proxy %"ecom_EiffelComCompiler_IEiffelHtmlDocumentationEvents_impl_proxy.h%"]()"
		end

	ccom_notify_percentage_complete (cpp_obj: POINTER; ul_percent: INTEGER) is
			-- Notify that the percentage completed has changed
		external
			"C++ [ecom_EiffelComCompiler::IEiffelHtmlDocumentationEvents_impl_proxy %"ecom_EiffelComCompiler_IEiffelHtmlDocumentationEvents_impl_proxy.h%"](EIF_INTEGER)"
		end

	ccom_output_header (cpp_obj: POINTER; bstr_msg: STRING) is
			-- Put a header message to the output
		external
			"C++ [ecom_EiffelComCompiler::IEiffelHtmlDocumentationEvents_impl_proxy %"ecom_EiffelComCompiler_IEiffelHtmlDocumentationEvents_impl_proxy.h%"](EIF_OBJECT)"
		end
	...
	ccom_delete_ieiffel_html_documentation_events_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_EiffelComCompiler::IEiffelHtmlDocumentationEvents_impl_proxy %"ecom_EiffelComCompiler_IEiffelHtmlDocumentationEvents_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_html_documentation_events_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_EiffelComCompiler::IEiffelHtmlDocumentationEvents_impl_proxy %"ecom_EiffelComCompiler_IEiffelHtmlDocumentationEvents_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_EiffelComCompiler::IEiffelHtmlDocumentationEvents_impl_proxy %"ecom_EiffelComCompiler_IEiffelHtmlDocumentationEvents_impl_proxy.h%"]():EIF_POINTER"
		end
