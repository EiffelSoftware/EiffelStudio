...
feature {NONE} -- Initialization
	...
	init_accelerator is
		...
		do
			create l_preference
			l_shortcut := l_preference.preferences.editor_data.shortcuts.item ("zoom_reset")
...
feature -- Command
	...
	execute is
		...
		do
			...
			l_preference.preferences.editor_data.font_zoom_factor_preference.reset
		end
...
end -- class EB_EDITOR_FONT_ZOOM_RESET_COMMAND
