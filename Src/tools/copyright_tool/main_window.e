...
feature -- Status report
	...
	stop_when_post_parsing_failed: BOOLEAN
...
feature {NONE} -- Copyright list
	...
	read_copyright_texts_list (a_show_dlg: BOOLEAN)
	...
	find_copyright_directory : DIRECTORY
	...
	on_list_item_selected (a_item: EV_LIST_ITEM)
	...
	load_copyright_text (a_string: STRING)
...
feature {NONE} -- Attaching copyrights
	...
	attach_files_and_directories (files, dirs: LIST [STRING])
			--
		local
			fn8: STRING
		do
	...
	attach_directory (a_directory: STRING; a_is_recursive: BOOLEAN)
	...
	send_output (a_assembler: COPYRIGHT_ASSEMBLER)
