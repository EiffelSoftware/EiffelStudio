...
class
	G_PROTECTED___DOWNLOAD_INTERACTION_SERVLET
...
feature-- Implementation
	...
	render_html_page (request: XH_REQUEST; response: XH_RESPONSE)
		...
		do
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_6)
				-- line: 3 row: 3 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_4)
				-- line: 3 row: 58 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_80)
				-- line: 3 row: 52 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_81)
				-- line: 3 row: 47 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_322)
				-- line: 3 row: 52 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_83)
				-- line: 3 row: 58 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_22)
				-- line: 4 row: 3 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_84)
				-- line: 7 row: 1 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_85)
				-- line: 5 row: 4 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_6)
				-- line: 6 row: 1 of file: ./protected/download_interaction.xeb
			response.append ("NoText")
				-- line: 6 row: 3 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_4)
				-- line: 7 row: 1 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_22)
				-- line: 7 row: 2 of file: ./protected/download_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_2)
