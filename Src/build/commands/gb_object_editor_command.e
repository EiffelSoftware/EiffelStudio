...
feature {NONE} -- Implementation
		...
		do_not_allow_object_type (object_stone: GB_STANDARD_OBJECT_STONE): BOOLEAN
		...
		update_object_editor (object_stone: GB_STANDARD_OBJECT_STONE; button: GB_COMMAND_TOOL_BAR_BUTTON)
