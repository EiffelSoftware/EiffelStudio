...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelFeatureDescriptor * *)grt_ec_ISE_c.ccom_ec_pointed_cell_47 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_47 ((ecom_eiffel_compiler::IEiffelFeatureDescriptor * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_47 (tmp_rgelt);
grt_ce_ISE_c.ccom_free_memory_pointed_71 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumFeature * *)grt_ec_ISE_c.ccom_ec_pointed_cell_50 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_50 ((ecom_eiffel_compiler::IEnumFeature * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_50 (tmp_ppenum);
