	...
	<div class="main">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <p> View and submit problem and bug reports to the Eiffel Software Team through this web site. 
