...
grt_ce_ISE_c.ccom_free_memory_pointed_221 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumIncludePaths * *)grt_ec_ISE_c.ccom_ec_pointed_cell_216 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_216 ((ecom_eiffel_compiler::IEnumIncludePaths * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_216 (tmp_ppenum);
