...
feature {NONE} -- Initialization
	...
	make (a_wish_list: LIST [CMS_WISH_LIST]; a_index: INTEGER; a_pages: INTEGER; a_categories: LIST [CMS_WISH_LIST_CATEGORY]; a_status: LIST [CMS_WISH_LIST_STATUS];)
