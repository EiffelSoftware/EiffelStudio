...
feature -- Factory
	...
	new_create_button: EV_BUTTON
		...
		do
			create Result
			Result.set_pixmap (pixmaps.mini_pixmaps.general_add_icon)
...
feature -- Defaults
	...
	fcw_font: EV_FONT
		...
		once
			create Result
			Result.set_family (family_modern)
			Result.set_height_in_points (Result.height_in_points + 2)
			Result.set_weight (weight_black)
		end
