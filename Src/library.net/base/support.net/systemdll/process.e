...
feature -- Access
	...
	frozen get_priority_class: PROCESSPRIORITYCLASS is
		external
	...
	frozen get_main_module: PROCESSMODULE is
		external
	...
	frozen get_threads: PROCESSTHREADCOLLECTION is
		external
	...
	frozen get_synchronizing_object: ISYNCHRONIZEINVOKE is
		external
	...
	frozen get_start_info: PROCESSSTARTINFO is
		external
	...
	frozen get_modules: PROCESSMODULECOLLECTION is
		external
...
feature -- Element Change
	...
	frozen set_priority_class (value: PROCESSPRIORITYCLASS) is
		external
	...
	frozen set_synchronizing_object (value: ISYNCHRONIZEINVOKE) is
		external
	...
	frozen set_start_info (value: PROCESSSTARTINFO) is
		external
...
feature -- Basic Operations
	...
	frozen get_current_process: PROCESS is
		external
	...
	frozen get_process_by_id_int32_string (process_id: INTEGER; machine_name: SYSTEM_STRING): PROCESS is
		external
	...
	frozen get_processes_string (machine_name: SYSTEM_STRING): NATIVE_ARRAY [PROCESS] is
		external
	...
	frozen start_process_start_info (start_info: PROCESSSTARTINFO): PROCESS is
		external
	...
	frozen start_string (file_name: SYSTEM_STRING): PROCESS is
		external
			"IL static signature (System.String): System.Diagnostics.Process use System.Diagnostics.Process"
		alias
			"Start"
	...
	frozen get_processes: NATIVE_ARRAY [PROCESS] is
		external
			"IL static signature (): System.Diagnostics.Process[] use System.Diagnostics.Process"
		alias
			"GetProcesses"
	...
	frozen get_processes_by_name (process_name: SYSTEM_STRING): NATIVE_ARRAY [PROCESS] is
		external
			"IL static signature (System.String): System.Diagnostics.Process[] use System.Diagnostics.Process"
		alias
			"GetProcessesByName"
	...
	frozen get_process_by_id (process_id: INTEGER): PROCESS is
		external
	...
	frozen start_string_string (file_name: SYSTEM_STRING; arguments: SYSTEM_STRING): PROCESS is
		external
	...
	frozen get_processes_by_name_string_string (process_name: SYSTEM_STRING; machine_name: SYSTEM_STRING): NATIVE_ARRAY [PROCESS] is
		external
			"IL static signature (System.String, System.String): System.Diagnostics.Process[] use System.Diagnostics.Process"
		alias
			"GetProcessesByName"
