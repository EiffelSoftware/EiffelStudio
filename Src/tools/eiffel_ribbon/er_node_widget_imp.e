...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			l_ev_horizontal_box_1.extend (node_type)
			extend (l_ev_label_2)
			extend (command_name)
			extend (l_ev_label_3)
			extend (label)
			...
			node_type.set_text ("??")
			node_type.align_text_left
			l_ev_label_2.set_text ("Identifier:")
			l_ev_label_2.align_text_left
			l_ev_label_3.set_text ("Label Title:")
			l_ev_label_3.align_text_left
			l_ev_label_4.set_text ("Key Tip:")
			...
			keytip.change_actions.extend (agent on_keytip_text_change)
...
feature -- Access
	...
	node_type: EV_LABEL
	command_name, label, keytip: EV_TEXT_FIELD
...
feature {NONE} -- Implementation
	...
	on_keytip_text_change
			-- Called by `change_actions' of `keytip'.
		deferred
		end
