...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelFeatureDescriptor * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_39 (eif_access (rgelt), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_39 ((ecom_eiffel_compiler::IEiffelFeatureDescriptor * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_39 (tmp_rgelt);
grt_ce_Eif_compiler.ccom_free_memory_pointed_63 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumFeature * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_42 (eif_access (ppenum), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_42 ((ecom_eiffel_compiler::IEnumFeature * *)tmp_ppenum, ppenum);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_42 (tmp_ppenum);
