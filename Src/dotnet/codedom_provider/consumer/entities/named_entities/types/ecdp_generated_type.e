...
feature -- Access
	...
	indexing_clauses: LINKED_LIST [ECDP_INDEXING_CLAUSE]
			-- Type indexing clauses
		
	parents: LINKED_LIST [ECDP_PARENT]
			-- List of parents

	creation_routines: LINKED_LIST [ECDP_CREATION_ROUTINE]
			-- Type creation routines

	features: LINKED_LIST [ECDP_FEATURE]
			-- Type features
...
feature -- Basic Operations
	...
	add_indexing_clause (a_clause: ECDP_INDEXING_CLAUSE) is
	...
	add_parent (a_parent: ECDP_PARENT) is
	...
	add_feature (a_feature: ECDP_FEATURE) is
	...
	add_creation_routine (a_creation_routine: ECDP_CREATION_ROUTINE) is
...
feature -- Basics Operations on inheritance clauses
	...
	parent (a_name: STRING): ECDP_PARENT is
	...
	add_redefine_clause_from_dotnet (a_dotnet_feature_name: STRING; arguments: LINKED_LIST [ECDP_PARAMETER_DECLARATION_EXPRESSION]): STRING is
...
feature -- Code generation
	...
	indexing_clause: STRING is
		...
		local
			l_indexing_clause: ECDP_INDEXING_CLAUSE
		do
	...
	inheritance_clauses_code (a_list: LINKED_LIST [ECDP_INHERITANCE_CLAUSE]): STRING is
	...
	features_code (a_list: LINKED_LIST [ECDP_FEATURE]): STRING is 
			-- Code corresponding to `a_list' of features.
		require
			non_void_list: a_list /= Void
		local
			l_clauses: HASH_TABLE [LINKED_LIST [ECDP_FEATURE], STRING]
			l_features: LINKED_LIST [ECDP_FEATURE]
		do
	...
	features_per_clauses (a_list: LINKED_LIST [ECDP_FEATURE]): HASH_TABLE [LINKED_LIST [ECDP_FEATURE], STRING] is
		...
		do
			...
			loop
				...
				if not Result.has (l_clause) then
					Result.extend (create {LINKED_LIST [ECDP_FEATURE]}.make, l_clause)
				end
				check
