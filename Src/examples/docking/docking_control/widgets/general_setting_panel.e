...
feature {NONE} -- Implementation
	...
	on_show_all_indicators_check_button_selected is
	...
	on_choose_color_button_selected is
	...
	on_background_color_drawer_exposed (a_x, a_y, a_width, a_height: INTEGER) is
	...
	on_lock_editors_button_selected is
	...
	on_lock_tools_button_selected is
	...
	on_lock_tool_bars_button_selected is
	...
	on_open_layout_button_selected is
	...
	on_open_editor_layout_button_selected is
	...
	on_open_tool_layout_button_selected is
	...
	on_save_layout_button_selected is
	...
	on_save_editor_layout_button_selected is
	...
	on_save_tool_layout_button_selected is
	...
	on_close_place_holder_button_selected is
...
feature {NONE} -- Layout save
	...
	standard_layout: INTEGER is 1
	editor_layout: INTEGER is 2
	tool_layout: INTEGER is 3

	save_file_dialog: EV_FILE_SAVE_DIALOG
	open_file_dialog: EV_FILE_OPEN_DIALOG

	on_layout_save (a_dialog: like save_file_dialog; a_type: INTEGER) is
		require
	...
	on_open_layout (a_dialog: like open_file_dialog; a_type: INTEGER) is
		require
			a_dialog_not_void: a_dialog /= Void
		local
			l_file_name: STRING_GENERAL
...
feature {NONE} -- Implementation
	...
	change_navigation_dialog_shortcut_key is
	...
	background_color_selected (a_dialog: EV_COLOR_DIALOG) is
...
feature {NONE} -- Implementation
	...
	new_widget (a_number: like new_widget_number): EV_DRAWING_AREA is
			-- New widget.
		do
			create Result
	...
	new_content (a_editor: BOOLEAN): SD_CONTENT is
			-- New content.
		require
			docking_manager_not_void: docking_manager /= Void
		local
	...
	is_content_hiden: BOOLEAN is True
	...
	key_constant: EV_KEY_CONSTANTS is
		once
			create Result
		end
