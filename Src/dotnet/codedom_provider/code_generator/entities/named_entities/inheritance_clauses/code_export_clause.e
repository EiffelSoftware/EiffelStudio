...
feature {NONE} -- Initialization
	...
	make is
			-- | Call `Precursor {CODE_INHERITANCE_CLAUSE}.
...
feature -- Status Report
	...
	ready: BOOLEAN is
		...
		do
			Result := Precursor {CODE_INHERITANCE_CLAUSE} and exports /= Void
		end
