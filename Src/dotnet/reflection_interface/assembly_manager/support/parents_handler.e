			...
			if not retried then
				...
				loop
					...
					if a_method_info /= Void then
						...
						is_inherited := not (a_method_info.declaringtype.basetype.assemblyqualifiedname.tolower.equals_string (a_type.assemblyqualifiedname.tolower))
						...
						if a_field_info /= Void then
							...
							is_inherited := not (a_field_info.declaringtype.basetype.assemblyqualifiedname.tolower.equals_string (a_type.assemblyqualifiedname.tolower))
							if a_feature /= Void and then not features_table.contains (a_feature) then
								features_table.add (a_feature.eiffelname, is_inherited)
							end
						else
							...
							if a_property_info /= Void then
								...
								if a_get_method_info /= Void then
									...
									is_inherited := not (a_get_method_info.declaringtype.basetype.assemblyqualifiedname.tolower.equals_string (a_type.assemblyqualifiedname.tolower))
								...
								if a_set_method_info /= Void then
									...
									is_inherited := not (a_set_method_info.declaringtype.basetype.assemblyqualifiedname.tolower.equals_string (a_type.assemblyqualifiedname.tolower))
