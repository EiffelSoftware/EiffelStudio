note
	description: "Summary description for {CMS_WISH_LIST_STATUS_INSPECTOR}."
	date: "$Date$"
	revision: "$Revision$"

class
	CMS_WISH_LIST_STATUS_INSPECTOR
...
feature -- Internal data
	...
	internal_data (fn: STRING; obj: CMS_WISH_LIST_STATUS): detachable CELL [detachable ANY]
		local
			l_fn: STRING
		do
			if obj /= Void then
