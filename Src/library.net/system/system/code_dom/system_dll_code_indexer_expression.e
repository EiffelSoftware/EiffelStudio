...
external class
	SYSTEM_DLL_CODE_INDEXER_EXPRESSION

inherit
	SYSTEM_DLL_CODE_EXPRESSION

create
	make_system_dll_code_indexer_expression_1,
	make_system_dll_code_indexer_expression

feature {NONE} -- Initialization

	frozen make_system_dll_code_indexer_expression_1 (target_object: SYSTEM_DLL_CODE_EXPRESSION; indices: NATIVE_ARRAY [SYSTEM_DLL_CODE_EXPRESSION]) is
		external
	...
	frozen make_system_dll_code_indexer_expression is
		external
...
end -- class SYSTEM_DLL_CODE_INDEXER_EXPRESSION
