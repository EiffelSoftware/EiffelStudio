...
feature -- Access
	...
	display_tool_names: ARRAYED_LIST [TUPLE [display_name: STRING_32; store_name: STRING]]
	...
	set_tools (a_tools: like tools)
		...
		do
			...
			loop
				...
				display_tool_names.force ([l_displayed_name, l_tool_id])
...
feature{NONE} -- Implementation/Sorting
	...
	sort_agent (a_column_list: LIST [INTEGER]; a_comparator: AGENT_LIST_COMPARATOR [TUPLE [STRING_32, STRING]])
		...
		local
			l_sorter: QUICK_SORTER [TUPLE [STRING_32, STRING]]
		do
...
feature{NONE} -- Implementation/Binding
	...
	bind_grid
			-- Bind grid.
		local
			l_cursor: like display_tool_names.new_cursor
			l_grid: like grid
			l_value: like value
