...
external class
	DRAWING_PAPER_SIZE_COLLECTION_IN_DRAWING_PRINTER_SETTINGS
...
feature {NONE} -- Initialization
	...
	frozen make (array: NATIVE_ARRAY [DRAWING_PAPER_SIZE]) is
		external
...
feature -- Access
	...
	get_item (index: INTEGER): DRAWING_PAPER_SIZE is
		external
...
end -- class DRAWING_PAPER_SIZE_COLLECTION_IN_DRAWING_PRINTER_SETTINGS
