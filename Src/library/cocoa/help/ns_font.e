...
feature -- Factory
	...
	font_with_name_size (a_font_name: STRING; a_size: REAL)
		do
...
--+ (NSFont *)fontWithDescriptor:(NSFontDescriptor *)fontDescriptor textTransform:(NSAffineTransform *)textTransform;
	...
	frozen font_font_with_name_size (a_font_name: POINTER; a_size: REAL): POINTER
		external
...
--/* UI font settings
--*/
	frozen font_system_font_of_size (a_font_size: REAL): POINTER
	...
	frozen font_bold_system_font_of_size (a_font_size: REAL): POINTER
	...
	frozen font_label_font_of_size (a_font_size: REAL): POINTER
...
--+ (NSFont *)toolTipsFontOfSize:(CGFloat)fontSize;
	frozen font_control_content_font_of_size (a_font_size: REAL): POINTER
...
--/********* Core font attribute *********/
	frozen font_font_name (a_font: POINTER): POINTER
			--- (NSString *)fontName;
		external
			"C inline use <Cocoa/Cocoa.h>"
		alias
	...
	frozen font_point_size (a_font: POINTER): REAL
			--- (CGFloat)pointSize;
		external
			"C inline use <Cocoa/Cocoa.h>"
		alias
...
--- (const CGFloat *)matrix;
	frozen font_family_name (a_font: POINTER): POINTER
			--- (NSString *)familyName;
		external
			"C inline use <Cocoa/Cocoa.h>"
		alias
	...
	frozen font_display_name (a_font: POINTER): POINTER
...
--- (CGFloat)capHeight;
--- (CGFloat)xHeight;
	frozen font_is_fixed_pitch (a_font: POINTER): BOOLEAN
			--- (BOOL)isFixedPitch;
		external
			"C inline use <Cocoa/Cocoa.h>"
		alias
