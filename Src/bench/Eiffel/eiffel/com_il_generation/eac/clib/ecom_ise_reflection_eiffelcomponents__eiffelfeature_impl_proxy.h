/*-----------------------------------------------------------
Implemented `_EiffelFeature' Interface.
-----------------------------------------------------------*/

#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__EIFFELFEATURE_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__EIFFELFEATURE_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
class _EiffelFeature_impl_proxy;
}
...
{
public:
	_EiffelFeature_impl_proxy (IUnknown * a_pointer);
	virtual ~_EiffelFeature_impl_proxy ();
