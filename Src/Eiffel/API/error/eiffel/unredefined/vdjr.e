...
feature -- Output
	...
	trace_primary_context (a_text_formatter: TEXT_FORMATTER)
		...
		do
			if attached {attached TEXT_FORMATTER} a_text_formatter as l_formatter and then attached new_feature as l_feature and then attached class_c as l_class then
