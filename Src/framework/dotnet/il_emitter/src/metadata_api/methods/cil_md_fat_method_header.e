	...
	make, remake (a_max_stack: INTEGER_16; a_code_size, a_locals_token: INTEGER)
		...
		do
			...
			internal_data := Header_size | (
				{CIL_MD_METHOD_CONSTANTS}.Fat_format |
				{CIL_MD_METHOD_CONSTANTS}.Init_locals)
		ensure
...
invariant
	valid_flags: flags & {CIL_MD_METHOD_CONSTANTS}.Fat_format =
			{CIL_MD_METHOD_CONSTANTS}.Fat_format
...
end -- class CIL_MD_FAT_METHOD_HEADER
