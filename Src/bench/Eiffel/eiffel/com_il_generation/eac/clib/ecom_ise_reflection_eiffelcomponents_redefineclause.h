...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_REDEFINECLAUSE_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_REDEFINECLAUSE_H__
#ifdef __cplusplus
extern "C" {
...
public:
	RedefineClause ();
	RedefineClause (IUnknown * a_pointer);
	virtual ~RedefineClause ();
