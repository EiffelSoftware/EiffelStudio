...
feature {NONE} -- Initialization
	...
	make (a_id: like id; a_desc: like description; a_optional: like optional; a_allow_mutliple: like allow_multiple; a_arg_name: like arg_name; a_arg_desc: like arg_description; a_val_optional: like is_value_optional; a_flags: like flag_descriptions; a_cs_flags: like is_case_sensitive)
		...
		require
			...
			a_flags_contains_attached_items: across a_flags as c all not c.item.is_empty end
...
feature -- Access
	...
	flags: ARRAYED_LIST [CHARACTER_32]
		...
		do
			...
			result_contains_printable_characters: across Result as l_c all is_character_printable (l_c.item) end
		end
...
invariant
	...
	flag_descriptions_contains_attached_items: across flag_descriptions as l_desc all not l_desc.item.is_empty end
