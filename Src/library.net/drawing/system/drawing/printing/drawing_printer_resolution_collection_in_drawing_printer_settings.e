...
external class
	DRAWING_PRINTER_RESOLUTION_COLLECTION_IN_DRAWING_PRINTER_SETTINGS
...
feature {NONE} -- Initialization
	...
	frozen make (array: NATIVE_ARRAY [DRAWING_PRINTER_RESOLUTION]) is
		external
...
feature -- Access
	...
	get_item (index: INTEGER): DRAWING_PRINTER_RESOLUTION is
		external
...
end -- class DRAWING_PRINTER_RESOLUTION_COLLECTION_IN_DRAWING_PRINTER_SETTINGS
