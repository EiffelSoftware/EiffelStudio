<div id="breadcrumb">
	<span class="ico"><img src="{$theme_path/}images/ico-megaphone.png" width="21" height="21" alt="Image Description"></span>
			  		<a href="{$site_url/}welcome">Welcome</a>
			  		:: Purpose
</div>
<h1>Purpose</h1>
<p>Eiffel.org is a forum that brings together Eiffel developers around the world
