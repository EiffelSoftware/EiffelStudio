...
feature -- Access
	...
	nearest_domain_with_scope (a_scope: QL_SCOPE): QL_DOMAIN
	...
	new_domain (a_domain_generator: QL_DOMAIN_GENERATOR): QL_DOMAIN
			-- Domain generated by `a_domain_generator' from `wrapped_domain'.
		require
