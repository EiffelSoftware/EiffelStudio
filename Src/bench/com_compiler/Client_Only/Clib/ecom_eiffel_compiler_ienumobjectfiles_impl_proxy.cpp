...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumObjectFiles * *)grt_ec_ISE_c.ccom_ec_pointed_cell_218 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_218 ((ecom_eiffel_compiler::IEnumObjectFiles * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_218 (tmp_ppenum);
