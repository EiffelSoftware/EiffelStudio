...
class
	ECDP_PROPERTY_REFERENCE_EXPRESSION
...
feature -- Access
	...
	code: STRING is
			...
			-- | OR		:= "feature {`target_object'}.set/get_`property_name'" if typeof `target_object' is ECDP_TYPE_REFERENCE_EXPRESSION
...
end -- class ECDP_PROPERTY_REFERENCE_EXPRESSION
