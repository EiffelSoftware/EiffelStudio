/*-----------------------------------------------------------
Implemented `_SelectClause' Interface.
-----------------------------------------------------------*/

#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__SELECTCLAUSE_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__SELECTCLAUSE_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
class _SelectClause_impl_proxy;
}
...
{
public:
	_SelectClause_impl_proxy (IUnknown * a_pointer);
	virtual ~_SelectClause_impl_proxy ();
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_ISE_Reflection_EiffelComponents::_SelectClause * p__SelectClause;
