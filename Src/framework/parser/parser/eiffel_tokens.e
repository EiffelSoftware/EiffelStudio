...
feature -- Access
	...
	token_name (a_token: INTEGER): STRING
		...
		do
			...
			when TE_DOT then
				Result := "TE_DOT"
			when PREDECESSOR_OPERATOR then
				Result := "PREDECESSOR_OPERATOR"
			when TE_LPARAN then
				Result := "TE_LPARAN"
...
feature -- Token codes
	...
	TE_OLD: INTEGER = 294
	TE_DOT: INTEGER = 295
	PREDECESSOR_OPERATOR: INTEGER = 296
	TE_LPARAN: INTEGER = 297
	TE_BLOCK_OPEN: INTEGER = 298
	TE_ID: INTEGER = 299
	TE_TUPLE: INTEGER = 300
	TE_INTEGER: INTEGER = 301
	TE_REAL: INTEGER = 302
	TE_CHAR: INTEGER = 303
	TE_LSQURE: INTEGER = 304
	TE_RSQURE: INTEGER = 305
	TE_ACCEPT: INTEGER = 306
	TE_ADDRESS: INTEGER = 307
	TE_LARRAY: INTEGER = 308
	TE_RARRAY: INTEGER = 309
	TE_RPARAN: INTEGER = 310
	TE_LCURLY: INTEGER = 311
	TE_RCURLY: INTEGER = 312
	TE_SEMICOLON: INTEGER = 313
	TE_COLON: INTEGER = 314
	TE_COMMA: INTEGER = 315
	TE_BAR: INTEGER = 316
	TE_CONSTRAIN: INTEGER = 317
	TE_QUESTION: INTEGER = 318
	TE_BLOCK_CLOSE: INTEGER = 319
	TE_FALSE: INTEGER = 320
	TE_TRUE: INTEGER = 321
	TE_RESULT: INTEGER = 322
	TE_RETRY: INTEGER = 323
	TE_UNIQUE: INTEGER = 324
	TE_CURRENT: INTEGER = 325
	TE_DEFERRED: INTEGER = 326
	TE_VOID: INTEGER = 327
	TE_END: INTEGER = 328
	TE_FROZEN: INTEGER = 329
	TE_PARTIAL_CLASS: INTEGER = 330
	TE_CREATION: INTEGER = 331
	TE_PRECURSOR: INTEGER = 332
	TE_AGENT: INTEGER = 333
	TE_ALIAS: INTEGER = 334
	TE_ALL: INTEGER = 335
	TE_AS: INTEGER = 336
	TE_CHECK: INTEGER = 337
	TE_CLASS: INTEGER = 338
	TE_CONVERT: INTEGER = 339
	TE_CREATE: INTEGER = 340
	TE_DEBUG: INTEGER = 341
	TE_DO: INTEGER = 342
	TE_ELSE: INTEGER = 343
	TE_ELSEIF: INTEGER = 344
	TE_ENSURE: INTEGER = 345
	TE_EXPANDED: INTEGER = 346
	TE_EXPORT: INTEGER = 347
	TE_EXTERNAL: INTEGER = 348
	TE_FEATURE: INTEGER = 349
	TE_FROM: INTEGER = 350
	TE_IF: INTEGER = 351
	TE_INHERIT: INTEGER = 352
	TE_INSPECT: INTEGER = 353
	TE_INVARIANT: INTEGER = 354
	TE_LIKE: INTEGER = 355
	TE_LOCAL: INTEGER = 356
	TE_LOOP: INTEGER = 357
	TE_OBSOLETE: INTEGER = 358
	TE_ONCE: INTEGER = 359
	TE_ONCE_STRING: INTEGER = 360
	TE_REDEFINE: INTEGER = 361
	TE_REFERENCE: INTEGER = 362
	TE_RENAME: INTEGER = 363
	TE_REQUIRE: INTEGER = 364
	TE_RESCUE: INTEGER = 365
	TE_SELECT: INTEGER = 366
	TE_SEPARATE: INTEGER = 367
	TE_THEN: INTEGER = 368
	TE_UNDEFINE: INTEGER = 369
	TE_UNTIL: INTEGER = 370
	TE_VARIANT: INTEGER = 371
	TE_WHEN: INTEGER = 372
	TE_ACROSS: INTEGER = 373
	TE_ASSIGN: INTEGER = 374
	TE_ATTRIBUTE: INTEGER = 375
	TE_ATTACHED: INTEGER = 376
	TE_DETACHABLE: INTEGER = 377
	TE_INDEXING: INTEGER = 378
	TE_IS: INTEGER = 379
	TE_NOTE: INTEGER = 380
	TE_SOME: INTEGER = 381
	TE_STRING: INTEGER = 382
	TE_EMPTY_STRING: INTEGER = 383
	TE_VERBATIM_STRING: INTEGER = 384
	TE_EMPTY_VERBATIM_STRING: INTEGER = 385
	TE_STR_LT: INTEGER = 386
	TE_STR_LE: INTEGER = 387
	TE_STR_GT: INTEGER = 388
	TE_STR_GE: INTEGER = 389
	TE_STR_MINUS: INTEGER = 390
	TE_STR_PLUS: INTEGER = 391
	TE_STR_STAR: INTEGER = 392
	TE_STR_SLASH: INTEGER = 393
	TE_STR_MOD: INTEGER = 394
	TE_STR_DIV: INTEGER = 395
	TE_STR_POWER: INTEGER = 396
	TE_STR_AND: INTEGER = 397
	TE_STR_AND_THEN: INTEGER = 398
	TE_STR_IMPLIES: INTEGER = 399
	TE_STR_OR: INTEGER = 400
	TE_STR_OR_ELSE: INTEGER = 401
	TE_STR_XOR: INTEGER = 402
	TE_STR_NOT: INTEGER = 403
	TE_STR_FREE: INTEGER = 404
	TE_STR_BRACKET: INTEGER = 405
	TE_STR_PARENTHESES: INTEGER = 406
