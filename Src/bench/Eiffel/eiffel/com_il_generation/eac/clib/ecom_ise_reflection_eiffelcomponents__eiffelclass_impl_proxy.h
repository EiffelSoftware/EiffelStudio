...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__EIFFELCLASS_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__EIFFELCLASS_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
public:
	_EiffelClass_impl_proxy (IUnknown * a_pointer);
	virtual ~_EiffelClass_impl_proxy ();
