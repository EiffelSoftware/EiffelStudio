<h1>$motion</h1> <!-- Replaced by the name of your module-->
			...
			<div>
				...
				<form action="{$site_url/}{$resource_path/}/{$module_name/}" id="wish_list" method="GET" itemprop="size">
					...
					<input type="hidden" name="filter_content" id="filter_content_pe" value="{$view.filter_content/}"/>
						...
						<label class="class-form-4 tooltip" itemprop="report_number" title="The number of reports you want to see.">Current page {$index/} of {$pages/}
						</label>	
