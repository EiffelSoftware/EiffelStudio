...
#include "ecom_EiffelComCompiler_IEiffelSystemBrowser_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*pp_ienum_assembly = grt_ec_ISE_c.ccom_ec_pointed_interface_45 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*pp_ieiffel_cluster_descriptor = grt_ec_ISE_c.ccom_ec_pointed_interface_49 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*pp_ieiffel_class_descriptor = grt_ec_ISE_c.ccom_ec_pointed_interface_52 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*pp_ieiffel_feature_descriptor = grt_ec_ISE_c.ccom_ec_pointed_interface_55 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
