...
feature 
	...
	make_visible (a_parent: COMPOSITE) is
		...
		do
			initialize (Context_const.drawing_box_form_name, a_parent);

			!!label_width.make (Context_const.drawing_area_width_name, Current);
			!!label_height.make (Context_const.drawing_area_height_name, Current);
