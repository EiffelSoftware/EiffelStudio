...
feature -- Search
	...
	substring_index (a_string, a_pattern: STRING_GENERAL; start_pos, end_pos: INTEGER): INTEGER
	...
	substring_index_with_deltas (a_string, a_pattern: STRING_GENERAL; start_pos, end_pos: INTEGER): INTEGER
	...
	fuzzy_index (a_string, a_pattern: STRING_GENERAL; start_pos, end_pos, fuzzy: INTEGER): INTEGER
...
feature {NONE} -- Implementation
	...
	internal_initialize_deltas (a_pattern: STRING_GENERAL; a_pattern_count: INTEGER; a_deltas: like deltas)
	...
	initialize_fuzzy_deltas (a_pattern: STRING_GENERAL; fuzzy: INTEGER)
