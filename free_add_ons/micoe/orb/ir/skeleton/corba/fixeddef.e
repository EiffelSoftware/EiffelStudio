deferred class CORBA_FIXEDDEF_SKEL
...
feature { NONE }
    ...
    dispatcher : DICTIONARY [COURIER, STRING] is
        ...
        do
            ...
            result.put (cour, "_get_digits")
            create cour.make (void, void, 5)
            result.put (cour, "_set_digits")
            create cour.make (void, void, 6)
            result.put (cour, "_get_scale")
            create cour.make (void, void, 7)
            result.put (cour, "_set_scale")
        end

end -- class CORBA_FIXEDDEF_SKEL
