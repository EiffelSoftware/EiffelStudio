...
#ifndef __ECOM_EIFFELCOMCOMPILER_CEIFFELCOMPLETIONINFO_S_H__
#define __ECOM_EIFFELCOMCOMPILER_CEIFFELCOMPLETIONINFO_S_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_EiffelComCompiler
{
class CEiffelCompletionInfo : public ecom_EiffelComCompiler::IEiffelCompletionInfo, public IProvideClassInfo2
{
public:
