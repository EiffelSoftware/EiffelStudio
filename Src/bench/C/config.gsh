...
ccflags='-mno-cygwin'
dllflags=''
link_line='$compiler_path\bin\ld -r -o $(OUTDIR)\$@ $(OBJECTS)'
link_wline='$compiler_path\bin\ld -r -o $(OUTDIR)\$@ $(WOBJECTS)'
link_eline='$compiler_path\bin\ld -r -o $(OUTDIR)\$@ $(EOBJECTS)'
#
optimize='-O2'
#optimize=''
output_cmd='-o'
