...
feature -- Token codes
	...
	TE_EMPTY_STRING: INTEGER is 360
	TE_VERBATIM_STRING: INTEGER is 361
	TE_EMPTY_VERBATIM_STRING: INTEGER is 362
	TE_STR_LT: INTEGER is 363
	TE_STR_LE: INTEGER is 364
	TE_STR_GT: INTEGER is 365
	TE_STR_GE: INTEGER is 366
	TE_STR_MINUS: INTEGER is 367
	TE_STR_PLUS: INTEGER is 368
	TE_STR_STAR: INTEGER is 369
	TE_STR_SLASH: INTEGER is 370
	TE_STR_MOD: INTEGER is 371
	TE_STR_DIV: INTEGER is 372
	TE_STR_POWER: INTEGER is 373
	TE_STR_AND: INTEGER is 374
	TE_STR_AND_THEN: INTEGER is 375
	TE_STR_IMPLIES: INTEGER is 376
	TE_STR_OR: INTEGER is 377
	TE_STR_OR_ELSE: INTEGER is 378
	TE_STR_XOR: INTEGER is 379
