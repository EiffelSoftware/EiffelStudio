...
class
	G_UPLOAD_RCV_SERVLET_GENERATOR
	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 8 row: 2 of file: ./upload_rcv.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 8 row: 2 of file: ./upload_rcv.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 8 row: 1 of file: ./upload_rcv.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 8 row: 1 of file: ./upload_rcv.xeb"
			...
			stack.put (temp)
				-- line: 5 row: 4 of file: ./upload_rcv.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 4 of file: ./upload_rcv.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 6 row: 1 of file: ./upload_rcv.xeb
			create {XTAG_XEB_DISPLAY_TAG} temp.make
			temp.debug_information := "line: 6 row: 1 of file: ./upload_rcv.xeb"
			stack.item.add_to_body (temp)
			temp.put_dynamic_attribute("text", "upload")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "display"
				-- line: 6 row: 3 of file: ./upload_rcv.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 3 of file: ./upload_rcv.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
