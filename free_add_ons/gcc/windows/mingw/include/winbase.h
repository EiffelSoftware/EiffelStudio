...
WINBASEAPI LPVOID WINAPI GetEnvironmentStrings(void);
WINBASEAPI LPVOID WINAPI GetEnvironmentStringsA(void);
WINBASEAPI LPVOID WINAPI GetEnvironmentStringsW(void);
