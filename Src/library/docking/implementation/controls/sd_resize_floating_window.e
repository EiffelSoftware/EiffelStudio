...
feature {NONE} -- Implementation for resizing.
	...
	init_resize_actions is
		...
		do
			...
			internal_resize_bar_top.pointer_button_press_actions.extend (agent on_pointer_press_top)


			internal_resize_bar_bottom.pointer_button_press_actions.extend (agent on_pointer_press_bottom)


			internal_resize_bar_left.pointer_button_press_actions.extend (agent on_pointer_press_left)


			internal_resize_bar_right.pointer_button_press_actions.extend (agent on_pointer_press_right)
...
feature {NONE}  -- Implementation for agents.
	...
	on_pointer_press_top (a_x: INTEGER; a_y: INTEGER; a_button: INTEGER; a_x_tilt: DOUBLE; a_y_tilt: DOUBLE; a_pressure: DOUBLE; a_screen_x: INTEGER; a_screen_y: INTEGER) is
	...
	on_pointer_press_bottom (a_x: INTEGER; a_y: INTEGER; a_button: INTEGER; a_x_tilt: DOUBLE; a_y_tilt: DOUBLE; a_pressure: DOUBLE; a_screen_x: INTEGER; a_screen_y: INTEGER) is
	...
	on_pointer_press_left (a_x: INTEGER; a_y: INTEGER; a_button: INTEGER; a_x_tilt: DOUBLE; a_y_tilt: DOUBLE; a_pressure: DOUBLE; a_screen_x: INTEGER; a_screen_y: INTEGER) is
	...
	on_pointer_press_right (a_x: INTEGER; a_y: INTEGER; a_button: INTEGER; a_x_tilt: DOUBLE; a_y_tilt: DOUBLE; a_pressure: DOUBLE; a_screen_x: INTEGER; a_screen_y: INTEGER) is
