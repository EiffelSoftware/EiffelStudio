...
feature {NONE} -- Implementation
	...
	c_outi (i: INTEGER_8): STRING is
			-- Printable representation of integer value
		external
			"C (EIF_INTEGER): EIF_REFERENCE | %"eif_out.h%""
		end

	c_ascii_char (code: INTEGER_8): CHARACTER is
...
feature {NONE} -- Bit operations implementation
	...
	eif_bit_and (i, j: INTEGER_8): INTEGER_8 is
			-- Bitwise and between `i' and `j'.
		external
			"C [macro %"eif_misc.h%"]"
		end

	eif_bit_or (i, j: INTEGER_8): INTEGER_8 is
			-- Bitwise or between `i' and `j'.
		external
			"C [macro %"eif_misc.h%"]"
		end

	eif_bit_xor (i, j: INTEGER_8): INTEGER_8 is
			-- Bitwise xor between `i' and `j'.
		external
			"C [macro %"eif_misc.h%"]"
		end

	eif_bit_not (i: INTEGER_8): INTEGER_8 is
			-- One's complement of `i'.
		external
			"C [macro %"eif_misc.h%"]"
		end

	eif_bit_shift_left (i: INTEGER_8; n: INTEGER): INTEGER_8 is
			-- Shift `i' from `n' position to left.
		external
			"C [macro %"eif_misc.h%"]"
		end

	eif_bit_shift_right (i: INTEGER_8; n: INTEGER): INTEGER_8 is
			-- Shift `i' from `n' position to right.
		external
			"C [macro %"eif_misc.h%"]"
		end

	eif_bit_test (i: INTEGER_8; n: INTEGER): BOOLEAN is
