note
	description: "Criterion to test if top indexing clause of a class contain certain text"
...
feature -- Evaluate
	...
	is_satisfied_by (a_item: QL_CLASS): BOOLEAN
		...
		do
			...
			if l_class_as /= Void and then l_class_as.top_indexes /= Void and then match_list /= Void then
