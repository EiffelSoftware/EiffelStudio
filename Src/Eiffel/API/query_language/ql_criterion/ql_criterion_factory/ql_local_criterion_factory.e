...
feature{NONE} -- New criterion
	...
	new_false_criterion: QL_SIMPLE_LOCAL_CRITERION
	...
	new_is_compiled_criterion: QL_SIMPLE_LOCAL_CRITERION
	...
	new_is_in_immediate_feature_criterion: QL_SIMPLE_LOCAL_CRITERION
	...
	new_is_visible_criterion: QL_SIMPLE_LOCAL_CRITERION
	...
	new_is_used_criterion: QL_LOCAL_IS_USED_CRI
	...
	new_true_criterion: QL_SIMPLE_LOCAL_CRITERION
	...
	new_name_is_criterion (a_name: READABLE_STRING_GENERAL; a_case_sensitive: BOOLEAN; a_matching_strategy: INTEGER): QL_LOCAL_NAME_IS_CRI
	...
	new_text_contain_criterion (a_text: READABLE_STRING_GENERAL; a_case_sensitive: BOOLEAN; a_matching_strategy: INTEGER): QL_LOCAL_TEXT_CONTAIN_CRI
...
feature -- Criterion index
	...
	c_false: INTEGER = 1
	c_is_compiled: INTEGER = 2
	c_is_used: INTEGER = 3
	c_is_visible: INTEGER = 4
	c_true: INTEGER = 5
	c_name_is: INTEGER = 6
	c_text_contain: INTEGER = 7
	c_is_immediate: INTEGER = 8
	c_contain_ast: INTEGER = 9
	c_value_of_metric_is: INTEGER = 10
	c_is_satisfied_by: INTEGER = 11

feature{NONE} -- Implementation

	false_agent (a_item: QL_LOCAL): BOOLEAN
	...
	true_agent (a_item: QL_LOCAL): BOOLEAN
	...
	is_compiled_agent (a_item: QL_LOCAL): BOOLEAN
	...
	is_visible_agent (a_item: QL_LOCAL): BOOLEAN
	...
	is_in_immediate_feature_agent (a_item: QL_LOCAL): BOOLEAN
