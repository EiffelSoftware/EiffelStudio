...
#include "ecom_EiffelComCompiler_IEnumAssembly_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ieiffel_assembly_properties = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_139 (pp_ieiffel_assembly_properties, NULL));
		if (*pp_ieiffel_assembly_properties != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_139 (((tmp_pp_ieiffel_assembly_properties != NULL) ? eif_wean (tmp_pp_ieiffel_assembly_properties) : NULL), pp_ieiffel_assembly_properties);
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ienum_assembly = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_46 (pp_ienum_assembly, NULL));
		if (*pp_ienum_assembly != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_46 (((tmp_pp_ienum_assembly != NULL) ? eif_wean (tmp_pp_ienum_assembly) : NULL), pp_ienum_assembly);
