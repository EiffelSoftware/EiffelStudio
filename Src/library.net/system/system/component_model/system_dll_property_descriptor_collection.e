...
external class
	SYSTEM_DLL_PROPERTY_DESCRIPTOR_COLLECTION
...
feature {NONE} -- Initialization
	...
	frozen make (properties: NATIVE_ARRAY [SYSTEM_DLL_PROPERTY_DESCRIPTOR]) is
		external
...
feature -- Access
	...
	frozen empty: SYSTEM_DLL_PROPERTY_DESCRIPTOR_COLLECTION is
		external
	...
	get_item (index: INTEGER): SYSTEM_DLL_PROPERTY_DESCRIPTOR is
		external
	...
	get_item_string (name: SYSTEM_STRING): SYSTEM_DLL_PROPERTY_DESCRIPTOR is
		external
...
feature -- Basic Operations
	...
	sort_array_string_icomparer (names: NATIVE_ARRAY [SYSTEM_STRING]; comparer: ICOMPARER): SYSTEM_DLL_PROPERTY_DESCRIPTOR_COLLECTION is
		external
	...
	frozen add (value: SYSTEM_DLL_PROPERTY_DESCRIPTOR): INTEGER is
		external
	...
	frozen remove (value: SYSTEM_DLL_PROPERTY_DESCRIPTOR) is
		external
	...
	sort_array_string (names: NATIVE_ARRAY [SYSTEM_STRING]): SYSTEM_DLL_PROPERTY_DESCRIPTOR_COLLECTION is
		external
	...
	frozen insert (index: INTEGER; value: SYSTEM_DLL_PROPERTY_DESCRIPTOR) is
		external
	...
	frozen index_of (value: SYSTEM_DLL_PROPERTY_DESCRIPTOR): INTEGER is
		external
			"IL signature (System.ComponentModel.PropertyDescriptor): System.Int32 use System.ComponentModel.PropertyDescriptorCollection"
		alias
			"IndexOf"
	...
	find (name: SYSTEM_STRING; ignore_case: BOOLEAN): SYSTEM_DLL_PROPERTY_DESCRIPTOR is
		external
	...
	sort: SYSTEM_DLL_PROPERTY_DESCRIPTOR_COLLECTION is
		external
	...
	frozen contains (value: SYSTEM_DLL_PROPERTY_DESCRIPTOR): BOOLEAN is
		external
	...
	sort_icomparer (comparer: ICOMPARER): SYSTEM_DLL_PROPERTY_DESCRIPTOR_COLLECTION is
		external
...
end -- class SYSTEM_DLL_PROPERTY_DESCRIPTOR_COLLECTION
