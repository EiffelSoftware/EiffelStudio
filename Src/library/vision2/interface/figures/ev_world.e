...
inherit
	...
	FIXED_LIST [LINKED_LIST[EV_FIGURE]]
		rename
			make as al_make,
...
feature -- Element change
	...
	put (v: EV_FIGURE) is
		...
		do
			set_modified_with (item.surround_box)
			v.attach_drawing_imp_with_parent ( Current, drawing)
			al_item.put (v)
			set_modified_with (v.surround_box)
		end
...
feature {EV_WORLD} -- Element change
