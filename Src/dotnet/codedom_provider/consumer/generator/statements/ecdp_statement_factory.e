...
feature {ECDP_CONSUMER_FACTORY} -- Visitor features.
	...
	generate_assign_statement (a_source: SYSTEM_DLL_CODE_ASSIGN_STATEMENT) is
		...
		local
			an_assign_statement: ECDP_ASSIGN_STATEMENT
		do
	...
	generate_comment_statement (a_source: SYSTEM_DLL_CODE_COMMENT_STATEMENT) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_comment_statement: ECDP_COMMENT_STATEMENT
		do
	...
	generate_condition_statement (a_source: SYSTEM_DLL_CODE_CONDITION_STATEMENT) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_conditon_statement: ECDP_CONDITION_STATEMENT
		do
	...
	generate_expression_statement (a_source: SYSTEM_DLL_CODE_EXPRESSION_STATEMENT) is
		...
		require
			non_void_source: a_source /= Void
		local
			an_expression_statement: ECDP_EXPRESSION_STATEMENT
		do
	...
	generate_iteration_statement (a_source: SYSTEM_DLL_CODE_ITERATION_STATEMENT) is
		...
		require
			non_void_source: a_source /= Void
		local
			an_iteration_statement: ECDP_ITERATION_STATEMENT
		do
	...
	generate_routine_return_statement (a_source: SYSTEM_DLL_CODE_METHOD_RETURN_STATEMENT) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_routine_return_statement: ECDP_ROUTINE_RETURN_STATEMENT
		do
	...
	generate_variable_declaration_statement (a_source: SYSTEM_DLL_CODE_VARIABLE_DECLARATION_STATEMENT) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_variable_declaration_statement: ECDP_VARIABLE_DECLARATION_STATEMENT
		do
...
feature {NONE} -- Implementation
	...
	initialize_assign_statement (a_source: SYSTEM_DLL_CODE_ASSIGN_STATEMENT; an_assign_statement: ECDP_ASSIGN_STATEMENT) is
		...
		local
			...
			set_property: ECDP_PROPERTY_REFERENCE_EXPRESSION
		do
	...
	initialize_comment_statement (a_source: SYSTEM_DLL_CODE_COMMENT_STATEMENT; a_comment_statement: ECDP_COMMENT_STATEMENT) is
	...
	initialize_condition_statement (a_source: SYSTEM_DLL_CODE_CONDITION_STATEMENT; a_conditon_statement: ECDP_CONDITION_STATEMENT) is
	...
	generate_true_statements (a_source: SYSTEM_DLL_CODE_CONDITION_STATEMENT; a_conditon_statement: ECDP_CONDITION_STATEMENT) is
	...
	generate_false_statements (a_source: SYSTEM_DLL_CODE_CONDITION_STATEMENT; a_conditon_statement: ECDP_CONDITION_STATEMENT) is
			-- | Call in loop `generate_statement_from_dom'.
	...
	initialize_expression_statement (a_source: SYSTEM_DLL_CODE_EXPRESSION_STATEMENT; an_expression_statement: ECDP_EXPRESSION_STATEMENT) is
	...
	initialize_iteration_statement (a_source: SYSTEM_DLL_CODE_ITERATION_STATEMENT; an_iteration_statement: ECDP_ITERATION_STATEMENT) is
	...
	generate_loop_statements (a_source: SYSTEM_DLL_CODE_ITERATION_STATEMENT; an_iteration_statement: ECDP_ITERATION_STATEMENT) is
			-- | Call in loop `generate_statement_from_dom'.
	...
	initialize_routine_return_statement (a_source: SYSTEM_DLL_CODE_METHOD_RETURN_STATEMENT; a_routine_return_statement: ECDP_ROUTINE_RETURN_STATEMENT) is
			-- | Call `generate_expression_from_dom' to generate `expression'.			
	...
	initialize_variable_declaration_statement (a_source: SYSTEM_DLL_CODE_VARIABLE_DECLARATION_STATEMENT; a_variable_declaration: ECDP_VARIABLE_DECLARATION_STATEMENT) is
			-- | Set `name'.
