...
feature {NONE} -- Implementation
	...
	set_default_button is
			-- Set a button to the `default_button_style' style.
		require else
			ok_button_exists: ok_button.exists
			cancel_button_exists: cancel_button.exists
			help_button_exists: help_button.exists
		...
		do
			if not ok_button_hidden then
				ok_button.set_style (Default_button_style)
			...
			if not cancel_button_hidden then
				if not default_button_set then
					cancel_button.set_style (Default_button_style)
					default_button_set := True
					default_button_id := cancel_id
				else
			...
			if not help_button_hidden then
				if not default_button_set then
					help_button.set_style (Default_button_style)
					default_button_set := True
					default_button_id := help_id
				else
					help_button.set_style (Button_style)
				end
			end
			if not apply_button_hidden then
				if not default_button_set then
					apply_button.set_style (Default_button_style)
					default_button_id := apply_id
				else
	...
	set_default_attributes is
		...
		local
			default_font: FONT
			default_windows_font: FONT_WINDOWS
