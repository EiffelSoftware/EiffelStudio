...
feature {NONE} -- Implementation
	...
	About_eiffelcom: STRING is "EiffelCOM 4.5 Build 3 %N%N Copyright (C) 1999-2000%N %
						% Interactive Software Engineering Inc. %N%N ISE Building, 2nd floor %N 270 Storke Road, Goleta, %N CA 93117 USA %N%N Tel: (805)685-1006   Fax: (805)695-6869 %N Email: <info@eiffel.com> %N Webpage: http://www.eiffel.com %N%N Support Webpage: http://support.eiffel.com"
