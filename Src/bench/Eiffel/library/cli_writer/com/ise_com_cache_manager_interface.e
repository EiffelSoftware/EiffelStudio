indexing
	description: "Eiffel interface class for emitter.exe or ISE.CacheManager.dll assemblies"
	date: "$Date$"
	revision: "$Revision$"
...
feature {NONE} -- Implementation
	...
	c_is_successful (ap:POINTER; aret_val: POINTER): INTEGER is
			-- was the last operation successful?
		external
			"C++ ISE_Cache_ISE_COM_CACHE_MANAGER signature (VARIANT_BOOL*):EIF_INTEGER use %"ise_cache_manager.h%""
		alias
			"is_successful"
		end
	...
	c_last_error_message (ap:POINTER; aret_val: POINTER): INTEGER is
			-- last error message of a failed operation
		external
			"C++ ISE_Cache_ISE_COM_CACHE_MANAGER signature (LPWSTR*):EIF_INTEGER use %"ise_cache_manager.h%""
		alias
			"last_error_message"
		end
	...
	c_consume_gac_assembly (ap, aname, aversion, aculture, akey: POINTER): INTEGER is
			...
			-- "'aname', Version='aversion', Culture='aculture', PublicKeyToken='akey'"
		external
			"C++ ISE_Cache_ISE_COM_CACHE_MANAGER signature (BSTR, BSTR, BSTR, BSTR):EIF_INTEGER use %"ise_cache_manager.h%""
		alias
	...
	c_consume_local_assembly (ap, apath, adest: POINTER): INTEGER is
		...
		external
			"C++ ISE_Cache_ISE_COM_CACHE_MANAGER signature (BSTR, BSTR):EIF_INTEGER use %"ise_cache_manager.h%""
		alias
	...
	c_relative_folder_name (ap, aname, aversion, aculture, akey: POINTER; aret_val:POINTER): INTEGER is
		...
		external
			"C++ ISE_Cache_ISE_COM_CACHE_MANAGER signature (BSTR, BSTR, BSTR, BSTR, LPWSTR*):EIF_INTEGER use %"ise_cache_manager.h%""
		alias
