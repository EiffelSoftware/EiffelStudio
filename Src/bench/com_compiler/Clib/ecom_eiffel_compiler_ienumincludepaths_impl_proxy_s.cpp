...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_198 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_198 ((BSTR *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_198 (tmp_rgelt);
grt_ce_ISE.ccom_free_memory_pointed_199 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumIncludePaths * *)grt_ec_ISE.ccom_ec_pointed_cell_194 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_194 ((ecom_eiffel_compiler::IEnumIncludePaths * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_194 (tmp_ppenum);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_200 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_200 ((BSTR *)tmp_rgelt, rgelt);
	
	grt_ce_ISE.ccom_free_memory_pointed_200 (tmp_rgelt);
