...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			string_constant_retrieval_functions.extend (agent label_non_compliant)
			l_ev_label_1.align_text_left
			integer_constant_set_procedures.extend (agent hbox_legend.set_padding (?))
			...
			pixmap_constant_retrieval_functions.extend (agent icon_check)
			string_constant_set_procedures.extend (agent l_ev_label_2.set_text (?))
			string_constant_retrieval_functions.extend (agent label_check)
			l_ev_cell_3.set_minimum_width (6)
			l_ev_pixmap_2.set_minimum_width (16)
			l_ev_pixmap_2.set_minimum_height (16)
			pixmap_constant_set_procedures.extend (agent l_ev_pixmap_2.copy (?))
			pixmap_constant_retrieval_functions.extend (agent icon_cross)
			string_constant_set_procedures.extend (agent l_ev_label_3.set_text (?))
			string_constant_retrieval_functions.extend (agent label_cross)
			l_ev_cell_4.set_minimum_width (6)
			l_ev_pixmap_3.set_minimum_width (16)
			l_ev_pixmap_3.set_minimum_height (16)
			pixmap_constant_set_procedures.extend (agent l_ev_pixmap_3.copy (?))
			pixmap_constant_retrieval_functions.extend (agent icon_caution)
			string_constant_set_procedures.extend (agent l_ev_label_4.set_text (?))
			string_constant_retrieval_functions.extend (agent label_caution)
			...
			string_constant_set_procedures.extend (agent btn_export.set_text (?))
			string_constant_retrieval_functions.extend (agent button_export)
			btn_export.set_minimum_width (120)
			integer_constant_set_procedures.extend (agent btn_export.set_minimum_height (?))
			integer_constant_retrieval_functions.extend (agent button_height)
			pixmap_constant_set_procedures.extend (agent btn_export.set_pixmap (?))
			pixmap_constant_retrieval_functions.extend (agent icon_export)
			string_constant_set_procedures.extend (agent l_ev_frame_2.set_text (?))
			string_constant_retrieval_functions.extend (agent frame_report_generation)
			...
			string_constant_set_procedures.extend (agent chk_show_cls_compliant.set_text (?))
			string_constant_retrieval_functions.extend (agent check_cls_compliance)
			string_constant_set_procedures.extend (agent chk_show_cls_compliant.set_tooltip (?))
			string_constant_retrieval_functions.extend (agent tooltip_cls_compliance)
			string_constant_set_procedures.extend (agent chk_show_all.set_text (?))
			string_constant_retrieval_functions.extend (agent check_show_all)
			string_constant_set_procedures.extend (agent chk_show_all.set_tooltip (?))
			string_constant_retrieval_functions.extend (agent tooltip_show_all)
			...
			string_constant_set_procedures.extend (agent lbl_progress.set_text (?))
			string_constant_retrieval_functions.extend (agent label_progress)
			string_constant_set_procedures.extend (agent lbl_progress.set_tooltip (?))
			string_constant_retrieval_functions.extend (agent tooltip_progress)
			integer_constant_set_procedures.extend (agent lbl_progress.set_minimum_height (?))
			integer_constant_retrieval_functions.extend (agent button_height)
			string_constant_set_procedures.extend (agent prg_check.set_tooltip (?))
			string_constant_retrieval_functions.extend (agent tooltip_progress)
			integer_constant_set_procedures.extend (agent prg_check.set_minimum_height (?))
			integer_constant_retrieval_functions.extend (agent button_height)
			string_constant_set_procedures.extend (agent btn_start_checking.set_text (?))
			string_constant_retrieval_functions.extend (agent button_check)
			string_constant_set_procedures.extend (agent btn_start_checking.set_tooltip (?))
			string_constant_retrieval_functions.extend (agent tooltip_check)
			btn_start_checking.set_minimum_width (95)
			integer_constant_set_procedures.extend (agent btn_start_checking.set_minimum_height (?))
			integer_constant_retrieval_functions.extend (agent button_height)
			pixmap_constant_set_procedures.extend (agent btn_start_checking.set_pixmap (?))
...
feature {NONE} -- Implementation
	...
	l_ev_cell_4, l_ev_cell_5, l_ev_cell_6: EV_CELL
	l_ev_pixmap_1, l_ev_pixmap_2, l_ev_pixmap_3: EV_PIXMAP
	l_ev_frame_1,
