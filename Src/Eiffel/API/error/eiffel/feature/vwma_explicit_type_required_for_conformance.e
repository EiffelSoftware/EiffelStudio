note
	description: "[
		Manifest array has to specify an explicit type because the implicit type does not conform to the type of a reattachment target.
...
class VWMA_EXPLICIT_TYPE_REQUIRED_FOR_CONFORMANCE
...
feature {COMPILER_ERROR_VISITOR} -- Visitor
	...
	process_issue (v: COMPILER_ERROR_VISITOR)
			-- <Precursor>
		do
			v.process_array_explicit_type_required_for_conformance (Current)
		end
