...
feature {NONE}  -- Externals
	...
	ccom_flush_completion_features (cpp_obj: POINTER; a_file_name: STRING) is
			-- Flush temporary completion features for a specifi file
		external
			"C++ [ecom_eiffel_compiler::IEiffelCompletionInfo_impl_proxy %"ecom_eiffel_compiler_IEiffelCompletionInfo_impl_proxy.h%"](EIF_OBJECT)"
		end
	...
	ccom_initialize_feature (cpp_obj: POINTER; a_name: STRING; a_arguments: POINTER; a_argument_types: POINTER; a_return_type: STRING; a_feature_type: INTEGER; a_file_name: STRING) is
			-- Initialize a feature for completion without compiltation
		external
			"C++ [ecom_eiffel_compiler::IEiffelCompletionInfo_impl_proxy %"ecom_eiffel_compiler_IEiffelCompletionInfo_impl_proxy.h%"](EIF_OBJECT,VARIANT *,VARIANT *,EIF_OBJECT,EIF_INTEGER,EIF_OBJECT)"
		end

	ccom_delete_ieiffel_completion_info_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_eiffel_compiler::IEiffelCompletionInfo_impl_proxy %"ecom_eiffel_compiler_IEiffelCompletionInfo_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_completion_info_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_eiffel_compiler::IEiffelCompletionInfo_impl_proxy %"ecom_eiffel_compiler_IEiffelCompletionInfo_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_eiffel_compiler::IEiffelCompletionInfo_impl_proxy %"ecom_eiffel_compiler_IEiffelCompletionInfo_impl_proxy.h%"]():EIF_POINTER"
		end
