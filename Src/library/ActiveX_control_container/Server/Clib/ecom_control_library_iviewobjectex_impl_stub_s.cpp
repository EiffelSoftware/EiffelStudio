...
#include "ecom_control_library_IViewObjectEx_impl_stub_s.h"
...
ecom_control_library::IViewObjectEx_impl_stub::IViewObjectEx_impl_stub( EIF_OBJECT eif_obj )
{
  ref_count = 0;
...
ecom_control_library::IViewObjectEx_impl_stub::~IViewObjectEx_impl_stub()
{
...
-----------------------------------------------------------*/
{
  ...
  eiffel_procedure = eif_procedure ("draw", type_id);
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::GetColorSet(  /* [in] */ ULONG dw_draw_aspect, /* [in] */ LONG lindex, /* [in] */ ULONG pv_aspect, /* [in] */ ecom_control_library::tagDVTARGETDEVICE * ptd, /* [in] */ ULONG hic_target_dev, /* [out] */ ecom_control_library::tagLOGPALETTE * * pp_color_set )
...
-----------------------------------------------------------*/
{
  ...
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("get_color_set", type_id);
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::Freeze(  /* [in] */ ULONG dw_draw_aspect, /* [in] */ LONG lindex, /* [in] */ ULONG pv_aspect, /* [out] */ ULONG * pdw_freeze )
...
-----------------------------------------------------------*/
{
  ...
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("freeze", type_id);
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::Unfreeze(  /* [in] */ ULONG dw_freeze )
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::SetAdvise(  /* [in] */ ULONG aspects, /* [in] */ ULONG advf, /* [in] */ ecom_control_library::IAdviseSink * p_adv_sink )
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::GetAdvise(  /* [out] */ ULONG * p_aspects, /* [out] */ ULONG * p_advf, /* [out] */ ecom_control_library::IAdviseSink * * pp_adv_sink )
...
-----------------------------------------------------------*/
{
  ...
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("get_advise", type_id);
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::IViewObject2_GetExtent(  /* [in] */ ULONG dw_draw_aspect, /* [in] */ LONG lindex, /* [in] */ ecom_control_library::tagDVTARGETDEVICE * ptd, /* [out] */ ecom_control_library::tagSIZEL * lpsizel )
...
-----------------------------------------------------------*/
{
  ...
  EIF_OBJECT tmp_lpsizel = NULL;
  if (lpsizel != NULL)
  {
    tmp_lpsizel = eif_protect (grt_ce_control_interfaces2.ccom_ce_pointed_record_249 (lpsizel));
  }
  
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("get_extent", type_id);

  (FUNCTION_CAST (void, (EIF_REFERENCE, EIF_INTEGER, EIF_INTEGER, EIF_REFERENCE, EIF_REFERENCE))eiffel_procedure) (eif_access (eiffel_object), (EIF_INTEGER)tmp_dw_draw_aspect, (EIF_INTEGER)tmp_lindex, ((tmp_ptd != NULL) ? eif_access (tmp_ptd) : NULL), ((tmp_lpsizel != NULL) ? eif_access (tmp_lpsizel) : NULL));
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::GetRect(  /* [in] */ ULONG dw_aspect, /* [out] */ ecom_control_library::_RECTL * p_rect )
...
-----------------------------------------------------------*/
{
  ...
  if (p_rect != NULL)
  {
    tmp_p_rect = eif_protect (grt_ce_control_interfaces2.ccom_ce_pointed_record_381 (p_rect));
  }
  
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("get_rect", type_id);

  (FUNCTION_CAST (void, (EIF_REFERENCE, EIF_INTEGER, EIF_REFERENCE))eiffel_procedure) (eif_access (eiffel_object), (EIF_INTEGER)tmp_dw_aspect, ((tmp_p_rect != NULL) ? eif_access (tmp_p_rect) : NULL));
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::GetViewStatus(  /* [out] */ ULONG * pdw_status )
...
-----------------------------------------------------------*/
{
  ...
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("get_view_status", type_id);

  (FUNCTION_CAST (void, (EIF_REFERENCE, EIF_REFERENCE))eiffel_procedure) (eif_access (eiffel_object), ((tmp_pdw_status != NULL) ? eif_access (tmp_pdw_status) : NULL));
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::QueryHitPoint(  /* [in] */ ULONG dw_aspect, /* [in] */ ecom_control_library::tagRECT * p_rect_bounds, /* [in] */ ecom_control_library::tagPOINT ptl_loc, /* [in] */ LONG l_close_hint, /* [out] */ ULONG * p_hit_result )
...
-----------------------------------------------------------*/
{
  ...
  EIF_OBJECT tmp_ptl_loc = NULL;
  tmp_ptl_loc = eif_protect (grt_ce_control_interfaces2.ccom_ce_record_tag_point_record203 (ptl_loc));
  EIF_INTEGER tmp_l_close_hint = (EIF_INTEGER)l_close_hint;
  EIF_OBJECT tmp_p_hit_result = NULL;
  if (p_hit_result != NULL)
  {
    tmp_p_hit_result = eif_protect (rt_ce.ccom_ce_pointed_unsigned_long (p_hit_result, NULL));
  }
  
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("query_hit_point", type_id);

  (FUNCTION_CAST (void, (EIF_REFERENCE, EIF_INTEGER, EIF_REFERENCE, EIF_REFERENCE, EIF_INTEGER, EIF_REFERENCE))eiffel_procedure) (eif_access (eiffel_object), (EIF_INTEGER)tmp_dw_aspect, ((tmp_p_rect_bounds != NULL) ? eif_access (tmp_p_rect_bounds) : NULL), ((tmp_ptl_loc != NULL) ? eif_access (tmp_ptl_loc) : NULL), (EIF_INTEGER)tmp_l_close_hint, ((tmp_p_hit_result != NULL) ? eif_access (tmp_p_hit_result) : NULL));
  rt_ec.ccom_ec_pointed_unsigned_long (((tmp_p_hit_result != NULL) ? eif_wean (tmp_p_hit_result) : NULL), p_hit_result);
  if (tmp_p_rect_bounds != NULL)
    eif_wean (tmp_p_rect_bounds);
  if (tmp_ptl_loc != NULL)
    eif_wean (tmp_ptl_loc);
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::QueryHitRect(  /* [in] */ ULONG dw_aspect, /* [in] */ ecom_control_library::tagRECT * p_rect_bounds, /* [in] */ ecom_control_library::tagRECT * p_rect_loc, /* [in] */ LONG l_close_hint, /* [out] */ ULONG * p_hit_result )
...
-----------------------------------------------------------*/
{
  ...
  EIF_OBJECT tmp_p_rect_loc = NULL;
  if (p_rect_loc != NULL)
  {
    tmp_p_rect_loc = eif_protect (grt_ce_control_interfaces2.ccom_ce_pointed_record_210 (p_rect_loc));
  }
  EIF_INTEGER tmp_l_close_hint = (EIF_INTEGER)l_close_hint;
  EIF_OBJECT tmp_p_hit_result = NULL;
  if (p_hit_result != NULL)
  ...
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("query_hit_rect", type_id);

  (FUNCTION_CAST (void, (EIF_REFERENCE, EIF_INTEGER, EIF_REFERENCE, EIF_REFERENCE, EIF_INTEGER, EIF_REFERENCE))eiffel_procedure) (eif_access (eiffel_object), (EIF_INTEGER)tmp_dw_aspect, ((tmp_p_rect_bounds != NULL) ? eif_access (tmp_p_rect_bounds) : NULL), ((tmp_p_rect_loc != NULL) ? eif_access (tmp_p_rect_loc) : NULL), (EIF_INTEGER)tmp_l_close_hint, ((tmp_p_hit_result != NULL) ? eif_access (tmp_p_hit_result) : NULL));
  rt_ec.ccom_ec_pointed_unsigned_long (((tmp_p_hit_result != NULL) ? eif_wean (tmp_p_hit_result) : NULL), p_hit_result);
  if (tmp_p_rect_bounds != NULL)
    eif_wean (tmp_p_rect_bounds);
  if (tmp_p_rect_loc != NULL)
    eif_wean (tmp_p_rect_loc);
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::GetNaturalExtent(  /* [in] */ ULONG dw_aspect, /* [in] */ LONG lindex, /* [in] */ ecom_control_library::tagDVTARGETDEVICE * ptd, /* [in] */ ecom_control_library::wireHDC hic_target_dev, /* [in] */ ecom_control_library::tagExtentInfo * p_extent_info, /* [out] */ ecom_control_library::tagSIZEL * psizel )
...
-----------------------------------------------------------*/
{
  ...
  EIF_POINTER tmp_hic_target_dev = (EIF_POINTER)hic_target_dev;
  EIF_OBJECT tmp_p_extent_info = NULL;
  if (p_extent_info != NULL)
  {
    tmp_p_extent_info = eif_protect (grt_ce_control_interfaces2.ccom_ce_pointed_record_393 (p_extent_info));
  }
  ...
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("get_natural_extent", type_id);

  (FUNCTION_CAST (void, (EIF_REFERENCE, EIF_INTEGER, EIF_INTEGER, EIF_REFERENCE, EIF_POINTER, EIF_REFERENCE, EIF_REFERENCE))eiffel_procedure) (eif_access (eiffel_object), (EIF_INTEGER)tmp_dw_aspect, (EIF_INTEGER)tmp_lindex, ((tmp_ptd != NULL) ? eif_access (tmp_ptd) : NULL), (EIF_POINTER)tmp_hic_target_dev, ((tmp_p_extent_info != NULL) ? eif_access (tmp_p_extent_info) : NULL), ((tmp_psizel != NULL) ? eif_access (tmp_psizel) : NULL));
  
  if (tmp_ptd != NULL)
    eif_wean (tmp_ptd);
  if (tmp_p_extent_info != NULL)
    eif_wean (tmp_p_extent_info);
...
STDMETHODIMP_(ULONG) ecom_control_library::IViewObjectEx_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IViewObjectEx_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IViewObjectEx_impl_stub::QueryInterface( REFIID riid, void ** ppv )
...
-----------------------------------------------------------*/
{
  if (riid == IID_IUnknown)
    *ppv = static_cast<ecom_control_library::IViewObjectEx*>(this);
  else if (riid == IID_IViewObjectEx_)
    *ppv = static_cast<ecom_control_library::IViewObjectEx*>(this);
  else if (riid == IID_IViewObject2_)
    *ppv = static_cast<ecom_control_library::IViewObject2*>(this);
