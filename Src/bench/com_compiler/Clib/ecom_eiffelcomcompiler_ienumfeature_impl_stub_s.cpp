		...
		case 10088:
			{
				...
				ecom_EiffelComCompiler::IEiffelFeatureDescriptor * * arg_0 = 0;
				IID tmp_iid_0 = {0x75550181,0x6a69,0x43d5,{0xaa,0x40,0x51,0xee,0xc3,0xe2,0xd1,0x9f}};
				ecom_EiffelComCompiler::IEiffelFeatureDescriptor * tmp_tmp_arg_0 = 0;
		...
		case 10091:
			{
				...
				ecom_EiffelComCompiler::IEnumFeature * * arg_0 = 0;
				IID tmp_iid_0 = {0xdc003e49,0x6c17,0x4be2,{0xbd,0x81,0x3d,0x35,0x40,0xb7,0x38,0xb1}};
				ecom_EiffelComCompiler::IEnumFeature * tmp_tmp_arg_0 = 0;
				if (tmp_value [0]->vt = (VT_UNKNOWN |VT_BYREF))
				{
					IUnknown ** tmp_arg_0 = tmp_value [0]->ppunkVal;
					if (tmp_arg_0 != NULL)
		...
		case 10092:
			{
				...
				ecom_EiffelComCompiler::IEiffelFeatureDescriptor * * arg_1 = 0;
				IID tmp_iid_1 = {0x75550181,0x6a69,0x43d5,{0xaa,0x40,0x51,0xee,0xc3,0xe2,0xd1,0x9f}};
				ecom_EiffelComCompiler::IEiffelFeatureDescriptor * tmp_tmp_arg_1 = 0;
