...
#include "ecom_EiffelComCompiler_IEnumFeature_impl_proxy.h"
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ieiffel_feature_descriptor = (ecom_EiffelComCompiler::IEiffelFeatureDescriptor * *)grt_ec_ISE_c.ccom_ec_pointed_cell_56 (eif_access (pp_ieiffel_feature_descriptor), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_56 ((ecom_EiffelComCompiler::IEiffelFeatureDescriptor * *)tmp_pp_ieiffel_feature_descriptor, pp_ieiffel_feature_descriptor);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pul_fetched, pul_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_56 (tmp_pp_ieiffel_feature_descriptor);
grt_ce_ISE_c.ccom_free_memory_pointed_84 (tmp_pul_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ienum_feature = (ecom_EiffelComCompiler::IEnumFeature * *)grt_ec_ISE_c.ccom_ec_pointed_cell_59 (eif_access (pp_ienum_feature), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_59 ((ecom_EiffelComCompiler::IEnumFeature * *)tmp_pp_ienum_feature, pp_ienum_feature);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_59 (tmp_pp_ienum_feature);
