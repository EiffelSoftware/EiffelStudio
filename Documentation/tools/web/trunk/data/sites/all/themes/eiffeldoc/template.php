 ...
 *   eiffeldoc theme would define a eiffeldoc_breadcrumb() function.
 *
...
if (theme_get_setting('eiffeldoc_fixed')) {
...
function eiffeldoc_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function eiffeldoc_preprocess_page(&$vars, $hook) {
  //$vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function eiffeldoc_preprocess_node(&$vars, $hook) {
  //$vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function eiffeldoc_preprocess_comment(&$vars, $hook) {
  //$vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function eiffeldoc_preprocess_block(&$vars, $hook) {
  //$vars['sample_variable'] = t('Lorem ipsum.');
}
// */
