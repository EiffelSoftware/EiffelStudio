...
#define eif_builtin_REFLECTOR_c_set_dynamic_type(obj,dftype)		eif_set_dynamic_type(obj,dftype)
...
#define eif_builtin_TYPE_is_attached(obj)					eif_is_attached_type(eif_gen_param_id(Dftype(obj), 1))
