...
public:
	...
	-----------------------------------------------------------*/
	void ccom_remote_next(  /* [in] */ EIF_INTEGER celt,  /* [out] */ ecom_control_library::tagFORMATETC * rgelt,  /* [out] */ EIF_OBJECT pcelt_fetched );
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_control_library::IEnumFORMATETC * p_IEnumFORMATETC;
