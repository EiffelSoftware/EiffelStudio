...
#ifndef __ECOM_CONTROL_LIBRARY_IADVISESINK_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IADVISESINK_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_control_library
{
class IAdviseSink_impl_stub : public ecom_control_library::IAdviseSink
{
public:
  IAdviseSink_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IAdviseSink_impl_stub ();
