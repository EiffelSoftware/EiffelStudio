...
#include "ecom_EiffelComCompiler_IEnumIncludePaths_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pbstr_include_path = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_223 (pbstr_include_path, NULL));
	}
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_223 (((tmp_pbstr_include_path != NULL) ? eif_wean (tmp_pbstr_include_path) : NULL), pbstr_include_path);
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ienum_include_paths = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_219 (pp_ienum_include_paths, NULL));
		if (*pp_ienum_include_paths != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_219 (((tmp_pp_ienum_include_paths != NULL) ? eif_wean (tmp_pp_ienum_include_paths) : NULL), pp_ienum_include_paths);
...
-----------------------------------------------------------*/
{
	...
	if (pbstr_include_path != NULL)
	{
		tmp_pbstr_include_path = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_225 (pbstr_include_path, NULL));
	}
	...
	if (*pbstr_include_path != NULL)
		rt_ce.free_memory_bstr (*pbstr_include_path);
	grt_ec_ISE_c.ccom_ec_pointed_cell_225 (((tmp_pbstr_include_path != NULL) ? eif_wean (tmp_pbstr_include_path) : NULL), pbstr_include_path);
