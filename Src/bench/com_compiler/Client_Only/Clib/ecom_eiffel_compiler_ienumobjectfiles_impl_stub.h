...
#ifndef __ECOM_EIFFEL_COMPILER_IENUMOBJECTFILES_IMPL_STUB_H__
#define __ECOM_EIFFEL_COMPILER_IENUMOBJECTFILES_IMPL_STUB_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_eiffel_compiler
{
class IEnumObjectFiles_impl_stub : public ecom_eiffel_compiler::IEnumObjectFiles
{
public:
	...
	No description available.
	-----------------------------------------------------------*/
	STDMETHODIMP Clone(  /* [out] */ ecom_eiffel_compiler::IEnumObjectFiles * * ppenum );
