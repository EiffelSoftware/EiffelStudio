...
#include "ecom_eiffel_compiler_IEiffelClassDescriptor_impl_stub.h"
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelClassDescriptor_impl_stub::tool_tip(  /* [out, retval] */ BSTR * return_value )
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelClassDescriptor_impl_stub::is_in_system(  /* [out, retval] */ VARIANT_BOOL * return_value )
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_clients = grt_ec_ISE_c.ccom_ec_pointed_interface_39 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_clients = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_suppliers = grt_ec_ISE_c.ccom_ec_pointed_interface_39 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_suppliers = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_ancestors = grt_ec_ISE_c.ccom_ec_pointed_interface_39 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_ancestors = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_descendants = grt_ec_ISE_c.ccom_ec_pointed_interface_39 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelClassDescriptor_impl_stub::GetTypeInfo( unsigned int itinfo, LCID lcid, ITypeInfo **pptinfo )
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelClassDescriptor_impl_stub::GetTypeInfoCount( unsigned int * pctinfo )
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelClassDescriptor_impl_stub::GetIDsOfNames( REFIID riid, OLECHAR ** rgszNames, unsigned int cNames, LCID lcid, DISPID *rgdispid )
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelClassDescriptor_impl_stub::Invoke( DISPID dispID, REFIID riid, LCID lcid, unsigned short wFlags, DISPPARAMS *pDispParams, VARIANT *pVarResult, EXCEPINFO *pExcepInfo, unsigned int *puArgErr )
