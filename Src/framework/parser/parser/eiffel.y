...
%token <TUPLE [keyword: KEYWORD_AS; id: ID_AS; line, column: INTEGER; filename: STRING] as keyword_id> TE_ACROSS TE_ASSIGN TE_ATTRIBUTE TE_ATTACHED TE_DETACHABLE TE_INDEXING TE_IS TE_NOTE TE_SOME
