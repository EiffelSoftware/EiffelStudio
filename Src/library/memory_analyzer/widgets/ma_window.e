...
feature {NONE} -- Initialization
	...
	user_initialization
		...
		do
			...
			gc_graphs.dpi_changed_actions.extend (agent (a_dpi: NATURAL_32; x, y, w, h: INTEGER_32) do analyze_gc.redraw_for_resize end)
...
feature -- Redefine
	...
	destroy
		...
		do
			...
			split_incre.dpi_changed_actions.wipe_out
			gc_graphs.dpi_changed_actions.wipe_out
...
feature {NONE} -- Implementation for agents
	...
	update_splitter_proportion_once_dpi_change (a_splitter: EV_SPLIT_AREA; a_proportion: REAL; a_dpi: NATURAL_32; x, y, w, h: INTEGER_32)
			-- Set `a_splitter' with `a_proportion'.
			-- Wipe out `a_splitter' `resize_actions' when `a_splitter' is shown.
		do
			update_splitter_proportion_once (a_splitter, a_proportion, x, y, w, h)
		end
