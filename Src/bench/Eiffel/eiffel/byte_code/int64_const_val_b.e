indexing
	description: "Representation of a 64-bit integer constant"
	date: "$Date$"
	revision: "$Revision$"
...
feature {NONE} -- Initialization
	...
	make (context_class: CLASS_C; i: INTEGER_64; c: CONSTANT_I) is
...
feature -- Code generation
	...
	generation_value: INTEGER_64 is
			-- Value to generate
		local
		...
		do
			...
			Result := integer_value.integer_64_value
		end
