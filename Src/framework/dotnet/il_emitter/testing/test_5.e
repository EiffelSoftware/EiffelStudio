...
feature -- Test
	...
	test
		...
		do
			create lib_entry.make_with_name ("test5", {PE_LIB}.il_only | {PE_LIB}.bits32)
			...
			create ins.make ({CIL_INSTRUCTION_OPCODES}.i_ldc_i4,{CIL_OPERAND_FACTORY}.integer64_operand (57, {CIL_OPERAND_SIZE}.i32))
