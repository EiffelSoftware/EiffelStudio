...
feature {NONE} -- NSKeyedUnarchiver Externals
	...
	objc_init_for_reading_with_data_ (an_item: POINTER; a_data: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSKeyedUnarchiver *)$an_item initForReadingWithData:$a_data];
			 ]"
		end
	...
	objc_set_delegate_ (an_item: POINTER; a_delegate: POINTER)
		...
		alias
			"[
				[(NSKeyedUnarchiver *)$an_item setDelegate:$a_delegate];
			 ]"
		end
	...
	objc_delegate (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSKeyedUnarchiver *)$an_item delegate];
			 ]"
		end

	objc_finish_decoding (an_item: POINTER)
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <Foundation/Foundation.h>"
		alias
			"[
				[(NSKeyedUnarchiver *)$an_item finishDecoding];
			 ]"
		end

feature -- NSKeyedUnarchiver

	set_delegate_ (a_delegate: detachable NS_KEYED_UNARCHIVER_DELEGATE_PROTOCOL)
			-- Auto generated Objective-C wrapper.
		local
	...
	delegate: detachable NS_KEYED_UNARCHIVER_DELEGATE_PROTOCOL
			-- Auto generated Objective-C wrapper.
		local
