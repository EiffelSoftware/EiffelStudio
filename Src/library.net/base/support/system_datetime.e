...
feature -- Access
	...
	frozen get_day_of_week: SYSTEM_DAYOFWEEK is
		external
...
feature -- Basic Operations
	...
	frozen parse_exact_string_string_iformat_provider_date_time_styles (s: STRING; format: STRING; provider: SYSTEM_IFORMATPROVIDER; style: SYSTEM_GLOBALIZATION_DATETIMESTYLES): SYSTEM_DATETIME is
		external
	...
	frozen parse_string_iformat_provider_date_time_styles (s: STRING; provider: SYSTEM_IFORMATPROVIDER; styles: SYSTEM_GLOBALIZATION_DATETIMESTYLES): SYSTEM_DATETIME is
		external
	...
	frozen extend (value: SYSTEM_TIMESPAN): SYSTEM_DATETIME is
		external
	...
	frozen parse_exact_string_array_string (s: STRING; formats: ARRAY [STRING]; provider: SYSTEM_IFORMATPROVIDER; style: SYSTEM_GLOBALIZATION_DATETIMESTYLES): SYSTEM_DATETIME is
		external
			"IL static signature (System.String, System.String[], System.IFormatProvider, System.Globalization.DateTimeStyles): System.DateTime use System.DateTime"
		alias
			"ParseExact"
