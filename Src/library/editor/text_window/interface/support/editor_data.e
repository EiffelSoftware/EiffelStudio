...
feature {NONE} -- Implementation
	...
	initialize_preferences is
		...
		do
			l_manager := preferences.new_manager ("editor")
			
				-- Preferences
				
			tabulation_spaces_preference := l_manager.new_integer_resource_value (tabulation_spaces_string, 4)	
			left_margin_width_preference := l_manager.new_integer_resource_value (left_margin_width_string, 10)		
			margin_background_color_preference := l_manager.new_color_resource_value (margin_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))		
			margin_separator_color_preference := l_manager.new_color_resource_value (margin_separator_color_string, create {EV_COLOR}.make_with_8_bit_rgb (0, 0, 0))			
			line_number_text_color_preference := l_manager.new_color_resource_value (line_number_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (192, 192, 192))	
			use_tab_for_indentation_preference := l_manager.new_boolean_resource_value (use_tab_for_indentation_string, True)		
			mouse_wheel_scroll_full_page_preference := l_manager.new_boolean_resource_value (mouse_wheel_scroll_full_page_string, False)			
			mouse_wheel_scroll_size_preference := l_manager.new_integer_resource_value (mouse_wheel_scroll_size_string, 3)
			remove_trailing_white_space_preference := l_manager.new_boolean_resource_value (remove_trailing_white_space_string, False)
			blinking_cursor_preference := l_manager.new_boolean_resource_value (blinking_cursor_string, False)
			automatic_update_preference := l_manager.new_boolean_resource_value (automatic_update_string, True)			
--			highlight_document_changes_preference := l_manager.new_boolean_resource_value (highlight_document_changes_string, False)			
			
			editor_font_preference := l_manager.new_font_resource_value (editor_font_string, create {EV_FONT})	
			font_cell.put (editor_font_preference)			
			header_font_preference := l_manager.new_font_resource_value (header_font_string, create {EV_FONT})
			header_font_cell.put (header_font_preference)
			keyword_font_preference := l_manager.new_font_resource_value (keyword_font_string, create {EV_FONT})	
			keyword_font_cell.put (keyword_font_preference)
			
			normal_text_color_preference := l_manager.new_color_resource_value (normal_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (0, 0, 0))
			normal_background_color_preference := l_manager.new_color_resource_value (normal_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			selection_text_color_preference := l_manager.new_color_resource_value (selection_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 128))
			selection_background_color_preference := l_manager.new_color_resource_value (selection_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (0, 0, 128))
			string_text_color_preference := l_manager.new_color_resource_value (string_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (115, 85, 0))			
			string_background_color_preference := l_manager.new_color_resource_value (string_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			keyword_text_color_preference := l_manager.new_color_resource_value (keyword_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (0, 0, 128))
			keyword_background_color_preference := l_manager.new_color_resource_value (keyword_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			spaces_text_color_preference := l_manager.new_color_resource_value (spaces_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (128, 128, 128))
			spaces_background_color_preference := l_manager.new_color_resource_value (spaces_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			comments_text_color_preference := l_manager.new_color_resource_value (comments_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (128, 0, 0))
			comments_background_color_preference := l_manager.new_color_resource_value (comments_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			operator_text_color_preference := l_manager.new_color_resource_value (operator_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 0, 0))
			operator_background_color_preference := l_manager.new_color_resource_value (operator_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			number_text_color_preference := l_manager.new_color_resource_value (number_text_color_string, create {EV_COLOR}.make_with_8_bit_rgb (128, 0, 255))
			number_background_color_preference := l_manager.new_color_resource_value (number_background_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 255))
			highlight_color_preference := l_manager.new_color_resource_value (highlight_color_string, create {EV_COLOR}.make_with_8_bit_rgb (255, 255, 128))
