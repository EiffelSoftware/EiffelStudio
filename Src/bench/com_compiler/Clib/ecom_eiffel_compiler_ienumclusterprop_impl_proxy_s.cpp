...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClusterProperties * *)grt_ec_ISE.ccom_ec_pointed_cell_183 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_183 ((ecom_eiffel_compiler::IEiffelClusterProperties * *)tmp_rgelt, rgelt);
...
grt_ce_ISE.ccom_free_memory_pointed_186 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumClusterProp * *)grt_ec_ISE.ccom_ec_pointed_cell_180 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_180 ((ecom_eiffel_compiler::IEnumClusterProp * *)tmp_ppenum, ppenum);
