...
feature -- Text
	...
	e_evaluate_metric: STRING_32 do Result := locale.translation ("Evaluate metric: ") end
	e_not_evaluated: STRING_32 do Result := locale.translation ("Not evaluated") end
	e_evaluating: STRING_32 do Result := locale.translation ("Evaluating: ") end
	e_evaluating_value: STRING_32 do Result := locale.translation ("Evaluating...") end
	e_undefined_value: STRING_32 do Result := locale.translation ("Undefined") end
	e_value: STRING_32 do Result := locale.translation ("Value:") end
	e_interrupted_by_user: STRING_32 do Result := locale.translation ("Interrupted by user") end
	e_interrupted_by_compile: STRING_32 do Result := locale.translation ("Interrupted because Eiffel complication starts") end
	e_no_metric_is_selected: STRING_32 do Result := locale.translation ("No metric is selected.") end

	e_xml_files: STRING_32 do Result := locale.translation ("XML files") end
	e_all_files: STRING_32 do Result := locale.translation ("All files") end

feature -- Titles

	t_expression: STRING_32 do Result := locale.translation ("Expression:") end
	t_criterion: STRING_32 do Result := locale.translation ("Criterion") end
	t_properties: STRING_32 do Result := locale.translation ("Properties") end
	t_status: STRING_32 do Result := locale.translation ("Status") end
	t_ok: STRING_32 do Result := locale.translation ("OK") end
	t_cancel: STRING_32 do Result := locale.translation ("Cancel") end
	t_type: STRING_32 do Result := locale.translation ("type") end
	t_value_of_reference: STRING_32 do Result := locale.translation ("Reference value") end
	t_value_of_current: STRING_32 do Result := locale.translation ("Current value") end
	t_difference: STRING_32 do Result := locale.translation ("Difference") end
	t_ratio: STRING_32 do Result := locale.translation ("ratio") end
	t_basic: STRING_32 do Result := locale.translation ("basic") end
	t_linear: STRING_32 do Result := locale.translation ("linear") end
	t_definition_tab: STRING_32 do Result := locale.translation ("Metric Definition") end
	t_evaluation_tab: STRING_32 do Result := locale.translation ("Metric Evaluation") end
	t_archive_tab: STRING_32 do Result := locale.translation ("Metric Archive") end
	t_detail_result_tab: STRING_32 do Result := locale.translation ("Detailed Result") end
	t_history_tab: STRING_32 do Result := locale.translation ("Metric History") end
	t_path: STRING_32 do Result := locale.translation ("Location") end
	t_group: STRING_32 do Result := locale.translation ("Group") end
	t_metrics: STRING_32 do Result := locale.translation ("Metrics") end
	t_coefficient: STRING_32 do Result := locale.translation ("Coefficient") end
	t_metric_valid: STRING_32 do Result := locale.translation ("Metric is valid.") end
	t_save_metric: STRING_32 do Result := locale.translation ("Current metric has been modified, save it?") end
	...
	t_metric_not_saved: STRING_32 do Result := locale.translation ("Note: Metric is not saved.") end
	t_select_archive: STRING_32 do Result := locale.translation ("Select a metric archive file") end
	t_metric_no_metric_selected: STRING_32 do Result := locale.translation ("No metric is selected") end
	t_metric_is_not_valid: STRING_32 do Result := locale.translation ("is invalid") end
	t_selected_metric: STRING_32 do Result := locale.translation ("Selected metric") end
	t_selected_file_not_exists: STRING_32 do Result := locale.translation ("Specified file doesn't exist") end
	...
	t_no_archive_selected: STRING_32 do Result := locale.translation ("No metric archive is selected.") end
	t_archive_management: STRING_32 do Result := locale.translation ("Archive Management") end
	t_archive_comparison: STRING_32 do Result := locale.translation ("Archive Comparison") end
	t_location: STRING_32 do Result := locale.translation ("Location") end
	t_select_source_domain: STRING_32 do Result := locale.translation ("Setup input domain:") end
	t_select_metric: STRING_32 do Result := locale.translation ("Select metric:") end
	t_select_reference_archive: STRING_32 do Result := locale.translation ("Select reference archive (URL acceptable):") end
	t_select_current_archive: STRING_32 do Result := locale.translation ("Select current archive (URL acceptable):") end
	t_archive_comparison_result: STRING_32 do Result := locale.translation ("Archive comparison result:") end
	t_clean: STRING_32 do Result := locale.translation ("Clean") end
	t_compare: STRING_32 do Result := locale.translation ("Compare") end
	t_input_domain: STRING_32 do Result := locale.translation ("Input domain") end
	t_result: STRING_32 do Result := locale.translation ("Results:") end
	t_input_domain_title: STRING_32 do Result := locale.translation ("Input domain:") end
	t_metric_criterion_definition: STRING_32 do Result := locale.translation ("Definition:") end
	t_select_domain_scope: STRING_32 do Result := locale.translation ("Select domain scope") end
	t_predefined_text_not_editable: STRING_32 do Result := locale.translation ("Text not editable because current metric is predefined.") end
	t_text_not_editable: STRING_32 do Result := locale.translation ("Text not editable.") end
	t_metric_definition: STRING_32 do Result := locale.translation ("Metric definition") end
	t_checking_metric_vadility: STRING_32 do Result := locale.translation ("Checking metric validity") end
	t_loading_metrics: STRING_32 do Result := locale.translation ("Loading metrics...") end
	t_analysing_archive: STRING_32 do Result := locale.translation ("Analyzing metric archive(s)...") end
	t_saving_metrics: STRING_32 do Result := locale.translation ("Saving metrics...") end
	t_removing_metrics: STRING_32 do Result := locale.translation ("Removing metrics...") end
	t_result_not_up_to_date: STRING_32 do Result := locale.translation ("Current metric result may not be up-to-date") end
	t_feature_version_setting: STRING_32 do Result := locale.translation ("Feature version setting:") end
	t_only_current_version: STRING_32 do Result := locale.translation ("Only current version") end
	t_descendant_version: STRING_32 do Result := locale.translation ("Current version and all its descendant versions") end
	t_to_do: STRING_32 do Result := locale.translation ("To do:") end
	...
	t_metric_original_name: STRING_32 do Result := locale.translation ("Original metric name") end
	t_metric_name: STRING_32 do Result := locale.translation ("Metric name") end
	t_metric_description: STRING_32 do Result := locale.translation ("Description") end
	t_metric_unit: STRING_32 do Result := locale.translation ("Unit") end
	t_select_all_metrics: STRING_32 do Result := locale.translation ("Select All Metrics") end
	t_deselect_all_metrics: STRING_32 do Result := locale.translation ("Deselect All Metrics") end
	...
	err_input_domain_invalid: STRING_32 do Result := locale.translation ("Input domain invalid") end
	t_previous_value: STRING_32 do Result := locale.translation ("Previous value") end
	t_calculated_time: STRING_32 do Result := locale.translation ("Calculated time") end
	t_warning_check_failed: STRING_32 do Result := locale.translation ("Warning check failed") end

	f_run_history_recalculation: STRING_32 do Result := locale.translation ("Recalculate selected metric(s)") end
	f_stop_history_recalculation: STRING_32 do Result := locale.translation ("Stop metric recalculation") end
	f_remove_history_node: STRING_32 do Result := locale.translation ("Remove selected metric history") end
	f_display_history_in_tree_view: STRING_32 do Result := locale.translation ("Display history in tree view?") end
	f_send_to_history: STRING_32 do Result := locale.translation ("Send last calculated metric value to history") end
	t_hide_old_archive: STRING_32 do Result := locale.translation ("Hide archives more than ") end
	t_days: STRING_32 do Result := locale.translation (" days old.") end
	f_keep_archive_detailed_result: STRING_32 do Result := locale.translation ("Keep detailed result when recalculating archive?%NIf yes, detailed result will be available by double clicking the icon in %"Result%" column in history result area after recalculation.") end
	f_keep_metric_detailed_result: STRING_32 do Result := locale.translation ("Keep detailed result when evaluating metric?") end
	f_remove_detailed_result: STRING_32 do Result := locale.translation ("Remove detailed result?") end
	t_detailed_result: STRING_32 do Result := locale.translation ("Result") end
	f_double_click_to_go_to_result_panel: STRING_32 do Result := locale.translation ("Double click to go to result panel") end
	f_select_all_history: STRING_32 do Result := locale.translation ("Select all history items") end
	f_deselect_all_history: STRING_32 do Result := locale.translation ("Deselect all history items") end
	f_select_recalculatable_history: STRING_32 do Result := locale.translation ("Select recalculatable history items") end
	f_deselect_recalculatable_history: STRING_32 do Result := locale.translation ("Deselect recalculatable history items") end
	t_select_all_history: STRING_32 do Result := locale.translation ("Select All") end
	t_deselect_all_history: STRING_32 do Result := locale.translation ("Deselect All") end
	t_select_recalculatable_history: STRING_32 do Result := locale.translation ("Select Recalculatable") end
	t_deselect_recalculatable_history: STRING_32 do Result := locale.translation ("Deselect Recalculatable") end
	t_filter: STRING_32 do Result := locale.translation ("Filter") end
	...
	t_match_all_of_the_following: STRING_32 do Result := locale.translation ("Match all") end
	t_match_any_of_the_following: STRING_32 do Result := locale.translation ("Match any") end
	t_select_tester: STRING_32 do Result := locale.translation ("Select metric value testers:") end
	l_domain: STRING_32 do Result := locale.translation ("domain") end
	l_error_message: STRING_32 do Result := locale.translation ("error message") end
	l_setup_metric_value_retriever: STRING_32 do Result := locale.translation ("Setup metric value retriever") end
	t_add_new_metric_value_retriever: STRING_32 do Result := locale.translation ("Add new metric value retriever") end
	t_use_external_delayed: STRING_32 do Result := locale.translation ("Use external delayed domain") end
	t_warning: STRING_32 do Result := locale.translation ("Warning") end
	t_row: STRING_32 do Result := locale.translation ("row") end
	t_column: STRING_32 do Result := locale.translation ("column") end
	t_identical: STRING_32 do Result := locale.translation ("Identity") end
	t_containing: STRING_32 do Result := locale.translation ("Containing") end
	t_wildcard: STRING_32 do Result := locale.translation ("Wildcard") end
	t_regexp: STRING_32 do Result := locale.translation ("Regular expression") end
	t_matching_strategy: STRING_32 do Result := locale.translation ("Matching Strategy") end
	t_clear_result: STRING_32 do Result := locale.translation ("Clear detailed result") end
	t_case_sensitive: STRING_32 do Result := locale.translation ("Case-sensitive") end
	t_case_insensitive: STRING_32 do Result := locale.translation ("Case-insensitive") end
	l_external_command_tester: STRING_32 do Result := locale.translation ("External command tester") end
	l_as_file_name: STRING_32 do Result := locale.translation ("As file name?") end
	l_enabled: STRING_32 do Result := locale.translation ("Enabled?") end
	l_exit_code: STRING_32 do Result := locale.translation ("Exit code") end
	l_redirected_to_output: STRING_32 do Result := locale.translation ("Redirected to output?") end
	l_setup_external_command: STRING_32 do Result := locale.translation ("Setup external command for criterion") end

feature -- Titles for editor token

	te_input_domain: STRING = "Input domain"
	te_no_metric: STRING = "No metric"

feature -- Labels

	l_select_input_domain: STRING_32 do Result := locale.translation ("Select input domain:") end
	l_select_metric: STRING_32 do Result := locale.translation ("Select metric:") end
	l_parse_error: STRING_32 do Result := locale.translation ("Parse error:") end
	l_ratio_metric: STRING_32 do Result := locale.translation ("ratio metric") end
	l_linear_metric: STRING_32 do Result := locale.translation ("linear metric") end
	l_basic_metric: STRING_32 do Result := locale.translation ("basic metric") end
	l_denominator_metric: STRING_32 do Result := locale.translation ("denominator metric") end
	l_numerator_metric: STRING_32 do Result := locale.translation ("numerator metric") end
	l_variable_metric: STRING_32 do Result := locale.translation ("variable metric") end
	l_metric_archive_node: STRING_32 do Result := locale.translation ("metric archive node") end
	l_criterion: STRING_32 do Result := locale.translation ("criterion") end
	l_name_colon: STRING_32 do Result := locale.translation ("Name:") end
	l_type_colon: STRING_32 do Result := locale.translation ("Type:") end
	l_unit_colon: STRING_32 do Result := locale.translation ("Unit:") end
	l_description_colon: STRING_32 do Result := locale.translation ("Description:") end
	l_no_result_available: STRING_32 do Result := locale.translation ("No result available.") end
	l_metric_definition_file: STRING_32 do Result := locale.translation ("Metrics definition file:") end
	l_use_case_sensitive: STRING_32 do Result := locale.translation ("Case sensitive") end
	l_use_regular_expression: STRING_32 do Result := locale.translation ("Use regular expression") end
	l_constant_value: STRING_32 do Result := locale.translation ("constant value") end
	l_metric_value: STRING_32 do Result := locale.translation ("metric value") end
	l_value_tester: STRING_32 do Result := locale.translation ("value tester") end
	l_current: STRING_32 do Result := locale.translation ("current") end
	l_current_version: STRING_32 do Result := locale.translation ("current version") end
	l_desendent_versions: STRING_32 do Result := locale.translation ("descendent versions") end
	l_direct: STRING_32 do Result := locale.translation ("direct") end
	l_indirect: STRING_32 do Result := locale.translation ("indirect") end
	l_normal_referenced: STRING_32 do Result := locale.translation ("normal") end
	l_syntactical_referenced: STRING_32 do Result := locale.translation ("syntactical") end
	l_empty_domain: STRING_32 do Result := locale.translation ("empty domain") end
	l_use_external_delayed_domain: STRING_32 do Result := locale.translation ("use external delayed domain") end
	l_no_value_tester: STRING_32 do Result := locale.translation ("No value tester") end

feature -- Tooltip

	f_quick_metric_definition: STRING_32 do Result := locale.translation ("Define quick metric (or drop a basic metric here as a template)") end
	f_run: STRING_32 do Result := locale.translation ("Run selected metric%NRunnable when a metric is selected and input domain is set.") end
	f_go_to_definition: STRING_32 do Result := locale.translation ("Go to definition") end
	f_stop: STRING_32 do Result := locale.translation ("Stop metric evaluation") end
	f_move_row_up: STRING_32 do Result := locale.translation ("Move selected row up") end
	f_move_row_down: STRING_32 do Result := locale.translation ("Move selected row down") end
	f_del_row: STRING_32 do Result := locale.translation ("Delete selected row") end
	f_clear_rows: STRING_32 do Result := locale.translation ("Remove all rows") end
	f_indent_with_and_criterion: STRING_32 do Result := locale.translation ("Indent selected row using an %"AND%" criterion") end
	f_indent_with_or_criterion: STRING_32 do Result := locale.translation ("Indent selected row using an %"OR%" criterion") end
	f_drop_metric_here: STRING_32 do Result := locale.translation ("Pick metric and drop here") end
	f_reload_metrics: STRING_32 do Result := locale.translation ("Reload metrics") end

	f_start_archive: STRING_32 do Result := locale.translation ("Start metric archive evaluation") end
	f_stop_archive: STRING_32 do Result := locale.translation ("Stop metric archive evaluation") end
	f_select_exist_archive_file: STRING_32 do Result := locale.translation ("Select an existing metric archive file") end
	f_clean_archive: STRING_32 do Result := locale.translation ("Clean archive?") end

	f_compare_archive: STRING_32 do Result := locale.translation ("Compare metric archive") end
	f_select_current_archive: STRING_32 do Result := locale.translation ("Select current metric archive file") end
	f_select_reference_archive: STRING_32 do Result := locale.translation ("Select reference metric archive file") end
	f_select_userdefined_metrics: STRING_32 do Result := locale.translation ("Select/deselect user-defined metrics") end
	f_select_predefined_metrics: STRING_32 do Result := locale.translation ("Select/deselect predefined metrics") end
	f_group_metric_by_unit: STRING_32 do Result := locale.translation ("Group metrics by unit") end

	f_add_scope: STRING_32 do Result := locale.translation ("Add scope") end
	f_remove_scope: STRING_32 do Result := locale.translation ("Remove selected scope(s)") end
	f_remove_all_scopes: STRING_32 do Result := locale.translation ("Remove all scopes") end
	f_delayed_scope: STRING_32 do Result := locale.translation ("Use input domain as criterion domain.") end
	f_use_delayed_scope: STRING_32 do Result := locale.translation ("Use delayed domain") end
	f_save: STRING_32 do Result := locale.translation ("Save") end
	f_new: STRING_32 do Result := locale.translation ("New metric") end
	f_remove: STRING_32 do Result := locale.translation ("Remove current selected metric") end
	f_domain_item_invalid: STRING_32 do Result := locale.translation ("Item invalid in current system") end
	f_application_scope: STRING_32 do Result := locale.translation ("Add current application target scope") end
	f_search_for_class: STRING_32 do Result := locale.translation ("Search for group/class/feature") end
	f_filter_result: STRING_32 do Result := locale.translation ("Filter result which is not visible from input domain") end
	f_pick_and_drop_items: STRING_32 do Result := locale.translation ("Pick items like group/class/feature and drop here") end
	f_pick_and_drop_metric_and_items: STRING_32 do Result := locale.translation ("Pick metrics or items like group/class/feature and drop here") end
	f_insert_text_here: STRING_32 do Result := locale.translation ("Insert text here") end
	f_get_criterion_list: STRING_32 do Result := locale.translation ("Available criterion list") end;
	f_get_negation: STRING_32 do Result := locale.translation ("You can put %"not%" before a criterion name to negate it") end
	f_open_metric_file_in_external_editor: STRING_32 do Result := locale.translation ("Open user defined metric file in external editor") end
	f_create_new_metric_using_current_data: STRING_32 do Result := locale.translation ("Clone selected metric to a new metric") end
	f_setup_criterion_domain: STRING_32 do Result := locale.translation ("Setup criterion domain properties") end
	f_setup_criterion_text: STRING_32 do Result := locale.translation ("Setup criterion text properties") end
	f_double_click_to_go_to_definition: STRING_32 do Result := locale.translation ("(Double click to go to definition)") end
	f_display_in_percentage: STRING_32 do Result := locale.translation ("Display result in percentage? (Only applicable for ratio metrics)") end
	f_add_linear_variable_metric: STRING_32 do Result := locale.translation ("Add selected metric") end
	f_run_metric_again: STRING_32 do Result := locale.translation ("Evaluate metric again to get up-to-date result") end
	f_auto_go_to_result: STRING_32 do Result := locale.translation ("Automatically go to result panel after metric evaluation?") end
	f_press_esc_to_wipe_out: STRING_32 do Result := locale.translation ("Press ESC to wipe out") end
	f_move_unit_up: STRING_32 do Result := locale.translation ("Move metric unit up.%N") end
	...
	l_argument_unit: STRING_32 do Result := locale.translation("Argument") end
	l_line_unit: STRING_32 do Result := locale.translation("Line") end
	l_compilation_unit: STRING_32 do Result := locale.translation("Compilation") end
	l_local_unit: STRING_32 do Result := locale.translation("Local") end
	l_ratio_unit: STRING_32 do Result := locale.translation("Ratio") end

	l_retrieve_indirect_referenced_class (a_for_supplier: BOOLEAN): STRING_32
		do
	...
	l_retrieve_referenced_class (a_for_supplier: BOOLEAN): STRING_32
		do
			if a_for_supplier then
	...
	l_retrieve_normally_referenced_class (a_for_supplier: BOOLEAN): STRING_32
		do
			if a_for_supplier then
	...
	l_retrieve_only_syntacticall_referenced_class (a_for_supplier: BOOLEAN): STRING_32
		do
			if a_for_supplier then
	...
	l_setup_referenced_class_dialog (a_for_supplier: BOOLEAN): STRING_32
		do
			if a_for_supplier then
	...
	l_setup_domain_dialog: STRING_32 do Result := locale.translation ("Setup domain") end

	l_base_value: STRING_32 do Result := locale.translation ("Base value") end
	l_operator: STRING_32 do Result := locale.translation ("Operator") end
	t_drop_program_elements: STRING_32 do Result := locale.translation ("Drop target/group/class/feature here") end

	f_metrics_in_archive (a_count: INTEGER): STRING_32
		do
...
feature -- Error/warning message
	...
	err_invalid_tag: STRING_32 do Result := locale.translation ("Invalid tag.") end
			-- Invalid tag error
	...
	err_too_many_criteria: STRING_32
	...
	err_too_many_criterion_section: STRING_32
	...
	err_metric_name_missing_in_metric_definition: STRING_32
	...
	err_metric_name_missing_in_archive_node: STRING_32
	...
	err_numerator_metric_missing: STRING_32
	...
	err_denominator_metric_missing: STRING_32
			-- Numerator metric missing error
		do
	...
	err_variable_metric_name_missing: STRING_32
	...
	err_coefficient_missing: STRING_32
	...
	err_case_sensitive_attr_missing: STRING_32
	...
	err_regular_expression_attr_missing: STRING_32
	...
	err_criterion_name_missing: STRING_32
	...
	err_unit_name_missing: STRING_32
	...
	err_domain_item_id_is_missing: STRING_32
	...
	err_domain_item_type_is_missing: STRING_32
	...
	err_metric_type_missing: STRING_32
	...
	err_archive_time_missing: STRING_32
	...
	err_archive_value_missing: STRING_32
	...
	err_variable_metric_missing: STRING_32
	...
	err_variable_metric_not_defined: STRING_32
	...
	err_domain_item_not_exist: STRING_32
	...
	err_text_in_text_criterion_empty: STRING_32
	...
	err_metric_name_empty: STRING_32
	...
	err_metric_name_missing: STRING_32
	...
	err_no_value_tester_specified: STRING_32 do Result := locale.translation ("No value tester is specified.") end
	...
	err_too_many_value_retriever: STRING_32
		do
	...
	err_divided_by_zero: STRING_32 do Result := locale.translation ("Divided by 0") end

feature -- To do messages

	variable_metric_missing_to_do: STRING_32
		do
	...
	variable_metric_not_defined_to_do: STRING_32
		do
	...
	variable_metric_unit_not_correct_to_do: STRING_32
		do
	...
	numerator_denominator_metric_not_defined_to_do: STRING_32
		do
	...
	unit_in_basic_metric_not_same_to_do: STRING_32 do Result := locale.translation ("Make sure every (recursive) criterion in basic metric is of the same unit with that basic metric.") end
	criterion_not_exist_to_do: STRING_32 do Result := locale.translation ("Make sure that the criterion of given unit exists.") end
	domain_item_not_exists_to_do: STRING_32 do Result := locale.translation ("Make sure that at least one domain item is listed in a domain criterion.") end
	text_in_text_criterion_empty_to_do: STRING_32 do Result := locale.translation ("Make sure to specify a non-empty string for a text criterion.") end
	...
	recursive_definition_to_do: STRING_32 do Result := locale.translation ("In linear metric, make sure that every variable metric doesn't involve recursive metric.%NIn ratio metric, make sure that numerator metric or denominator metric doesn't involve recursive metric.") end
	make_sure_denominator_coefficient_non_zero_to_do: STRING_32 do Result := locale.translation ("Make sure coefficient for denominator metric is a non-zero real number.") end

	no_value_tester_specified_to_do: STRING_32 do Result := locale.translation ("Make sure that at least one value tester is specified.") end

	metric_name_info: STRING_32
	...
	invalid_domain_item_info: STRING_32
	...
	metric_invalid_to_do: STRING_32
			-- Invalid metric to-do message
		do
			Result := locale.translation ("Make sure that referenced metric exists and is valid.")
		end

	delayed_domain_item_appear_to_do: STRING_32 do Result := locale.translation ("Remove delayed domain item.") end
	input_domain_item_appear_to_do: STRING_32 do Result := locale.translation ("Remove input domain item.") end
...
feature -- Utilities
	...
	xml_position (a_column: INTEGER; a_row: INTEGER): STRING_32
