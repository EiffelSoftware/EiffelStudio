...
feature -- Token codes
	...
	TE_BLOCKING: INTEGER is 263
	TE_STAR: INTEGER is 264
	TE_LT: INTEGER is 265
	TE_GT: INTEGER is 266
	TE_DQUOTE: INTEGER is 267
	TE_ACCESS: INTEGER is 268
	TE_C_LANGUAGE: INTEGER is 269
	TE_CPP_LANGUAGE: INTEGER is 270
	TE_INLINE: INTEGER is 271
	TE_DELETE: INTEGER is 272
	TE_DLL_LANGUAGE: INTEGER is 273
	TE_DLLWIN_LANGUAGE: INTEGER is 274
	TE_ENUM: INTEGER is 275
	TE_GET_PROPERTY: INTEGER is 276
	TE_IL_LANGUAGE: INTEGER is 277
	TE_MACRO: INTEGER is 278
	TE_FIELD: INTEGER is 279
	TE_JAVA_LANGUAGE: INTEGER is 280
	TE_DEFERRED: INTEGER is 281
	TE_OPERATOR: INTEGER is 282
	TE_INTEGER: INTEGER is 283
	TE_SET_FIELD: INTEGER is 284
	TE_SET_PROPERTY: INTEGER is 285
	TE_SIGNATURE: INTEGER is 286
	TE_STATIC: INTEGER is 287
	TE_CREATOR: INTEGER is 288
	TE_STATIC_FIELD: INTEGER is 289
	TE_SET_STATIC_FIELD: INTEGER is 290
	TE_STRUCT: INTEGER is 291
	TE_TYPE: INTEGER is 292
	TE_SIGNED: INTEGER is 293
	TE_UNSIGNED: INTEGER is 294
	TE_USE: INTEGER is 295
