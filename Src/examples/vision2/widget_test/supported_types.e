...
--			Result.extend ("EV_CELL")
--			Result.extend ("EV_FIXED")
			Result.extend ("EV_FRAME")
--			Result.extend ("EV_HORIZONTAL_SPLIT_AREA")
--			Result.extend ("EV_HORIZONTAL_BOX")
--			Result.extend ("EV_NOTEBOOK")
--			Result.extend ("EV_SCROLLABLE_AREA")
--			Result.extend ("EV_TABLE")
--			Result.extend ("EV_VERTICAL_BOX")
--			Result.extend ("EV_VERTICAL_SPLIT_AREA")
--			Result.extend ("EV_VIEWPORT")
--		
			Result.extend ("EV_BUTTON")
			Result.extend ("EV_CHECK_BUTTON")
			Result.extend ("EV_COMBO_BOX")
--			Result.extend ("EV_HORIZONTAL_PROGRESS_BAR")
--			Result.extend ("EV_HORIZONTAL_RANGE")
--			Result.extend ("EV_HORIZONTAL_SEPARATOR")
			Result.extend ("EV_LABEL")
--			Result.extend ("EV_LIST")
--			Result.extend ("EV_MULTI_COLUMN_LIST")
--			Result.extend ("EV_PASSWORD_FIELD")
--			Result.extend ("EV_PIXMAP")
...
--			Result.extend ("EV_TOOL_BAR")
--			Result.extend ("EV_TREE")
--			Result.extend ("EV_VERTICAL_PROGRESS_BAR")
--			Result.extend ("EV_VERTICAL_RANGE")
--			Result.extend ("EV_VERTICAL_SEPARATOR")
--			Result.extend ("EV_DRAWING_AREA")
--			Result.extend ("EV_VERTICAL_SCROLL_BAR")
--			Result.extend ("EV_HORIZONTAL_SCROLL_BAR")
--			Result.extend ("EV_TOOL_BAR_BUTTON")
--			Result.extend ("EV_TOOL_BAR_TOGGLE_BUTTON")
--			Result.extend ("EV_TOOL_BAR_RADIO_BUTTON")
--			Result.extend ("EV_TOOL_BAR_SEPARATOR")
