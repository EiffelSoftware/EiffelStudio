...
feature -- C code generation
	...
	generate (buffer: GENERATION_BUFFER; a_class: CLASS_C; generated_wrappers: SEARCH_TABLE [STRING])
...
debug ("CECIL")
	...
	generate_wrappers (buffer: GENERATION_BUFFER; a_class: CLASS_C; generated_wrappers: SEARCH_TABLE [STRING])
