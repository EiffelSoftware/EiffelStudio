...
feature
    ...
    get_value (index : INTEGER) : CORBA_UNIONMEMBER is
    ...
    set_value (value : CORBA_UNIONMEMBER; index : INTEGER) is
...
feature { ANY }
    ...
    type_name : STRING is
        ...
        do
            result := "UnionMemberSeq"
        end

end -- class CORBA_UNIONMEMBERSEQ
