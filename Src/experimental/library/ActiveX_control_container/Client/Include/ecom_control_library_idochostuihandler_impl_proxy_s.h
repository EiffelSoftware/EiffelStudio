...
public:
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_show_ui(  /* [in] */ EIF_INTEGER dw_id,  /* [in] */ ::IOleInPlaceActiveObject * p_active_object,  /* [in] */ ::IOleCommandTarget * p_command_target,  /* [in] */ ::IOleInPlaceFrame * p_frame,  /* [in] */ ::IOleInPlaceUIWindow * p_doc );
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_resize_border(  /* [in] */ ecom_control_library::tagRECT * prc_border,  /* [in] */ ::IOleInPlaceUIWindow * p_uiwindow,  /* [in] */ EIF_INTEGER f_rame_window );
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_get_drop_target(  /* [in] */ ::IDropTarget * p_drop_target,  /* [out] */ EIF_OBJECT pp_drop_target );
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_filter_data_object(  /* [in] */ ::IDataObject * p_do,  /* [out] */ EIF_OBJECT pp_doret );
...
private:
  ...
  Interface pointer
  -----------------------------------------------------------*/
  ::IDocHostUIHandler * p_IDocHostUIHandler;
