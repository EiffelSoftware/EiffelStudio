...
feature {NONE} -- Initialization
	...
	make
		...
		do
			create file_records.make (10)
			create file_modified_callbacks.make (10)
...
feature {NONE} -- Access
	...
	file_records: HASH_TABLE [FILE_NOTIFIER_RECORD, like file_name_key]
	...
	file_modified_callbacks: HASH_TABLE [EVENT_TYPE [TUPLE [modification_type: NATURAL_8]], like file_name_key]
...
feature -- Event handlers
	...
	on_file_modified (a_file_name: PATH; a_type: NATURAL_8)
...
invariant
	...
	file_records_contains_monitored_items: across file_records as l_record all l_record.item.is_monitoring end
