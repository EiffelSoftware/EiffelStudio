...
feature -- Access
	...
	frozen dbnull: SYSTEM_OBJECT is
		external
...
feature -- Basic Operations
	...
	frozen to_boolean_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): BOOLEAN is
		external
	...
	frozen to_int64_string (value: SYSTEM_STRING): INTEGER_64 is
		external
	...
	frozen to_decimal_decimal (value: DECIMAL): DECIMAL is
		external
	...
	frozen to_byte_decimal (value: DECIMAL): INTEGER_8 is
		external
	...
	frozen from_base64_string (s: SYSTEM_STRING): NATIVE_ARRAY [INTEGER_8] is
		external
	...
	frozen to_int32_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): INTEGER is
		external
	...
	frozen to_string_int16_int32 (value: INTEGER_16; to_base: INTEGER): SYSTEM_STRING is
		external
	...
	frozen to_int32_object (value: SYSTEM_OBJECT): INTEGER is
		external
	...
	frozen to_int32_date_time (value: SYSTEM_DATE_TIME): INTEGER is
		external
	...
	frozen to_byte_date_time (value: SYSTEM_DATE_TIME): INTEGER_8 is
		external
	...
	frozen to_char_date_time (value: SYSTEM_DATE_TIME): CHARACTER is
		external
	...
	frozen to_boolean_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): BOOLEAN is
		external
	...
	frozen change_type_object_type_code (value: SYSTEM_OBJECT; type_code: TYPE_CODE): SYSTEM_OBJECT is
		external
	...
	frozen to_int16_string_int32 (value: SYSTEM_STRING; from_base: INTEGER): INTEGER_16 is
		external
	...
	frozen to_char_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): CHARACTER is
		external
	...
	frozen to_byte_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): INTEGER_8 is
		external
	...
	frozen to_int32_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): INTEGER is
		external
	...
	frozen to_string_int32_iformat_provider (value: INTEGER; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_string_string (value: SYSTEM_STRING): SYSTEM_STRING is
		external
	...
	frozen to_int16_string (value: SYSTEM_STRING): INTEGER_16 is
		external
	...
	frozen to_string_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_string_decimal_iformat_provider (value: DECIMAL; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_string_byte_int32 (value: INTEGER_8; to_base: INTEGER): SYSTEM_STRING is
		external
	...
	frozen to_byte_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): INTEGER_8 is
		external
	...
	frozen to_decimal_date_time (value: SYSTEM_DATE_TIME): DECIMAL is
		external
	...
	frozen to_date_time_date_time (value: SYSTEM_DATE_TIME): SYSTEM_DATE_TIME is
		external
	...
	frozen to_decimal_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): DECIMAL is
		external
	...
	frozen to_decimal (value: SYSTEM_STRING): DECIMAL is
		external
	...
	frozen is_dbnull (value: SYSTEM_OBJECT): BOOLEAN is
		external
	...
	frozen to_date_time_string (value: SYSTEM_STRING): SYSTEM_DATE_TIME is
		external
	...
	frozen change_type_object_type_iformat_provider (value: SYSTEM_OBJECT; conversion_type: TYPE; provider: IFORMAT_PROVIDER): SYSTEM_OBJECT is
		external
	...
	frozen to_string_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_byte_string (value: SYSTEM_STRING): INTEGER_8 is
		external
			"IL static signature (System.String): System.Byte use System.Convert"
		alias
			"ToByte"
	...
	frozen to_int64_date_time (value: SYSTEM_DATE_TIME): INTEGER_64 is
		external
	...
	frozen to_int32_string (value: SYSTEM_STRING): INTEGER is
		external
	...
	frozen to_date_time_double (value: DOUBLE): SYSTEM_DATE_TIME is
		external
	...
	frozen to_int32_string_int32 (value: SYSTEM_STRING; from_base: INTEGER): INTEGER is
		external
	...
	frozen to_date_time_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): SYSTEM_DATE_TIME is
		external
	...
	frozen to_string_int64_int32 (value: INTEGER_64; to_base: INTEGER): SYSTEM_STRING is
		external
	...
	frozen to_int16_decimal (value: DECIMAL): INTEGER_16 is
		external
	...
	frozen to_decimal_char (value: CHARACTER): DECIMAL is
		external
	...
	frozen to_string_boolean_iformat_provider (value: BOOLEAN; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_double_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): DOUBLE is
		external
	...
	frozen to_char_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): CHARACTER is
		external
	...
	frozen to_int64_decimal (value: DECIMAL): INTEGER_64 is
		external
	...
	frozen change_type (value: SYSTEM_OBJECT; conversion_type: TYPE): SYSTEM_OBJECT is
		external
	...
	frozen to_byte_object (value: SYSTEM_OBJECT): INTEGER_8 is
		external
	...
	frozen to_date_time_int64 (value: INTEGER_64): SYSTEM_DATE_TIME is
		external
	...
	frozen to_date_time_char (value: CHARACTER): SYSTEM_DATE_TIME is
		external
	...
	frozen to_decimal_single (value: REAL): DECIMAL is
		external
	...
	frozen to_base64_string_array_byte_int32 (in_array: NATIVE_ARRAY [INTEGER_8]; offset: INTEGER; length: INTEGER): SYSTEM_STRING is
		external
	...
	frozen to_char_decimal (value: DECIMAL): CHARACTER is
		external
	...
	frozen to_double_string (value: SYSTEM_STRING): DOUBLE is
		external
	...
	frozen to_int16_object (value: SYSTEM_OBJECT): INTEGER_16 is
		external
	...
	frozen to_char_object (value: SYSTEM_OBJECT): CHARACTER is
		external
	...
	frozen to_decimal_int16 (value: INTEGER_16): DECIMAL is
		external
	...
	frozen to_int64_string_int32 (value: SYSTEM_STRING; from_base: INTEGER): INTEGER_64 is
		external
	...
	frozen to_date_time_single (value: REAL): SYSTEM_DATE_TIME is
		external
	...
	frozen to_string_single_iformat_provider (value: REAL; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_decimal_double (value: DOUBLE): DECIMAL is
		external
	...
	frozen to_string_int16_iformat_provider (value: INTEGER_16; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_double_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): DOUBLE is
		external
	...
	frozen to_int16_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): INTEGER_16 is
		external
	...
	frozen from_base64_char_array (in_array: NATIVE_ARRAY [CHARACTER]; offset: INTEGER; length: INTEGER): NATIVE_ARRAY [INTEGER_8] is
		external
	...
	frozen to_single (value: DECIMAL): REAL is
		external
	...
	frozen to_int32_decimal (value: DECIMAL): INTEGER is
		external
	...
	frozen to_date_time_int16 (value: INTEGER_16): SYSTEM_DATE_TIME is
		external
	...
	frozen to_double (value: DECIMAL): DOUBLE is
		external
	...
	frozen to_decimal_int32 (value: INTEGER): DECIMAL is
		external
	...
	frozen to_byte_string_int32 (value: SYSTEM_STRING; from_base: INTEGER): INTEGER_8 is
		external
	...
	frozen to_decimal_object (value: SYSTEM_OBJECT): DECIMAL is
		external
	...
	frozen to_date_time_decimal (value: DECIMAL): SYSTEM_DATE_TIME is
		external
	...
	frozen to_int16_date_time (value: SYSTEM_DATE_TIME): INTEGER_16 is
		external
	...
	frozen to_single_object (value: SYSTEM_OBJECT): REAL is
		external
	...
	frozen to_decimal_boolean (value: BOOLEAN): DECIMAL is
		external
	...
	frozen to_string_int32_int32 (value: INTEGER; to_base: INTEGER): SYSTEM_STRING is
		external
	...
	frozen to_string_double_iformat_provider (value: DOUBLE; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_boolean_string (value: SYSTEM_STRING): BOOLEAN is
		external
	...
	frozen to_string_char_iformat_provider (value: CHARACTER; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_string_byte_iformat_provider (value: INTEGER_8; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_int64_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): INTEGER_64 is
		external
	...
	frozen to_single_date_time (value: SYSTEM_DATE_TIME): REAL is
		external
	...
	frozen to_base64_char_array (in_array: NATIVE_ARRAY [INTEGER_8]; offset_in: INTEGER; length: INTEGER; out_array: NATIVE_ARRAY [CHARACTER]; offset_out: INTEGER): INTEGER is
		external
	...
	frozen to_int64_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): INTEGER_64 is
		external
	...
	frozen to_date_time_int32 (value: INTEGER): SYSTEM_DATE_TIME is
		external
	...
	frozen to_double_date_time (value: SYSTEM_DATE_TIME): DOUBLE is
		external
	...
	frozen to_string_int64_iformat_provider (value: INTEGER_64; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen to_char_string (value: SYSTEM_STRING): CHARACTER is
		external
	...
	frozen to_date_time_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): SYSTEM_DATE_TIME is
		external
	...
	frozen to_single_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): REAL is
		external
	...
	frozen to_date_time (value: BOOLEAN): SYSTEM_DATE_TIME is
		external
	...
	frozen to_decimal_int64 (value: INTEGER_64): DECIMAL is
		external
	...
	frozen to_decimal_byte (value: INTEGER_8): DECIMAL is
		external
	...
	frozen to_int16_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): INTEGER_16 is
		external
	...
	frozen to_boolean_decimal (value: DECIMAL): BOOLEAN is
		external
	...
	frozen to_int64_object (value: SYSTEM_OBJECT): INTEGER_64 is
		external
	...
	frozen to_boolean_object (value: SYSTEM_OBJECT): BOOLEAN is
		external
			"IL static signature (System.Object): System.Boolean use System.Convert"
		alias
			"ToBoolean"
	...
	frozen to_boolean_date_time (value: SYSTEM_DATE_TIME): BOOLEAN is
		external
	...
	frozen to_double_object (value: SYSTEM_OBJECT): DOUBLE is
		external
	...
	frozen to_single_string (value: SYSTEM_STRING): REAL is
		external
	...
	frozen to_date_time_byte (value: INTEGER_8): SYSTEM_DATE_TIME is
		external
	...
	frozen to_date_time_object (value: SYSTEM_OBJECT): SYSTEM_DATE_TIME is
		external
	...
	frozen get_type_code (value: SYSTEM_OBJECT): TYPE_CODE is
		external
	...
	frozen to_decimal_string_iformat_provider (value: SYSTEM_STRING; provider: IFORMAT_PROVIDER): DECIMAL is
		external
	...
	frozen to_single_object_iformat_provider (value: SYSTEM_OBJECT; provider: IFORMAT_PROVIDER): REAL is
		external
	...
	frozen to_string_date_time_iformat_provider (value: SYSTEM_DATE_TIME; provider: IFORMAT_PROVIDER): SYSTEM_STRING is
		external
	...
	frozen change_type_object_type_code_iformat_provider (value: SYSTEM_OBJECT; type_code: TYPE_CODE; provider: IFORMAT_PROVIDER): SYSTEM_OBJECT is
		external
	...
	frozen to_base64_string (in_array: NATIVE_ARRAY [INTEGER_8]): SYSTEM_STRING is
		external
			"IL static signature (System.Byte[]): System.String use System.Convert"
		alias
			"ToBase64String"
