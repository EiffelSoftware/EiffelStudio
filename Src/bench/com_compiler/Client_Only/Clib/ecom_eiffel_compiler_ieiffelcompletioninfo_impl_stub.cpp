...
-----------------------------------------------------------*/
{
	...
	{
		tmp_return_names = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_record_238 (return_names));
	}
	EIF_OBJECT tmp_return_signatures = NULL;
	if (return_signatures != NULL)
	{
		tmp_return_signatures = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_record_239 (return_signatures));
	}
	EIF_OBJECT tmp_return_image_indexes = NULL;
	if (return_image_indexes != NULL)
	{
		tmp_return_image_indexes = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_record_240 (return_image_indexes));
	}
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelCompletionInfo_impl_stub::GetTypeInfo( unsigned int itinfo, LCID lcid, ITypeInfo **pptinfo )
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelCompletionInfo_impl_stub::GetTypeInfoCount( unsigned int * pctinfo )
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelCompletionInfo_impl_stub::GetIDsOfNames( REFIID riid, OLECHAR ** rgszNames, unsigned int cNames, LCID lcid, DISPID *rgdispid )
...
STDMETHODIMP ecom_eiffel_compiler::IEiffelCompletionInfo_impl_stub::Invoke( DISPID dispID, REFIID riid, LCID lcid, unsigned short wFlags, DISPPARAMS *pDispParams, VARIANT *pVarResult, EXCEPINFO *pExcepInfo, unsigned int *puArgErr )
