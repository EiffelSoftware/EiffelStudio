...
class
	ECD_ROUTINE_REFERENCE_EXPRESSION
...
feature -- Access
	...
	code: STRING is
			...
			-- | OR		:= "feature {`target_object'}.`routine_name'" if typeof `target_object' is ECD_TYPE_REFERENCE_EXPRESSION.
		...
		local
			...
			l_type_ref_exp: ECD_TYPE_REFERENCE_EXPRESSION
...
feature {NONE} -- Implementation
	...
	generated_routine_name: STRING is
		...
		local
			l_this_target_object: ECD_THIS_REFERENCE_EXPRESSION
		do
			if target_object /= Void then
	...
	caller_type: TYPE is
		...
		local
			this_target_object: ECD_THIS_REFERENCE_EXPRESSION
			argument_target_object: ECD_ARGUMENT_REFERENCE_EXPRESSION
			variable_target_object: ECD_VARIABLE_REFERENCE_EXPRESSION
			type_target_object: ECD_TYPE_REFERENCE_EXPRESSION
	...
	implementing_type (a_dotnet_type_name: STRING; a_dotnet_feature_name: STRING; feature_arguments: LINKED_LIST [ECD_EXPRESSION]): STRING is
		...
		local
			l_generated_type: ECD_GENERATED_TYPE
			l_parents: LINKED_LIST [ECD_PARENT]
		do
...
end -- class ECD_ROUTINE_REFERENCE_EXPRESSION
