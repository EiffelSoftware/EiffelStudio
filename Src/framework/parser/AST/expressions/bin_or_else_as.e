...
feature -- Access
	...
	op_name: ID_AS
		...
		once
			create Result.initialize_from_id ({PREDEFINED_NAMES}.or_else_operator_name_id)
		end

	operator_id: like alias_id
			-- <Precursor>
		do
			Result := alias_id ({PREDEFINED_NAMES}.or_else_operator_name_id, is_valid_binary_kind_mask ⦶ is_binary_kind_mask)
		end
