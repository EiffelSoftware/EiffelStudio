...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_201 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_201 ((BSTR *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_201 (tmp_rgelt);
grt_ce_ISE.ccom_free_memory_pointed_202 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumObjectFiles * *)grt_ec_ISE.ccom_ec_pointed_cell_196 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_196 ((ecom_eiffel_compiler::IEnumObjectFiles * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_196 (tmp_ppenum);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_203 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_203 ((BSTR *)tmp_rgelt, rgelt);
	
	grt_ce_ISE.ccom_free_memory_pointed_203 (tmp_rgelt);
