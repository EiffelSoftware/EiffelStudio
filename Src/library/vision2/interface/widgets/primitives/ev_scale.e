...
indexing 
	description: "EiffelVision scale"
...
--|
--| Revision 1.4.6.4  2000/02/02 01:27:49  brendel
--| Cannot be released yet.
--| First, we need to decide what a Scale is supposed to do.
--|
--| Revision 1.4.6.3  2000/01/28 22:24:25  oconnor
--| released
--|
