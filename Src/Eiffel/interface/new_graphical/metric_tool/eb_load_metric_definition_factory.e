...
feature -- Archive node creation
	...
	new_metric_archive_node (a_metric_name: STRING; a_metric_type: INTEGER; a_time: DATE_TIME; a_value: DOUBLE; a_input: EB_METRIC_DOMAIN; a_uuid: UUID; a_filtered: BOOLEAN): EB_METRIC_ARCHIVE_NODE
