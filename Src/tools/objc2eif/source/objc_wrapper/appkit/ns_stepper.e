...
feature {NONE} -- NSStepper Externals
	...
	objc_min_value (an_item: POINTER): REAL_64
		...
		alias
			"[
				return [(NSStepper *)$an_item minValue];
			 ]"
		end
	...
	objc_set_min_value_ (an_item: POINTER; a_min_value: REAL_64)
		...
		alias
			"[
				[(NSStepper *)$an_item setMinValue:$a_min_value];
			 ]"
		end
	...
	objc_max_value (an_item: POINTER): REAL_64
		...
		alias
			"[
				return [(NSStepper *)$an_item maxValue];
			 ]"
		end
	...
	objc_set_max_value_ (an_item: POINTER; a_max_value: REAL_64)
		...
		alias
			"[
				[(NSStepper *)$an_item setMaxValue:$a_max_value];
			 ]"
		end
	...
	objc_increment (an_item: POINTER): REAL_64
		...
		alias
			"[
				return [(NSStepper *)$an_item increment];
			 ]"
		end
	...
	objc_set_increment_ (an_item: POINTER; a_increment: REAL_64)
		...
		alias
			"[
				[(NSStepper *)$an_item setIncrement:$a_increment];
			 ]"
		end
	...
	objc_value_wraps (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSStepper *)$an_item valueWraps];
			 ]"
		end
	...
	objc_set_value_wraps_ (an_item: POINTER; a_value_wraps: BOOLEAN)
		...
		alias
			"[
				[(NSStepper *)$an_item setValueWraps:$a_value_wraps];
			 ]"
		end
	...
	objc_autorepeat (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSStepper *)$an_item autorepeat];
			 ]"
		end
	...
	objc_set_autorepeat_ (an_item: POINTER; a_autorepeat: BOOLEAN)
		...
		alias
			"[
				[(NSStepper *)$an_item setAutorepeat:$a_autorepeat];
			 ]"
		end
