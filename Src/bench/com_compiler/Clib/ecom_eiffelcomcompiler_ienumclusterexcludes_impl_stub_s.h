...
#ifndef __ECOM_EIFFELCOMCOMPILER_IENUMCLUSTEREXCLUDES_IMPL_STUB_S_H__
#define __ECOM_EIFFELCOMCOMPILER_IENUMCLUSTEREXCLUDES_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
public:
	...
	No description available.
	-----------------------------------------------------------*/
	STDMETHODIMP Clone(  /* [out] */ ecom_EiffelComCompiler::IEnumClusterExcludes * * ppenum );
