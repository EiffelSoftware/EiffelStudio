...
feature -- Basic operations
	...
	infix "+" (other: INTEGER_8): INTEGER_8
			-- Sum with `other'
		do
			Result := Precursor (other)
		end
...
feature -- Bit operations
	...
	bit_and (i: INTEGER_8): INTEGER_8
			-- Bitwise and between Current' and `i'.
		do
			Result := Precursor (i)
		end

	bit_or (i: INTEGER_8): INTEGER_8
	...
	bit_shift_left (n: INTEGER): INTEGER_8
			-- Shift Current from `n' position to left.
		do
			Result := Precursor (n)
		end

	bit_shift_right (n: INTEGER): INTEGER_8
