...
feature {NONE} -- Implementation
	...
	expected_compile_result: EIFFEL_COMPILATION_RESULT;
			-- Result expected from compilation

	process_syntax_phrase (phrase: STRING; cr: EIFFEL_COMPILATION_RESULT) is
