...
feature -- Basic operations
	...
	generate (a_folder: READABLE_STRING_32)
		...
		do
			...
			a_file.put_string (u.string_32_to_utf_8_string_8 (generated_resource_file))
			a_file.close
		end

	Generated_resource_file: STRING_32
			-- Resource file content
		local
			str_buffer: STRING_32
		do
