...
feature {NONE} -- Implementation
	...
	main_menu: WEL_MENU is
		...
		local
			listbox_popupmenu: WEL_MENU
			multiplelistbox_popupmenu: WEL_MENU
			combobox_popupmenu: WEL_MENU
			edit_popupmenu: WEL_MENU
			multipleedit_popupmenu: WEL_MENU
			button_popupmenu: WEL_MENU
			scrollbar_popupmenu: WEL_MENU
			create_popupmenu: WEL_MENU
			radiobuttons_popupmenu: WEL_MENU
			checkbuttons_popupmenu: WEL_MENU
		once
				-- create the listbox menu
			create listbox_popupmenu.make
			listbox_popupmenu.append_string("&Create", Cmd_list_box_create)
			listbox_popupmenu.append_string("&Delete", Cmd_list_box_delete)
			listbox_popupmenu.append_string("&Add item", Cmd_list_box_add_item)
			listbox_popupmenu.append_separator
			listbox_popupmenu.append_string("&Count item", Cmd_list_box_count_item)
			listbox_popupmenu.append_string("Current &item", Cmd_list_box_current_item)
			listbox_popupmenu.append_separator
			listbox_popupmenu.append_string("E&xit", Cmd_exit)

				-- create the multiplelistbox menu
			create multiplelistbox_popupmenu.make
			multiplelistbox_popupmenu.append_string("&Create", Cmd_mul_create)
			multiplelistbox_popupmenu.append_string("&Delete", Cmd_mul_delete)
			multiplelistbox_popupmenu.append_string("&Add item", Cmd_mul_add_item)
			multiplelistbox_popupmenu.append_separator
			multiplelistbox_popupmenu.append_string("&Count item", Cmd_mul_count_item)
			multiplelistbox_popupmenu.append_string("Current &item", Cmd_mul_current_item)

				-- create the combobox menu
			create combobox_popupmenu.make
			combobox_popupmenu.append_string("&Create", Cmd_combo_box_create)
			combobox_popupmenu.append_string("&Delete", Cmd_combo_box_delete)
			combobox_popupmenu.append_string("&Add item", Cmd_combo_box_add_item)
			combobox_popupmenu.append_separator
			combobox_popupmenu.append_string("&Count item", Cmd_combo_box_count_item)
			combobox_popupmenu.append_string("Current &item", Cmd_combo_box_current_item)
			combobox_popupmenu.append_separator
			combobox_popupmenu.append_string("&Show list", Cmd_combo_box_show_list)
			combobox_popupmenu.append_string("&Hide list", Cmd_combo_box_hide_list)

				-- create the edit menu
			create edit_popupmenu.make
			edit_popupmenu.append_string("&Create", Cmd_edit_create)
			edit_popupmenu.append_string("&Delete", Cmd_edit_delete)
			edit_popupmenu.append_separator
			edit_popupmenu.append_string("&Set text", Cmd_edit_set_text)
			edit_popupmenu.append_string("&Clear text", Cmd_edit_clear_text)
			edit_popupmenu.append_string("&Text length", Cmd_edit_text_length)
			edit_popupmenu.append_string("C&urrent text", Cmd_edit_current_text)

				-- create the multipleedit menu
			create multipleedit_popupmenu.make
			multipleedit_popupmenu.append_string("&Create", Cmd_multi_edit_create)
			multipleedit_popupmenu.append_string("&Delete", Cmd_multi_edit_delete)
			multipleedit_popupmenu.append_separator
			multipleedit_popupmenu.append_string("&Set text", Cmd_multi_edit_set_text)
			multipleedit_popupmenu.append_string("&Clear text", Cmd_multi_edit_clear_text)
			multipleedit_popupmenu.append_string("&Text length", Cmd_multi_edit_text_length)
			multipleedit_popupmenu.append_string("C&urrent text", Cmd_multi_edit_current_text)

				-- create the button menu
			create button_popupmenu.make
			button_popupmenu.append_string("&Create", Cmd_button_create)
			button_popupmenu.append_string("&Delete", Cmd_button_delete)
			button_popupmenu.append_separator
			button_popupmenu.append_string("&Enable", Cmd_button_enable)
			button_popupmenu.append_string("&Disable", Cmd_button_disable)

				-- create the scrollbar menu
			create scrollbar_popupmenu.make
			create create_popupmenu.make
			create_popupmenu.append_string("Create &horizontal", Cmd_scroll_bar_set_horizontal)
			create_popupmenu.append_string("Create &vertical", Cmd_scroll_bar_set_vertical)
			scrollbar_popupmenu.append_popup(create_popupmenu, "&Create")
			scrollbar_popupmenu.append_string("&Delete", Cmd_scroll_bar_delete)

				-- create the radiobuttons menu
			create radiobuttons_popupmenu.make
			radiobuttons_popupmenu.append_string("&Create", Cmd_radio_create)
			radiobuttons_popupmenu.append_string("&Delete", Cmd_radio_delete)
			radiobuttons_popupmenu.append_separator
			radiobuttons_popupmenu.append_string("&State", Cmd_radio_state)

				-- create the checkbuttons menu
			create checkbuttons_popupmenu.make
			checkbuttons_popupmenu.append_string("&Create", Cmd_check_create)
			checkbuttons_popupmenu.append_string("&Delete", Cmd_check_delete)
			checkbuttons_popupmenu.append_separator
			checkbuttons_popupmenu.append_string("&State", Cmd_check_state)

				-- Create the main menu bar.
			create Result.make
			Result.append_popup (listbox_popupmenu,"&ListBox")
			Result.append_popup (multiplelistbox_popupmenu,"&MultipleListBox")
			Result.append_popup (combobox_popupmenu,"C&omboBox")
			Result.append_popup (edit_popupmenu,"&Edit")
			Result.append_popup (multipleedit_popupmenu,"M&ultipleEdit")
			Result.append_popup (button_popupmenu,"&Button")
			Result.append_popup (scrollbar_popupmenu,"&Scrollbar")
			Result.append_popup (radiobuttons_popupmenu,"&RadioButtons")
			Result.append_popup (checkbuttons_popupmenu,"&CheckButtons")
