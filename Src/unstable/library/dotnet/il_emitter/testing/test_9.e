note
	description: "Summary description for {TEST_9}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature -- Test
	...
	test
		...
		do
			create pe_file.make ("test9", {PE_LIB}.il_only | {PE_LIB}.bits32)
			...
			pe_file.dump_output_file ("test_9e.exe", {CIL_OUTPUT_MODE}.peexe, false)
