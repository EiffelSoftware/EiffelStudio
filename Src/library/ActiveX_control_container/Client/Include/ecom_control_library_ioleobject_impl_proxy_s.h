...
public:
  ...
  -----------------------------------------------------------*/
  void ccom_set_client_site(  /* [in] */ ::IOleClientSite * p_client_site );
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_set_moniker(  /* [in] */ EIF_INTEGER dw_which_moniker,  /* [in] */ ::IMoniker * pmk );
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_init_from_data(  /* [in] */ ::IDataObject * p_data_object,  /* [in] */ EIF_INTEGER f_creation,  /* [in] */ EIF_INTEGER dw_reserved );
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_do_verb(  /* [in] */ EIF_INTEGER i_verb,  /* [in] */ ecom_control_library::tagMSG * lpmsg,  /* [in] */ ::IOleClientSite * p_active_site,  /* [in] */ EIF_INTEGER lindex,  /* [in] */ EIF_POINTER hwnd_parent,  /* [in] */ ecom_control_library::tagRECT * lprc_pos_rect );
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_advise(  /* [in] */ ::IAdviseSink * p_adv_sink,  /* [out] */ EIF_OBJECT pdw_connection );
