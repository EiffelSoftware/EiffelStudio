...
feature -- Access
	...
	make (a_direction: INTEGER; a_source: SD_RESIZE_SOURCE) is
		...
		do
			...
			elseif a_direction = {SD_SHARED}.dock_bottom or a_direction = {SD_SHARED}.dock_top then
...
feature {NONE} -- Implementation
	...
	handle_pointer_motion (a_x, a_y: INTEGER; a_x_tilt, a_y_tilt, a_pressure: DOUBLE; a_screen_x, a_screen_y: INTEGER) is
