...
feature {NONE} -- Implementation
	...
	main_menu: WEL_MENU is
			-- Window's menu
		local
			display_popupmenu: WEL_MENU
		once
			create display_popupmenu.make
			display_popupmenu.append_string("Zoom &in%T+", Cmd_zoom_in)
			display_popupmenu.append_string("Zoom &out%T-", Cmd_zoom_out)
			display_popupmenu.append_separator
			display_popupmenu.append_string("&Refresh%TF5", Cmd_refresh)
			display_popupmenu.append_separator
			display_popupmenu.append_string("&Automatic refresh", Cmd_automatic_refresh)
			display_popupmenu.append_separator
			display_popupmenu.append_string("E&xit", Cmd_exit)

			create Result.make
			Result.append_popup(display_popupmenu,"&Display")
		ensure
