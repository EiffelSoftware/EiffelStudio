...
external class
	DATETIMEPICKERACCESSIBLEOBJECT_IN_SYSTEM_WINDOWS_FORMS_DATETIMEPICKER
...
create
	make_datetimepickeraccessibleobject

feature {NONE} -- Initialization

	frozen make_datetimepickeraccessibleobject (owner: SYSTEM_WINDOWS_FORMS_DATETIMEPICKER) is
		external
...
end -- class DATETIMEPICKERACCESSIBLEOBJECT_IN_SYSTEM_WINDOWS_FORMS_DATETIMEPICKER
