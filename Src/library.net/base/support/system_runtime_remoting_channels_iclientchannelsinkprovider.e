...
feature -- Basic Operations
	...
	create_sink (channel: SYSTEM_RUNTIME_REMOTING_CHANNELS_ICHANNELSENDER; url: STRING; remoteChannelData: ANY): SYSTEM_RUNTIME_REMOTING_CHANNELS_ICLIENTCHANNELSINK is
		external
