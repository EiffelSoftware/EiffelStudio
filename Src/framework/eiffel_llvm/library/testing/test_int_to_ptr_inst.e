...
feature -- Test routines
	...
	test_int_to_ptr_inst_1
		...
		do
			...
			create i.make (create {CONSTANT_INT}.make (create {INTEGER_TYPE}.make (ctx, 32), 10), create {POINTER_TYPE}.make (create {INTEGER_TYPE}.make (ctx, 32)))
