...
feature
	...
	init is
		...
		local
			...
			as80: TYPE_DEC_AS;
			as81: UNIQUE_AS;
			as82: ROUTINE_AS_EBUILD;
			as83: EXTERNAL_AS;
			as85: CONSTANT_AS;
			as86: FEATURE_AS_EBUILD;
			as87: SUPPLIERS_AS;
			as88: INVARIANT_AS;
			as89: VARIANT_AS;
		...
		do
			...
			!!as116.make (0);
			as116.pass_address (click_list_sd);
			!!as117;
			as117.pass_address (click_elem_sd);
			as117.pass_click_set
		end;
