...
xmlns:MSHelp="http://msdn.microsoft.com/mshelp">
	...
	<xsl:param name="generation_output"/>
	<!--************************VARIABLES**********************-->
	<xsl:variable name="title" select="/document/@title"/>
	<xsl:variable name="doc_output" select="/document/@output"/>
	<!--<xsl:variable name="stylesheet" select="/document/@stylesheet"/>-->
	<!--************************TEMPLATES**********************-->
	...
	<xsl:template match="line_break">
		<br/>
	</xsl:template>
	<xsl:template match="code_line_break">
