...
enum InstanceState
{
    ...
    /// </summary>
    eComplete = ((UINT)~((UINT)0)), // Should be MAXUINT but it is not declared on old versions of VC++
};
...
struct DECLSPEC_UUID("89143C9A-05AF-49B0-B717-72E218A2185C") DECLSPEC_NOVTABLE ISetupInstance2 : public ISetupInstance
{
    ...
    STDMETHOD(GetProduct)(
        _Out_ ISetupPackageReference** ppPackage
        ) = 0;
