...
class
	ECD_TRY_CATCH_FINALLY_STATEMENT
...
feature -- Access
	...
	try_statements: LINKED_LIST [ECD_STATEMENT]
			-- Statements in try clause
			
	finally_statements: LINKED_LIST [ECD_STATEMENT]
			-- Statements in finally clause
			
	catch_clauses: LINKED_LIST [ECD_STATEMENT]
			-- Catch clauses
...
feature -- Status Setting
	...
	add_try_statement (a_statement: ECD_STATEMENT) is
	...
	add_finally_statement (a_statement: ECD_STATEMENT) is
	...
	add_catch_clause (a_clause: ECD_STATEMENT) is
...
end -- class ECD_TRY_CATCH_FINALLY_STATEMENT_STATEMENT
