...
feature -- Test routines
	...
	test_md_node_1
		...
		do
			...
			create v.make
			v.push_back (ms)
			v.push_back (create {MD_STRING}.make (ctx, "test_metadata_two"))
			...
			m.print (s)
			s_result := s.string
			assert ("test_md_string_1", s_result ~ test_md_node_1_expected)
		end

	test_md_node_1_expected: STRING_8 =
"[
; ModuleID = 'test'
...
!0 = metadata !{metadata !"test_metadata", metadata !"test_metadata_two"}
