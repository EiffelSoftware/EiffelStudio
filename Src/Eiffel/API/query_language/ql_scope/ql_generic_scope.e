...
feature{QL_SHARED_SCOPES} -- Initialization
	...
	make
		...
		do
			...
			scope_index_set: index = generic_scope_index
		end
...
feature -- Access
	...
	path_domain_generator (a_item: QL_GENERIC; a_path: READABLE_STRING_GENERAL): QL_DOMAIN_GENERATOR
			-- Domain generator for current scope
		do
...
feature -- Metric support
	...
	basic_scope (a_calculate_function: FUNCTION [QL_GENERIC, DOUBLE]; a_criterion: QL_GENERIC_CRITERION): QL_METRIC_GENERIC_BASIC_SCOPE_INFO
