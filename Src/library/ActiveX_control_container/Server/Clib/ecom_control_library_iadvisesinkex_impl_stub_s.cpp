...
STDMETHODIMP ecom_control_library::IAdviseSinkEx_impl_stub::OnDataChange(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc, /* [in] */ ecom_control_library::wireASYNC_STGMEDIUM * p_stgmed )
...
STDMETHODIMP ecom_control_library::IAdviseSinkEx_impl_stub::OnViewChange(  /* [in] */ ULONG dw_aspect, /* [in] */ LONG lindex )
...
STDMETHODIMP ecom_control_library::IAdviseSinkEx_impl_stub::OnRename(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
STDMETHODIMP ecom_control_library::IAdviseSinkEx_impl_stub::OnSave( void )
...
STDMETHODIMP ecom_control_library::IAdviseSinkEx_impl_stub::OnClose( void )
...
STDMETHODIMP ecom_control_library::IAdviseSinkEx_impl_stub::OnViewStatusChange(  /* [in] */ ULONG dw_view_status )
...
-----------------------------------------------------------*/
{
  ...
  EIF_PROCEDURE eiffel_procedure = 0;
  eiffel_procedure = eif_procedure ("on_view_status_change", type_id);
