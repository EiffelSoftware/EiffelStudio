...
void ecom_control_library::IRunningObjectTable_impl_proxy::ccom_register(  /* [in] */ EIF_INTEGER grf_flags,  /* [in] */ IUnknown * punk_object,  /* [in] */ ::IMoniker * pmk_object_name,  /* [out] */ EIF_OBJECT pdw_register )
...
void ecom_control_library::IRunningObjectTable_impl_proxy::ccom_is_running(  /* [in] */ ::IMoniker * pmk_object_name )
...
void ecom_control_library::IRunningObjectTable_impl_proxy::ccom_get_object(  /* [in] */ ::IMoniker * pmk_object_name,  /* [out] */ EIF_OBJECT ppunk_object )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IRunningObjectTable->NoteChangeTime(tmp_dw_register, (struct _FILETIME *)pfiletime);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IRunningObjectTable_impl_proxy::ccom_get_time_of_last_change(  /* [in] */ ::IMoniker * pmk_object_name,  /* [out] */ ecom_control_library::_FILETIME * pfiletime )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IRunningObjectTable->GetTimeOfLastChange(pmk_object_name, (struct _FILETIME *)pfiletime);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
