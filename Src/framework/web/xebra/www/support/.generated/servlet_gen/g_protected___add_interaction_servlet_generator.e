...
class
	G_PROTECTED___ADD_INTERACTION_SERVLET_GENERATOR
	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 81 row: 2 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 81 row: 2 of file: ./protected/add_interaction.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 81 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 81 row: 1 of file: ./protected/add_interaction.xeb"
			...
			temp.tag_id := "declare_region"
			stack.put (temp)
				-- line: 3 row: 3 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 3 row: 3 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 79 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 79 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
				-- line: 4 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 4 row: 76 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 4 row: 76 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "title_box")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
				-- line: 4 row: 70 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 4 row: 70 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "h1"
			stack.put (temp)
				-- line: 4 row: 65 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 65 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Problem Report Interaction Submission")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
			stack.remove
				-- line: 5 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%/9/%/9/%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 77 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 77 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "main_id")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
				-- line: 6 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 11 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 11 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "p"
			stack.put (temp)
				-- line: 8 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 8 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/Fill in the description for the new interaction for the%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 9 row: 9 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 9 row: 9 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "b"
			stack.put (temp)
				-- line: 9 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_DISPLAY_TAG} temp.make
			temp.debug_information := "line: 9 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("css_class", "field_name")
			temp.put_value_attribute("text", "synopsis_status_label")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "display"
				-- line: 9 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 9 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 10 row: 3 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 10 row: 3 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " problem report .%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 11 row: 3 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 11 row: 3 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 12 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_DISPLAY_TAG} temp.make
			temp.debug_information := "line: 12 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "NoText")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "display"
				-- line: 12 row: 3 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 12 row: 3 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 76 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 76 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "standard_padding")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "table"
			stack.put (temp)
				-- line: 13 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 13 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 21 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 21 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 14 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 14 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 17 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 17 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "field_name")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 16 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 16 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/Description:%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 17 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 17 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 20 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 20 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 18 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 18 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 19 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_F_VALIDATOR_TAG} temp.make
			temp.debug_information := "line: 19 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "RequiredFieldValidator")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "validator"
				-- line: 19 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 19 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 20 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 20 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 21 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 21 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 26 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 26 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 22 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 22 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 24 row: 10 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 24 row: 10 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("colspan", "2")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 23 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 23 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 24 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_F_VALIDATOR_TAG} temp.make
			temp.debug_information := "line: 24 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "textBox")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "validator"
				-- line: 24 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 24 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 25 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 25 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " %N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 26 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 26 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 45 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 45 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "private_interaction")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 27 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 27 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 44 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 44 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("colspan", "2")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 28 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 28 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%/9/%/9/%/9/%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 33 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 33 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "private_change")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
				-- line: 29 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 29 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 30 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 30 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "private_link")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			stack.put (temp)
				-- line: 29 row: 92 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 29 row: 92 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("alt", "")
			temp.put_value_attribute("class", "info_icon")
			temp.put_value_attribute("src", "<%%=information_icon_url %%>")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "img"
			stack.remove
				-- line: 30 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 30 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 31 row: 57 of file: ./protected/add_interaction.xeb
			create {XTAG_F_CHECK_BOX_TAG} temp.make
			temp.debug_information := "line: 31 row: 57 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("label", "Private")
			temp.put_value_attribute("value", "private")
			temp.put_value_attribute("name", "a_private")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "check_box"
				-- line: 32 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 32 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%/9/%/9/%/9/%/9/%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 34 row: 9 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 34 row: 9 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%N%/9/%/9/%/9/    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 38 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 38 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "close_report_change")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
				-- line: 35 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 35 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 36 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 36 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "close_report_link")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			stack.put (temp)
				-- line: 35 row: 97 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 35 row: 97 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("alt", "")
			temp.put_value_attribute("class", "info_icon")
			temp.put_value_attribute("src", "<%%=information_icon_url %%>")
			...
			temp.tag_id := "img"
			stack.remove
				-- line: 36 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 36 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 36 row: 93 of file: ./protected/add_interaction.xeb
			create {XTAG_F_CHECK_BOX_TAG} temp.make
			temp.debug_information := "line: 36 row: 93 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("label", "Close report")
			temp.put_value_attribute("value", "close_report_box")
			temp.put_value_attribute("name", "a_close_report_box")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "check_box"
				-- line: 37 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 37 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%/9/%/9/%/9/%/9/%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 39 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 39 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 43 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 43 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "reopen_report_change")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
				-- line: 40 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 40 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 41 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 41 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "reopen_report_link")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			stack.put (temp)
				-- line: 40 row: 98 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 40 row: 98 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("alt", "")
			temp.put_value_attribute("class", "info_icon")
			temp.put_value_attribute("src", "<%%=information_icon_url %%>")
			...
			temp.tag_id := "img"
			stack.remove
				-- line: 41 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 41 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 41 row: 95 of file: ./protected/add_interaction.xeb
			create {XTAG_F_CHECK_BOX_TAG} temp.make
			temp.debug_information := "line: 41 row: 95 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("label", "Reopen report")
			temp.put_value_attribute("value", "reopen_report_box")
			temp.put_value_attribute("name", "a_reopen_report_box")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "check_box"
				-- line: 42 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 42 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%/9/%/9/%/9/%/9/%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 43 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 43 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 44 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 44 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 45 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 45 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 53 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 53 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "status_change")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 46 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 46 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 52 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 52 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("colspan", "2")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 48 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 48 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/Change status from%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 49 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_DISPLAY_TAG} temp.make
			temp.debug_information := "line: 49 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "noText")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "display"
				-- line: 51 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 51 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/to%N%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 52 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 52 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 53 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 53 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 61 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 61 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "category_change")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 54 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 54 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 60 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 60 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("colspan", "2")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 56 row: 6 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 56 row: 6 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/Change category from%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 57 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_DISPLAY_TAG} temp.make
			temp.debug_information := "line: 57 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "NoText")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "display"
				-- line: 59 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 59 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/to%N%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 60 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 60 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 61 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 61 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 66 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 66 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 62 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 62 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 65 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 65 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("colspan", "2")
			temp.put_value_attribute("class", "field_name")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 64 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 64 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/Attachments:%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 65 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 65 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 66 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 66 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 70 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 70 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 67 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 67 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 69 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 69 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("colspan", "2")
			temp.put_value_attribute("class", "last_field_name")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 68 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 68 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 69 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 69 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 70 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 70 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 75 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 75 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 71 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 71 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 74 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 74 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("colspan", "2")
			temp.put_value_attribute("class", "submit_column")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
				-- line: 73 row: 5 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 73 row: 5 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 74 row: 4 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 74 row: 4 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 75 row: 3 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 75 row: 3 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 76 row: 3 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 76 row: 3 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 77 row: 3 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 77 row: 3 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 78 row: 1 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_DISPLAY_TAG} temp.make
			temp.debug_information := "line: 78 row: 1 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "message_label")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "display"
				-- line: 78 row: 2 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 78 row: 2 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 79 row: 2 of file: ./protected/add_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 79 row: 2 of file: ./protected/add_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
