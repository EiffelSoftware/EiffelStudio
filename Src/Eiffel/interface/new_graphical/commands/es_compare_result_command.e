...
feature {NONE} -- Implementation
	...
	pixmap: EV_PIXMAP is
		...
		do
			Result := pixmaps.icon_pixmaps.testing_compare_with_expected_result_icon
		end

	pixel_buffer: EV_PIXEL_BUFFER is
			-- Pixel buffer representing the command.
		do
			Result := pixmaps.icon_pixmaps.testing_compare_with_expected_result_icon_buffer
		end
	...
	name: STRING_GENERAL is
			...
			-- preferences.
		do
			Result := "compare_with_expected_result"
		end
