indexing
	description: "Objects that represent a section for the assertion level."
...
feature -- Access
	...
	name: STRING is
			-- Name of the section.
		once
			Result := conf_interface_names.section_assertions
		end

	icon: EV_PIXMAP is
			-- Icon of the section.
		once
			Result := pixmaps.icon_pixmaps.project_settings_assertions_icon
		end
...
feature {NONE} -- Implementation
	...
	create_select_actions: EV_NOTIFY_ACTION_SEQUENCE is
		...
		do
			create Result
			Result.extend (agent configuration_window.show_properties_target_assertions (target))
		end
