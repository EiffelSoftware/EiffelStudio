...
feature {NONE} -- Implementation
	...
	xml_class_figure_node_name: STRING is "BON_CLASS_FIGURE"
			-- Name of xml nodes describing class figures.
		
	xml_cluster_figure_node_name: STRING is "BON_CLUSTER_FIGURE"
			-- Name of xml nodes describing cluster figures.
			
	xml_client_supplier_figure_node_name: STRING is "BON_CLIENT_SUPPLIER_FIGURE"
			-- Name of xml nodes describing client supplier links.
		
	xml_inheritance_figure_node_name: STRING is "BON_INHERITANCE_FIGURE";
