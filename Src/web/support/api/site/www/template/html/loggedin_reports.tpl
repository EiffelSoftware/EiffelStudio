		...
		<tbody>
			{foreach from="$reports" item="item"}
				<tr>
					...
					<td itemprop="synopsis">
						<a href="{$host/}/report_detail/{$item.number/}" itemprop="report_interaction" rel="report_interaction">{htmlentities}{$item.synopsis/}{/htmlentities}</a></td>
