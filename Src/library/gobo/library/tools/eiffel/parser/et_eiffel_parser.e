...
yyval62 := ast_factory.new_once_manifest_string (yyvs2.item (yyvsp2), yyvs16.item (yyvsp16)) 
if yy_parsing_status = yyContinue then
	yyssp := yyssp - 2
	yyvsp62 := yyvsp62 + 1
	yyvsp2 := yyvsp2 -1
	...
	yydefact_template: SPECIAL [INTEGER] is
		...
		once
			Result := yyfixed_array (<<
			  ...
			  547,    6,  225,  223,  224,    7,    0,  657,  283,  652,
	...
	yypact_template: SPECIAL [INTEGER] is
		...
		once
			Result := yyfixed_array (<<
			 ...
			 -32768, -32768, -32768, -32768, -32768, -32768,  969, -32768,   40, -32768,
	...
	yytable_template_1 (an_array: ARRAY [INTEGER]) is
		...
		do
			yy_array_subcopy (an_array, <<
			 ...
			 1146,   84,  879,   85, 1029,  770,  771,  119, 1021, 1238,
	...
	yycheck_template_1 (an_array: ARRAY [INTEGER]) is
		...
		do
			yy_array_subcopy (an_array, <<
			 ...
			 1094,   24,  800,   26,   14,  621,  622,   28,   14, 1188,
