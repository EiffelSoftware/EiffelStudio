...
feature
    ...
    get_value (index : INTEGER) : CORBA_STRUCTMEMBER is
    ...
    set_value (value : CORBA_STRUCTMEMBER; index : INTEGER) is
...
feature { NONE }
    ...
    bound : INTEGER
    store : ARRAY [CORBA_STRUCTMEMBER]
...
feature { ANY }
    ...
    type_name : STRING is
        ...
        do
            result := "StructMemberSeq"
        end

end -- class CORBA_STRUCTMEMBERSEQ
