...
class
	G_PROTECTED___ADD_INTERACTION_SERVLET
...
feature-- Implementation
	...
	render_html_page (request: XH_REQUEST; response: XH_RESPONSE)
		...
		do
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_220)
				-- line: 4 row: 70 of file: ./protected/add_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_83)
				-- line: 4 row: 76 of file: ./protected/add_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_22)
				-- line: 5 row: 4 of file: ./protected/add_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_221)
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_223)
			...
			response.append ("synopsis_status_label")
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_226)
				-- line: 11 row: 1 of file: ./protected/add_interaction.xeb
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_227)
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_228)
				-- line: 16 row: 5 of file: ./protected/add_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_229)
				-- line: 17 row: 1 of file: ./protected/add_interaction.xeb
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_18)
				-- AN ERROR OCCURRED IN GENERATION OF XTAG_F_VALIDATION_RESULT
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_125)
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_242)
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_245)
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_246)
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_247)
				-- line: 64 row: 5 of file: ./protected/add_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_248)
				-- line: 65 row: 1 of file: ./protected/add_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_117)
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_249)
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_250)
				-- line: 73 row: 5 of file: ./protected/add_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_251)
				-- line: 74 row: 1 of file: ./protected/add_interaction.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_117)
