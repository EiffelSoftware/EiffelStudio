...
feature {NONE}  -- Externals
	...
	c_size_of_tag_oifi: INTEGER is
			-- Size of structure
		external
			"C [macro %"ecom_control_library_tagOIFI_s.h%"]"
		alias
			"sizeof(ecom_control_library::tagOIFI)"
		end

	ccom_tag_oifi_cb (a_pointer: POINTER): INTEGER is
			-- No description available.
		external
			"C++ [macro %"ecom_control_library_tagOIFI_s_impl.h%"](ecom_control_library::tagOIFI *):EIF_INTEGER"
		end

	ccom_tag_oifi_set_cb (a_pointer: POINTER; arg2: INTEGER) is
			-- No description available.
		external
			"C++ [macro %"ecom_control_library_tagOIFI_s_impl.h%"](ecom_control_library::tagOIFI *, UINT)"
		end
	...
	ccom_tag_oifi_set_f_mdiapp (a_pointer: POINTER; arg2: INTEGER) is
			-- No description available.
		external
			"C++ [macro %"ecom_control_library_tagOIFI_s_impl.h%"](ecom_control_library::tagOIFI *, LONG)"
		end

	ccom_tag_oifi_hwnd_frame (a_pointer: POINTER): POINTER is
			-- No description available.
		external
			"C++ [macro %"ecom_control_library_tagOIFI_s_impl.h%"](ecom_control_library::tagOIFI *):EIF_POINTER"
		end

	ccom_tag_oifi_set_hwnd_frame (a_pointer: POINTER; arg2: POINTER) is
			-- No description available.
		external
			"C++ [macro %"ecom_control_library_tagOIFI_s_impl.h%"](ecom_control_library::tagOIFI *, ecom_control_library::wireHWND)"
		end
	...
	ccom_tag_oifi_set_h_accel (a_pointer: POINTER; arg2: POINTER) is
			-- No description available.
		external
			"C++ [macro %"ecom_control_library_tagOIFI_s_impl.h%"](ecom_control_library::tagOIFI *, ecom_control_library::wireHACCEL)"
		end
