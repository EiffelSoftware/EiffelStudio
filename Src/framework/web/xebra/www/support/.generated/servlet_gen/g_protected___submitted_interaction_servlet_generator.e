...
class
	G_PROTECTED___SUBMITTED_INTERACTION_SERVLET_GENERATOR
	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 49 row: 2 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 49 row: 2 of file: ./protected/submitted_interaction.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 49 row: 1 of file: ./protected/submitted_interaction.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 49 row: 1 of file: ./protected/submitted_interaction.xeb"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 3 row: 3 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 4 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 3 row: 67 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "h1"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 3 row: 62 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Interaction Submission Confirmation")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
			stack.remove
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 3 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 47 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 4 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 46 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "problem_report")
			temp.put_value_attribute("width", "480px")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "table"
			stack.put (temp)
				-- line: 7 row: 5 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 7 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 12 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("visible", "false")
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 8 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 11 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 9 row: 7 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 9 row: 57 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 9 row: 50 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Status changed to:")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 10 row: 6 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 10 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " %N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 11 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 12 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 17 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("visible", "false")
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 13 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 16 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 14 row: 7 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 14 row: 59 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "field_name")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "span"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 14 row: 52 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Category changed to:")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 15 row: 6 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 15 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " %N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 16 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 17 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 22 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("visible", "false")
			temp.put_value_attribute("id", "responsible_change")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 18 row: 6 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 18 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 21 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 19 row: 7 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 19 row: 62 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "field_name")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "span"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 19 row: 55 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Responsible changed to:")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 20 row: 6 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 20 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " %N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 21 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 22 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 27 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("visible", "false")
			temp.put_value_attribute("id", "private")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
				-- line: 23 row: 6 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 23 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 26 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 25 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%/9/Interaction is private and will not be sent to user nor will it be visible to him.%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 26 row: 5 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 26 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 27 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 32 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 28 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 31 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 29 row: 7 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 29 row: 44 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "field_name")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "span"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 29 row: 37 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "text:")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 30 row: 1 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 30 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "br"
				-- line: 30 row: 6 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 30 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 31 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 32 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 38 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 33 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 37 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "last_row")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "td"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 34 row: 7 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 34 row: 51 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("class", "field_name")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "span"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 34 row: 44 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 35 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "br"
				-- line: 36 row: 6 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 36 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 37 row: 5 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 37 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 38 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 45 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "tr"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 39 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 44 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 40 row: 7 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 41 row: 1 of file: ./protected/submitted_interaction.xeb
			create {XTAG_F_COMMAND_LINK_TAG} temp.make
			temp.debug_information := "line: 41 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("action", "on_submit")
			temp.put_value_attribute("text", "Submit")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "command_link"
				-- line: 42 row: 7 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 42 row: 7 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/%/9/|%N%/9/%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 43 row: 1 of file: ./protected/submitted_interaction.xeb
			create {XTAG_F_COMMAND_LINK_TAG} temp.make
			temp.debug_information := "line: 43 row: 1 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("action", "on_edit")
			temp.put_value_attribute("text", "Edit")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "command_link"
				-- line: 43 row: 6 of file: ./protected/submitted_interaction.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 43 row: 6 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 44 row: 5 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 45 row: 4 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 46 row: 3 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 47 row: 2 of file: ./protected/submitted_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
