note
	description: "Object that represents an AND operation on two target criteria"
...
feature -- Evaluate
	...
	is_satisfied_by (a_item: QL_TARGET): BOOLEAN
			-- Evaluate `a_item'.
		do
...
feature -- Criterion
	...
	left: QL_TARGET_CRITERION
	right: QL_TARGET_CRITERION;
