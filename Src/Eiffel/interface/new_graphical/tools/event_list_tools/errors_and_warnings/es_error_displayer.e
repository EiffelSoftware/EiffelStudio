...
feature {NONE} -- Factory
	...
	create_warning_event_item (a_warning: ERROR): EVENT_LIST_ITEM_I
		...
		do
			...
			create {EVENT_LIST_WARNING_ITEM} Result.make ({ENVIRONMENT_CATEGORIES}.compilation, once "Eiffel Compilation Warning", a_warning)
		ensure
			result_attached: Result /= Void
	...
	create_error_event_item (a_error: ERROR): EVENT_LIST_ITEM_I
		...
		do
			...
			create {EVENT_LIST_ERROR_ITEM} Result.make ({ENVIRONMENT_CATEGORIES}.compilation, once "Eiffel Compilation Error", a_error)
		ensure
			result_attached: Result /= Void
