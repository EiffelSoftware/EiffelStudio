...
feature {STRING} -- Implementation
	...
	str_search (c_str: POINTER; c: CHARACTER; i, len: INTEGER): INTEGER is
			...
			-- 0 if no occurrence
		external
			"C (EIF_CHARACTER *, EIF_CHARACTER, EIF_INTEGER, EIF_INTEGER): EIF_INTEGER | %"eif_str.h%""
		end;
	...
	str_last_search (c_str: POINTER; c: CHARACTER; len: INTEGER): INTEGER is
			...
			-- 0 if no occurrence
		external
			"C (EIF_CHARACTER *, EIF_CHARACTER, EIF_INTEGER): EIF_INTEGER | %"eif_str.h%""
		end;
	...
	str_ljustify (c_string: POINTER; length,cap: INTEGER) is
		...
		external
			"C (EIF_CHARACTER *, EIF_INTEGER, EIF_INTEGER) | %"eif_str.h%""
		end;
	...
	str_strict_cmp (this, other: POINTER; len: INTEGER ): INTEGER is
			...
			-- > 0 if `this' > `other'
		external
			"C (char *, char *, size_t): EIF_INTEGER | <string.h>"
		alias
			"strncmp"
		end;
	...
	str_lower (c_string: POINTER; length: INTEGER) is
		...
		external
			"C (EIF_CHARACTER *, EIF_INTEGER) | %"eif_str.h%""
		end;
	...
	str_ator (c_string: POINTER; length: INTEGER): REAL is
		...
		external
			"C (EIF_CHARACTER *, EIF_INTEGER): EIF_REAL | %"eif_str.h%""
		end;

	str_atod (c_string: POINTER; length: INTEGER): DOUBLE is
			-- Value of double in `c_string'
		external
			"C (EIF_CHARACTER *, EIF_INTEGER): EIF_DOUBLE | %"eif_str.h%""
		end;

	str_isi (c_string: POINTER; length: INTEGER): BOOLEAN is
			-- Is is an integer?
		external
			"C (EIF_CHARACTER *, EIF_INTEGER): EIF_BOOLEAN | %"eif_str.h%""
		end;
	...
	str_mirror (c_string, new_string: POINTER; length: INTEGER) is
		...
		external
			"C (EIF_CHARACTER *, EIF_CHARACTER *, EIF_INTEGER) | %"eif_str.h%""
		end;
	...
	str_fill (c_string: POINTER; n: INTEGER; c: CHARACTER) is
		...
		external
			"C (EIF_CHARACTER *, EIF_INTEGER, EIF_CHARACTER) | %"eif_str.h%""
		end;
	...
	str_replace (c_string, other_string: POINTER; c_length, other_length,
			...
			-- by `other_string'.
		external
			"C (EIF_CHARACTER *, EIF_CHARACTER *, EIF_INTEGER, EIF_INTEGER, EIF_INTEGER, EIF_INTEGER) | %"eif_str.h%""
		end;
