...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			project_specific_name_holder.set_padding_width (small_padding)
			...
			l_ev_vertical_box_7.set_padding_width (small_padding)
			l_ev_vertical_box_7.set_border_width (small_padding)
			...
			l_ev_vertical_box_8.set_padding_width (small_padding)
			...
			l_ev_vertical_box_9.set_padding_width (medium_padding)
