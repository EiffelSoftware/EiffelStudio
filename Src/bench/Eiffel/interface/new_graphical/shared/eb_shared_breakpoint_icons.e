indexing
	description: "Shared breakpoint icon resources for the debugger/context tool."
	date       : "$Date$"
	revision   : "$Revision$"

class 
	EB_SHARED_BREAKPOINT_ICONS
...
feature {NONE} -- {EB_SHARED_PIXMAP_FACTORY} Implementation
	...
	image_matrix: EV_PIXMAP is
		...
		once
			Result := pixmap_file_content ("breakpoint_icon_matrix")
		end
...
end -- class EB_SHARED_BREAKPOINT_ICONS
