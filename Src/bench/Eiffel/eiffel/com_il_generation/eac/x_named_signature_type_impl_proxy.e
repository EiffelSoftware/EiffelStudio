indexing
	description: "Implemented `_NamedSignatureType' Interface."
	Note: "Automatically generated by the EiffelCOM Wizard."

class
	X_NAMED_SIGNATURE_TYPE_IMPL_PROXY
...
feature {NONE}  -- Initialization
	...
	make_from_pointer (cpp_obj: POINTER) is
			-- Make from pointer
		do
			initializer := ccom_create_x_named_signature_type_impl_proxy_from_pointer(cpp_obj)
...
feature {NONE}  -- Implementation
	...
	delete_wrapper is
			-- Delete wrapper
		do
			ccom_delete_x_named_signature_type_impl_proxy(initializer)
		end
...
feature {NONE}  -- Externals
	...
	ccom_to_string (cpp_obj: POINTER): STRING is
			-- No description available.
		external
			"C++ [ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType_impl_proxy %"ecom_ISE_Reflection_EiffelComponents__NamedSignatureType_impl_proxy.h%"](): EIF_REFERENCE"
		end

	ccom_equals (cpp_obj: POINTER; obj: POINTER): BOOLEAN is
			-- No description available.
		external
			"C++ [ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType_impl_proxy %"ecom_ISE_Reflection_EiffelComponents__NamedSignatureType_impl_proxy.h%"](VARIANT *): EIF_BOOLEAN"
		end

	ccom_get_hash_code (cpp_obj: POINTER): INTEGER is
			-- No description available.
		external
			"C++ [ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType_impl_proxy %"ecom_ISE_Reflection_EiffelComponents__NamedSignatureType_impl_proxy.h%"](): EIF_INTEGER"
		end
	...
	ccom_make1 (cpp_obj: POINTER) is
			-- No description available.
		external
			"C++ [ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType_impl_proxy %"ecom_ISE_Reflection_EiffelComponents__NamedSignatureType_impl_proxy.h%"]()"
		end

	ccom_set_eiffel_name (cpp_obj: POINTER; a_name: STRING) is
			-- No description available.
		external
			"C++ [ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType_impl_proxy %"ecom_ISE_Reflection_EiffelComponents__NamedSignatureType_impl_proxy.h%"](EIF_OBJECT)"
		end
	...
	ccom_delete_x_named_signature_type_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType_impl_proxy %"ecom_ISE_Reflection_EiffelComponents__NamedSignatureType_impl_proxy.h%"]()"
		end

	ccom_create_x_named_signature_type_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType_impl_proxy %"ecom_ISE_Reflection_EiffelComponents__NamedSignatureType_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType_impl_proxy %"ecom_ISE_Reflection_EiffelComponents__NamedSignatureType_impl_proxy.h%"]():EIF_POINTER"
		end
...
end -- X_NAMED_SIGNATURE_TYPE_IMPL_PROXY
