...
feature -- Text
	...
	e_evaluate_metric: STRING_GENERAL is do Result := locale.translation ("Evaluate metric: ") end
	e_not_evaluated: STRING_GENERAL is do Result := locale.translation ("Not evaluated") end
	e_evaluating: STRING_GENERAL is do Result := locale.translation ("Evaluating: ") end
	e_evaluating_value: STRING_GENERAL is do Result := locale.translation ("Evaluating...") end
	e_undefined_value: STRING_GENERAL is do Result := locale.translation ("Undefined") end
	e_value: STRING_GENERAL is do Result := locale.translation ("Value:") end
	e_interrupted_by_user: STRING_GENERAL is do Result := locale.translation ("Interrupted by user") end
...
feature -- Titles
	...
	t_criterion: STRING_GENERAL is do Result := locale.translation ("Criterion") end
	t_properties: STRING_GENERAL is do Result := locale.translation ("Properties") end
	t_status: STRING_GENERAL is do Result := locale.translation ("Status") end
	t_ok: STRING_GENERAL is do Result := locale.translation ("OK") end
	t_cancel: STRING_GENERAL is do Result := locale.translation ("Cancel") end
	t_type: STRING_GENERAL is do Result := locale.translation ("type") end
	t_value_of_reference: STRING_GENERAL is do Result := locale.translation ("Reference value") end
	t_value_of_current: STRING_GENERAL is do Result := locale.translation ("Current value") end
	t_difference: STRING_GENERAL is do Result := locale.translation ("Difference") end
	t_ratio: STRING_GENERAL is do Result := locale.translation ("ratio") end
	t_basic: STRING_GENERAL is do Result := locale.translation ("basic") end
	t_linear: STRING_GENERAL is do Result := locale.translation ("linear") end
	t_definition_tab: STRING_GENERAL is do Result := locale.translation ("Metric Definition") end
	t_evaluation_tab: STRING_GENERAL is do Result := locale.translation ("Metric Evaluation") end
	t_archive_tab: STRING_GENERAL is do Result := locale.translation ("Metric Archive") end
	t_detail_result_tab: STRING_GENERAL is do Result := locale.translation ("Detailed Result") end
	t_history_tab: STRING_GENERAL is do Result := locale.translation ("Metric History") end
	t_path: STRING_GENERAL is do Result := locale.translation ("Location") end
	t_group: STRING_GENERAL is do Result := locale.translation ("Group") end
	t_metrics: STRING_GENERAL is do Result := locale.translation ("Metrics") end
	...
	t_metric_is_not_valid: STRING_GENERAL is do Result := locale.translation ("is invalid") end
	t_selected_metric: STRING_GENERAL is do Result := locale.translation ("Selected metric") end
	t_selected_file_not_exists: STRING_GENERAL is do Result := locale.translation ("Specified file doesn't exist") end
	...
	t_location: STRING_GENERAL is do Result := locale.translation ("Location") end
	t_select_source_domain: STRING_GENERAL is do Result := locale.translation ("Setup input domain:") end
	t_select_metric: STRING_GENERAL is do Result := locale.translation ("Select metric:") end
	t_select_reference_archive: STRING_GENERAL is do Result := locale.translation ("Select reference archive (URL acceptable):") end
	t_select_current_archive: STRING_GENERAL is do Result := locale.translation ("Select current archive (URL acceptable):") end
	t_archive_comparison_result: STRING_GENERAL is do Result := locale.translation ("Archive comparison result:") end
	t_clean: STRING_GENERAL is do Result := locale.translation ("Clean") end
	t_compare: STRING_GENERAL is do Result := locale.translation ("Compare") end
	t_input_domain: STRING_GENERAL is do Result := locale.translation ("Input domain") end
	t_result: STRING_GENERAL is do Result := locale.translation ("Results:") end
	t_input_domain_title: STRING_GENERAL is do Result := locale.translation ("Input domain:") end
	t_metric_criterion_definition: STRING_GENERAL is do Result := locale.translation ("Definition:") end
	t_select_domain_scope: STRING_GENERAL is do Result := locale.translation ("Select domain scope") end
	t_predefined_text_not_editable: STRING_GENERAL is do Result := locale.translation ("Text not editable because current metric is predefined.") end
	t_text_not_editable: STRING_GENERAL is do Result := locale.translation ("Text not editable.") end
	t_metric_definition: STRING_GENERAL is do Result := locale.translation ("Metric definition") end
	t_checking_metric_vadility: STRING_GENERAL is do Result := locale.translation ("Checking metric validity") end
	t_loading_metrics: STRING_GENERAL is do Result := locale.translation ("Loading metrics...") end
	t_analysing_archive: STRING_GENERAL is do Result := locale.translation ("Analyzing metric archive(s)...") end
	t_saving_metrics: STRING_GENERAL is do Result := locale.translation ("Saving metrics...") end
	t_removing_metrics: STRING_GENERAL is do Result := locale.translation ("Removing metrics...") end
	t_result_not_up_to_date: STRING_GENERAL is do Result := locale.translation ("Current metric result may not be up-to-date") end
	t_feature_version_setting: STRING_GENERAL is do Result := locale.translation ("Feature version setting:") end
	t_only_current_version: STRING_GENERAL is do Result := locale.translation ("Only current version") end
	t_descendant_version: STRING_GENERAL is do Result := locale.translation ("Current version and all its descendant versions") end
	t_to_do: STRING_GENERAL is do Result := locale.translation ("To do:") end
	t_close: STRING_GENERAL is do Result := locale.translation ("Close") end
	t_metric_definition_error_wizard: STRING_GENERAL is do Result := locale.translation ("Metric definition error wizard") end
	t_metric_archive_calculation_finished: STRING_GENERAL is do Result := locale.translation ("Metric archive calculation finished.") end
	t_import_metric_title: STRING_GENERAL is do Result := locale.translation ("Import Metrics") end
	t_import_selected_metrics: STRING_GENERAL is do Result := locale.translation ("Import Selected Metrics") end
	t_backup_user_defined_metrics: STRING_GENERAL is do Result := locale.translation ("Backup User-defined Metrics") end
	t_metric_definition_file: STRING_GENERAL is do Result := locale.translation ("Metric Definition File:") end
	t_load: STRING_GENERAL is do Result := locale.translation ("Load") end
	t_import: STRING_GENERAL is do Result := locale.translation ("Import") end
	t_metric_original_name: STRING_GENERAL is do Result := locale.translation ("Original metric name") end
	t_metric_name: STRING_GENERAL is do Result := locale.translation ("Metric name") end
	t_metric_description: STRING_GENERAL is do Result := locale.translation ("Description") end
	t_metric_unit: STRING_GENERAL is do Result := locale.translation ("Unit") end
	t_select_all_metrics: STRING_GENERAL is do Result := locale.translation ("Select All Metrics") end
	t_deselect_all_metrics: STRING_GENERAL is do Result := locale.translation ("Deselect All Metrics") end
	t_select_integral_metrics: STRING_GENERAL is do Result := locale.translation ("Select Integral Metrics") end
	t_deselect_integral_metrics: STRING_GENERAL is do Result := locale.translation ("Deselect Integral Metrics") end

	t_backup_metrics: STRING_GENERAL is do Result := locale.translation ("Backup user-defined metrics") end
	t_select_file_for_backup: STRING_GENERAL is do Result := locale.translation ("Select a file for user-defined metrics backup:") end
	t_backup: STRING_GENERAL is do Result := locale.translation ("Backup") end
	t_importing_metrics: STRING_GENERAL is do Result := locale.translation ("Importing metrics...") end
	t_metrics_imported: STRING_GENERAL is do Result := locale.translation ("Metric(s) imported.") end
	t_metric_backuped: STRING_GENERAL is do Result := locale.translation ("User-defined metrics backup finished.") end
	t_metrics_list: STRING_GENERAL is do Result := locale.translation ("Metric List:") end
	t_short_line: STRING_GENERAL is do Result := locale.translation ("-") end
	t_archive_not_up_to_date: STRING_GENERAL is do Result := locale.translation ("Current archive value may not up-to-date") end
	err_input_domain_invalid: STRING_GENERAL is do Result := locale.translation ("Input domain invalid") end
	t_previous_value: STRING_GENERAL is do Result := locale.translation ("Previous value") end
	t_calculated_time: STRING_GENERAL is do Result := locale.translation ("Calculated time") end
	t_warning_check_failed: STRING_GENERAL is do Result := locale.translation ("Warning check failed") end

	f_run_history_recalculation: STRING_GENERAL is do Result := locale.translation ("Recalculate selected metric(s)") end
	f_stop_history_recalculation: STRING_GENERAL is do Result := locale.translation ("Stop metric recalculation") end
	f_remove_history_node: STRING_GENERAL is do Result := locale.translation ("Remove selected metric history") end
	f_display_history_in_tree_view: STRING_GENERAL is do Result := locale.translation ("Display history in tree view?") end
	f_send_to_history: STRING_GENERAL is do Result := locale.translation ("Send last calculated metric value to history") end
	t_hide_old_archive: STRING_GENERAL is do Result := locale.translation ("Hide archives more than ") end
	t_days: STRING_GENERAL is do Result := locale.translation (" days old.") end
	f_keep_archive_detailed_result: STRING_GENERAL is do Result := locale.translation ("Keep detailed result when recalculating archive?%NIf yes, detailed result will be available by double clicking the icon in %"Result%" column in history result area after recalculation.") end
	f_keep_metric_detailed_result: STRING_GENERAL is do Result := locale.translation ("Keep detailed result when evaluating metric?") end
	f_remove_detailed_result: STRING_GENERAL is do Result := locale.translation ("Remove detailed result?") end
	t_detailed_result: STRING_GENERAL is do Result := locale.translation ("Result") end
	f_double_click_to_go_to_result_panel: STRING_GENERAL  is do Result := locale.translation ("Double click to go to result panel") end
	f_select_all_history: STRING_GENERAL is do Result := locale.translation ("Select all history items") end
	f_deselect_all_history: STRING_GENERAL is do Result := locale.translation ("Deselect all history items") end
	f_select_recalculatable_history: STRING_GENERAL is do Result := locale.translation ("Select recalculatable history items") end
	f_deselect_recalculatable_history: STRING_GENERAL is do Result := locale.translation ("Deselect recalculatable history items") end
	t_select_all_history: STRING_GENERAL is do Result := locale.translation ("Select All") end
	t_deselect_all_history: STRING_GENERAL is do Result := locale.translation ("Deselect All") end
	t_select_recalculatable_history: STRING_GENERAL is do Result := locale.translation ("Select Recalculatable") end
	t_deselect_recalculatable_history: STRING_GENERAL is do Result := locale.translation ("Deselect Recalculatable") end
	t_filter: STRING_GENERAL is do Result := locale.translation ("Filter") end
	t_setup_feature_domain: STRING_GENERAL is do Result := locale.translation ("Setup feature domain") end
	l_to_do_dialog: STRING_GENERAL is do Result := locale.translation ("To do information") end
	t_add_new_value_evaluator: STRING_GENERAL is do Result := locale.translation ("Add new value evaluator") end
	t_add_new_constant_value_retriever: STRING is do Result := locale.translation ("Add new constant value retriever") end
	t_remove_value_retriever: STRING_GENERAL is do Result := locale.translation ("Remove selected value retriever") end
	t_remove_all_value_retriever: STRING_GENERAL is do Result := locale.translation ("Remove all value retriever") end
	t_setup_value_criterion: STRING_GENERAL is do Result := locale.translation ("Setup value criterion") end
	t_match_all_of_the_following: STRING_GENERAL is do Result := locale.translation ("Match all") end
	t_match_any_of_the_following: STRING_GENERAL is do Result := locale.translation ("Match any") end
	t_select_tester: STRING_GENERAL is do Result := locale.translation ("Select metric value testers:") end
	l_domain: STRING_GENERAL is do Result := locale.translation ("domain") end
	l_error_message: STRING_GENERAL is do Result := locale.translation ("error message") end
	l_setup_metric_value_retriever: STRING_GENERAL is do Result := locale.translation ("Setup metric value retriever") end
	t_add_new_metric_value_retriever: STRING_GENERAL is do Result := locale.translation ("Add new metric value retriever") end
	t_use_external_delayed: STRING_GENERAL is do Result := locale.translation ("Use external delayed domain") end
	t_warning: STRING_GENERAL is do Result := locale.translation ("Warning") end
	t_row: STRING_GENERAL is do Result := locale.translation ("row") end
	t_column: STRING_GENERAL is do Result := locale.translation ("column") end
	t_identical: STRING_GENERAL is do Result := locale.translation ("Identity") end
	t_containing: STRING_GENERAL is do Result := locale.translation ("Containing") end
	t_wildcard: STRING_GENERAL is do Result := locale.translation ("Wildcard") end
	t_regexp: STRING_GENERAL is do Result := locale.translation ("Regular expression") end
	t_matching_strategy: STRING_GENERAL is do Result := locale.translation ("Matching Strategy") end
...
feature -- Labels
	...
	l_select_input_domain: STRING_GENERAL is do Result := locale.translation ("Select input domain:") end
	l_select_metric: STRING_GENERAL is do Result := locale.translation ("Select metric:") end
	l_parse_error: STRING_GENERAL is do Result := locale.translation ("Parse error:") end
	l_ratio_metric: STRING_GENERAL is do Result := locale.translation ("ratio metric") end
	l_linear_metric: STRING_GENERAL is do Result := locale.translation ("linear metric") end
	l_basic_metric: STRING_GENERAL is do Result := locale.translation ("basic metric") end
	l_denominator_metric: STRING_GENERAL is do Result := locale.translation ("denominator metric") end
	l_numerator_metric: STRING_GENERAL is do Result := locale.translation ("numerator metric") end
	l_variable_metric: STRING_GENERAL is do Result := locale.translation ("variable metric") end
	l_metric_archive_node: STRING_GENERAL is do Result := locale.translation ("metric archive node") end
	l_criterion: STRING_GENERAL is do Result := locale.translation ("criterion") end
	l_name_colon: STRING_GENERAL is do Result := locale.translation ("Name:") end
	l_type_colon: STRING_GENERAL is do Result := locale.translation ("Type:") end
	l_unit_colon: STRING_GENERAL is do Result := locale.translation ("Unit:") end
	l_description_colon: STRING_GENERAL is do Result := locale.translation ("Description:") end
	l_no_result_available: STRING_GENERAL is do Result := locale.translation ("No result available.") end
	l_metric_definition_file: STRING_GENERAL is do Result := locale.translation ("Metrics definition file:") end
	l_use_case_sensitive: STRING_GENERAL is do Result := locale.translation ("Case sensitive") end
	l_use_regular_expression: STRING_GENERAL is do Result := locale.translation ("Use regular expression") end
	l_constant_value: STRING_GENERAL is do Result := locale.translation ("constant value") end
	l_metric_value: STRING_GENERAL is do Result := locale.translation ("metric value") end
	l_value_tester: STRING_GENERAL is do Result := locale.translation ("value tester") end
	l_current: STRING_GENERAL is do Result := locale.translation ("current") end
	l_current_version: STRING_GENERAL is do Result := locale.translation ("current version") end
	l_desendent_versions: STRING_GENERAL is do Result := locale.translation ("descendent versions") end
	l_direct: STRING_GENERAL is do Result := locale.translation ("direct") end
	l_indirect: STRING_GENERAL is do Result := locale.translation ("indirect") end
	l_normal_referenced: STRING_GENERAL is do Result := locale.translation ("normal") end
	l_syntactical_referenced: STRING_GENERAL is do Result := locale.translation ("syntactical") end
	l_empty_domain: STRING_GENERAL is do Result := locale.translation ("empty domain") end
	l_use_external_delayed_domain: STRING_GENERAL is do Result := locale.translation ("use external delayed domain") end
	l_no_value_tester: STRING_GENERAL is do Result := locale.translation ("No value tester") end

feature -- Tooltip

	f_quick_metric_definition: STRING_GENERAL is do Result := locale.translation ("Define quick metric (or drop a basic metric here as a template)") end
	f_run: STRING_GENERAL is do Result := locale.translation ("Run selected metric%NRunnable when a metric is selected and input domain is set.") end
	f_go_to_definition: STRING_GENERAL is do Result := locale.translation ("Go to definition") end
	f_stop: STRING_GENERAL is do Result := locale.translation ("Stop metric evaluation") end
	f_move_row_up: STRING_GENERAL is do Result := locale.translation ("Move selected row up") end
	f_move_row_down: STRING_GENERAL is do Result := locale.translation ("Move selected row down") end
	f_del_row: STRING_GENERAL is do Result := locale.translation ("Delete selected row") end
	...
	f_stop_archive: STRING_GENERAL is do Result := locale.translation ("Stop metric archive evaluation") end
	f_select_exist_archive_file: STRING_GENERAL is do Result := locale.translation ("Select an existing metric archive file") end
	f_clean_archive: STRING_GENERAL is do Result := locale.translation ("Clean archive?") end

	f_compare_archive: STRING_GENERAL is do Result := locale.translation ("Compare metric archive") end
	f_select_current_archive: STRING_GENERAL is do Result := locale.translation ("Select current metric archive file") end
	f_select_reference_archive: STRING_GENERAL is do Result := locale.translation ("Select reference metric archive file") end
	f_select_userdefined_metrics: STRING_GENERAL is do Result := locale.translation ("Select/deselect user-defined metrics") end
	f_select_predefined_metrics: STRING_GENERAL is do Result := locale.translation ("Select/deselect predefined metrics") end
	f_group_metric_by_unit: STRING_GENERAL is do Result := locale.translation ("Group metrics by unit") end

	f_add_scope: STRING_GENERAL is do Result := locale.translation ("Add scope") end
	f_remove_scope: STRING_GENERAL is do Result := locale.translation ("Remove selected scope(s)") end
	f_remove_all_scopes: STRING_GENERAL is do Result := locale.translation ("Remove all scopes") end
	f_delayed_scope: STRING_GENERAL is do Result := locale.translation ("Use input domain as criterion domain.") end
	f_use_delayed_scope: STRING_GENERAL is do Result := locale.translation ("Use delayed domain") end
	f_save: STRING_GENERAL is do Result := locale.translation ("Save") end
	f_new: STRING_GENERAL is do Result := locale.translation ("New metric") end
	f_remove: STRING_GENERAL is do Result := locale.translation ("Remove current selected metric") end
	f_domain_item_invalid: STRING_GENERAL is do Result := locale.translation ("Item invalid in current system") end
	...
	f_open_metric_file_in_external_editor: STRING_GENERAL is do Result := locale.translation ("Open user defined metric file in external editor") end
	f_create_new_metric_using_current_data: STRING_GENERAL is do Result := locale.translation ("Clone selected metric to a new metric") end
	f_setup_criterion_domain: STRING_GENERAL is do Result := locale.translation ("Setup criterion domain properties") end
	f_setup_criterion_text: STRING_GENERAL is do Result := locale.translation ("Setup criterion text properties") end
	f_double_click_to_go_to_definition: STRING_GENERAL is do Result := locale.translation ("(Double click to go to definition)") end
	f_display_in_percentage: STRING_GENERAL is do Result := locale.translation ("Display result in percentage? (Only applicable for ratio metrics)") end
	f_add_linear_variable_metric: STRING_GENERAL is do Result := locale.translation ("Add selected metric") end
	f_run_metric_again: STRING_GENERAL is do Result := locale.translation ("Evaluate metric again to get up-to-date result") end
	f_auto_go_to_result: STRING_GENERAL is do Result := locale.translation ("Automatically go to result panel after metric evaluation?") end
	f_press_esc_to_wipe_out: STRING_GENERAL is do Result := locale.translation ("Press ESC to wipe out") end
	f_move_unit_up: STRING_GENERAL is do Result := locale.translation ("Move metric unit up.%N") end
	f_move_unit_down: STRING_GENERAL is do Result := locale.translation ("Move metric unit down.%N") end
	f_rearrange_unit: STRING_GENERAL is do Result := locale.translation ("Or you can pick a metric unit and drop it on another metric to rearrange their order.") end
	f_show_to_do_message: STRING_GENERAL is do Result := locale.translation ("Display a message about how to deal with the metric definition error") end
	f_import_metrics: STRING_GENERAL is do Result := locale.translation ("Import metrics from file") end
	f_clear_defined_domain: STRING_GENERAL is do Result := locale.translation ("Clear defined domain") end
	f_check_warning: STRING_GENERAL is do Result := locale.translation ("Check defined warnings when archive is recalculated?") end

	l_target_unit: STRING_GENERAL is do Result := locale.translation("Target") end
	l_group_unit: STRING_GENERAL is do Result := locale.translation("Group") end
	l_class_unit: STRING_GENERAL is do Result := locale.translation("Class") end
	l_feature_unit: STRING_GENERAL is do Result := locale.translation("Feature") end
	l_generic_unit: STRING_GENERAL is do Result := locale.translation("Generic") end
	l_assertion_unit: STRING_GENERAL is do Result := locale.translation("Assertion") end
	l_argument_unit: STRING_GENERAL is do Result := locale.translation("Argument") end
	l_line_unit: STRING_GENERAL is do Result := locale.translation("Line") end
	l_compilation_unit: STRING_GENERAL is do Result := locale.translation("Compilation") end
	l_local_unit: STRING_GENERAL is do Result := locale.translation("Local") end
	l_ratio_unit: STRING_GENERAL is do Result := locale.translation("Ratio") end
	...
	l_setup_domain_dialog: STRING_GENERAL is do Result := locale.translation ("Setup domain") end
...
feature -- Error/warning message
	...
	err_invalid_tag: STRING_GENERAL is do Result := locale.translation ("Invalid tag.") end
			-- Invalid tag error

	err_invalid_description_tag: STRING_GENERAL is do Result := locale.translation ("Invalid description tag.") end
	...
	err_operator_missing: STRING_GENERAL is do Result := locale.translation ("Operator in value criterion is missing.") end
	...
	err_tester_relation_missing: STRING_GENERAL is do Result := locale.translation ("Relation for value tester is missing.") end
	...
	err_no_value_tester_specified: STRING_GENERAL is do Result := locale.translation ("No value tester is specified.") end

	err_base_value_missing: STRING_GENERAL is do Result := locale.translation ("Base value of a value tester is missing.") end
	...
	err_domain_missing: STRING_GENERAL is do Result := locale.translation ("Domain is missing.") end
	err_value_tester_missing: STRING_GENERAL is do Result := locale.translation ("Value tester is missing.") end
	err_value_retriever_missing: STRING_GENERAL is do Result := locale.translation ("Value retriever is missing.") end
	...
	err_delayed_domain_item_appear: STRING_GENERAL is do Result := locale.translation ("Delayed domain item appears.") end
	err_input_domain_item_appear: STRING_GENERAL is do Result := locale.translation ("Input domain item appears.") end
...
feature -- To do messages
	...
	unit_in_basic_metric_not_same_to_do: STRING_GENERAL is do Result := locale.translation ("Make sure every (recursive) criterion in basic metric is of the same unit with that basic metric.") end
	criterion_not_exist_to_do: STRING_GENERAL is do Result := locale.translation ("Make sure that the criterion of given unit exists.") end
	domain_item_not_exists_to_do: STRING_GENERAL is do Result := locale.translation ("Make sure that at least one domain item is listed in a domain criterion.") end
	text_in_text_criterion_empty_to_do: STRING_GENERAL is do Result := locale.translation ("Make sure to specify a non-empty string for a text criterion.") end
	...
	recursive_definition_to_do: STRING_GENERAL is do Result := locale.translation ("In linear metric, make sure that every variable metric doesn't involve recursive metric.%NIn ratio metric, make sure that numerator metric or denominator metric doesn't involve recursive metric.") end
	make_sure_denominator_coefficient_non_zero_to_do: STRING_GENERAL is do Result := locale.translation ("Make sure coefficient for denominator metric is a non-zero real number.") end

	no_value_tester_specified_to_do: STRING_GENERAL is do Result := locale.translation ("Make sure that at least one value tester is specified.") end
	...
	delayed_domain_item_appear_to_do: STRING_GENERAL is do Result := locale.translation ("Remove delayed domain item.") end
	input_domain_item_appear_to_do: STRING_GENERAL is do Result := locale.translation ("Remove input domain item.") end
