...
feature -- Element Change
	...
	frozen put_i_th (index: INTEGER; value: SYSTEM_CODEDOM_CODETYPEREFERENCE) is
		external
...
feature -- Basic Operations
	...
	frozen has (value: SYSTEM_CODEDOM_CODETYPEREFERENCE): BOOLEAN is
		external
	...
	frozen extend (value: SYSTEM_TYPE) is
		external
