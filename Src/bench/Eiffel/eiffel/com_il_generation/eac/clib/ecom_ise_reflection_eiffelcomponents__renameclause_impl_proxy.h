...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__RENAMECLAUSE_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__RENAMECLAUSE_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
class _RenameClause_impl_proxy;
}
...
{
public:
	_RenameClause_impl_proxy (IUnknown * a_pointer);
	virtual ~_RenameClause_impl_proxy ();
