...
feature -- Access
	...
	new_formal_dec_as (f: FORMAL_AS; c: CONSTRAINT_LIST_AS; cf: EIFFEL_LIST [FEATURE_NAME]; c_as: SYMBOL_AS; ck_as, ek_as: KEYWORD_AS; q: BOOLEAN; q_as: SYMBOL_AS): FORMAL_CONSTRAINT_AS is
