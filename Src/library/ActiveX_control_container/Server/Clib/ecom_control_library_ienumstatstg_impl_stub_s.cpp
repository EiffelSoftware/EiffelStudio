...
#include "ecom_control_library_IEnumSTATSTG_impl_stub_s.h"
...
ecom_control_library::IEnumSTATSTG_impl_stub::IEnumSTATSTG_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IEnumSTATSTG_impl_stub::~IEnumSTATSTG_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IEnumSTATSTG_impl_stub::RemoteNext(  /* [in] */ ULONG celt, /* [out] */ ecom_control_library::tagSTATSTG * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_control_interfaces2.ccom_ce_pointed_record_76 (rgelt));
	}
...
STDMETHODIMP ecom_control_library::IEnumSTATSTG_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_control_library::IEnumSTATSTG_impl_stub::Reset( void )
...
STDMETHODIMP ecom_control_library::IEnumSTATSTG_impl_stub::Clone(  /* [out] */ ecom_control_library::IEnumSTATSTG * * ppenum )
...
STDMETHODIMP_(ULONG) ecom_control_library::IEnumSTATSTG_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IEnumSTATSTG_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IEnumSTATSTG_impl_stub::QueryInterface( REFIID riid, void ** ppv )
...
-----------------------------------------------------------*/
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<ecom_control_library::IEnumSTATSTG*>(this);
	else if (riid == IID_IEnumSTATSTG_)
		*ppv = static_cast<ecom_control_library::IEnumSTATSTG*>(this);
	else
