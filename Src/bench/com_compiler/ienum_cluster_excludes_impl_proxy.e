...
feature {NONE}  -- Externals
	...
	ccom_delete_ienum_cluster_excludes_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_EiffelComCompiler::IEnumClusterExcludes_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterExcludes_impl_proxy_s.h%"]()"
		end

	ccom_create_ienum_cluster_excludes_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_EiffelComCompiler::IEnumClusterExcludes_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterExcludes_impl_proxy_s.h%"](IUnknown *)"
		end
