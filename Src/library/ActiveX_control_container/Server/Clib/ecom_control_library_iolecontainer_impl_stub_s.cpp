...
#include "ecom_control_library_IOleContainer_impl_stub_s.h"
...
ecom_control_library::IOleContainer_impl_stub::IOleContainer_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IOleContainer_impl_stub::~IOleContainer_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IOleContainer_impl_stub::ParseDisplayName(  /* [in] */ ecom_control_library::IBindCtx * pbc, /* [in] */ LPWSTR psz_display_name, /* [out] */ ULONG * pch_eaten, /* [out] */ ecom_control_library::IMoniker * * ppmk_out )
...
STDMETHODIMP ecom_control_library::IOleContainer_impl_stub::EnumObjects(  /* [in] */ ULONG grf_flags, /* [out] */ ecom_control_library::IEnumUnknown * * ppenum )
...
STDMETHODIMP ecom_control_library::IOleContainer_impl_stub::LockContainer(  /* [in] */ LONG f_lock )
...
STDMETHODIMP_(ULONG) ecom_control_library::IOleContainer_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IOleContainer_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IOleContainer_impl_stub::QueryInterface( REFIID riid, void ** ppv )
