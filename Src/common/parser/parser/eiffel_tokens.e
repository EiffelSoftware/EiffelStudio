...
feature -- Token codes
	...
	TE_PRECURSOR: INTEGER is 341
	TE_AGENT: INTEGER is 342
	TE_PREFIX: INTEGER is 343
	TE_REDEFINE: INTEGER is 344
	TE_RENAME: INTEGER is 345
	TE_REQUIRE: INTEGER is 346
	TE_RESCUE: INTEGER is 347
	TE_RESULT: INTEGER is 348
	TE_RETRY: INTEGER is 349
	TE_SELECT: INTEGER is 350
	TE_SEPARATE: INTEGER is 351
	TE_THEN: INTEGER is 352
	TE_UNDEFINE: INTEGER is 353
	TE_UNIQUE: INTEGER is 354
	TE_UNTIL: INTEGER is 355
	TE_VARIANT: INTEGER is 356
	TE_WHEN: INTEGER is 357
	TE_QUESTION: INTEGER is 358
	TE_CURLYTILDE: INTEGER is 359
	TE_BOOLEAN_ID: INTEGER is 360
	TE_CHARACTER_ID: INTEGER is 361
	TE_DOUBLE_ID: INTEGER is 362
	TE_INTEGER_ID: INTEGER is 363
	TE_INTEGER_8_ID: INTEGER is 364
	TE_INTEGER_16_ID: INTEGER is 365
	TE_INTEGER_64_ID: INTEGER is 366
	TE_WIDE_CHAR_ID: INTEGER is 367
	TE_NONE_ID: INTEGER is 368
	TE_POINTER_ID: INTEGER is 369
	TE_REAL_ID: INTEGER is 370
	TE_EMPTY_STRING: INTEGER is 371
	TE_VERBATIM_STRING: INTEGER is 372
	TE_EMPTY_VERBATIM_STRING: INTEGER is 373
	TE_STR_LT: INTEGER is 374
	TE_STR_LE: INTEGER is 375
	TE_STR_GT: INTEGER is 376
	TE_STR_GE: INTEGER is 377
	TE_STR_MINUS: INTEGER is 378
	TE_STR_PLUS: INTEGER is 379
	TE_STR_STAR: INTEGER is 380
	TE_STR_SLASH: INTEGER is 381
	TE_STR_MOD: INTEGER is 382
	TE_STR_DIV: INTEGER is 383
	TE_STR_POWER: INTEGER is 384
	TE_STR_AND: INTEGER is 385
	TE_STR_AND_THEN: INTEGER is 386
	TE_STR_IMPLIES: INTEGER is 387
	TE_STR_OR: INTEGER is 388
	TE_STR_OR_ELSE: INTEGER is 389
	TE_STR_XOR: INTEGER is 390
	TE_STR_NOT: INTEGER is 391
	TE_STR_FREE: INTEGER is 392
