...
--| --|----------------------------------------------------------------
--|
--| Revision 1.9  2001/06/07 23:08:16  rogers
--| Merged DEVEL branch into Main trunc.
--|
--| Revision 1.5.8.14  2000/11/02 05:02:13  manus
...
--|
--| Revision 1.5.8.7  2000/07/21 22:12:46  pichery
--| Added drawing operations for flat separators.
--|
--| Revision 1.5.8.6  2000/06/22 19:05:19  pichery
--| - Added the style `is_flat'
--|
--| Revision 1.5.8.5  2000/06/13 19:02:02  rogers
--| Removed FIXME NOT_REVIEWED. Comments, formatting. Removed unreferenced
--| local variable.
--|
...
--| Modified to comply with the major vision2 changes. See diff 
--| for redefinitions. Added interface.
--|
