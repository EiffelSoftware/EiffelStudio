...
grt_ce_ISE.ccom_free_memory_pointed_219 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumIncludePaths * *)grt_ec_ISE.ccom_ec_pointed_cell_214 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_214 ((ecom_eiffel_compiler::IEnumIncludePaths * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_214 (tmp_ppenum);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_220 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_220 ((BSTR *)tmp_rgelt, rgelt);
	
	grt_ce_ISE.ccom_free_memory_pointed_220 (tmp_rgelt);
