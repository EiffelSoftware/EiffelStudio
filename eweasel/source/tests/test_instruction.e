...
deferred class TEST_INSTRUCTION

feature

	initialize (tcf: TEST_CONTROL_FILE) is
	...
	initialize_for_conditional (tcf: TEST_CONTROL_FILE cmd, args: STRING) is
			-- Initialize instruction from information in
...
feature -- Properties
	...
	command_table: HASH_TABLE [TEST_INSTRUCTION, STRING] is
	...
	init_environment: TEST_ENVIRONMENT is
...
feature {NONE} -- Implementation
	...
	set_arguments (tcf: TEST_CONTROL_FILE) is
			-- Set `subst_arguments' and get other info from `tcf'
		require
			tcf_not_void: tcf /= Void;
		do
			test_control_file := tcf;
