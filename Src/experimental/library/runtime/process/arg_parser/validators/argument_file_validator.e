...
feature {NONE} -- Internationalization
	...
	e_invalid_file_name: IMMUTABLE_STRING_32
		once
			create Result.make_from_string_general ("The specified file name is invalid.")
		end

	e_file_is_not_file: IMMUTABLE_STRING_32
		once
			create Result.make_from_string_general ("The specified file does not represent a file.")
		end

	e_file_does_not_exist: IMMUTABLE_STRING_32
		once
			create Result.make_from_string_general ("The specified file does not exist.")
		end
