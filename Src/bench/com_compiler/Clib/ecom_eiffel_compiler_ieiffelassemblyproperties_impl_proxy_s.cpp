...
#include "ecom_eiffel_compiler_IEiffelAssemblyProperties_impl_proxy_s.h"
...
ecom_eiffel_compiler::IEiffelAssemblyProperties_impl_proxy::IEiffelAssemblyProperties_impl_proxy( IUnknown * a_pointer )
{
	HRESULT hr, hr2;
...
EIF_REFERENCE ecom_eiffel_compiler::IEiffelAssemblyProperties_impl_proxy::ccom_assembly_name(  )
...
EIF_REFERENCE ecom_eiffel_compiler::IEiffelAssemblyProperties_impl_proxy::ccom_assembly_version(  )
...
EIF_REFERENCE ecom_eiffel_compiler::IEiffelAssemblyProperties_impl_proxy::ccom_assembly_culture(  )
...
EIF_REFERENCE ecom_eiffel_compiler::IEiffelAssemblyProperties_impl_proxy::ccom_assembly_public_key(  )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IEiffelAssemblyProperties->assembly_public_key( &ret_value);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
	...
	hr = p_IEiffelAssemblyProperties->assembly_path( &ret_value);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
EIF_REFERENCE ecom_eiffel_compiler::IEiffelAssemblyProperties_impl_proxy::ccom_assembly_identifier(  )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IEiffelAssemblyProperties->assembly_identifier( &ret_value);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
