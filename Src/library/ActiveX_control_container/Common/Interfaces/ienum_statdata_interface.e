...
feature -- Status Report
	...
	next_user_precondition (celt: INTEGER; rgelt: ARRAY [TAG_STATDATA_RECORD]; pcelt_fetched: INTEGER_REF): BOOLEAN
	...
	clone1_user_precondition (ppenum: CELL [IENUM_STATDATA_INTERFACE]): BOOLEAN
