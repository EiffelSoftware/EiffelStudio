...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelAssemblyProperties * *)grt_ec_ISE_c.ccom_ec_pointed_cell_208 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_208 ((ecom_eiffel_compiler::IEiffelAssemblyProperties * *)tmp_rgelt, rgelt);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumAssembly * *)grt_ec_ISE_c.ccom_ec_pointed_cell_219 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_219 ((ecom_eiffel_compiler::IEnumAssembly * *)tmp_ppenum, ppenum);
