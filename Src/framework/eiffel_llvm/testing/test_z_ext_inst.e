...
feature -- Test routines
	...
	test_z_ext_inst_1
		...
		do
			...
			create i.make (create {CONSTANT_INT}.make (create {INTEGER_TYPE}.make (ctx, 32), 8), create {INTEGER_TYPE}.make (ctx, 64))
			b.inst_list_push_back (i)
			create s.make
			m.print (s)
			s_result := s.string
			assert ("test_z_ext_inst_1", s_result ~ test_z_ext_inst_1_expected)
		end

	test_z_ext_inst_1_expected: STRING_8 =
"[
; ModuleID = 'test'
