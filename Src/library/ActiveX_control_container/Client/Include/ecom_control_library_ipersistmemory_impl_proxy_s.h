...
public:
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_load(  /* [in] */ EIF_OBJECT p_mem,  /* [in] */ EIF_INTEGER cb_size );


  /*-----------------------------------------------------------
  No description available.
  -----------------------------------------------------------*/
  void ccom_save(  /* [out] */ EIF_OBJECT p_mem,  /* [in] */ EIF_INTEGER f_clear_dirty,  /* [in] */ EIF_INTEGER cb_size );
...
private:
  ...
  Interface pointer
  -----------------------------------------------------------*/
  ::IPersistMemory * p_IPersistMemory;
