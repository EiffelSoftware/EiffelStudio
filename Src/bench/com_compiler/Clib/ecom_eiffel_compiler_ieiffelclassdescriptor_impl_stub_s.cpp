...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_clients = grt_ec_ISE.ccom_ec_pointed_interface_32 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_clients = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_suppliers = grt_ec_ISE.ccom_ec_pointed_interface_32 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_suppliers = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_ancestors = grt_ec_ISE.ccom_ec_pointed_interface_32 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_ancestors = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_descendants = grt_ec_ISE.ccom_ec_pointed_interface_32 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
