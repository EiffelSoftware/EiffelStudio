...
feature -- Logic operations
	...
	conjuncted alias "and" (other: QL_LINE_CRITERION): QL_LINE_CRITERION
			-- Boolean conjunction with `other'
		do
			create {QL_LINE_AND_CRITERION}Result.make (Current, other)
		end

	negated alias "not": QL_LINE_CRITERION
			-- Negation
		do
			create {QL_LINE_NOT_CRITERION}Result.make (Current)
		end

	disjuncted alias "or" (other: QL_LINE_CRITERION): QL_LINE_CRITERION
