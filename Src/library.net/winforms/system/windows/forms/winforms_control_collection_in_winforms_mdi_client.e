...
external class
	WINFORMS_CONTROL_COLLECTION_IN_WINFORMS_MDI_CLIENT
...
create
	make_winforms_control_collection_in_winforms_mdi_client

feature {NONE} -- Initialization

	frozen make_winforms_control_collection_in_winforms_mdi_client (owner: WINFORMS_MDI_CLIENT) is
		external
...
end -- class WINFORMS_CONTROL_COLLECTION_IN_WINFORMS_MDI_CLIENT
