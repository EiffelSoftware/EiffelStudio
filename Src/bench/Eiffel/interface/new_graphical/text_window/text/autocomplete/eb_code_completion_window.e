...
feature -- Initialization
	...
	initialize_for_features (an_editor: like editor; feature_name: STRING; a_remainder: INTEGER; completion_possibilities: SORTABLE_ARRAY [EB_NAME_FOR_COMPLETION]; a_complete_word: BOOLEAN) is
	...
	initialize_for_classes (an_editor: like editor; class_name: STRING; a_remainder: INTEGER; completion_possibilities: SORTABLE_ARRAY [EB_NAME_FOR_COMPLETION]) is
...
feature {NONE} -- Implementation
	...
	close_and_complete is
		...
		do
			...
			exit
			editor.block_focus_in_actions
			editor.set_focus
			editor.resume_focus_in_actions
		end
	...
	exit is
		...
		do
			if not is_closing then
				...
				editor.resume_focus_out_actions
			end
		end
