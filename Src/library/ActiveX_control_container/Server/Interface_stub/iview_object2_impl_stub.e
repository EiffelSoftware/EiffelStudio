...
feature {NONE}  -- Externals
	...
	ccom_create_item (eif_object: IVIEW_OBJECT2_IMPL_STUB): POINTER is
			-- Initialize `item'
		external
			"C++ [new ecom_control_library::IViewObject2_impl_stub %"ecom_control_library_IViewObject2_impl_stub_s.h%"](EIF_OBJECT)"
		end

end -- IVIEW_OBJECT2_IMPL_STUB
