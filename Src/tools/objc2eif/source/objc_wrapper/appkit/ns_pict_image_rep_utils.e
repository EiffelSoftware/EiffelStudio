...
feature -- NSPICTImageRep
	...
	image_rep_with_data_ (a_pict_data: detachable NS_DATA): detachable NS_OBJECT
		...
		do
			...
			result_pointer := objc_image_rep_with_data_ (l_objc_class.item, a_pict_data__item)
...
feature {NONE} -- NSPICTImageRep Externals
	...
	objc_image_rep_with_data_ (a_class_object: POINTER; a_pict_data: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(Class)$a_class_object imageRepWithData:$a_pict_data];
			 ]"
		end
