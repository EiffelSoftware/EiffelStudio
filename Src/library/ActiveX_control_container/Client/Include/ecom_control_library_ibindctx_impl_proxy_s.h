...
public:
  ...
  No description available.
  -----------------------------------------------------------*/
  void ccom_set_bind_options(  /* [in] */ ecom_control_library::tagBIND_OPTS2 * pbindopts );


  /*-----------------------------------------------------------
  No description available.
  -----------------------------------------------------------*/
  void ccom_get_bind_options(  /* [in, out] */ ecom_control_library::tagBIND_OPTS2 * pbindopts );
