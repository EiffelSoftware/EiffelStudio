...
#define WEBKIT_DOM_CSS_STYLE_SHEET_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_CSS_STYLE_SHEET, WebKitDOMCSSStyleSheetClass)
#define WEBKIT_DOM_IS_CSS_STYLE_SHEET(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_CSS_STYLE_SHEET))
#define WEBKIT_DOM_IS_CSS_STYLE_SHEET_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_CSS_STYLE_SHEET))
