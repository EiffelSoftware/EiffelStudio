...
feature {EV_ANY} -- Implementation
	...
	create_interface_objects
			...
			-- Redefined by descendants to create objects
			-- Make it compatible with void-safe Vision2, so that code
			-- generated by EiffelBuild is compilable with non void-safe version.
		do
		end
