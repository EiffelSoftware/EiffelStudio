note
	description: "[
					...
					Martins 2/26/07: This is an unoffical error! Not ECMA approved!
				]"
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature -- Output
	...
	build_explain (a_text_formatter: TEXT_FORMATTER)
		...
		do
			...
			a_text_formatter.add (type.dump)
		end

feature {COMPILER_EXPORTER} -- Setting

	set_type (a_type: TYPE_AS)
