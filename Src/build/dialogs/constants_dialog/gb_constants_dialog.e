...
feature -- Basic operation
	...
	update_for_addition (constant: GB_CONSTANT)
	...
	update_for_removal (constant: GB_CONSTANT)
			-- Update constants displayed in `Current' to reflect
		require
...
feature {NONE} -- Implementation
	...
	key_pressed_on_constants_list (a_key: EV_KEY)
	...
	directory_constant_deletable (directory_constant: GB_DIRECTORY_CONSTANT; all_pixmaps_for_deletion: ARRAYED_LIST [GB_CONSTANT]): BOOLEAN
	...
	column_clicked (a_column: INTEGER)
	...
	item_selected_in_list (an_item: EV_MULTI_COLUMN_LIST_ROW)
	...
	item_deselected_in_list (an_item: EV_MULTI_COLUMN_LIST_ROW)
