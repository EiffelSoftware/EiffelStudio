...
feature
	try is
		...
		do
			...
			io.put_string ((create {like Current}).generating_type.name_32.to_string_8)
			io.new_line
			...
			io.put_string (z.generating_type.name_32.to_string_8)
			io.new_line
	...
	try2 is
		...
		do
			...
			io.put_string (y.generating_type.name_32.to_string_8)
			io.new_line

			io.put_string ((create {ARRAY [like Current]}.make_filled (Current, 1, 10)).generating_type.name_32.to_string_8)
			io.new_line
