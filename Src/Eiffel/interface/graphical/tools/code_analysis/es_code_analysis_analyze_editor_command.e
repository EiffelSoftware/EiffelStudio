...
class
	ES_CODE_ANALYSIS_ANALYZE_EDITOR_COMMAND
...
feature -- Items
	...
	new_sd_toolbar_item (display_text: BOOLEAN): EB_SD_COMMAND_TOOL_BAR_BUTTON
		...
		do
			...
			Result.select_actions.extend (agent analyze_editor)
		ensure then
...
feature {NONE} -- Implementation
	...
	pixmap: EV_PIXMAP
		...
		do
			Result := pixmaps.icon_pixmaps.analyzer_analyze_editor_icon
		end

	pixel_buffer: EV_PIXEL_BUFFER
			-- Pixel buffer representing the command.
		do
			Result := pixmaps.icon_pixmaps.analyzer_analyze_editor_icon_buffer
		end

feature -- Access

	name: STRING = "Analyze_editor"
			-- <Precursor>
...
feature {NONE} -- Implementation
	...
	menu_name: STRING_GENERAL
		...
		do
			Result := ca_messages.analyze_editor_menu (Void)
		end

	tooltext: STRING_GENERAL
			-- Text for the toolbar button.
		do
			Result := ca_names.analyze_editor_tool_text
		end

	tooltip: STRING_GENERAL
			-- Tooltip for the toolbar button.
		do
			Result := ca_names.analyze_editor_tooltip
		end

	description: STRING_GENERAL
			-- Description for this command.
		do
			Result := ca_messages.analyze_editor_description
		end
