...
feature {NONE} -- Implementation
	...
	test_anchors is
		...
		do
			...
			create a_2
			check_for_true ("anchors - 8", is_same_type (a_2, create {A [detachable G]}))
			create a_3
			check_for_true ("anchors - 9", is_same_type (a_3, create {A [attached G]}))

			create a_4
			check_for_true ("anchors - 10", is_same_type (a_4, create {A [attached G]}))
			create a_5
			check_for_true ("anchors - 11", is_same_type (a_5, create {A [detachable G]}))
			create a_6
			check_for_true ("anchors - 12", is_same_type (a_6, create {A [attached G]}))

			create a_7
			check_for_true ("anchors - 13", is_same_type (a_7, create {A [detachable G]}))
			create a_8
			check_for_true ("anchors - 14", is_same_type (a_8, create {A [detachable G]}))
			create a_9
			check_for_true ("anchors - 15", is_same_type (a_9, create {A [attached G]}))

			create b_1
			check_for_true ("anchors - 16", is_same_type (b_1, create {A [G]}))
			create b_2
			check_for_true ("anchors - 17", is_same_type (b_2, create {A [detachable G]}))
			create b_3
			check_for_true ("anchors - 18", is_same_type (b_3, create {A [attached G]}))

			create b_4
			check_for_true ("anchors - 19", is_same_type (b_4, create {A [attached G]}))
			create b_5
			check_for_true ("anchors - 20", is_same_type (b_5, create {A [detachable G]}))
			create b_6
			check_for_true ("anchors - 21", is_same_type (b_6, create {A [attached G]}))

			create b_7
			check_for_true ("anchors - 22", is_same_type (b_7, create {A [detachable G]}))
			create b_8
			check_for_true ("anchors - 23", is_same_type (b_8, create {A [detachable G]}))
			create b_9
			check_for_true ("anchors - 24", is_same_type (b_9, create {A [attached G]}))
		end
	...
	test_single_generic (is_attached: BOOLEAN) is
		local
			a_att: A [attached G]
			a_det: A [detachable G]
			a_neutral: A [G]
		do
			a_att ?= create {A [detachable G]}
			check_for_true ("single generic - 1", a_att = Void)
			a_att ?= create {A [attached G]}
	...
	test_same_types (is_attached: BOOLEAN) is
		...
		do
			check_for_true ("same_type - 1", is_same_type (create {A [detachable G]}, create {attached A [detachable G]}))
			check_for_true ("same_type - 2", is_same_type (create {A [detachable G]}, create {detachable A [detachable G]}))
			check_for_true ("same_type - 3", is_same_type (create {attached A [detachable G]}, create {detachable A [detachable G]}))

			check_for_true ("same_type - 5", is_same_type (create {A [attached G]}, create {detachable A [attached G]}))
			check_for_true ("same_type - 6", is_same_type (create {attached A [attached G]}, create {detachable A [attached G]}))

			check_for_true ("same_type - 7", is_same_type (create {like anchor_1}, create {A [detachable G]}))
			check_for_true ("same_type - 8", is_same_type (create {like anchor_2}, create {A [attached G]}))
			check_for_true ("same_type - 9", is_same_type (create {like anchor_3}, create {A [detachable G]}))
			check_for_true ("same_type - 10", is_same_type (create {like anchor_4}, create {A [attached G]}))
			check_for_true ("same_type - 11", is_same_type (create {like anchor_5}, create {A [detachable G]}))
			check_for_true ("same_type - 12", is_same_type (create {like anchor_6}, create {A [attached G]}))
			...
			check_for_true ("same_type - 16", is_same_type (create {A [G]}, create {attached A [G]}))
			check_for_true ("same_type - 17", is_same_type (create {A [G]}, create {detachable A [G]}))
			check_for_true ("same_type - 18", is_same_type (create {attached A [G]}, create {detachable A [G]}))

			if is_attached then
				check_for_true ("same_type - 19", is_same_type (create {A [attached G]}, create {A [G]}))
				check_for_true ("same_type - 20", not is_same_type (create {A [detachable G]}, create {A [G]}))
			else
				check_for_true ("same_type - 21", not is_same_type (create {A [attached G]}, create {A [G]}))
				check_for_true ("same_type - 22", is_same_type (create {A [detachable G]}, create {A [G]}))
			end
		end

	anchor_1: A [detachable G]
	anchor_2: A [attached G]
	anchor_3: attached A [detachable G]
	anchor_4: attached A [attached G]
	anchor_5: detachable A [detachable G]
	anchor_6: detachable A [attached G]
	anchor_7: A [G]
	anchor_8: attached A [G]
	anchor_9: detachable A [G]
