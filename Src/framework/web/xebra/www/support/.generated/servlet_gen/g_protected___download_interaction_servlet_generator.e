...
class
	G_PROTECTED___DOWNLOAD_INTERACTION_SERVLET_GENERATOR
	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 9 row: 2 of file: ./protected/download_interaction.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 9 row: 2 of file: ./protected/download_interaction.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 9 row: 1 of file: ./protected/download_interaction.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 9 row: 1 of file: ./protected/download_interaction.xeb"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 3 row: 3 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 3 row: 58 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 3 row: 52 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "h1"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 3 row: 47 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Interaction Download")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
			stack.remove
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 3 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 7 row: 1 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 4 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_DISPLAY_TAG} temp.make
			temp.debug_information := "line: 6 row: 1 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 3 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 7 row: 2 of file: ./protected/download_interaction.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
