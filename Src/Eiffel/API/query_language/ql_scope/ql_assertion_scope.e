...
feature -- Access
	...
	path_domain_generator (a_item: QL_ASSERTION; a_path: READABLE_STRING_GENERAL): QL_DOMAIN_GENERATOR
			-- Domain generator for current scope
		do
	...
	empty_domain: QL_ASSERTION_DOMAIN
			-- An empty domain whose scope is assertion
		do
			create Result.make
		end

	delayed_domain: QL_DELAYED_ASSERTION_DOMAIN
