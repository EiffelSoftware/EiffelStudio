...
feature {EV_NEW_LIST_ITEM_LIST_IMP, EV_NEW_LIST_ITEM_IMP} -- Implementation

	previous_selected_item_imp: EV_NEW_LIST_ITEM_IMP
...
feature {NONE} -- Implementation
	...
	call_select_actions (selected_item_imp: EV_NEW_LIST_ITEM_IMP) is
			-- Call `select_actions'.
		do
