...
feature -- Access
	...
	Shared_file_name_factory: WIZARD_FILE_NAME_FACTORY
			-- Shared file name factory.
		once
			create Result
		end

	system_descriptor: WIZARD_SYSTEM_DESCRIPTOR
			-- System descriptor.
		do
			Result := System_descriptor_cell.item
		end

	vartype_namer: WIZARD_VARTYPE_NAMER
	...
	Generation_Successful: STRING = "Generation terminated successfully"
			-- Successful ending message

	Generation_Aborted: STRING = "Generation aborted"
			-- Successful ending message

feature {WIZARD_MANAGER} -- Element Change

	set_system_descriptor (a_descriptor: like system_descriptor)
...
feature {NONE} -- Implementation
	...
	System_descriptor_cell: CELL [WIZARD_SYSTEM_DESCRIPTOR]
