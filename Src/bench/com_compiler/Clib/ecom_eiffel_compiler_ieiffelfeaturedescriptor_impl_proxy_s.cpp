...
-----------------------------------------------------------*/
{
	...
	grt_ce_ISE.ccom_free_memory_pointed_101 (tmp_return_value);
...
-----------------------------------------------------------*/
{
	...
	tmp_file_path = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_76 (eif_access (file_path), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_76 ((BSTR *)tmp_file_path, file_path);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_line_number, line_number);
	
	grt_ce_ISE.ccom_free_memory_pointed_76 (tmp_file_path);
grt_ce_ISE.ccom_free_memory_pointed_77 (tmp_line_number);
