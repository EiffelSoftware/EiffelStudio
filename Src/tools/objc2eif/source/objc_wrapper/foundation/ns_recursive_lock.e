...
feature {NONE} -- NSRecursiveLock Externals
	...
	objc_try_lock (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSRecursiveLock *)$an_item tryLock];
			 ]"
		end
	...
	objc_lock_before_date_ (an_item: POINTER; a_limit: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSRecursiveLock *)$an_item lockBeforeDate:$a_limit];
			 ]"
		end
	...
	objc_set_name_ (an_item: POINTER; a_n: POINTER)
		...
		alias
			"[
				[(NSRecursiveLock *)$an_item setName:$a_n];
			 ]"
		end
	...
	objc_name (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSRecursiveLock *)$an_item name];
			 ]"
		end
