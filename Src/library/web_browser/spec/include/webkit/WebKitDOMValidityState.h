...
#define WEBKIT_DOM_VALIDITY_STATE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_VALIDITY_STATE, WebKitDOMValidityStateClass)
#define WEBKIT_DOM_IS_VALIDITY_STATE(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_VALIDITY_STATE))
#define WEBKIT_DOM_IS_VALIDITY_STATE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_VALIDITY_STATE))
