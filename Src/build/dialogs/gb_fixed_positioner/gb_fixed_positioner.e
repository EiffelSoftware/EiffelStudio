...
feature {NONE} -- Initialization
	...
	make_with_editor (an_editor: GB_EV_FIXED_EDITOR_CONSTRUCTOR)
		...
		do
			...
			grid_visible_control.select_actions.extend (agent draw_widgets)
			scrollable_area.resize_actions.extend (agent (x, y, w, h: INTEGER_32) do set_initial_area_size end)
			...
			grid_size_control.change_actions.extend (agent (v: INTEGER_32) do draw_widgets end)
...
feature {NONE} -- Implementation
	...
	set_item_width (widget: EV_WIDGET; a_width: INTEGER)
	...
	set_item_x_position (widget: EV_WIDGET; an_x_position: INTEGER)
	...
	set_item_height (widget: EV_WIDGET; a_height: INTEGER)
	...
	set_item_y_position (widget: EV_WIDGET; a_y_position: INTEGER)
...
feature {NONE} -- Implementation
	...
	track_movement (x, y: INTEGER; a_x_tilt, a_y_tilt, a_pressure: DOUBLE; a_screen_x, a_screen_y: INTEGER)
	...
	button_pressed (x, y, a_button: INTEGER; a_x_tilt, a_y_tilt, a_pressure: DOUBLE; a_screen_x, a_screen_y: INTEGER)
	...
	button_released (x, y, a_button: INTEGER; a_x_tilt, a_y_tilt, a_pressure: DOUBLE; a_screen_x, a_screen_y: INTEGER)
	...
	clicked_for_enlarge (a_x, a_y, a_button: INTEGER; a_x_tilt, a_y_tilt, a_pressure: DOUBLE; a_screen_x, a_screen_y: INTEGER)
...
feature {NONE} -- Scrolling attributes.
	...
	x_right, x_center: INTEGER = unique
		-- Constants used with `scrolling_x_start'.

	y_bottom, y_center: INTEGER = unique
