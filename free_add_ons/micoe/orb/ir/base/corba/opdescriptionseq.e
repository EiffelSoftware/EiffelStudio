...
feature
    ...
    get_value (index : INTEGER) : CORBA_OPERATIONDESCRIPTION is
    ...
    set_value (value : CORBA_OPERATIONDESCRIPTION; index : INTEGER) is
...
feature { NONE }
    ...
    bound : INTEGER
    store : ARRAY [CORBA_OPERATIONDESCRIPTION]
...
feature { ANY }
    ...
    type_name : STRING is
        ...
        do
            result := "OpDescriptionSeq"
        end

end -- class CORBA_OPDESCRIPTIONSEQ
