...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumClusterExcludes * *)grt_ec_ISE.ccom_ec_pointed_cell_206 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_206 ((ecom_eiffel_compiler::IEnumClusterExcludes * *)tmp_ppenum, ppenum);
