...
STDMETHODIMP ecom_control_library::ui_window::GetWindow(  /* [out] */ ecom_control_library::wireHWND * phwnd )
...
STDMETHODIMP ecom_control_library::ui_window::ContextSensitiveHelp(  /* [in] */ LONG f_enter_mode )
...
STDMETHODIMP ecom_control_library::ui_window::GetBorder(  /* [out] */ ecom_control_library::tagRECT * lprect_border )
...
STDMETHODIMP ecom_control_library::ui_window::RequestBorderSpace(  /* [in] */ ecom_control_library::tagRECT * pborderwidths )
...
STDMETHODIMP ecom_control_library::ui_window::SetBorderSpace(  /* [in] */ ecom_control_library::tagRECT * pborderwidths )
...
STDMETHODIMP ecom_control_library::ui_window::SetActiveObject(  /* [in] */ ecom_control_library::IOleInPlaceActiveObject * p_active_object, /* [in] */ LPWSTR psz_obj_name )
...
STDMETHODIMP ecom_control_library::ui_window::GetClassInfo( ITypeInfo ** ppti )
...
-----------------------------------------------------------*/
{
	...
	if (SUCCEEDED (hr))
	{
		hr = ptl->GetTypeInfoOfGuid (CLSID_ui_window_, ppti);
		ptl->Release ();
	}
	return hr;
};
...
STDMETHODIMP ecom_control_library::ui_window::GetGUID( DWORD dwKind, GUID * pguid )
