...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__UNDEFINECLAUSE_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__UNDEFINECLAUSE_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
class _UndefineClause_impl_proxy;
}
...
{
public:
	_UndefineClause_impl_proxy (IUnknown * a_pointer);
	virtual ~_UndefineClause_impl_proxy ();
