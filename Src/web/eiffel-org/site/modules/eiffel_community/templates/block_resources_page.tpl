								...
								<ul>
									<li>
										<a href="{$site_url/}resources/libraries">
											<span class="ico"><img src="{$site_url/}theme/images/ico1.png" width="52" height="52" alt="Image Description"></span>
											<h2>Libraries</h2>
									...
									<li>
										<div>
											<a href="{$site_url/}resources/wish_list"> <span class="ico"><img src="{$site_url/}theme/images/ico5.png" width="52" height="52" alt="Image Description"></span>
									...
									<li>
										<div>
											<a href="{$site_url/}resources/follow_us"> <span class="ico"><img src="{$site_url/}theme/images/ico5.png" width="52" height="52" alt="Image Description"></span>
											<h2>Follow us</h2>
