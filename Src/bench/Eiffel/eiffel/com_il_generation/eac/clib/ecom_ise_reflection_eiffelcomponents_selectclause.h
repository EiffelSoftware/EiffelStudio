...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_SELECTCLAUSE_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_SELECTCLAUSE_H__
#ifdef __cplusplus
extern "C" {
...
public:
	SelectClause ();
	SelectClause (IUnknown * a_pointer);
	virtual ~SelectClause ();
