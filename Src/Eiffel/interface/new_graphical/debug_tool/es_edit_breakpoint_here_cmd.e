...
feature {NONE} -- Initialization
	...
	make (a_develop_window: EB_DEVELOPMENT_WINDOW)
			-- Creation method
		do
			make_window_command (a_develop_window)
			enable_sensitive
	...
	init_accelerator
		...
		do
			create l_preference
			l_shortcut := l_preference.preferences.debug_tool_data.edit_bp_here_shortcut_preference
...
feature -- Query
	...
	menu_name: STRING_GENERAL
			-- Menu name
		do
			Result := interface_names.m_Edit_breakpoint_here
		end
