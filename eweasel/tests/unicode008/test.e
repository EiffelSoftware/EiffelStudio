...
feature -- Make
	...
	make
		do
			...
			report ((–脣 Current).to_character_32, 0x8123, 05)	-- E8 84 A3:	E1..EC	80..BF	80..BF
			...
			report ((–🀙 Current).to_character_32, 0x1F019, 08)	-- F0 9F 80 99:	F0	90..BF	80..BF	80..BF
...
feature {TEST} -- Tests: operators
	...
	operator_05 alias "–脣": NATURAL_32	-- E8 84 A3:	E1..EC	80..BF	80..BF
		do
			Result := 0x8123
		end
	...
	operator_08 alias "–🀙": NATURAL_32	-- F0 9F 80 99:	F0	90..BF	80..BF	80..BF
		do
			Result := 0x1F019
		end
