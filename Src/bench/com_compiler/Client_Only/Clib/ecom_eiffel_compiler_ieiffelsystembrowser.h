...
#define __ECOM_EIFFEL_COMPILER_IEIFFELSYSTEMBROWSER_H__
#ifdef __cplusplus
extern "C" {
...
public:
	...
	-----------------------------------------------------------*/
	virtual STDMETHODIMP external_clusters(  /* [out, retval] */ ecom_eiffel_compiler::IEnumCluster * * some_clusters ) = 0;
