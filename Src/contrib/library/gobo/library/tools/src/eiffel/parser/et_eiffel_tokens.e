...
feature -- Last values
	...
	last_detachable_et_bit_constant_value: detachable ET_BIT_CONSTANT
...
feature -- Token codes
	...
	E_STRPARENTHESIS: INTEGER = 358
	E_STRIMPLIES: INTEGER = 359
	E_STRFREEOP: INTEGER = 360
	E_STRNOT: INTEGER = 361
	E_STRING: INTEGER = 362
	E_REAL: INTEGER = 363
	E_RESULT: INTEGER = 364
	E_RETRY: INTEGER = 365
	E_DIV: INTEGER = 366
	E_GE: INTEGER = 367
	E_LE: INTEGER = 368
	E_MOD: INTEGER = 369
	E_VOID: INTEGER = 370
	E_CHARERR: INTEGER = 371
	E_STRERR: INTEGER = 372
	E_INTERR: INTEGER = 373
	E_OLD: INTEGER = 374
	E_NE: INTEGER = 375
