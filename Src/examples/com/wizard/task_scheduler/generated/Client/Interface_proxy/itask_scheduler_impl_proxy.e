...
feature {NONE}  -- Initialization
	...
	make_from_pointer (a_object: POINTER)
			-- Make from pointer
		do
			initializer := ccom_create_itask_scheduler_impl_proxy_from_pointer(a_object)
...
feature {NONE}  -- Implementation
	...
	delete_wrapper
			-- Delete wrapper
		do
			ccom_delete_itask_scheduler_impl_proxy(initializer)
		end
...
feature {NONE}  -- Externals
	...
	ccom_set_target_computer (a_object: POINTER; pwsz_computer: STRING)
			-- Selects the computer that the ITaskScheduler interface operates on.
		external
			"C++ [ecom_MS_TaskSched_lib::ITaskScheduler_impl_proxy %"ecom_MS_TaskSched_lib_ITaskScheduler_impl_proxy.h%"](EIF_OBJECT)"
		end
	...
	ccom_activate (a_object: POINTER; pwsz_name: STRING; a_riid: POINTER; pp_unk: CELL [ECOM_INTERFACE])
			-- Returns an active interface to the specified task.
		external
			"C++ [ecom_MS_TaskSched_lib::ITaskScheduler_impl_proxy %"ecom_MS_TaskSched_lib_ITaskScheduler_impl_proxy.h%"](EIF_OBJECT,GUID *,EIF_OBJECT)"
		end
	...
	ccom_new_work_item (a_object: POINTER; pwsz_task_name: STRING; rclsid: POINTER; a_riid: POINTER; pp_unk: CELL [ECOM_INTERFACE])
			-- Allocates space for a new task and retrieves its address.
		external
			"C++ [ecom_MS_TaskSched_lib::ITaskScheduler_impl_proxy %"ecom_MS_TaskSched_lib_ITaskScheduler_impl_proxy.h%"](EIF_OBJECT,GUID *,GUID *,EIF_OBJECT)"
		end

	ccom_add_work_item (a_object: POINTER; pwsz_task_name: STRING; p_work_item: POINTER)
			-- Adds a task to the schedule of tasks.
		external
			"C++ [ecom_MS_TaskSched_lib::ITaskScheduler_impl_proxy %"ecom_MS_TaskSched_lib_ITaskScheduler_impl_proxy.h%"](EIF_OBJECT,ecom_MS_TaskSched_lib::IScheduledWorkItem *)"
		end

	ccom_is_of_type (a_object: POINTER; pwsz_name: STRING; a_riid: POINTER)
			-- Checks the object type.
		external
			"C++ [ecom_MS_TaskSched_lib::ITaskScheduler_impl_proxy %"ecom_MS_TaskSched_lib_ITaskScheduler_impl_proxy.h%"](EIF_OBJECT,GUID *)"
		end

	ccom_delete_itask_scheduler_impl_proxy (a_pointer: POINTER)
			-- Release resource
		external
			"C++ [delete ecom_MS_TaskSched_lib::ITaskScheduler_impl_proxy %"ecom_MS_TaskSched_lib_ITaskScheduler_impl_proxy.h%"]()"
		end

	ccom_create_itask_scheduler_impl_proxy_from_pointer (a_pointer: POINTER): POINTER
			-- Create from pointer
		external
			"C++ [new ecom_MS_TaskSched_lib::ITaskScheduler_impl_proxy %"ecom_MS_TaskSched_lib_ITaskScheduler_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (a_object: POINTER): POINTER
			-- Item
		external
			"C++ [ecom_MS_TaskSched_lib::ITaskScheduler_impl_proxy %"ecom_MS_TaskSched_lib_ITaskScheduler_impl_proxy.h%"](): EIF_POINTER"
		end

end -- ITASK_SCHEDULER_IMPL_PROXY
