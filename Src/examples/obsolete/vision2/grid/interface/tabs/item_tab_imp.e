...
feature {NONE} -- Implementation
	...
	pixmap_holder_item_selected
			-- Called by `select_actions' of `pixmap_holder'.
		deferred
		end
	
	left_border_spin_button_changed (a_value: INTEGER)
			-- Called by `change_actions' of `left_border_spin_button'.
		deferred
		end
	
	spacing_spin_button_changed (a_value: INTEGER)
			-- Called by `change_actions' of `spacing_spin_button'.
		deferred
		end
	
	left_alignment_item_selected
	...
	apply_pixmap_row_button_selected
	...
	apply_background_row_button_selected
	...
	top_border_spin_button_changed (a_value: INTEGER)
	...
	apply_bottom_border_row_button_selected
