...
feature -- Access
	...
	arguments: LINKED_LIST [ECD_PARAMETER_DECLARATION_EXPRESSION]
			-- Routine arguments

	locals: LINKED_LIST [ECD_VARIABLE_DECLARATION_STATEMENT]
			-- Routine local variables

	statements: LINKED_LIST [ECD_STATEMENT]
			-- Routine statements
...
feature -- Status Report
	...
	ready: BOOLEAN is
		...
		do
			Result := Precursor {ECD_FEATURE} and arguments /= Void and locals /= Void and statements /= Void
		end
...
feature -- Basic Operations
	...
	add_argument (an_argument: ECD_PARAMETER_DECLARATION_EXPRESSION) is
	...
	add_local (a_local_variable: ECD_VARIABLE_DECLARATION_STATEMENT) is
	...
	add_statement (a_statement: ECD_STATEMENT) is
...
feature {NONE} -- Implementation
	...
	body: STRING is
		...
		local
			...
			l_decl: ECD_VARIABLE_DECLARATION_STATEMENT
		do
...
end -- class ECD_ROUTINE_INTEFACE
