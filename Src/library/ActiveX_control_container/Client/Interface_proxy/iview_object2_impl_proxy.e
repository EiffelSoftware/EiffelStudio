...
feature {NONE}  -- Externals
	...
	ccom_draw (cpp_obj: POINTER; dw_draw_aspect: INTEGER; lindex: INTEGER; pv_aspect: INTEGER; ptd: POINTER; hdc_target_dev: INTEGER; hdc_draw: INTEGER; lprc_bounds: POINTER; lprc_wbounds: POINTER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_INTEGER,EIF_INTEGER,EIF_INTEGER,ecom_control_library::tagDVTARGETDEVICE *,EIF_INTEGER,EIF_INTEGER,ecom_control_library::_RECTL *,ecom_control_library::_RECTL *)"
		end
	...
	ccom_set_advise (cpp_obj: POINTER; aspects: INTEGER; advf: INTEGER; p_adv_sink: POINTER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_INTEGER,EIF_INTEGER,::IAdviseSink *)"
		end
