...
feature {COMPILER_EXPORTER} -- Implementation
	...
	check_universe is
		...
		do
			...
			l_actions.put (agent system.set_character_class (?, False), "CHARACTER_8")
			l_actions.put (agent system.set_character_class (?, True), "CHARACTER_32")
			...
			l_actions.put (agent system.set_real_32_class, "REAL_32")
			l_actions.put (agent system.set_real_64_class, "REAL_64")
			l_actions.put (agent system.set_pointer_class, "POINTER")
			l_actions.put (agent system.set_typed_pointer_class, "TYPED_POINTER")
			l_actions.put (agent system.set_string_class, "STRING_8")
			...
			l_actions.put (agent system.set_character_ref_class (?, False), "CHARACTER_8_REF")
			l_actions.put (agent system.set_character_ref_class (?, True), "CHARACTER_32_REF")
			...
			l_actions.put (agent system.set_real_32_ref_class, "REAL_32_REF")
			l_actions.put (agent system.set_real_64_ref_class, "REAL_64_REF")
