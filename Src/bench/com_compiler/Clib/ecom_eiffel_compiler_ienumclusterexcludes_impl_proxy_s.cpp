...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumClusterExcludes * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_148 (eif_access (ppenum), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_148 ((ecom_eiffel_compiler::IEnumClusterExcludes * *)tmp_ppenum, ppenum);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_148 (tmp_ppenum);
