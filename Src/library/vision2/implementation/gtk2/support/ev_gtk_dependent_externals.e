...
feature -- Externals
	...
	gtk_text_buffer_insert_at_cursor (a_text_buffer: POINTER; a_string: POINTER; a_length: INTEGER) is
		external
			"C signature (GtkTextBuffer*, gchar *, gint) use <gtk/gtk.h>"
		end
		
	gtk_text_buffer_insert (a_text_buffer: POINTER; a_text_iter: POINTER; a_string: POINTER; a_length: INTEGER) is
		external
	...
	gtk_text_buffer_get_selection_bounds (a_text_buffer: POINTER; a_start_iter: POINTER; a_end_iter: POINTER): BOOLEAN is
		external
			"C signature (GtkTextBuffer*, GtkTextIter*, GtkTextIter*): gboolean use <gtk/gtk.h>"
		end
		
	gtk_text_buffer_get_selection_bound (a_text_buffer: POINTER): POINTER is
		external
			"C signature (GtkTextBuffer*): GtkTextMark* use <gtk/gtk.h>"
		end
		
	gtk_text_buffer_get_insert (a_text_buffer: POINTER): POINTER is
		external
			"C signature (GtkTextBuffer*): GtkTextMark* use <gtk/gtk.h>"
		end
		
	gtk_text_buffer_move_mark (a_text_buffer: POINTER; a_text_mark: POINTER; a_text_iter: POINTER) is
		external
	...
	gtk_text_buffer_get_iter_at_line (a_text_buffer: POINTER; a_text_iter: POINTER; a_line_number: INTEGER) is
		external
			"C signature (GtkTextBuffer*, GtkTextIter*, gint) use <gtk/gtk.h>"
		end
		
	gtk_text_buffer_get_iter_at_mark (a_text_buffer: POINTER; a_text_iter: POINTER; a_text_mark: POINTER) is
		external
			"C signature (GtkTextBuffer*, GtkTextIter*, GtkTextMark*) use <gtk/gtk.h>"
		end
		
	gtk_text_buffer_get_iter_at_offset (a_text_buffer: POINTER; a_text_iter: POINTER; a_char_offset: INTEGER) is
		external
			"C signature (GtkTextBuffer*, GtkTextIter*, gint) use <gtk/gtk.h>"
		end
		
	gtk_text_buffer_delete_selection (a_text_buffer: POINTER; a_interactive: BOOLEAN; a_default_editable: BOOLEAN) is
		external
	...
	gtk_text_view_forward_display_line (a_text_view: POINTER; a_text_iter: POINTER): BOOLEAN is
		external
			"C signature (GtkTextView*, GtkTextIter*): gboolean use <gtk/gtk.h>"
		end
		
	gtk_text_view_forward_display_line_end (a_text_view: POINTER; a_text_iter: POINTER): BOOLEAN is
		external
			"C signature (GtkTextView*, GtkTextIter*): gboolean use <gtk/gtk.h>"
		end
	...
	gtk_image_set_from_pixmap (a_image: POINTER; a_pixmap: POINTER; a_mask: POINTER) is
		external
