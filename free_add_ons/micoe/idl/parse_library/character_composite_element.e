...
deferred class CHARACTER_COMPOSITE_ELEMENT
...
------------------------------------------------------
    ...
    add_component (elemnt : CHARACTER) is
...
------------------------------------------------------
    ...
    component_at (index : INTEGER) : CHARACTER is
...
------------------------------------------------------
feature { CHARACTER_COMPOSITE_ELEMENT }

    components : INDEXED_LIST [CHARACTER]

end -- class CHARACTER_COMPOSITE_ELEMENT
