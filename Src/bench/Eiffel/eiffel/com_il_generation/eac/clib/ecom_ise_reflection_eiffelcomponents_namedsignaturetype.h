...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_NAMEDSIGNATURETYPE_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_NAMEDSIGNATURETYPE_H__
#ifdef __cplusplus
extern "C" {
...
public:
	NamedSignatureType ();
	NamedSignatureType (IUnknown * a_pointer);
	virtual ~NamedSignatureType ();
