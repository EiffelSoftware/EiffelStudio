...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelParameterDescriptor * *)grt_ec_ISE.ccom_ec_pointed_cell_122 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_122 ((ecom_eiffel_compiler::IEiffelParameterDescriptor * *)tmp_rgelt, rgelt);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumParameter * *)grt_ec_ISE.ccom_ec_pointed_cell_95 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_95 ((ecom_eiffel_compiler::IEnumParameter * *)tmp_ppenum, ppenum);
