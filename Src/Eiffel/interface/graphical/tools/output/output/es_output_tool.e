indexing
	description: "[
		Tool descriptor for EiffelStudio's output tool.
	]"
...
feature -- Access
	...
	title: STRING_32
		...
		do
			Result := interface_names.to_output_tool
		end
	...
	shortcut_preference_name: STRING_32
		...
		do
			Result := "show_output_tool"
		end

feature {NONE} -- Factory

	create_tool: ES_OUTPUT_TOOL_PANEL
