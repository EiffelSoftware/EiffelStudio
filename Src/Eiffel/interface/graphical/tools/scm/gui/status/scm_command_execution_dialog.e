note
	description: "Summary description for {SCM_COMMAND_EXECUTION_DIALOG}."
	date: "$Date$"
	revision: "$Revision$"

class
	SCM_COMMAND_EXECUTION_DIALOG
...
feature {NONE} -- Initialization
	...
	make (a_service: SOURCE_CONTROL_MANAGEMENT_S; a_command: READABLE_STRING_GENERAL; a_output: READABLE_STRING_GENERAL)
		do
...
feature -- Access
	...
	output: READABLE_STRING_GENERAL
...
feature -- Access
	...
	title: STRING_32
			-- <Precursor>
		do
			Result := scm_names.title_scm_command_execution (command_name)
		end
