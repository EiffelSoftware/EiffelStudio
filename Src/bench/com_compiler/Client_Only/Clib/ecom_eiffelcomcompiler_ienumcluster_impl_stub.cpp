...
#include "ecom_EiffelComCompiler_IEnumCluster_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ieiffel_cluster_descriptor = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_50 (pp_ieiffel_cluster_descriptor, NULL));
		if (*pp_ieiffel_cluster_descriptor != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_50 (((tmp_pp_ieiffel_cluster_descriptor != NULL) ? eif_wean (tmp_pp_ieiffel_cluster_descriptor) : NULL), pp_ieiffel_cluster_descriptor);
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ienum_cluster = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_43 (pp_ienum_cluster, NULL));
		if (*pp_ienum_cluster != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_43 (((tmp_pp_ienum_cluster != NULL) ? eif_wean (tmp_pp_ienum_cluster) : NULL), pp_ienum_cluster);
