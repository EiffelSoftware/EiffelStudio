...
feature -- Test routines
	...
	test_fadd_operator_1
		...
		do
			...
			m.print (s)
			s_result := s.string
			assert ("test_fadd_operator_1", s_result ~ test_fadd_operator_1_expected)
		end

	test_fadd_operator_1_expected: STRING_8 =
"[
; ModuleID = 'test'

define i32 @main() {
  %1 = fadd double 4.700000e+00, 8.700000e+00
}
