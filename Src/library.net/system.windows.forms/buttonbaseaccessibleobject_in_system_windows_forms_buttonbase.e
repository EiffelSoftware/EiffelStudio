indexing
	...
	external_name: "System.Windows.Forms.ButtonBase+ButtonBaseAccessibleObject"

external class
	BUTTONBASEACCESSIBLEOBJECT_IN_SYSTEM_WINDOWS_FORMS_BUTTONBASE
...
create
	make_buttonbaseaccessibleobject

feature {NONE} -- Initialization

	frozen make_buttonbaseaccessibleobject (owner: SYSTEM_WINDOWS_FORMS_CONTROL) is
		external
			"IL creator signature (System.Windows.Forms.Control) use System.Windows.Forms.ButtonBase+ButtonBaseAccessibleObject"
		end
...
feature -- Basic Operations
	...
	do_default_action is
		external
			"IL signature (): System.Void use System.Windows.Forms.ButtonBase+ButtonBaseAccessibleObject"
		alias
			"DoDefaultAction"
		end

end -- class BUTTONBASEACCESSIBLEOBJECT_IN_SYSTEM_WINDOWS_FORMS_BUTTONBASE
