indexing
	description: "Objects that represent the feature style that only show full name and arguments"
...
class
	EB_NAME_SIGNATURE_FEATURE_STYLE
	...
	text (a_item: EB_GRID_FEATURE_ITEM): LIST [EDITOR_TOKEN] is
		...
		do
			...
			if a_item.associated_feature.is_real_feature then
				...
				a_item.associated_feature.e_feature.append_arguments (token_writer)
			else
