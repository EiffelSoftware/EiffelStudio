...
feature {CODE_CONSUMER_FACTORY} -- Visitor features.
	...
	generate_delegate_create_expression (a_source: SYSTEM_DLL_CODE_DELEGATE_CREATE_EXPRESSION) is
		...
		local
			a_delegate_create_expression: CODE_DELEGATE_CREATE_EXPRESSION
		do
	...
	generate_delegate_invoke_expression (a_source: SYSTEM_DLL_CODE_DELEGATE_INVOKE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_delegate_invoke_expression: CODE_DELEGATE_INVOKE_EXPRESSION
		do
...
feature {NONE} -- Implementation
	...
	initialize_delegate_create_expression (a_source: SYSTEM_DLL_CODE_DELEGATE_CREATE_EXPRESSION; a_delegate_create_expression: CODE_DELEGATE_CREATE_EXPRESSION) is
	...
	initialize_delegate_invoke_expression (a_source: SYSTEM_DLL_CODE_DELEGATE_INVOKE_EXPRESSION; a_delegate_invoke_expression: CODE_DELEGATE_INVOKE_EXPRESSION) is
			-- | Call `generate_expression_from_dom' to generate `target_object'.
	...
	generate_delegate_arguments (a_source: SYSTEM_DLL_CODE_DELEGATE_INVOKE_EXPRESSION; delegate_invoke_expression: CODE_DELEGATE_INVOKE_EXPRESSION) is
		...
		do
			...
			if l_arguments /= Void then
				...
				Event_manager.raise_event (feature {CODE_EVENTS_IDS}.Missing_parameters, ["delegate invoke expression"])
			end
		end
