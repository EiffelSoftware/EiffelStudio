...
feature -- Element change
	...
	precede, prepend_character (c: CHARACTER)
			-- Add `c' at front.
		do
	...
	append_character, extend (c: CHARACTER)
			-- Append `c' at end.
		local
			current_count: INTEGER
		do
...
feature {STRING} -- Implementation
	...
	str_cprepend (c_string: POINTER; c: CHARACTER; length: INTEGER)
	...
	str_rmall (c_string: POINTER; c: CHARACTER; length: INTEGER): INTEGER
