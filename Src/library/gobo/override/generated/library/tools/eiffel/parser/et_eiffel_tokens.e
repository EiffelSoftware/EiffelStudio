...
feature -- Token codes
	...
	E_RECAST: INTEGER = 311
	E_ASSIGN: INTEGER = 312
	E_ACROSS: INTEGER = 313
	E_SOME: INTEGER = 314
	E_AGENT: INTEGER = 315
	E_PRECURSOR: INTEGER = 316
	E_ARROW: INTEGER = 317
	E_DOTDOT: INTEGER = 318
	E_LARRAY: INTEGER = 319
	E_RARRAY: INTEGER = 320
	E_ASSIGN_SYMBOL: INTEGER = 321
	E_REVERSE: INTEGER = 322
	E_UNKNOWN: INTEGER = 323
	E_BIT: INTEGER = 324
	E_FALSE: INTEGER = 325
	E_TRUE: INTEGER = 326
	E_BREAK: INTEGER = 327
	E_CHARACTER: INTEGER = 328
	E_CURRENT: INTEGER = 329
	E_FREEOP: INTEGER = 330
	E_IDENTIFIER: INTEGER = 331
	E_BITTYPE: INTEGER = 332
	E_TUPLE: INTEGER = 333
	E_INTEGER: INTEGER = 334
	E_AND: INTEGER = 335
	E_OR: INTEGER = 336
	E_XOR: INTEGER = 337
	E_NOT: INTEGER = 338
	E_IMPLIES: INTEGER = 339
	E_STRPLUS: INTEGER = 340
	E_STRMINUS: INTEGER = 341
	E_STRSTAR: INTEGER = 342
	E_STRSLASH: INTEGER = 343
	E_STRDIV: INTEGER = 344
	E_STRMOD: INTEGER = 345
	E_STRPOWER: INTEGER = 346
	E_STRLT: INTEGER = 347
	E_STRLE: INTEGER = 348
	E_STRGT: INTEGER = 349
	E_STRGE: INTEGER = 350
	E_STRAND: INTEGER = 351
	E_STROR: INTEGER = 352
	E_STRXOR: INTEGER = 353
	E_STRANDTHEN: INTEGER = 354
	E_STRORELSE: INTEGER = 355
	E_STRDOTDOT: INTEGER = 356
	E_STRBRACKET: INTEGER = 357
	E_STRIMPLIES: INTEGER = 358
	E_STRFREEOP: INTEGER = 359
	E_STRNOT: INTEGER = 360
	E_STRING: INTEGER = 361
	E_REAL: INTEGER = 362
	E_RESULT: INTEGER = 363
	E_RETRY: INTEGER = 364
	E_DIV: INTEGER = 365
	E_GE: INTEGER = 366
	E_LE: INTEGER = 367
	E_MOD: INTEGER = 368
	E_VOID: INTEGER = 369
	E_CHARERR: INTEGER = 370
	E_STRERR: INTEGER = 371
	E_INTERR: INTEGER = 372
	E_OLD: INTEGER = 373
	E_NE: INTEGER = 374
	E_NOT_TILDE: INTEGER = 375
