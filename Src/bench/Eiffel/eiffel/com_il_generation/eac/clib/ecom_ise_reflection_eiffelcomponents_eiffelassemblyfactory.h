...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_EIFFELASSEMBLYFACTORY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_EIFFELASSEMBLYFACTORY_H__
#ifdef __cplusplus
extern "C" {
...
public:
	...
	EiffelAssemblyFactory (IUnknown * a_pointer);
	virtual ~EiffelAssemblyFactory ();
