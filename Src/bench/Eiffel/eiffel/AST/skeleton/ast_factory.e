...
feature -- Access
	...
	new_class_type_as (n: ID_AS; g: EIFFEL_LIST [TYPE]; is_ref, is_exp, is_sep: BOOLEAN): CLASS_TYPE_AS is
	...
	new_type_dec_as (i: ARRAYED_LIST [INTEGER]; t: TYPE; l: TOKEN_LOCATION): TYPE_DEC_AS is
