...
feature {DS_BINARY_SEARCH_TREE_CONTAINER} -- Status report
	...
	is_node_in_tree (a_node: DS_BINARY_SEARCH_TREE_CONTAINER_NODE [G, K]): BOOLEAN
	...
	are_nodes_in_same_tree (a_node_1, a_node_2: DS_BINARY_SEARCH_TREE_CONTAINER_NODE [G, K]): BOOLEAN
...
feature {DS_BINARY_SEARCH_TREE_CONTAINER} -- Cursor implementation
	...
	predecessor_for_cursor (v: DS_BINARY_SEARCH_TREE_CONTAINER_NODE [G, K]): DS_BINARY_SEARCH_TREE_CONTAINER_NODE [G, K]
			-- Predecessor of `v' if it exists, Void otherwise
			-- (Performance: O(height).)
		require
			v_not_void: v /= Void
	...
	successor_for_cursor (v: DS_BINARY_SEARCH_TREE_CONTAINER_NODE [G, K]): DS_BINARY_SEARCH_TREE_CONTAINER_NODE [G, K]
			-- Successor of `v' if it exists, Void otherwise
			-- (Performance: O(height).)
		require
			v_not_void: v /= Void
