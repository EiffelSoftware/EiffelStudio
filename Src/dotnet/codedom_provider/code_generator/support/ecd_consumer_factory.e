...
feature {ECD_CODE_GENERATOR, ECD_FACTORY} -- Basic Operations
	...
	generate_type_reference_from_dom (a_type_reference: SYSTEM_DLL_CODE_TYPE_REFERENCE) is
		...
		do
				-- Create `code_dom_source'.
			(create {ECD_TYPE_REFERENCE_FACTORY}).generate_type_reference (a_type_reference)
	...
	generate_custom_attribute_declaration (an_argument: SYSTEM_DLL_CODE_ATTRIBUTE_DECLARATION) is
		...
		do
				-- Create `code_dom_source'.
			(create {ECD_CUSTOM_ATTRIBUTE_FACTORY}).initialize_custom_attribute_declaration (an_argument)
		end
	...
	generate_custom_attribute_argument (an_argument: SYSTEM_DLL_CODE_ATTRIBUTE_ARGUMENT) is
		...
		do
				-- Create `code_dom_source'.
			(create {ECD_CUSTOM_ATTRIBUTE_FACTORY}).initialize_custom_attribute_argument (an_argument)
		end
...
feature {NONE} -- Implementation
	...
	generate_code_dom_compile_unit (a_compile_unit: SYSTEM_DLL_CODE_COMPILE_UNIT) is
		...
		do	
			...
			if snippet_compile_unit /= Void then 
				(create {ECD_EIFFEL_FACTORY}).generate_snippet_compile_unit (snippet_compile_unit)
			else
				(create {ECD_EIFFEL_FACTORY}).generate_compile_unit (a_compile_unit)
			end
		end
	...
	generate_code_dom_namespace (a_namespace: SYSTEM_DLL_CODE_NAMESPACE) is
		...
		require
			non_void_namespace: a_namespace /= Void
		do	
			(create {ECD_EIFFEL_FACTORY}).generate_namespace (a_namespace)
		end
	...
	generate_code_dom_member (a_member: SYSTEM_DLL_CODE_TYPE_MEMBER) is
		...
		do
			...
			if snippet_type_member /= Void then
				(create {ECD_MEMBER_FACTORY}).generate_snippet_feature (snippet_type_member)
			else
				event ?= a_member
				if event /= Void then
					(create {ECD_MEMBER_FACTORY}).generate_event (event)
				else
					field ?= a_member
					if field /= Void then
						(create {ECD_MEMBER_FACTORY}).generate_attribute (field)
					else
						property ?= a_member
						if property /= Void then
							(create {ECD_ROUTINE_FACTORY}).generate_property (property)
						else
							constructor ?= a_member
							if constructor /= Void then
								(create {ECD_ROUTINE_FACTORY}).generate_creation_routine (constructor)
							else
								entry_point_method ?= a_member
								if entry_point_method /= Void then
									(create {ECD_ROUTINE_FACTORY}).generate_root_procedure (entry_point_method)
								else
									method ?= a_member
									if method /= Void then
										(create {ECD_ROUTINE_FACTORY}).generate_routine (method)
									else
										delegate ?= a_member
										if delegate /= Void then
											Event_manager.raise_event (feature {ECD_EVENTS_IDS}.Not_implemented, ["delegate type generation"])
										--	(create {ECD_TYPE_FACTORY}).generate_delegate (delegate)
											...
											type ?= a_member
											if type /= Void then
												(create {ECD_TYPE_FACTORY}).generate_type (type)
											end
										end
									end
								end
	...
	generate_code_dom_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		local
			...
			l_agent: PROCEDURE [ECD_CONSUMER_FACTORY, TUPLE [SYSTEM_DLL_CODE_STATEMENT]]
		do
	...
	generate_code_dom_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		local
			l_exp_type: TYPE
			l_agent: PROCEDURE [ECD_CONSUMER_FACTORY, TUPLE [SYSTEM_DLL_CODE_EXPRESSION]]
		do
...
feature {NONE} -- Statements agents.
	...
	generate_assign_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_STATEMENT_FACTORY}).generate_assign_statement (assign_statement)
		end
	...
	generate_attach_event_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_EVENT_STATEMENT_FACTORY}).generate_attach_event_statement (attach_event_statement)
		end
	...
	generate_comment_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_STATEMENT_FACTORY}).generate_comment_statement (comment_statement)
		end
	...
	generate_condition_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_STATEMENT_FACTORY}).generate_condition_statement (condition_statement)
		end
	...
	generate_expression_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_STATEMENT_FACTORY}).generate_expression_statement (expression_statement)
		end
	...
	generate_iteration_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_STATEMENT_FACTORY}).generate_iteration_statement (iteration_statement)
		end
	...
	generate_method_return_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_STATEMENT_FACTORY}).generate_routine_return_statement (method_return_statement)
		end
	...
	generate_remove_event_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_EVENT_STATEMENT_FACTORY}).generate_remove_event_statement (remove_event_statement)
		end
	...
	generate_snippet_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_STATEMENT_FACTORY}).generate_snippet_statement (snippet_statement)
		end
	...
	generate_try_catch_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_EXCEPTION_STATEMENT_FACTORY}).generate_try_catch_finally_statement (try_catch_statement)
		end
	...
	generate_variable_declaration_statement (a_statement: SYSTEM_DLL_CODE_STATEMENT) is
		...
		do
			...
			(create {ECD_STATEMENT_FACTORY}).generate_variable_declaration_statement (variable_declaration_statement)
		end
...
feature {NONE} -- Expression agents.
	...
	generate_argument_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_ARGUMENT_EXPRESSION_FACTORY}).generate_argument_reference_expression (argument_reference_expression)
		end
	...
	generate_array_create_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_ARRAY_EXPRESSION_FACTORY}).generate_array_create_expression (array_create_expression)
		end
	...
	generate_array_indexer_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_ARRAY_EXPRESSION_FACTORY}).generate_array_indexer_expression (array_indexer_expression)
		end
	...
	generate_base_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_PROPERTY_EXPRESSION_FACTORY}).generate_base_reference_expression (base_reference_expression)
		end
	...
	generate_binary_operator_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_binary_operator_expression (binary_operator_expression)
		end
	...
	generate_cast_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_cast_expression (cast_expression)
		end
	...
	generate_delegate_create_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_DELEGATE_EXPRESSION_FACTORY}).generate_delegate_create_expression (delegate_create_expression)
		end
	...
	generate_delegate_invoke_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_DELEGATE_EXPRESSION_FACTORY}).generate_delegate_invoke_expression (delegate_invoke_expression)
		end
	...
	generate_event_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_event_reference_expression (event_reference_expression)
		end
	...
	generate_field_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_attribute_reference_expression (field_reference_expression)
		end
	...
	generate_indexer_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_indexer_expression (indexer_expression)
		end
	...
	generate_method_invoke_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_ROUTINE_EXPRESSION_FACTORY}).generate_routine_invoke_expression (method_invoke_expression)
		end
	...
	generate_method_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_ROUTINE_EXPRESSION_FACTORY}).generate_routine_reference_expression (method_reference_expression)
		end
	...
	generate_object_create_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_object_create_expression (object_create_expression)
		end
	...
	generate_parameter_declaration_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_ARGUMENT_EXPRESSION_FACTORY}).generate_parameter_declaration_expression (parameter_declaration_expression)
		end
	...
	generate_primitive_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_primitive_expression (primitive_expression)
		end
	...
	generate_property_set_value_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_PROPERTY_EXPRESSION_FACTORY}).generate_property_set_value_reference_expression (property_set_value_reference_expression)
		end
	...
	generate_snippet_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_snippet_expression (snippet_expression)
		end
	...
	generate_this_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_this_reference_expression (this_reference_expression)
		end
	...
	generate_type_of_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_type_of_expression (type_of_expression)
		end
	...
	generate_type_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_type_reference_expression (type_reference_expression)
		end
	...
	generate_variable_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_EXPRESSION_FACTORY}).generate_variable_reference_expression (variable_reference_expression)
		end
	...
	generate_property_reference_expression (an_expression: SYSTEM_DLL_CODE_EXPRESSION) is
		...
		do
			...
			(create {ECD_PROPERTY_EXPRESSION_FACTORY}).generate_property_reference_expression (property_reference_expression)
		end

end -- class ECD_CONSUMER_FACTORY
