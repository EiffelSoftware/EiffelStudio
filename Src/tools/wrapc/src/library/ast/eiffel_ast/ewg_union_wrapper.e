...
feature {NONE} -- Initialization
	...
	make (a_mapped_eiffel_name: STRING; a_header_file_name: STRING;
			a_c_union_type: EWG_C_AST_UNION_TYPE; a_members: like members)
		require
			...
			a_c_union_type_not_void: a_c_union_type /= Void
			a_members_not_void: a_members /= Void
		do
			make_composite_data_wrapper (a_mapped_eiffel_name, a_header_file_name, a_c_union_type, a_members)
		ensure
			mapped_eiffel_name_set: mapped_eiffel_name = a_mapped_eiffel_name
			header_file_name_set: header_file_name = a_header_file_name
			c_union_type_set: c_union_type = a_c_union_type
			c_composite_data_type_set: c_composite_data_type = a_c_union_type
