...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumObjectFiles * *)grt_ec_ISE.ccom_ec_pointed_cell_218 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_218 ((ecom_eiffel_compiler::IEnumObjectFiles * *)tmp_ppenum, ppenum);
