...
feature -- Statics
	...
	frozen from_string (s: SYSTEM_STRING): INTEGER
			-- (Static)
	...
	frozen from_string_with_style (s: SYSTEM_STRING; style: NUMBER_STYLES): INTEGER
			-- (Static)
	...
	frozen from_string_with_format (s: SYSTEM_STRING; provider: IFORMAT_PROVIDER): INTEGER
			-- (Static)
	...
	frozen from_string_with_style_and_format (s: SYSTEM_STRING; style: NUMBER_STYLES; provider: IFORMAT_PROVIDER): INTEGER
			-- (Static)
			-- Converts the string representation of a number in a specified style
