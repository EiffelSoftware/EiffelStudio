...
This is a Win32 C function to embed a Internal Explorer object (actually, an OLE object) in your own window (in order to 
...
static const CHAR	ClassName[] = "Eiffel Browser"; 
...
long EmbedBrowserObject(HWND hwnd)
{
	...
	pClassFactory = 0;
	l_result = CoGetClassObject(&CLSID_WebBrowser, CLSCTX_INPROC_SERVER | CLSCTX_INPROC_HANDLER, NULL, &IID_IClassFactory, (void **)&pClassFactory); 
	
	if (!l_result && pClassFactory)
	{
