indexing
	description: "Object that represents a full signature style for feature item in class browser"
...
class
	EB_GRID_JUST_NAME_FEATURE_STYLE

inherit
	EB_GRID_FEATURE_ITEM_STYLE
		redefine
			is_full_signature_style
		end
...
feature -- Style type
	...
	is_full_signature_style: BOOLEAN is True
...
feature -- Access
	...
	text (a_item: EB_GRID_FEATURE_ITEM): LIST [EDITOR_TOKEN] is
		...
		do
			...
			if a_item.associated_feature.is_real_feature then
				a_item.associated_feature.e_feature.append_name (token_writer)
			else
