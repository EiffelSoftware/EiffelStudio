...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClassDescriptor * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_35 (eif_access (rgelt), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_35 ((ecom_eiffel_compiler::IEiffelClassDescriptor * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_35 (tmp_rgelt);
grt_ce_Eif_compiler.ccom_free_memory_pointed_42 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumEiffelClass * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_24 (eif_access (ppenum), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_24 ((ecom_eiffel_compiler::IEnumEiffelClass * *)tmp_ppenum, ppenum);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_24 (tmp_ppenum);
