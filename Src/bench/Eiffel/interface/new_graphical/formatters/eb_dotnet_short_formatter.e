indexing
	description: "Formatter to display the XML text a class with no analysis, short."
	author: "Xavier Rousselot"
	date: "$Date$"
	revision: "$Revision$"

class
	EB_DOTNET_SHORT_FORMATTER
...
feature {NONE} -- Gui Properties
	...
	menu_name: STRING is
		...
		do
			Result := Interface_names.m_Showdotnets
		end

	command_name: STRING is
			-- Name of the command.
		do
			Result := Interface_names.L_dotnetShort
		end

	post_fix: STRING is "dns"
...
end -- class EB_DOTNET_SHORT_FORMATTER
