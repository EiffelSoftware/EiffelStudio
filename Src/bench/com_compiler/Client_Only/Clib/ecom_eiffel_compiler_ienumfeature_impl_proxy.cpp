...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelFeatureDescriptor * *)grt_ec_ISE_c.ccom_ec_pointed_cell_46 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_46 ((ecom_eiffel_compiler::IEiffelFeatureDescriptor * *)tmp_rgelt, rgelt);
...
grt_ce_ISE_c.ccom_free_memory_pointed_70 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumFeature * *)grt_ec_ISE_c.ccom_ec_pointed_cell_49 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_49 ((ecom_eiffel_compiler::IEnumFeature * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_49 (tmp_ppenum);
