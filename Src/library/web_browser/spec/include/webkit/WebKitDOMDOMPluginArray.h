...
#define WEBKIT_DOM_DOM_PLUGIN_ARRAY_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_DOM_PLUGIN_ARRAY, WebKitDOMDOMPluginArrayClass)
#define WEBKIT_DOM_IS_DOM_PLUGIN_ARRAY(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_DOM_PLUGIN_ARRAY))
#define WEBKIT_DOM_IS_DOM_PLUGIN_ARRAY_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_DOM_PLUGIN_ARRAY))
