...
#include "ecom_eiffel_compiler_IEnumAssembly_impl_stub.h"
...
ecom_eiffel_compiler::IEnumAssembly_impl_stub::IEnumAssembly_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_eiffel_compiler::IEnumAssembly_impl_stub::~IEnumAssembly_impl_stub()
{
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::Next(  /* [out] */ ecom_eiffel_compiler::IEiffelAssemblyProperties * * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_140 (rgelt, NULL));
		if (*rgelt != NULL)
			(*rgelt)->AddRef ();
	}
	...
	if (*rgelt != NULL)
		(*rgelt)->Release ();
	grt_ec_ISE_c.ccom_ec_pointed_cell_140 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::Reset( void )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::Clone(  /* [out] */ ecom_eiffel_compiler::IEnumAssembly * * ppenum )
...
-----------------------------------------------------------*/
{
	...
	if (ppenum != NULL)
	{
		tmp_ppenum = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_47 (ppenum, NULL));
		if (*ppenum != NULL)
			(*ppenum)->AddRef ();
	}
	...
	if (*ppenum != NULL)
		(*ppenum)->Release ();
	grt_ec_ISE_c.ccom_ec_pointed_cell_47 (((tmp_ppenum != NULL) ? eif_wean (tmp_ppenum) : NULL), ppenum);
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::ith_item(  /* [in] */ ULONG an_index, /* [out] */ ecom_eiffel_compiler::IEiffelAssemblyProperties * * rgelt )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::count(  /* [out, retval] */ ULONG * return_value )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::GetTypeInfo( unsigned int itinfo, LCID lcid, ITypeInfo **pptinfo )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::GetTypeInfoCount( unsigned int * pctinfo )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::GetIDsOfNames( REFIID riid, OLECHAR ** rgszNames, unsigned int cNames, LCID lcid, DISPID *rgdispid )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::Invoke( DISPID dispID, REFIID riid, LCID lcid, unsigned short wFlags, DISPPARAMS *pDispParams, VARIANT *pVarResult, EXCEPINFO *pExcepInfo, unsigned int *puArgErr )
...
STDMETHODIMP_(ULONG) ecom_eiffel_compiler::IEnumAssembly_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_eiffel_compiler::IEnumAssembly_impl_stub::AddRef()
...
STDMETHODIMP ecom_eiffel_compiler::IEnumAssembly_impl_stub::QueryInterface( REFIID riid, void ** ppv )
...
-----------------------------------------------------------*/
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<ecom_eiffel_compiler::IEnumAssembly*>(this);
