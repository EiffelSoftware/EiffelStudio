...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__UNDEFINECLAUSE_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__UNDEFINECLAUSE_H__
#ifdef __cplusplus
extern "C" {
...
#ifdef __cplusplus
extern "C" {
#ifndef __ecom_ISE_Reflection_EiffelComponents__UndefineClause_INTERFACE_DEFINED__
#define __ecom_ISE_Reflection_EiffelComponents__UndefineClause_INTERFACE_DEFINED__
namespace ecom_ISE_Reflection_EiffelComponents
{
class _UndefineClause : public IDispatch
{
public:
	_UndefineClause () {};
	~_UndefineClause () {};
