...
#ifndef __ECOM_EIFFEL_COMPILER_IENUMINCLUDEPATHS_IMPL_PROXY_H__
#define __ECOM_EIFFEL_COMPILER_IENUMINCLUDEPATHS_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_eiffel_compiler::IEnumIncludePaths * p_IEnumIncludePaths;
