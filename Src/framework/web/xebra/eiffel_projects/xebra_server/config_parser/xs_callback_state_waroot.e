note
	description: "Summary description for {XS_CALLBACK_STATE_WAROOT}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"

class
	XS_CALLBACK_STATE_WAROOT
...
feature -- Tag
	...
	on_attribute (a_namespace: STRING; a_prefix: STRING; a_local_part: STRING; a_value: STRING)
			-- <Precursor>
		do
			if a_local_part.is_equal ("path") then
				config_callback.webapps_root := a_value
			else
