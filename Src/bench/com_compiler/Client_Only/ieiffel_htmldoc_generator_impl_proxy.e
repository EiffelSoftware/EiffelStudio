...
feature {NONE}  -- Externals
	...
	ccom_is_loaded (cpp_obj: POINTER): BOOLEAN is
			-- Is the project loaded?
		external
			"C++ [ecom_eiffel_compiler::IEiffelHTMLDocGenerator_impl_proxy %"ecom_eiffel_compiler_IEiffelHTMLDocGenerator_impl_proxy.h%"](): EIF_BOOLEAN"
		end
	...
	ccom_add_status_callback (cpp_obj: POINTER; new_callback: POINTER) is
			-- Add a callback interface.
		external
			"C++ [ecom_eiffel_compiler::IEiffelHTMLDocGenerator_impl_proxy %"ecom_eiffel_compiler_IEiffelHTMLDocGenerator_impl_proxy.h%"](ecom_eiffel_compiler::IEiffelHTMLDocEvents *)"
		end
	...
	ccom_add_excluded_cluster (cpp_obj: POINTER; cluster_full_name: STRING) is
			-- Exclude a cluster from being generated.
		external
			"C++ [ecom_eiffel_compiler::IEiffelHTMLDocGenerator_impl_proxy %"ecom_eiffel_compiler_IEiffelHTMLDocGenerator_impl_proxy.h%"](EIF_OBJECT)"
		end
	...
	ccom_delete_ieiffel_htmldoc_generator_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_eiffel_compiler::IEiffelHTMLDocGenerator_impl_proxy %"ecom_eiffel_compiler_IEiffelHTMLDocGenerator_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_htmldoc_generator_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_eiffel_compiler::IEiffelHTMLDocGenerator_impl_proxy %"ecom_eiffel_compiler_IEiffelHTMLDocGenerator_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_eiffel_compiler::IEiffelHTMLDocGenerator_impl_proxy %"ecom_eiffel_compiler_IEiffelHTMLDocGenerator_impl_proxy.h%"]():EIF_POINTER"
		end
