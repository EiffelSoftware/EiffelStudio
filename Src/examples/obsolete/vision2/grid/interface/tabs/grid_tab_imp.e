...
feature {NONE} -- Implementation
	...
	icon_view_button_selected
			-- Called by `select_actions' of `icon_view_button'.
		deferred
		end
	
	colored_button_selected
	...
	texture_test_button_selected
			-- Called by `select_actions' of `texture_test_button'.
		deferred
		end
	
	remove_all_row_button_selected
	...
	is_column_resize_immediate_button_selected
			-- Called by `select_actions' of `is_column_resize_immediate_button'.
		deferred
		end
	
	is_header_displayed_button_selected
	...
	are_row_separators_enabled_button_selected
	...
	separator_color_combo_selected
	...
	resize_columns_to_button_selected
	...
	is_tree_enabled_button_selected
	...
	subrow_indent_button_changed (a_value: INTEGER)
