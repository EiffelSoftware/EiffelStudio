...
feature -- Token codes
	...
	E_NOTE: INTEGER is 286
	E_OBSOLETE: INTEGER is 287
	E_ONCE: INTEGER is 288
	E_ONCE_STRING: INTEGER is 289
	E_PREFIX: INTEGER is 290
	E_REDEFINE: INTEGER is 291
	E_RENAME: INTEGER is 292
	E_REQUIRE: INTEGER is 293
	E_RESCUE: INTEGER is 294
	E_SELECT: INTEGER is 295
	E_STRIP: INTEGER is 296
	E_WHEN: INTEGER is 297
	E_THEN: INTEGER is 298
	E_UNDEFINE: INTEGER is 299
	E_UNIQUE: INTEGER is 300
	E_UNTIL: INTEGER is 301
	E_VARIANT: INTEGER is 302
	E_DEFERRED: INTEGER is 303
	E_EXPANDED: INTEGER is 304
	E_REFERENCE: INTEGER is 305
	E_SEPARATE: INTEGER is 306
	E_ATTACHED: INTEGER is 307
	E_DETACHABLE: INTEGER is 308
	E_ATTRIBUTE: INTEGER is 309
	E_CONVERT: INTEGER is 310
	E_RECAST: INTEGER is 311
	E_ASSIGN: INTEGER is 312
	E_AGENT: INTEGER is 313
	E_PRECURSOR: INTEGER is 314
	E_ARROW: INTEGER is 315
	E_DOTDOT: INTEGER is 316
	E_LARRAY: INTEGER is 317
	E_RARRAY: INTEGER is 318
	E_ASSIGN_SYMBOL: INTEGER is 319
	E_REVERSE: INTEGER is 320
	E_UNKNOWN: INTEGER is 321
	E_BIT: INTEGER is 322
	E_FALSE: INTEGER is 323
	E_TRUE: INTEGER is 324
	E_BREAK: INTEGER is 325
	E_CHARACTER: INTEGER is 326
	E_CURRENT: INTEGER is 327
	E_FREEOP: INTEGER is 328
	E_IDENTIFIER: INTEGER is 329
	E_BITTYPE: INTEGER is 330
	E_TUPLE: INTEGER is 331
	E_INTEGER: INTEGER is 332
	E_AND: INTEGER is 333
	E_OR: INTEGER is 334
	E_XOR: INTEGER is 335
	E_NOT: INTEGER is 336
	E_IMPLIES: INTEGER is 337
	E_STRPLUS: INTEGER is 338
	E_STRMINUS: INTEGER is 339
	E_STRSTAR: INTEGER is 340
	E_STRSLASH: INTEGER is 341
	E_STRDIV: INTEGER is 342
	E_STRMOD: INTEGER is 343
	E_STRPOWER: INTEGER is 344
	E_STRLT: INTEGER is 345
	E_STRLE: INTEGER is 346
	E_STRGT: INTEGER is 347
	E_STRGE: INTEGER is 348
	E_STRAND: INTEGER is 349
	E_STROR: INTEGER is 350
	E_STRXOR: INTEGER is 351
	E_STRANDTHEN: INTEGER is 352
	E_STRORELSE: INTEGER is 353
	E_STRDOTDOT: INTEGER is 354
	E_STRBRACKET: INTEGER is 355
	E_STRIMPLIES: INTEGER is 356
	E_STRFREEOP: INTEGER is 357
	E_STRNOT: INTEGER is 358
	E_STRING: INTEGER is 359
	E_REAL: INTEGER is 360
	E_RESULT: INTEGER is 361
	E_RETRY: INTEGER is 362
	E_DIV: INTEGER is 363
	E_GE: INTEGER is 364
	E_LE: INTEGER is 365
	E_MOD: INTEGER is 366
	E_VOID: INTEGER is 367
	E_CHARERR: INTEGER is 368
	E_STRERR: INTEGER is 369
	E_INTERR: INTEGER is 370
	E_OLD: INTEGER is 371
	E_NE: INTEGER is 372
	E_NOT_TILDE: INTEGER is 373
