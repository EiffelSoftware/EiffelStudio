	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 8 row: 2 of file: ./contact.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 8 row: 2 of file: ./contact.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 8 row: 1 of file: ./contact.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 8 row: 1 of file: ./contact.xeb"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 6 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 5 row: 1 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "h2"
			stack.put (temp)
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 4 row: 45 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 38 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Contact")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 6 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 6 row: 1 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "p"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 26 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "You can write to ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 5 row: 88 of file: ./contact.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 5 row: 88 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("href", "mailto:someone@somewhere.com")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			stack.put (temp)
				-- line: 5 row: 84 of file: ./contact.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 84 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "someone@nowhere.com")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 5 row: 89 of file: ./contact.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 89 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 4 of file: ./contact.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N  ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
