...
#include "ecom_eiffel_compiler_IEnumClusterExcludes_impl_stub.h"
...
ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::IEnumClusterExcludes_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::~IEnumClusterExcludes_impl_stub()
{
...
STDMETHODIMP ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::Next(  /* [out] */ BSTR * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_176 (rgelt, NULL));
	}
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_176 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::Reset( void )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::Clone(  /* [out] */ ecom_eiffel_compiler::IEnumClusterExcludes * * ppenum )
...
-----------------------------------------------------------*/
{
	...
	if (ppenum != NULL)
	{
		tmp_ppenum = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_168 (ppenum, NULL));
		if (*ppenum != NULL)
			(*ppenum)->AddRef ();
	}
	...
	if (*ppenum != NULL)
		(*ppenum)->Release ();
	grt_ec_ISE_c.ccom_ec_pointed_cell_168 (((tmp_ppenum != NULL) ? eif_wean (tmp_ppenum) : NULL), ppenum);
...
STDMETHODIMP ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::ith_item(  /* [in] */ ULONG an_index, /* [out] */ BSTR * rgelt )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_178 (rgelt, NULL));
	}
	...
	if (*rgelt != NULL)
		rt_ce.free_memory_bstr (*rgelt);
	grt_ec_ISE_c.ccom_ec_pointed_cell_178 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::count(  /* [out, retval] */ ULONG * return_value )
...
STDMETHODIMP_(ULONG) ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::AddRef()
...
STDMETHODIMP ecom_eiffel_compiler::IEnumClusterExcludes_impl_stub::QueryInterface( REFIID riid, void ** ppv )
