...
feature -- Token codes
	...
	TE_STR_GE: INTEGER is 370
	TE_STR_MINUS: INTEGER is 371
	TE_STR_PLUS: INTEGER is 372
	TE_STR_STAR: INTEGER is 373
	TE_STR_SLASH: INTEGER is 374
	TE_STR_MOD: INTEGER is 375
	TE_STR_DIV: INTEGER is 376
	TE_STR_POWER: INTEGER is 377
	TE_STR_AND: INTEGER is 378
	TE_STR_AND_THEN: INTEGER is 379
	TE_STR_IMPLIES: INTEGER is 380
	TE_STR_OR: INTEGER is 381
	TE_STR_OR_ELSE: INTEGER is 382
	TE_STR_XOR: INTEGER is 383
	TE_STR_NOT: INTEGER is 384
	TE_STR_FREE: INTEGER is 385
	TE_STR_BRACKET: INTEGER is 386
