...
feature -- Access
	...
	err_attribute_missing (a_attr: STRING_GENERAL): STRING_32
		require
	...
	err_invalid_attribute (a_attribute: STRING_GENERAL): STRING_32
	...
	err_invalid_tag_position (a_tag: STRING_GENERAL): STRING_32
			-- Invalid tag error
		require
	...
	err_boolean_value_invalid (a_attr_name: STRING_GENERAL; a_value: STRING_GENERAL): STRING_32
		require
