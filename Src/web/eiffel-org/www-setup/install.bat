...
:: Default values
set ISE_MAJOR_MINOR_LATEST=21.11
set ISE_BUILD_LATEST=106046

set ISE_MAJOR_MINOR_NIGHTLY=21.11
set ISE_BUILD_NIGHTLY=106046

set ISE_MAJOR_MINOR_BETA=21.11
set ISE_BUILD_BETA=106046
