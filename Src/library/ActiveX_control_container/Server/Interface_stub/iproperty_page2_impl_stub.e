...
feature {NONE}  -- Externals
	...
	ccom_create_item (eif_object: IPROPERTY_PAGE2_IMPL_STUB): POINTER is
			-- Initialize `item'
		external
			"C++ [new ecom_control_library::IPropertyPage2_impl_stub %"ecom_control_library_IPropertyPage2_impl_stub_s.h%"](EIF_OBJECT)"
		end

end -- IPROPERTY_PAGE2_IMPL_STUB
