...
feature -- Token codes
	...
	TE_INTEGER: INTEGER = 287
	TE_REAL: INTEGER = 288
	TE_CHAR: INTEGER = 289
	TE_LSQURE: INTEGER = 290
	TE_RSQURE: INTEGER = 291
	TE_ACCEPT: INTEGER = 292
	TE_ADDRESS: INTEGER = 293
	TE_LARRAY: INTEGER = 294
	TE_RARRAY: INTEGER = 295
	TE_RPARAN: INTEGER = 296
	TE_LCURLY: INTEGER = 297
	TE_RCURLY: INTEGER = 298
	TE_BANG: INTEGER = 299
	TE_SEMICOLON: INTEGER = 300
	TE_COLON: INTEGER = 301
	TE_COMMA: INTEGER = 302
	TE_CONSTRAIN: INTEGER = 303
	TE_QUESTION: INTEGER = 304
	TE_FALSE: INTEGER = 305
	TE_TRUE: INTEGER = 306
	TE_RESULT: INTEGER = 307
	TE_RETRY: INTEGER = 308
	TE_UNIQUE: INTEGER = 309
	TE_CURRENT: INTEGER = 310
	TE_DEFERRED: INTEGER = 311
	TE_VOID: INTEGER = 312
	TE_END: INTEGER = 313
	TE_FROZEN: INTEGER = 314
	TE_PARTIAL_CLASS: INTEGER = 315
	TE_INFIX: INTEGER = 316
	TE_CREATION: INTEGER = 317
	TE_PRECURSOR: INTEGER = 318
	TE_PREFIX: INTEGER = 319
	TE_AGENT: INTEGER = 320
	TE_ALIAS: INTEGER = 321
	TE_ALL: INTEGER = 322
	TE_AS: INTEGER = 323
	TE_CHECK: INTEGER = 324
	TE_CLASS: INTEGER = 325
	TE_CONVERT: INTEGER = 326
	TE_CREATE: INTEGER = 327
	TE_DEBUG: INTEGER = 328
	TE_DO: INTEGER = 329
	TE_ELSE: INTEGER = 330
	TE_ELSEIF: INTEGER = 331
	TE_ENSURE: INTEGER = 332
	TE_EXPANDED: INTEGER = 333
	TE_EXPORT: INTEGER = 334
	TE_EXTERNAL: INTEGER = 335
	TE_FEATURE: INTEGER = 336
	TE_FROM: INTEGER = 337
	TE_IF: INTEGER = 338
	TE_INHERIT: INTEGER = 339
	TE_INSPECT: INTEGER = 340
	TE_INVARIANT: INTEGER = 341
	TE_LIKE: INTEGER = 342
	TE_LOCAL: INTEGER = 343
	TE_LOOP: INTEGER = 344
	TE_OBSOLETE: INTEGER = 345
	TE_ONCE: INTEGER = 346
	TE_ONCE_STRING: INTEGER = 347
	TE_REDEFINE: INTEGER = 348
	TE_REFERENCE: INTEGER = 349
	TE_RENAME: INTEGER = 350
	TE_REQUIRE: INTEGER = 351
	TE_RESCUE: INTEGER = 352
	TE_SELECT: INTEGER = 353
	TE_SEPARATE: INTEGER = 354
	TE_THEN: INTEGER = 355
	TE_UNDEFINE: INTEGER = 356
	TE_UNTIL: INTEGER = 357
	TE_VARIANT: INTEGER = 358
	TE_WHEN: INTEGER = 359
	TE_ACROSS: INTEGER = 360
	TE_ASSIGN: INTEGER = 361
	TE_ATTRIBUTE: INTEGER = 362
	TE_ATTACHED: INTEGER = 363
	TE_DETACHABLE: INTEGER = 364
	TE_INDEXING: INTEGER = 365
	TE_IS: INTEGER = 366
	TE_NOTE: INTEGER = 367
	TE_SOME: INTEGER = 368
