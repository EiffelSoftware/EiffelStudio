...
feature -- Actions
	...
	application_launched_actions: ACTION_SEQUENCE [TUPLE [DEBUGGER_S]]
			-- Application launched

	application_resumed_actions: ACTION_SEQUENCE [TUPLE [DEBUGGER_S]]
			-- Application resumed

	application_stopped_actions: ACTION_SEQUENCE [TUPLE [DEBUGGER_S]]
			-- Application stopped

	application_exited_actions: ACTION_SEQUENCE [TUPLE [DEBUGGER_S]]
			-- Application exited

	debugging_terminated_actions: ACTION_SEQUENCE [TUPLE [DEBUGGER_S]]
