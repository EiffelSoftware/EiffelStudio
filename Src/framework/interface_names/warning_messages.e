...
feature -- Project file/directory warnings
	...
	w_Select_project_to_create: STRING_32 is do Result := locale.translation ("Please select the kind of project you want to create.") end

	w_Cannot_open_project: STRING_32 is do Result := locale.translation ("Project is not readable. Check permissions.") end

	w_Cannot_create_project_directory (dir_name: STRING): STRING_32 is
		require
	...
	w_Project_directory_not_exist (file_name, dir_name: STRING): STRING_32 is
	...
	w_Cannot_compile: STRING_32 is do Result := locale.translation ("Read-only project: cannot compile.") end
	...
	w_configuration_files_needs_to_be_converted (a_file_name: STRING_GENERAL): STRING_32 is
		require
	...
	w_project_constains_no_compilable_target: STRING_32 is do Result := locale.translation ("This project contains no compilable target.%NPlease open a different project.") end
	...
	w_project_build_precompile: STRING_32 is do Result := locale.translation (
			"The project needs to use a precompile library, which has not been compiled.%N%
			%Should the precompile be built?")
		end

	w_project_build_precompile_error: STRING_32 is do Result := locale.translation ("Could not generate needed precompile.") end
	...
	w_no_compilable_target: STRING_32 is do Result := locale.translation ("Cannot compile project: no valid target found.") end
	...
	w_unable_to_retrieve_wizard_list: STRING_32 is do Result := locale.translation ("Unable to retrieve the list of installed wizard.") end

	w_unable_to_initiate_project: STRING_32 is do Result := locale.translation ("Unable to initialize the project generated by the wizard") end

	w_unable_to_write_file (a_name: STRING_GENERAL): STRING_32 is do Result := locale.formatted_string (locale.translation ("Unable to write file: $1"), [a_name]) end;

	w_file_is_corrupted (a_name: STRING_GENERAL): STRING_32 is do Result := locale.formatted_string (locale.translation ("File $1 is corrupted"), [a_name]) end;

	w_file_can_not_be_open (a_name: STRING_GENERAL): STRING_32 is do Result := locale.formatted_string (locale.translation ("File $1 cannot not be open"), [a_name]) end;
...
feature -- File warnings
	...
	w_File_does_not_exist_execution_impossible (a_file_name: STRING_GENERAL): STRING_32 is
		require
			a_file_name_not_void: a_file_name /= Void
		do
	...
	w_Not_creatable_choose_to_save (file_name: STRING_GENERAL): STRING_32 is
		require
			file_name_not_void: file_name /= Void
		do
	...
	w_Not_rename_swp (a_file_name, a_new_name: STRING_GENERAL): STRING_32 is
	...
	w_Not_rename (a_file_name, a_new_name: STRING_GENERAL): STRING_32 is
...
feature -- Project settings warnings
	...
	w_cluster_path_not_valid: STRING_32 is do Result := locale.translation ("Cluster path is not valid.") end
...
feature -- Debug warnings
	...
	w_Overflow_detected: STRING_32 is	do Result := locale.translation ("Possible stack overflow detected. The application has been paused to let you%N%
	...
	w_dbg_unable_to_get_call_stack_data: STRING_32 is do Result := locale.translation ("Unable to get call stack data") end

	w_dbg_double_click_to_refresh_call_stack: STRING_32 is do Result := locale.translation ("Double click to refresh call stack") end
...
feature -- Cluster tree warnings
	...
	w_Cannot_delete_library_cluster (cluster_name: STRING_GENERAL): STRING_32 is
		require
	...
	w_Cannot_delete_none_empty_cluster (cluster_name: STRING_GENERAL): STRING_32 is
		require
			cluster_name_not_void: cluster_name /= Void
		do
			Result := locale.formatted_string (
	...
	w_Cannot_add_to_library_cluster (cluster_name: STRING_GENERAL): STRING_32 is
		require
			cluster_name_not_void: cluster_name /= Void
		do
			Result := locale.formatted_string (
	...
	w_Cannot_find_class (class_name: STRING_GENERAL): STRING_32 is
		require
			class_name_not_void: class_name /= Void
		do
	...
	w_Cannot_find_cluster (cluster_name: STRING_GENERAL): STRING_32 is
		require
			cluster_name_not_void: cluster_name /= Void
		do
	...
	w_Clear_breakpoints: STRING_32 is do Result := locale.translation ("Forget all breakpoints?") end

	w_Cluster_path_already_exists (path: STRING_GENERAL): STRING_32 is
		require
	...
	w_Cluster_name_already_exists (name: STRING_GENERAL): STRING_32 is
		require
	...
	w_Cannot_delete_need_recompile: STRING_32 is do Result := locale.translation ("Compiled configuration is not up to date, please recompile.") end
...
feature -- Backup warnings
	...
	w_Backup_succeeded: STRING_32 is do Result := locale.translation ("Backup was successful.%N%
	...
	w_Backup_failed: STRING_32 is do Result := locale.translation ("Backup failed for some files.%N%
								%The state of the system was too damaged.") end

	w_Found_backup: STRING_32 is do Result := locale.translation ("A backed up version of the file was found.%N%
	...
	w_Save_backup: STRING_32 is do Result := locale.translation ("You are about to overwrite the original file with%N%
...
feature -- Dynamic library warnings
	...
	w_Not_a_compiled_class (cl_name: STRING_GENERAL): STRING_32 is
	...
	w_Not_a_compiled_class_line (cl_name: STRING_GENERAL): STRING_32 is
			-- The `cl_name' does not represent a valid class.
		do
			if cl_name /= Void then
				Result := locale.formatted_string (locale.translation ("%"$1%" is not a compiled class."), [cl_name])
	...
	w_Class_cannot_export: STRING_32 is do Result := locale.translation ("This class cannot export features.%N%
				%Please make sure that it is neither deferred nor generic%N%
				%and that the system is correctly compiled.") end

	w_No_exported_feature (f_name, cl_name: STRING_GENERAL): STRING_32 is
	...
	w_Feature_cannot_be_exported: STRING_32 is do Result := locale.translation ("This feature cannot be exported.%N%
	...
	w_Cannot_load_library (fn: STRING_GENERAL): STRING_32 is
	...
	w_Cannot_save_library (fn: STRING_GENERAL): STRING_32 is
...
feature -- Ace/Project settings warnings
	...
	w_Could_not_parse_ace: STRING_32 is do Result := locale.translation ("An error occurred while parsing the configuration file.%N%
...
feature -- Profiler messages
	...
	w_Profiler_select_one_output_switch: STRING_32 is do Result := locale.translation ("Select at least one output switch.") end

	w_Profiler_select_one_language: STRING_32 is do Result := locale.translation ("Select at least one language.") end

feature -- Project creation, retrieval, ...

	w_Fill_in_location_field: STRING_32 is do Result := locale.translation ("Please fill in the 'Location' field.") end

	w_Fill_in_project_name_field: STRING_32 is do Result := locale.translation ("Please fill in the 'System Name' field.") end

	w_Unable_to_load_ace_file (an_ace_name, a_reason: STRING_GENERAL): STRING_32 is
		do
	...
	w_Unable_to_load_config_file (an_ace_name, a_reason: STRING_GENERAL): STRING_32 is
		do
	...
	w_Invalid_directory_or_cannot_be_created (a_directory_name: STRING_GENERAL): STRING_32 is
		do
			Result := locale.formatted_string (locale.translation (
	...
	w_Environment_changed (a_key, a_old_val, a_new_val: STRING_GENERAL): STRING_32 is
		local
...
feature -- Refactoring
	...
	w_Feature_not_written_in_class: STRING_32 is do Result := locale.translation ("Feature is not written in selected class.") end
	w_Select_class_feature_to_rename: STRING_32 is do Result := locale.translation ("Select class or feature to rename.%NEither use pick and drop or target the editor to the feature or class.") end
	w_Select_feature_to_pull: STRING_32 is do Result := locale.translation ("Select a feature to pull up.%NEither use pick and drop or target the editor to the feature to pull up.") end
...
feature -- Warning messages
	...
	w_Class_not_modifiable: STRING_32 is do Result := locale.translation ("The text of this class cannot be modified.") end

	w_class_attribute_expected (a_name: STRING_GENERAL; a_id: STRING_GENERAL): STRING_32 is
		do
			Result := locale.formatted_string (locale.translation ("class $1 $2 attribute expected"), [a_name, a_id])
		end

	w_class_attributes_expected (a_name: STRING_GENERAL; a_id: STRING_GENERAL): STRING_32 is
		do
			Result := locale.formatted_string (locale.translation ("class? $1, $2 attributes expected"), [a_name, a_id])
		end

	w_cluster_attribute_expected (a_name: STRING_GENERAL; a_id: STRING_GENERAL): STRING_32 is
		do
			Result := locale.formatted_string (locale.translation ("cluster? $1, $2 attribute expected"), [a_name, a_id])
		end

	w_could_not_modify_class: STRING_32 is do Result := locale.translation ("The text of this class could not be modified.") end

	w_Could_not_save_all: STRING_32 is do Result := locale.translation ("Some files could not be saved.%N%
									%Exit was cancelled.") end

	w_cannot_save_file (a_file_name: STRING_GENERAL): STRING_32 is
		do
	...
	w_cannot_convert_file (a_file_name: STRING_GENERAL): STRING_32 is
		require
			a_file_name_not_void: a_file_name /= Void
		do
	...
	w_cannot_generate_png: STRING_32 is do Result := locale.translation ("Could not generate PNG file.%NInsufficient video memory.") end

	w_does_not_have_enclosing_cluster: STRING_32 is do Result := locale.translation ("This cluster does not have an enclosing cluster.") end
	...
	w_target_name_attribute_expected: STRING_32 is do Result := locale.translation ("TARGET name attribute expected") end

	w_source_name_attribute_expected: STRING_32 is do Result := locale.translation ("SOURCE name attribute expected") end

	w_Ignoring_all_stop_points: STRING_32 is do Result := locale.translation ("Application will ignore all breakpoints.") end

	w_Unknown_cluster_name: STRING_32 is do Result := locale.translation ("No cluster in the system has this name.") end;
	w_no_cluster_selected_for_class_creation: STRING_32 is do Result := locale.translation ("No cluster was selected. Please select a cluster to create a class.") end;
	w_read_only_cluster: STRING_32 is do Result := locale.translation ("Selected cluster is read only. Please select a writable cluster for class creation.") end

	w_Invalid_folder_name: STRING_32 is do Result := locale.translation ("Invalid folder name") end

	w_Folder_name_cannot_contain: STRING_32 is do Result := locale.translation ("%N A favorite folder name cannot contain any of the following characters: %N ( ) * ") end
	...
	w_MakefileSH_more_recent: STRING_32 is do Result := locale.translation ("The Makefile.SH is more recent than the system.") end

	w_Must_compile_first: STRING_32 is do Result := locale.translation ("You must compile a project first.") end

	w_Must_finalize_first: STRING_32 is do Result := locale.translation ("You must finalize your project first.") end

	w_No_class_matches: STRING_32 is do Result := locale.translation ("No class in any cluster matches this name.") end

	w_No_cluster_matches: STRING_32 is do Result := locale.translation ("No cluster in the system matches this name.") end

	w_No_feature_matches: STRING_32 is do Result := locale.translation ("No feature in this class matches this name.") end

	w_No_feature_to_display: STRING_32 is do Result := locale.translation ("No features in this file") end
	...
	w_No_system_generated (a_system_name: STRING): STRING_32 is
		do
			Result := locale.formatted_string (locale.translation (
				"Could not find $1.%NPlease make sure the C compilation ended correctly."), [a_system_name])
		end

	w_No_system: STRING_32 is do Result := locale.translation ("No system was defined.%NCannot launch the application.") end

	w_Not_an_integer: STRING_32 is do Result := locale.translation ("Please enter an integer value.") end

	w_Not_a_positive_integer: STRING_32 is do Result := locale.translation ("Please enter a positive integer value.") end

	w_Select_class_cluster_to_remove: STRING_32 is do Result := locale.translation ("Please select a class or a cluster before calling this command.%N%
										%It will then be removed.") end

	w_Specify_a_class: STRING_32 is do Result := locale.translation ("Please specify a compiled class (or * for all classes).") end

	w_Exiting_stops_compilation: STRING_32 is do Result := locale.translation ("It is not possible to exit EiffelStudio while the project is being compiled.") end

	w_Save_before_closing: STRING_32 is do Result := locale.translation ("Do you want to save your changes%N%
																			%before closing the window?") end

	w_Stop_debugger: STRING_32 is do Result := locale.translation ("This command will stop the debugger.") end

	w_Exiting_stops_debugger: STRING_32 is do Result := locale.translation ("Exiting will stop the debugger.") end

	w_Closing_stops_debugger: STRING_32 is do Result := locale.translation ("Closing the window will stop the debugger.") end

	w_Unexisting_system: STRING_32 is do Result := locale.translation ("System doesn't exist.") end
	...
	w_Text_not_editable: STRING_32 is do Result := locale.translation ("Current text is not editable.") end

	w_Class_syntax_error_before_generation (class_name: STRING_GENERAL): STRING_32 is
		require
			class_name_not_void: class_name /= Void
		do
	...
	w_Class_modified_outside_diagram: STRING_32 is do Result := locale.translation ("Class was modified outside the diagram.%N%
												%Previous commands are not undoable any longer.") end

	w_Class_syntax_error: STRING_32 is do Result := locale.translation ("Current class text has a syntax error.%NCode generation was cancelled.") end

	w_New_feature_syntax_error: STRING_32 is do Result := locale.translation ("New feature has syntax error.%NCode generation cancelled.") end

	w_Class_name_changed: STRING_32 is do Result := locale.translation ("Class name has changed since last compilation.%NCurrent text will not be clickable.%N%
						%Recompile to make it clickable again.") end

	w_Unable_to_execute_wizard (wizard_file: STRING_GENERAL): STRING_32 is
		do
			Result := locale.formatted_string (locale.translation (
	...
	w_Class_already_edited: STRING_32 is do Result := locale.translation ("This class is already being edited%N%
										%in another editor.%N%
										%Editing a class in several editors%N%
										%may cause loss of data.") end
	w_Invalid_options: STRING_32 is do Result := locale.translation ("The selected options are invalid.%N%
								%Please select different ones.") end

	w_Index_already_taken: STRING_32 is do Result := locale.translation ("This index is already used.%N%
									%Please select another one.") end

	w_Command_needs_class: STRING_32 is do Result := locale.translation ("This command requires a class name.%N%
									%It cannot be executed.") end

	w_Command_needs_file: STRING_32 is do Result := locale.translation ("This command requires a file name.%N%
									%It cannot be executed.") end

	w_Command_needs_directory: STRING_32 is do Result := locale.translation ("This command requires a directory.%N%
									%It cannot be executed.") end

	w_Finalize_precompile: STRING_32 is    do Result := locale.translation (".NET precompiled libraries can be finalized to create%N%
									%an optimized version as well as a workbench version.%N%
									%Would you like to create a finalized version?") end

	w_Replace_all: STRING_32 is do Result := locale.translation ("This operation cannot be undone for files not loaded into the EiffelStudio editor.%N%
									%Are you sure your would like to continue replacing all occurrences?") end

	w_No_system_defined: STRING_32 is do Result := locale.translation ("No project has been loaded.") end

	w_Finalizing_running: STRING_32 is do Result := locale.translation (
	...
	w_Freezing_running: STRING_32 is do Result := locale.translation (
	...
	w_cannot_clear_when_c_compilation_running: STRING_32 is do Result := locale.translation ("Please clear this window after c compilation has exited.") end
	w_cannot_save_when_c_compilation_running: STRING_32 is do Result := locale.translation ("Please save output after c compilation has exited.") end
	w_cannot_save_when_external_running: STRING_32 is do Result := locale.translation ("Please save output after external command has exited.") end
	w_external_command_running_in_development_window: STRING_32 is do Result := locale.translation ("An external command is running, closing this window will terminate it.%NContinue?") end;
	w_value_of_element_is_not_valid (a_name: STRING_GENERAL): STRING_32 is do Result := locale.formatted_string (locale.translation ("Value of element $1 is not valid."), [a_name]) end;
	w_element_expected_not_found (a_name: STRING_GENERAL): STRING_32 is do Result := locale.formatted_string (locale.translation ("Element $1 expected but not found."), [a_name]) end;
	w_retrieve_default_color: STRING_32 is do Result := locale.translation ("Retrieve default color.") end;

	w_help_topic_could_not_be_displayed: STRING_32 is do Result := locale.translation ("Help Topic could not be displayed, please check Eiffel Installation") end

	w_Unknown_error: STRING_32 is do Result := locale.translation ("An unknown error has occurred%N") end

	w_file_not_valid_assembly (a_file: STRING_GENERAL): STRING_32 is
		require
