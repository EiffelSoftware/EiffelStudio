...
feature -- Token codes
	...
	LAC_RENAME: INTEGER is 288
	LAC_REQUIRE: INTEGER is 289
	LAC_RIGHT_PARAM: INTEGER is 290
	LAC_ROOT: INTEGER is 291
	LAC_SEMICOLON: INTEGER is 292
	LAC_STRING: INTEGER is 293
	LAC_SYSTEM: INTEGER is 294
	LAC_TRACE: INTEGER is 295
	LAC_USE: INTEGER is 296
	LAC_VISIBLE: INTEGER is 297
	LAC_YES: INTEGER is 298
	LAC_LIBRARY: INTEGER is 299
