...
#ifndef __ECOM_EIFFEL_COMPILER_IENUMINCLUDEPATHS_IMPL_STUB_S_H__
#define __ECOM_EIFFEL_COMPILER_IENUMINCLUDEPATHS_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_eiffel_compiler
{
class IEnumIncludePaths_impl_stub : public ecom_eiffel_compiler::IEnumIncludePaths
{
public:
	...
	No description available.
	-----------------------------------------------------------*/
	STDMETHODIMP Clone(  /* [out] */ ecom_eiffel_compiler::IEnumIncludePaths * * ppenum );
