...
external class
	WEB_REGULAR_EXPRESSION_VALIDATOR
...
create
	make_web_regular_expression_validator

feature {NONE} -- Initialization

	frozen make_web_regular_expression_validator is
		external
...
feature -- Access
	...
	frozen get_validation_expression: SYSTEM_STRING is
		external
...
feature -- Element Change
	...
	frozen set_validation_expression (value: SYSTEM_STRING) is
		external
...
end -- class WEB_REGULAR_EXPRESSION_VALIDATOR
