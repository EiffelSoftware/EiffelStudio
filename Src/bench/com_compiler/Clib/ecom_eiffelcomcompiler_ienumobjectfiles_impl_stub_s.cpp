		...
		case 10091:
			{
				...
				ecom_EiffelComCompiler::IEnumObjectFiles * * arg_0 = 0;
				IID tmp_iid_0 = {0x99ec369f,0x3cc2,0x4b78,{0xa9,0xa3,0xcb,0xa2,0x53,0x88,0xf1,0x82}};
				ecom_EiffelComCompiler::IEnumObjectFiles * tmp_tmp_arg_0 = 0;
