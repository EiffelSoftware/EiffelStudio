note
	description: "Summary description for {CONSUMED_OBJECT_JSON_NAMES}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature	-- Names
	...
	unique_id: JSON_STRING once Result := "unique_id" end
	folder_name: JSON_STRING once Result := "folder_name" end
	name: JSON_STRING once Result := "name" end
	version: JSON_STRING once Result := "version" end
	culture: JSON_STRING once Result := "culture" end
	key: JSON_STRING once Result := "key" end
	location: JSON_STRING once Result := "location" end
	gac_path: JSON_STRING once Result := "gac_path" end
	...
	eiffel_name: JSON_STRING once Result := "eiffel_name" end
	dotnet_name: JSON_STRING once Result := "dotnet_name" end
	dotnet_eiffel_name: JSON_STRING once Result := "dotnet_eiffel_name" end
	parent: JSON_STRING once Result := "parent" end
	properties: JSON_STRING once Result := "properties" end
	interfaces: JSON_STRING once Result := "interfaces" end
	constructors: JSON_STRING once Result := "constructors" end
	functions: JSON_STRING once Result := "functions" end
	procedures: JSON_STRING once Result := "procedures" end
	arguments: JSON_STRING once Result := "arguments" end
	fields: JSON_STRING once Result := "fields" end
	events: JSON_STRING once Result := "events" end
	associated_reference_type: JSON_STRING once Result := "associated_reference_type" end
	enclosing_type: JSON_STRING once Result := "enclosing_type" end
	getter: JSON_STRING once Result := "getter" end
	setter: JSON_STRING once Result := "setter" end
	value: JSON_STRING once Result := "value" end
	adder: JSON_STRING once Result := "adder" end
	remover: JSON_STRING once Result := "remover" end
	...
	is_deferred: JSON_STRING once Result := "is_deferred" end
	is_frozen: JSON_STRING once Result := "is_frozen" end
	is_expanded: JSON_STRING once Result := "is_expanded" end
	is_enum: JSON_STRING once Result := "is_enum" end
	is_public: JSON_STRING once Result := "is_public" end
	is_static: JSON_STRING once Result := "is_static" end
