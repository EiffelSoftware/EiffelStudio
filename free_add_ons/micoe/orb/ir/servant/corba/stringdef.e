...
description: "represents a string definition in the IR";
keywords: "InterfaceRepository, IR";
status: "See notice at end of class";
date: "$Date$";
revision: "$Revision$"

class CORBA_STRINGDEF_IMPL
...
feature
    ...
    make is
	 ...
	 create private_dk.make (CORBA_dk_String)
      end
...
end -- class CORBA_STRINGDEF_IMPL
