...
#include "ecom_eiffel_compiler_IEnumFeature_impl_stub_s.h"
...
ecom_eiffel_compiler::IEnumFeature_impl_stub::IEnumFeature_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_eiffel_compiler::IEnumFeature_impl_stub::~IEnumFeature_impl_stub()
{
...
STDMETHODIMP ecom_eiffel_compiler::IEnumFeature_impl_stub::Next(  /* [out] */ ecom_eiffel_compiler::IEiffelFeatureDescriptor * * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_Eif_compiler.ccom_ce_pointed_cell_33 (rgelt, NULL));
		if (*rgelt != NULL)
			(*rgelt)->AddRef ();
	}
	...
	if (*rgelt != NULL)
		(*rgelt)->Release ();
	grt_ec_Eif_compiler.ccom_ec_pointed_cell_33 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_eiffel_compiler::IEnumFeature_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumFeature_impl_stub::Reset( void )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumFeature_impl_stub::Clone(  /* [out] */ ecom_eiffel_compiler::IEnumFeature * * ppenum )
...
-----------------------------------------------------------*/
{
	...
	if (ppenum != NULL)
	{
		tmp_ppenum = eif_protect (grt_ce_Eif_compiler.ccom_ce_pointed_cell_43 (ppenum, NULL));
		if (*ppenum != NULL)
			(*ppenum)->AddRef ();
	}
	...
	if (*ppenum != NULL)
		(*ppenum)->Release ();
	grt_ec_Eif_compiler.ccom_ec_pointed_cell_43 (((tmp_ppenum != NULL) ? eif_wean (tmp_ppenum) : NULL), ppenum);
...
STDMETHODIMP ecom_eiffel_compiler::IEnumFeature_impl_stub::ith_item(  /* [in] */ ULONG an_index, /* [out] */ ecom_eiffel_compiler::IEiffelFeatureDescriptor * * rgelt )
...
STDMETHODIMP ecom_eiffel_compiler::IEnumFeature_impl_stub::count(  /* [out, retval] */ ULONG * return_value )
...
STDMETHODIMP_(ULONG) ecom_eiffel_compiler::IEnumFeature_impl_stub::AddRef()
...
STDMETHODIMP ecom_eiffel_compiler::IEnumFeature_impl_stub::QueryInterface( REFIID riid, void ** ppv )
