...
feature -- Externals
	...
	Dot_workbench: STRING is external "C" alias "eif_dot_workbench" end;

	Driver: STRING is external "C" alias "eif_driver" end;

	Eiffelgen: STRING is external "C" alias "eif_eiffelgen" end;
	...
	Updt: STRING is external "C" alias "eif_updt" end;


	Copy_cmd: STRING is external "C" alias "eif_copy_cmd" end;

	Default_ace_name: STRING is external "C" alias "eif_default_ace" end;

	precompiled_directory: STRING is external "C" alias "eif_precompiled" end;
