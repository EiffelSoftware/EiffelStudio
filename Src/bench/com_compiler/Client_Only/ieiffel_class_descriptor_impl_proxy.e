...
feature {NONE}  -- Externals
	...
	ccom_name (cpp_obj: POINTER): STRING is
			-- Class name.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelClassDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClassDescriptor_impl_proxy.h%"](): EIF_REFERENCE"
		end
	...
	ccom_is_in_system (cpp_obj: POINTER): BOOLEAN is
			-- Is class in system?
		external
			"C++ [ecom_EiffelComCompiler::IEiffelClassDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClassDescriptor_impl_proxy.h%"](): EIF_BOOLEAN"
		end
	...
	ccom_feature_count (cpp_obj: POINTER): INTEGER is
			-- Number of class features.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelClassDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClassDescriptor_impl_proxy.h%"](): EIF_INTEGER"
		end
	...
	ccom_delete_ieiffel_class_descriptor_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_EiffelComCompiler::IEiffelClassDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClassDescriptor_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_class_descriptor_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_EiffelComCompiler::IEiffelClassDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClassDescriptor_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_EiffelComCompiler::IEiffelClassDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClassDescriptor_impl_proxy.h%"]():EIF_POINTER"
		end
