...
feature {NONE} -- Initialization
	...
	make (a_file_rule: CONF_FILE_RULE) is
		...
		do
			...
			create l_btn.make_with_text_and_action ("+", agent add_exclude)
			l_btn.set_minimum_width (small_button_width)
			hb.extend (l_btn)
			hb.disable_item_expand (l_btn)
			create l_btn.make_with_text_and_action ("-", agent remove_exclude)
			l_btn.set_minimum_width (small_button_width)
			hb.extend (l_btn)
			hb.disable_item_expand (l_btn)
			...
			create l_btn.make_with_text_and_action ("+", agent add_include)
			l_btn.set_minimum_width (small_button_width)
			hb.extend (l_btn)
			hb.disable_item_expand (l_btn)
			create l_btn.make_with_text_and_action ("-", agent remove_include)
			l_btn.set_minimum_width (small_button_width)
			hb.extend (l_btn)
			hb.disable_item_expand (l_btn)
