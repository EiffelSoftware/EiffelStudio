...
-----------------------------------------------------------*/
{
  ...
  hr = p_IViewObjectEx->Draw(tmp_dw_draw_aspect,tmp_lindex,tmp_pv_aspect,ptd,tmp_hdc_target_dev,tmp_hdc_draw,lprc_bounds,lprc_wbounds,p_continue);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IViewObjectEx->GetColorSet(tmp_dw_draw_aspect,tmp_lindex,tmp_pv_aspect,ptd,tmp_hic_target_dev,tmp_pp_color_set);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IViewObjectEx->Freeze(tmp_dw_draw_aspect,tmp_lindex,tmp_pv_aspect,tmp_pdw_freeze);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
