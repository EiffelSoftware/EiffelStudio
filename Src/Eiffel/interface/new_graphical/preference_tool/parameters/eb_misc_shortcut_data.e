...
feature {NONE} -- Modifiable shortcuts
	...
	show_tool_shortcuts: like default_shortcut_actions is
		...
		do
			...
			l_hash.put ([True, True, False, key_strings.item (Key_e).twin.as_string_8], "show_error_tool")
			l_hash.put ([True, True, False, key_strings.item (Key_w).twin.as_string_8], "show_warning_tool")
