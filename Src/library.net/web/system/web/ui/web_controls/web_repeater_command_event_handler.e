...
frozen external class
	WEB_REPEATER_COMMAND_EVENT_HANDLER
...
create
	make_web_repeater_command_event_handler

feature {NONE} -- Initialization

	frozen make_web_repeater_command_event_handler (object: SYSTEM_OBJECT; method: POINTER) is
		external
			"IL creator signature (System.Object, System.IntPtr) use System.Web.UI.WebControls.RepeaterCommandEventHandler"
		end

feature -- Basic Operations

	begin_invoke (source: SYSTEM_OBJECT; e: WEB_REPEATER_COMMAND_EVENT_ARGS; callback: ASYNC_CALLBACK; object: SYSTEM_OBJECT): IASYNC_RESULT is
		external
	...
	invoke (source: SYSTEM_OBJECT; e: WEB_REPEATER_COMMAND_EVENT_ARGS) is
		external
...
end -- class WEB_REPEATER_COMMAND_EVENT_HANDLER
