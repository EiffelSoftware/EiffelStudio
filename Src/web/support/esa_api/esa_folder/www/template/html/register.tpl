         ...
         <div class="col-lg-12">
          <form class="form-inline well" data-rel="register" id="registerHere" method='POST' action='{$host/}/register' itemprop="create">
            ...
            <legend><h1>Registration</h1></legend>
              <div class="span3"><p>Register yourself with Eiffel's web site, it's quick and free. 
            ...
            <div class="row">
               <div class="col-md-12">
                <div class="row">
                  <div class="col-md-4">  
                    <label class="control-label-api2" itemprop="first_name" >First Name</label>
            ...
            <div class="row">
             <div class="col-md-12">
              <div class="row">
                <div class="col-md-4">  
                   <label class="control-label-api2" itemprop="last_name">Last Name</label>
            ...
            <div class="row">
             <div class="col-md-12">
              <div class="row">
                <div class="col-md-4">  
                <label class="control-label-api2" itemprop="email">Email</label>
            ...
            <div class="row">
             <div class="col-md-12">
              <div class="row">
                <div class="col-md-4">  
                 <label class="control-label-api2" itemprop="user_name">User Name</label>
            ...
            <div class="row">
             <div class="col-md-12">
              <div class="row">
                <div class="col-md-4">  
                  <label class="control-label-api2" itemprop="password">Password</label>
            ...
            <div class="row">
             <div class="col-md-12">
              <div class="row">
                <div class="col-md-4">  
                  <label class="control-label-api2" itemprop="check_password">Re-type Password</label>
           ...
           <div class="row">
             <div class="col-md-12">
              <div class="row">
                <div class="col-md-4">  
                <label class="control-label-api2" for="input01">Security question</label>
           ...
           <div class="row">
             <div class="col-md-12">
              <div class="row">
                <div class="col-md-4">  
                <label class="control-label-api2" itemprop="answer">Answer</label>
