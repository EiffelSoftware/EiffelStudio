indexing
	description	: "Dialog asking the user if he really wants to quit the application"
	author		: "Arnaud PICHERY [aranud@mail.dotcom.fr]"
	date		: "$Date$"
	revision	: "$Revision$"

class
	EB_CONFIRM_EXIT_DIALOG
...
feature {NONE} -- Deferred Constants
	...
	confirmation_message_label: STRING is
		...
		do
			Result := Interface_names.l_Exit_application
		end
