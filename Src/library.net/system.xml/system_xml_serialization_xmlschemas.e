...
feature -- Element Change
	...
	frozen put_i_th (index: INTEGER; value: SYSTEM_XML_SCHEMA_XMLSCHEMA) is
		external
...
feature -- Basic Operations
	...
	frozen has (schema: SYSTEM_XML_SCHEMA_XMLSCHEMA): BOOLEAN is
		external
	...
	frozen extend (schemas: SYSTEM_XML_SERIALIZATION_XMLSCHEMAS) is
		external
