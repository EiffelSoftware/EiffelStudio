...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_175 (eif_access (rgelt), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_175 ((BSTR *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_175 (tmp_rgelt);
grt_ce_Eif_compiler.ccom_free_memory_pointed_176 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumObjectFiles * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_170 (eif_access (ppenum), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_170 ((ecom_eiffel_compiler::IEnumObjectFiles * *)tmp_ppenum, ppenum);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_170 (tmp_ppenum);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_177 (eif_access (rgelt), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_177 ((BSTR *)tmp_rgelt, rgelt);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_177 (tmp_rgelt);
