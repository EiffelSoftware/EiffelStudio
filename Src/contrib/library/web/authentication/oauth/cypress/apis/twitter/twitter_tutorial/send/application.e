note
	description: "[
					Here will show how to post a tweet calling the endpoint 1.1/statuses/update.json, Updates the authenticating user’s current status, also known as Tweeting.
					Go to https://dev.twitter.com/apps  
					1. register a new application.
					2. Go to permissions tab and set it to read and write.
					3. On Keys and Access Tokens page click "Create my access token" to generate an access token and secret.
	...
	EIS: "name=Post a tweet", "src=https://api.twitter.com/1.1/statuses/update.json", "protocol=uri"
...
feature {NONE} -- Twitter ID
	...
	twitter_screen_name : STRING = "Eiffel_Language"
			-- Tweet id to read.
