...
d:\com_wizard_cmd\EIFGEN\W_code\com_wizard_cmd.exe -new_com_project -com_file %2 -destination D:\testing_server\%1 -server -automation -compile_c -compile_eiffel -stop_on_error -output_none -not_spawn_ebench
