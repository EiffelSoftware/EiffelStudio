...
description: "Represents nonterminal <case>(75[2.3])";
keywords: "case";
...
feature { CONCRETE_SYNTAX_PARSER, SEMANTIC_VISITOR }
    ...
    set_element_spec (es : ELEMENT_SPEC) is
...
----------------------------------------------------
    ...
    is_default : BOOLEAN is
        ...
        do
            result := (component_count = 1 and then
                       component_at (1).is_default)
        end
----------------------------------------------------
