...
feature -- HTML
	...
	code_template_file_name: STRING 
	...
	empty_html_template_file_name: STRING
...
feature -- XML
	...
	header_xml_template_file_name: STRING
	...
	footer_xml_template_file_name: STRING
...
feature -- Web Help Files
	...
	html_tree_toc_template_file_name: STRING
	...
	html_simple_toc_template_file_name: STRING
	...
	html_filter_template_file_name: STRING
	...
	html_simple_filter_template_file_name: STRING
			-- HTML template file for left side filter code
		local
			l_file_path: FILE_NAME
		once
	...
	web_help_project_template_file_name: STRING
	...
	html_simple_toc_file_name: STRING
...
feature -- Access
	...
	html_title_token: STRING = "[!Title!]"
			-- Title tag token
	
	html_content_token: STRING = "[!Content!]"
			-- Content token
	
	html_stylesheet_token: STRING = "[!Stylesheet!]"
			-- Stylesheet token
			
	html_product_token: STRING = "[!Product!]"
			-- Token to indicate output product
	
	html_navigation_token: STRING = "[!Navigation!]"
			-- Token to replace with document navigation
	
	html_filter_token: STRING = "[!FilterHTML!]"
			-- Token to replace with document HTML filter
	
	html_filter_search_token: STRING = "[!FilterSearchHTML!]"
			-- Token to replace with document HTML filter for search form
	
	html_toc_token: STRING = "[!TOCHTML!]"
			-- Token to replace with document HTML toc
			
	html_toc_script_token: STRING = "[!TOCScript!]"
			-- Token for location of toc javascript

	html_toc_style_token: STRING = "[!TOCStyle!]"
			-- Token for location of toc stylesheet
	
	html_default_toc_token: STRING = "[!DefaultTOC!]"
			-- Token to replace default document toc
			
	html_default_filter_token: STRING = "[!DefaultFilter!]"
			-- Token to replace default document filter
	
	html_default_index_token: STRING = "[!DefaultIndex!]"
			-- Token to replace default index document
	
	filter_frame_size_token: STRING = "[!FilterFrameSize!]"
			-- Token to replace filter frame size
	
	html_subtoc_hash_token: STRING = "[!TOCHash!]"
			-- Token to replace with sub-toc hash 
	
	chart_suffix: STRING = "_chart"
			-- Suffix for code chart view files
		
	contract_suffix: STRING = "_flatshort"
			-- Suffix for code contract view
			
feature -- Query

	replace_token (text, a_token, new_text: STRING)
