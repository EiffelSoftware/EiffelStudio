...
feature -- Access
	...
	target: ECD_EXPRESSION
			-- Assignment target
	
	source: ECD_EXPRESSION
			-- Assignment source
	...
	code: STRING is
		...
		local
			cast: ECD_CAST_EXPRESSION
			create_expression: ECD_OBJECT_CREATE_EXPRESSION
			create_array_expression: ECD_ARRAY_CREATE_EXPRESSION
		do
			check
...
end -- class ECD_ASSIGN_STATEMENT
