...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClusterProperties * *)grt_ec_ISE_c.ccom_ec_pointed_cell_182 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_182 ((ecom_eiffel_compiler::IEiffelClusterProperties * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_182 (tmp_rgelt);
grt_ce_ISE_c.ccom_free_memory_pointed_185 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumClusterProp * *)grt_ec_ISE_c.ccom_ec_pointed_cell_179 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_179 ((ecom_eiffel_compiler::IEnumClusterProp * *)tmp_ppenum, ppenum);
