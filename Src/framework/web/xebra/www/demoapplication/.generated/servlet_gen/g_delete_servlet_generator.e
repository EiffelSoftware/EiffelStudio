	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 14 row: 2 of file: ./delete.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 14 row: 2 of file: ./delete.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 14 row: 1 of file: ./delete.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 14 row: 1 of file: ./delete.xeb"
			...
			stack.put (temp)
				-- line: 4 row: 6 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 6 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 7 row: 1 of file: ./delete.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 7 row: 1 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_dynamic_attribute("render", "not_authenticated_admin")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "container"
			stack.put (temp)
				-- line: 5 row: 8 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 8 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N      ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 6 row: 1 of file: ./delete.xeb
			create {XTAG_XEB_REDIRECT_TAG} temp.make
			temp.debug_information := "line: 6 row: 1 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("url", "login.xeb")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "redirect"
				-- line: 6 row: 6 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 6 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 7 row: 6 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 7 row: 6 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 12 row: 1 of file: ./delete.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 12 row: 1 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_dynamic_attribute("render", "authenticated_admin")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "container"
			stack.put (temp)
				-- line: 8 row: 8 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 8 row: 8 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N      ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 11 row: 1 of file: ./delete.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 11 row: 1 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "p"
			stack.put (temp)
				-- line: 9 row: 10 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 9 row: 10 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N        ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 10 row: 1 of file: ./delete.xeb
			create {XTAG_XEB_DISPLAY_TAG} temp.make
			temp.debug_information := "line: 10 row: 1 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_dynamic_attribute("text", "delete")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "display"
				-- line: 10 row: 8 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 10 row: 8 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N      ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 11 row: 6 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 11 row: 6 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 12 row: 4 of file: ./delete.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 12 row: 4 of file: ./delete.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N  ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
