...
#include "ecom_EiffelComCompiler_IEiffelHtmlDocumentationGenerator_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_p_ieiffel_html_documentation_events = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_interface_235 (p_ieiffel_html_documentation_events));
