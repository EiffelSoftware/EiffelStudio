indexing
	...
	external_name: "System.Web.UI.WebControls.CheckBoxList"

external class
	SYSTEM_WEB_UI_WEBCONTROLS_CHECKBOXLIST
...
feature {NONE} -- Initialization
	...
	frozen make_checkboxlist is
		external
			"IL creator use System.Web.UI.WebControls.CheckBoxList"
		end
...
feature -- Access
	...
	get_cell_spacing: INTEGER is
		external
			"IL signature (): System.Int32 use System.Web.UI.WebControls.CheckBoxList"
		alias
			"get_CellSpacing"
		end
	...
	get_text_align: SYSTEM_WEB_UI_WEBCONTROLS_TEXTALIGN is
		external
			"IL signature (): System.Web.UI.WebControls.TextAlign use System.Web.UI.WebControls.CheckBoxList"
		alias
			"get_TextAlign"
		end
	...
	get_repeat_layout: SYSTEM_WEB_UI_WEBCONTROLS_REPEATLAYOUT is
		external
			"IL signature (): System.Web.UI.WebControls.RepeatLayout use System.Web.UI.WebControls.CheckBoxList"
		alias
			"get_RepeatLayout"
		end
	...
	get_repeat_direction: SYSTEM_WEB_UI_WEBCONTROLS_REPEATDIRECTION is
		external
			"IL signature (): System.Web.UI.WebControls.RepeatDirection use System.Web.UI.WebControls.CheckBoxList"
		alias
			"get_RepeatDirection"
		end
...
feature -- Element Change
	...
	set_cell_spacing (value: INTEGER) is
		external
			"IL signature (System.Int32): System.Void use System.Web.UI.WebControls.CheckBoxList"
		alias
			"set_CellSpacing"
		end
	...
	set_text_align (value: SYSTEM_WEB_UI_WEBCONTROLS_TEXTALIGN) is
		external
			"IL signature (System.Web.UI.WebControls.TextAlign): System.Void use System.Web.UI.WebControls.CheckBoxList"
		alias
			"set_TextAlign"
		end
	...
	set_repeat_direction (value: SYSTEM_WEB_UI_WEBCONTROLS_REPEATDIRECTION) is
		external
			"IL signature (System.Web.UI.WebControls.RepeatDirection): System.Void use System.Web.UI.WebControls.CheckBoxList"
		alias
			"set_RepeatDirection"
		end
	...
	set_repeat_layout (value: SYSTEM_WEB_UI_WEBCONTROLS_REPEATLAYOUT) is
		external
			"IL signature (System.Web.UI.WebControls.RepeatLayout): System.Void use System.Web.UI.WebControls.CheckBoxList"
		alias
			"set_RepeatLayout"
		end
...
feature {NONE} -- Implementation
	...
	frozen system_web_ui_web_controls_irepeat_info_user_get_has_footer: BOOLEAN is
		external
			"IL signature (): System.Boolean use System.Web.UI.WebControls.CheckBoxList"
		alias
	...
	create_control_style: SYSTEM_WEB_UI_WEBCONTROLS_STYLE is
		external
			"IL signature (): System.Web.UI.WebControls.Style use System.Web.UI.WebControls.CheckBoxList"
		alias
			"CreateControlStyle"
		end
	...
	frozen system_web_ui_web_controls_irepeat_info_user_get_item_style (item_type: SYSTEM_WEB_UI_WEBCONTROLS_LISTITEMTYPE; repeat_index: INTEGER): SYSTEM_WEB_UI_WEBCONTROLS_STYLE is
		external
			"IL signature (System.Web.UI.WebControls.ListItemType, System.Int32): System.Web.UI.WebControls.Style use System.Web.UI.WebControls.CheckBoxList"
		alias
	...
	frozen system_web_ui_ipost_back_data_handler_load_post_data (post_data_key: STRING; post_collection: SYSTEM_COLLECTIONS_SPECIALIZED_NAMEVALUECOLLECTION): BOOLEAN is
		external
			"IL signature (System.String, System.Collections.Specialized.NameValueCollection): System.Boolean use System.Web.UI.WebControls.CheckBoxList"
		alias
	...
	on_pre_render (e: SYSTEM_EVENTARGS) is
		external
			"IL signature (System.EventArgs): System.Void use System.Web.UI.WebControls.CheckBoxList"
		alias
			"OnPreRender"
		end
	...
	render (writer: SYSTEM_WEB_UI_HTMLTEXTWRITER) is
		external
			"IL signature (System.Web.UI.HtmlTextWriter): System.Void use System.Web.UI.WebControls.CheckBoxList"
		alias
			"Render"
		end
	...
	frozen system_web_ui_ipost_back_data_handler_raise_post_data_changed_event is
		external
			"IL signature (): System.Void use System.Web.UI.WebControls.CheckBoxList"
		alias
	...
	frozen system_web_ui_web_controls_irepeat_info_user_render_item (item_type: SYSTEM_WEB_UI_WEBCONTROLS_LISTITEMTYPE; repeat_index: INTEGER; repeat_info: SYSTEM_WEB_UI_WEBCONTROLS_REPEATINFO; writer: SYSTEM_WEB_UI_HTMLTEXTWRITER) is
		external
			"IL signature (System.Web.UI.WebControls.ListItemType, System.Int32, System.Web.UI.WebControls.RepeatInfo, System.Web.UI.HtmlTextWriter): System.Void use System.Web.UI.WebControls.CheckBoxList"
		alias
			"System.Web.UI.WebControls.IRepeatInfoUser.RenderItem"
		end

	find_control_string_int32 (id: STRING; path_offset: INTEGER): SYSTEM_WEB_UI_CONTROL is
		external
			"IL signature (System.String, System.Int32): System.Web.UI.Control use System.Web.UI.WebControls.CheckBoxList"
		alias
			"FindControl"
		end
...
end -- class SYSTEM_WEB_UI_WEBCONTROLS_CHECKBOXLIST
