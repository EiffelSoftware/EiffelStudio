...
class
	ECDP_ATTRIBUTE_REFERENCE_EXPRESSION
...
feature -- Access
	...
	code: STRING is
		...
		local
			reference_expression: ECDP_TYPE_REFERENCE_EXPRESSION
			this_expression: ECDP_THIS_REFERENCE_EXPRESSION
...
end -- class ECDP_ATTRIBUTE_REFERENCE_EXPRESSION
