...
deferred class STRING_COMPOSITE_ELEMENT
...
------------------------------------------------------
    ...
    add_component (elemnt : STRING) is
...
------------------------------------------------------
    ...
    component_at (index : INTEGER) : STRING is
...
------------------------------------------------------
feature { STRING_COMPOSITE_ELEMENT }

    components : INDEXED_LIST [STRING]

end -- class STRING_COMPOSITE_ELEMENT
