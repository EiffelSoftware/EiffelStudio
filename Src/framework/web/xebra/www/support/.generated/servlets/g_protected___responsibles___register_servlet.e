...
class
	G_PROTECTED___RESPONSIBLES___REGISTER_SERVLET
...
feature-- Implementation
	...
	render_html_page (request: XH_REQUEST; response: XH_RESPONSE)
		...
		do
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_145)
				-- line: 3 row: 67 of file: ./protected/responsibles/register.xeb
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_146)
				-- line: 9 row: 1 of file: ./protected/responsibles/register.xeb
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_148)
				-- line: 12 row: 1 of file: ./protected/responsibles/register.xeb
			response.append ({G_SERVLET_CONSTANTS}.class_temp_22)
