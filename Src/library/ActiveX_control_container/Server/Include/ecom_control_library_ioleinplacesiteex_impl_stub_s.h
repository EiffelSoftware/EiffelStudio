...
#ifndef __ECOM_CONTROL_LIBRARY_IOLEINPLACESITEEX_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IOLEINPLACESITEEX_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
{
class IOleInPlaceSiteEx_impl_stub;
}
...
namespace ecom_control_library
{
class IOleInPlaceSiteEx_impl_stub : public ecom_control_library::IOleInPlaceSiteEx
{
public:
  IOleInPlaceSiteEx_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IOleInPlaceSiteEx_impl_stub ();
