...
void ecom_control_library::IAdviseSink_impl_proxy::ccom_on_data_change(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc,  /* [in] */ EIF_OBJECT p_stgmed )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IAdviseSink->OnDataChange(p_formatetc,tmp_p_stgmed);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IAdviseSink->OnViewChange(tmp_dw_aspect,tmp_lindex);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSink_impl_proxy::ccom_on_rename(  /* [in] */ ecom_control_library::IMoniker * pmk )
