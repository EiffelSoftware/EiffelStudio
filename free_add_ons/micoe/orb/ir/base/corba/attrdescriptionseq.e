...
feature
    ...
    get_value (index : INTEGER) : CORBA_ATTRIBUTEDESCRIPTION is
    ...
    set_value (value : CORBA_ATTRIBUTEDESCRIPTION; index : INTEGER) is
...
feature { NONE }
    ...
    bound : INTEGER
    store : ARRAY [CORBA_ATTRIBUTEDESCRIPTION]
...
feature { ANY }
    ...
    type_name : STRING is
        ...
        do
            result := "AttrDescriptionSeq"
        end

end -- class CORBA_ATTRDESCRIPTIONSEQ
