...
feature -- Basic Operations
	...
	next (celt: INTEGER; rgvar: ECOM_VARIANT; pcelt_fetched: INTEGER_REF)
...
feature {NONE}  -- Externals
	...
	ccom_next (cpp_obj: POINTER; celt: INTEGER; rgvar: POINTER; pcelt_fetched: INTEGER_REF)
			-- No description available.
		external
	...
	ccom_clone1 (cpp_obj: POINTER; ppenum: CELL [IENUM_VARIANT_INTERFACE])
			-- No description available.
		external
			"C++ [IEnumVARIANT1_impl_proxy %"ecom_IEnumVARIANT1_impl_proxy.h%"](EIF_OBJECT)"
		end

	ccom_delete_ienum_variant1_impl_proxy (a_pointer: POINTER)
			-- Release resource
		external
			"C++ [delete IEnumVARIANT1_impl_proxy %"ecom_IEnumVARIANT1_impl_proxy.h%"]()"
		end

	ccom_create_ienum_variant1_impl_proxy_from_pointer (a_pointer: POINTER): POINTER
			-- Create from pointer
		external
