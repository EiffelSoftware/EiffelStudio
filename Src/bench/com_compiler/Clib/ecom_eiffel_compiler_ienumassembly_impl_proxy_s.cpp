...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelAssemblyProperties * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_180 (eif_access (rgelt), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_180 ((ecom_eiffel_compiler::IEiffelAssemblyProperties * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_180 (tmp_rgelt);
grt_ce_Eif_compiler.ccom_free_memory_pointed_197 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumAssembly * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_189 (eif_access (ppenum), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_189 ((ecom_eiffel_compiler::IEnumAssembly * *)tmp_ppenum, ppenum);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_189 (tmp_ppenum);
