...
#include "ecom_eiffel_compiler_IEnumCluster_impl_proxy.h"
...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClusterDescriptor * *)grt_ec_ISE_c.ccom_ec_pointed_cell_46 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_46 ((ecom_eiffel_compiler::IEiffelClusterDescriptor * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_46 (tmp_rgelt);
grt_ce_ISE_c.ccom_free_memory_pointed_121 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumCluster * *)grt_ec_ISE_c.ccom_ec_pointed_cell_39 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_39 ((ecom_eiffel_compiler::IEnumCluster * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_39 (tmp_ppenum);
