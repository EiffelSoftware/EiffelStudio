...
feature -- Access
	...
	catch_statements: LINKED_LIST [ECD_STATEMENT]
			-- Catch statements
	...
	code: STRING is
			...
			-- TO BE DONE!!!
		local
			a_statement: ECD_STATEMENT
			a_event_manager: ECD_EVENT_MANAGER
		do
			create a_event_manager
			a_event_manager.raise_event (feature {ECD_EVENTS_IDS}.Not_implemented, ["catch clause entity"])
...
feature -- Basic Operations
	...
	add_catch_statement (a_statement: ECD_STATEMENT) is
