...
feature {NONE} -- Initialization
	...
	make is
		...
		do
			...
			create tool_bar_button4.make --Cmd_bold
			tool_bar_button4.set_style (Tbstyle_check)
			tool_bar_button4.set_state (Tbstate_enabled)
			tool_bar_button4.set_bitmap_index (bitmap_index2 + 0)

			create tool_bar_button5.make --Cmd_italic
			tool_bar_button5.set_style (Tbstyle_check)
			tool_bar_button5.set_state (Tbstate_enabled)
			tool_bar_button5.set_bitmap_index (bitmap_index2 + 1)

			create tool_bar_button6.make_separator

			create tool_bar_button7.make --Cmd_progress_bar
			tool_bar_button7.set_style (Tbstyle_button)
			tool_bar_button7.set_state (Tbstate_enabled)
			tool_bar_button7.set_bitmap_index (bitmap_index2 + 2)

			create tool_bar_button8.make --Cmd_exit
			tool_bar_button8.set_style (Tbstyle_button)
			tool_bar_button8.set_state (Tbstate_enabled)
			tool_bar_button8.set_bitmap_index (bitmap_index2 + 3)
...
feature {NONE} -- Implementation
	...
	main_menu: WEL_MENU is
		...
		once 
			...
			file_menu.append_string ("&Progress bar demonstration", Cmd_progress_bar)
			file_menu.append_separator
			file_menu.append_string ("E&xit", Cmd_exit)
