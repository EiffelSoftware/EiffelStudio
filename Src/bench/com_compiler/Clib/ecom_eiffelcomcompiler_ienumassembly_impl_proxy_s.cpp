...
#include "ecom_EiffelComCompiler_IEnumAssembly_impl_proxy_s.h"
...
EIF_INTEGER ecom_EiffelComCompiler::IEnumAssembly_impl_proxy::ccom_last_error_code()
...
EIF_REFERENCE ecom_EiffelComCompiler::IEnumAssembly_impl_proxy::ccom_last_source_of_exception()
...
EIF_REFERENCE ecom_EiffelComCompiler::IEnumAssembly_impl_proxy::ccom_last_error_description()
...
EIF_REFERENCE ecom_EiffelComCompiler::IEnumAssembly_impl_proxy::ccom_last_error_help_file()
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ieiffel_assembly_properties = (ecom_EiffelComCompiler::IEiffelAssemblyProperties * *)grt_ec_ISE.ccom_ec_pointed_cell_139 (eif_access (pp_ieiffel_assembly_properties), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_139 ((ecom_EiffelComCompiler::IEiffelAssemblyProperties * *)tmp_pp_ieiffel_assembly_properties, pp_ieiffel_assembly_properties);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pul_fetched, pul_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_139 (tmp_pp_ieiffel_assembly_properties);
grt_ce_ISE.ccom_free_memory_pointed_140 (tmp_pul_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_pp_ienum_assembly = (ecom_EiffelComCompiler::IEnumAssembly * *)grt_ec_ISE.ccom_ec_pointed_cell_46 (eif_access (pp_ienum_assembly), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_46 ((ecom_EiffelComCompiler::IEnumAssembly * *)tmp_pp_ienum_assembly, pp_ienum_assembly);
	
	grt_ce_ISE.ccom_free_memory_pointed_46 (tmp_pp_ienum_assembly);
