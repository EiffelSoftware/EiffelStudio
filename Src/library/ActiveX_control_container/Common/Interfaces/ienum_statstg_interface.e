...
feature -- Status Report
	...
	remote_next_user_precondition (celt: INTEGER; rgelt: TAG_STATSTG_RECORD; pcelt_fetched: INTEGER_REF): BOOLEAN is
	...
	clone1_user_precondition (ppenum: CELL [IENUM_STATSTG_INTERFACE]): BOOLEAN is
