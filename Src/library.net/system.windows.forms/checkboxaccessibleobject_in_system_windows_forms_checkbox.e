...
external class
	CHECKBOXACCESSIBLEOBJECT_IN_SYSTEM_WINDOWS_FORMS_CHECKBOX
...
create
	make_checkboxaccessibleobject

feature {NONE} -- Initialization

	frozen make_checkboxaccessibleobject (owner: SYSTEM_WINDOWS_FORMS_CONTROL) is
		external
...
end -- class CHECKBOXACCESSIBLEOBJECT_IN_SYSTEM_WINDOWS_FORMS_CHECKBOX
