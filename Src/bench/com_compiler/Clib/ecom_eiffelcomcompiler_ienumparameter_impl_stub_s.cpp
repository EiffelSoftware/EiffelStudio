...
STDMETHODIMP ecom_EiffelComCompiler::IEnumParameter_impl_stub::Next(  /* [out] */ ecom_EiffelComCompiler::IEiffelParameterDescriptor * * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_122 (rgelt, NULL));
		if (*rgelt != NULL)
			(*rgelt)->AddRef ();
	}
	...
	if (*rgelt != NULL)
		(*rgelt)->Release ();
	grt_ec_ISE.ccom_ec_pointed_cell_122 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumParameter_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumParameter_impl_stub::Clone(  /* [out] */ ecom_EiffelComCompiler::IEnumParameter * * ppenum )
...
-----------------------------------------------------------*/
{
	...
	if (ppenum != NULL)
	{
		tmp_ppenum = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_95 (ppenum, NULL));
		if (*ppenum != NULL)
			(*ppenum)->AddRef ();
	}
	...
	if (*ppenum != NULL)
		(*ppenum)->Release ();
	grt_ec_ISE.ccom_ec_pointed_cell_95 (((tmp_ppenum != NULL) ? eif_wean (tmp_ppenum) : NULL), ppenum);
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumParameter_impl_stub::ith_item(  /* [in] */ ULONG an_index, /* [out] */ ecom_EiffelComCompiler::IEiffelParameterDescriptor * * rgelt )
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumParameter_impl_stub::count(  /* [out, retval] */ ULONG * return_value )
