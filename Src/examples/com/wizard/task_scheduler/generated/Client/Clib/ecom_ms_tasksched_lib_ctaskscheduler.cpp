...
#include "ecom_MS_TaskSched_lib_CTaskScheduler.h"
static const CLSID CLSID_CTaskScheduler_ = {0x148bd52a,0xa2ab,0x11ce,{0xb1,0x1f,0x00,0xaa,0x00,0x53,0x05,0x03}};

static const IID IID_ITaskScheduler_ = {0x148bd527,0xa2ab,0x11ce,{0xb1,0x1f,0x00,0xaa,0x00,0x53,0x05,0x03}};

ecom_MS_TaskSched_lib::CTaskScheduler::CTaskScheduler()
{
	HRESULT hr;
	...
	hr = CoCreateInstanceEx (CLSID_CTaskScheduler_, NULL, CLSCTX_INPROC_SERVER, NULL, 1, &a_qi);
	rt.ccom_check_hresult (hr);
...
ecom_MS_TaskSched_lib::CTaskScheduler::CTaskScheduler( IUnknown * a_pointer )
{
	 HRESULT hr, hr2;
	hr = CoInitializeEx (NULL, COINIT_APARTMENTTHREADED);
	rt.ccom_check_hresult (hr);
...
void ecom_MS_TaskSched_lib::CTaskScheduler::ccom_set_target_computer(  /* [in] */ EIF_OBJECT pwsz_computer )
...
void ecom_MS_TaskSched_lib::CTaskScheduler::ccom_get_target_computer(  /* [out] */ EIF_OBJECT ppwsz_computer )
...
void ecom_MS_TaskSched_lib::CTaskScheduler::ccom_enum(  /* [out] */ EIF_OBJECT pp_enum_work_items )
...
void ecom_MS_TaskSched_lib::CTaskScheduler::ccom_activate(  /* [in] */ EIF_OBJECT pwsz_name,  /* [in] */ GUID * a_riid,  /* [out] */ EIF_OBJECT pp_unk )
...
void ecom_MS_TaskSched_lib::CTaskScheduler::ccom_delete(  /* [in] */ EIF_OBJECT pwsz_name )
...
void ecom_MS_TaskSched_lib::CTaskScheduler::ccom_new_work_item(  /* [in] */ EIF_OBJECT pwsz_task_name,  /* [in] */ GUID * rclsid,  /* [in] */ GUID * a_riid,  /* [out] */ EIF_OBJECT pp_unk )
...
void ecom_MS_TaskSched_lib::CTaskScheduler::ccom_add_work_item(  /* [in] */ EIF_OBJECT pwsz_task_name,  /* [in] */ ecom_MS_TaskSched_lib::IScheduledWorkItem * p_work_item )
...
void ecom_MS_TaskSched_lib::CTaskScheduler::ccom_is_of_type(  /* [in] */ EIF_OBJECT pwsz_name,  /* [in] */ GUID * a_riid )
...
EIF_POINTER ecom_MS_TaskSched_lib::CTaskScheduler::ccom_item()
