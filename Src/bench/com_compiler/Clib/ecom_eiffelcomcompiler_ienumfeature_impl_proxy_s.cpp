...
void ecom_EiffelComCompiler::IEnumFeature_impl_proxy::ccom_next(  /* [out] */ EIF_OBJECT rgelt,  /* [out] */ EIF_OBJECT pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	ecom_EiffelComCompiler::IEiffelFeatureDescriptor * * tmp_rgelt = 0;
	tmp_rgelt = (ecom_EiffelComCompiler::IEiffelFeatureDescriptor * *)grt_ec_ISE.ccom_ec_pointed_cell_57 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_57 ((ecom_EiffelComCompiler::IEiffelFeatureDescriptor * *)tmp_rgelt, rgelt);
...
void ecom_EiffelComCompiler::IEnumFeature_impl_proxy::ccom_skip(  /* [in] */ EIF_INTEGER celt )
...
void ecom_EiffelComCompiler::IEnumFeature_impl_proxy::ccom_clone1(  /* [out] */ EIF_OBJECT ppenum )
...
-----------------------------------------------------------*/
{
	...
	ecom_EiffelComCompiler::IEnumFeature * * tmp_ppenum = 0;
	tmp_ppenum = (ecom_EiffelComCompiler::IEnumFeature * *)grt_ec_ISE.ccom_ec_pointed_cell_60 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_60 ((ecom_EiffelComCompiler::IEnumFeature * *)tmp_ppenum, ppenum);
...
void ecom_EiffelComCompiler::IEnumFeature_impl_proxy::ccom_ith_item(  /* [in] */ EIF_INTEGER an_index,  /* [out] */ EIF_OBJECT rgelt )
