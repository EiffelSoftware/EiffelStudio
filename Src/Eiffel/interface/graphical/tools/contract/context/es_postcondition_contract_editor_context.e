note
	description: "[
		A contract editor ({ES_CONTRACT_EDITOR_WIDGET}) context for feature postcondition contracts.
	]"
...
feature {NONE} -- Factory
	...
	create_text_modifier: attached ES_POSTCONDITION_CONTRACT_TEXT_MODIFIER
			-- <Precursor>
		do
			create Result.make (context_feature, context_class)
		end

	create_parent_text_modifier (a_parent: attached CLASS_C): attached ES_POSTCONDITION_CONTRACT_TEXT_MODIFIER
			-- <Precursor>
		local
			l_class_i: CLASS_I
		do
