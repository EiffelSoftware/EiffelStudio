...
#define RTS_CF(rid,n,t,a,r) \
	{                                                         \
		...
		eif_log_call (l_scoop_processor_id, l_scoop_region_id, (call_data*) a); \
	}

/* TODO: For separate creation procedures, RTS_SD is not generated by the compiler. Therefore we need to compute l_scoop_processor_id again. */
#define RTS_CP(rid,n,t,a) {\
		((call_data*)(a)) -> routine_id = rid; \
		eif_log_call (eif_globals->scoop_processor_id, eif_globals->scoop_region_id, (call_data*) a); \
	}
