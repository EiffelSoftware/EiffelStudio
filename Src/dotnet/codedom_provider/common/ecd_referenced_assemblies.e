...
class
	ECD_REFERENCED_ASSEMBLIES

feature -- Access

	referenced_assemblies: LINKED_LIST [ECD_REFERENCED_ASSEMBLY] is
...
feature -- Status Setting
	...
	add_referenced_assembly (a_referenced_assembly: ECD_REFERENCED_ASSEMBLY) is
	...
	add_referenced_assembly_with_prefix (a_referenced_assembly: ASSEMBLY; a_prefix: STRING) is
		...
		local
			l_referenced_assembly: ECD_REFERENCED_ASSEMBLY
		do
...
end -- Class ECD_REFERENCED_ASSEMBLIES