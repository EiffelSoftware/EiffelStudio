...
void ecom_control_library::IBindCtx_impl_proxy::ccom_set_bind_options(  /* [in] */ ecom_control_library::tagBIND_OPTS2 * pbindopts )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IBindCtx->SetBindOptions((struct tagBIND_OPTS *)pbindopts);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IBindCtx_impl_proxy::ccom_get_bind_options(  /* [in, out] */ ecom_control_library::tagBIND_OPTS2 * pbindopts )
...
-----------------------------------------------------------*/
{
  ...
  hr = p_IBindCtx->GetBindOptions((struct tagBIND_OPTS *)pbindopts);
  if (FAILED (hr))
  {
    if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
      com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
  ...
  ::IRunningObjectTable * * tmp_pprot = 0;
  tmp_pprot = (::IRunningObjectTable * *)grt_ec_control_interfaces2.ccom_ec_pointed_cell_86 (eif_access (pprot), NULL);
  ...
  grt_ce_control_interfaces2.ccom_ce_pointed_cell_86 ((::IRunningObjectTable * *)tmp_pprot, pprot);
