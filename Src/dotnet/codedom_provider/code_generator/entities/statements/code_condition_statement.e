...
feature -- Access
	...
	true_statements: LINKED_LIST [CODE_STATEMENT]
			-- True statements
			
	false_statements: LINKED_LIST [CODE_STATEMENT]
			-- False statements
...
feature -- Status Setting
	...
	add_true_statement (a_statement: CODE_STATEMENT) is
	...
	add_false_statement (a_statement: CODE_STATEMENT) is
