...
feature -- Access
	...
	condition: ECD_EXPRESSION
			-- Condition
			
	true_statements: LINKED_LIST [ECD_STATEMENT]
			-- True statements
			
	false_statements: LINKED_LIST [ECD_STATEMENT]
			-- False statements
...
feature -- Status Setting
	...
	add_true_statement (a_statement: ECD_STATEMENT) is
	...
	add_false_statement (a_statement: ECD_STATEMENT) is
...
end -- class ECD_CONDITION_STATEMENT
