...
feature -- Access
	...
	init_statement: ECDP_STATEMENT
			-- Initialization statement
			
	test_expression: ECDP_EXPRESSION
			-- Test expression
	
	loop_statements: LINKED_LIST [ECDP_STATEMENT]
			-- | ARRAY_LIST [ECDP_STATEMENT]
			-- Loop statements
			
	increment_statement: ECDP_STATEMENT
			-- Increment statement
...
feature -- Status Setting
	...
	add_loop_statement (a_statement: ECDP_STATEMENT) is
...
feature {NONE} -- Implementation
	...
	is_statement_ready (a_statement: ECDP_STATEMENT): BOOLEAN is
...
end -- class ECDP_ITERATION_STATEMENT
