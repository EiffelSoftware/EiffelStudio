...
feature
    ...
    get_value (index : INTEGER) : CORBA_EXCEPTIONDESCRIPTION is
    ...
    set_value (value : CORBA_EXCEPTIONDESCRIPTION; index : INTEGER) is
...
feature { NONE }
    ...
    bound : INTEGER
    store : ARRAY [CORBA_EXCEPTIONDESCRIPTION]
...
end -- class CORBA_EXCDESCRIPTIONSEQ
