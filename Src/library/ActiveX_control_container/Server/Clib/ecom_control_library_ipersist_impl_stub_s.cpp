...
#include "ecom_control_library_IPersist_impl_stub_s.h"
...
ecom_control_library::IPersist_impl_stub::IPersist_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IPersist_impl_stub::~IPersist_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IPersist_impl_stub::IPersist_GetClassID(  /* [out] */ GUID * p_class_id )
...
STDMETHODIMP_(ULONG) ecom_control_library::IPersist_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IPersist_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IPersist_impl_stub::QueryInterface( REFIID riid, void ** ppv )
