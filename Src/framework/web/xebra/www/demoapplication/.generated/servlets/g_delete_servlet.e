...
feature-- Access
	...
	controller_1: DELETE_CONTROLLER
	...
	set_all_booleans (request: XH_REQUEST; response: XH_RESPONSE)
		...
		do
			...
			render_conditions ["class_temp_1"] := controller_2.not_authenticated
				...
				-- line: 7 row: 1 of file: ./delete.xeb
			render_conditions ["class_temp_2"] := controller_1.not_authenticated_admin
				-- line: 12 row: 1 of file: ./delete.xeb
				-- line: 12 row: 1 of file: ./delete.xeb
			render_conditions ["class_temp_3"] := controller_1.authenticated_admin
		end
	...
	render_html_page (request: XH_REQUEST; response: XH_RESPONSE)
		...
		do
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_89)
				...
				-- line: 6 row: 1 of file: ./delete.xeb
			response.set_goto_request ("login.xeb")
			...
			response.append ({G_SERVLET_CONSTANTS}.class_temp_38)
				...
				-- line: 10 row: 1 of file: ./delete.xeb
			if attached {STRING} controller_1.delete as l_text then 
				-- line: 10 row: 1 of file: ./delete.xeb
			response.append (l_text)
				-- line: 10 row: 1 of file: ./delete.xeb
				-- line: 10 row: 1 of file: ./delete.xeb
				...
				-- line: 10 row: 1 of file: ./delete.xeb
			response.append (controller_1.delete.out)
				-- line: 10 row: 1 of file: ./delete.xeb
				-- line: 10 row: 1 of file: ./delete.xeb
			end
