...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			l_ev_fixed_1.set_item_width (sample, 0032)
			l_ev_fixed_1.set_item_height (sample, 0032)
			l_ev_fixed_1.set_item_x_position (tutorial, 0180)
			l_ev_fixed_1.set_item_y_position (tutorial, 0020)
			l_ev_fixed_1.set_item_width (tutorial, 0032)
			l_ev_fixed_1.set_item_height (tutorial, 0032)
			l_ev_fixed_1.set_item_x_position (how_to, 0020)
			l_ev_fixed_1.set_item_y_position (how_to, 0100)
			l_ev_fixed_1.set_item_width (how_to, 0032)
			l_ev_fixed_1.set_item_height (how_to, 0032)
			l_ev_fixed_1.set_item_x_position (empty_file, 0020)
			l_ev_fixed_1.set_item_y_position (empty_file, 0020)
			l_ev_fixed_1.set_item_width (empty_file, 0032)
			l_ev_fixed_1.set_item_height (empty_file, 0032)
			l_ev_fixed_1.set_item_x_position (project, 0100)
			l_ev_fixed_1.set_item_y_position (project, 0100)
			l_ev_fixed_1.set_item_width (project, 0032)
			l_ev_fixed_1.set_item_height (project, 0032)
