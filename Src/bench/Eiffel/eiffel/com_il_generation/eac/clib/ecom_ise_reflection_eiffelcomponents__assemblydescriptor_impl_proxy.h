/*-----------------------------------------------------------
Implemented `_AssemblyDescriptor' Interface.
-----------------------------------------------------------*/

#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__ASSEMBLYDESCRIPTOR_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__ASSEMBLYDESCRIPTOR_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
class _AssemblyDescriptor_impl_proxy;
}
...
{
public:
	_AssemblyDescriptor_impl_proxy (IUnknown * a_pointer);
	virtual ~_AssemblyDescriptor_impl_proxy ();
