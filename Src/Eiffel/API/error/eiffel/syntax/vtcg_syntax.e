note
	description: "Error about non-conforming actual routine type parameter (used for automatically converted routine types)."
...
feature -- Output
	...
	trace (a_text_formatter: TEXT_FORMATTER)
		...
		do
			...
			a_text_formatter.add_new_line
			a_text_formatter.add ("Actual #2: ")
			type.generics [2].ext_append_to (a_text_formatter, type.base_class)
			a_text_formatter.add_new_line
			...
			system.tuple_class.append_name (a_text_formatter)
			a_text_formatter.add_new_line
