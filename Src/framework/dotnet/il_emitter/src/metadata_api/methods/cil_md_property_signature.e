...
feature -- Settings
	...
	set_property_type (t: INTEGER_8)
		...
		require
			...
			valid_type:
				t = {CIL_MD_SIGNATURE_CONSTANTS}.property_sig or else
				t = {CIL_MD_SIGNATURE_CONSTANTS}.property_sig | {CIL_MD_SIGNATURE_CONSTANTS}.has_current
		do
