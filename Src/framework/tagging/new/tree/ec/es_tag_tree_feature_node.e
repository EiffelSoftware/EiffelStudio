note
	description: "[
		{ES_TAG_TREE_NODE} representing Eiffel features.
	]"
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
class
	ES_TAG_TREE_FEATURE_NODE [G -> TAG_ITEM]

inherit
	ES_TAG_TREE_NODE [G, E_FEATURE]
...
feature {NONE} -- Implementation
	...
	retrieve_item (a_project: EC_PROJECT_ACCESS): like item
		...
		local
			l_classc: CLASS_C
		do
			if attached {ES_TAG_TREE_NODE [G, CLASS_I]} parent as l_parent then
