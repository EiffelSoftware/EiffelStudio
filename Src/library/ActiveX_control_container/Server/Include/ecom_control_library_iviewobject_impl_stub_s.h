...
#ifndef __ECOM_CONTROL_LIBRARY_IVIEWOBJECT_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IVIEWOBJECT_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_control_library
{
class IViewObject_impl_stub : public ecom_control_library::IViewObject
{
public:
  IViewObject_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IViewObject_impl_stub ();
