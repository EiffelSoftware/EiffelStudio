...
feature {NONE}  -- Externals
	...
	ccom_get_cluster_tree (cpp_obj: POINTER): IENUM_CLUSTER_PROP_INTERFACE is
			-- Retrieve enumerator of clusters in tree form.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"](): EIF_REFERENCE"
		end
	...
	ccom_get_cluster_full_name (cpp_obj: POINTER; bstr_name: STRING): STRING is
			-- Get a clusters full name from its name.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT): EIF_REFERENCE"
		end
	...
	ccom_get_cluster_properties_by_id (cpp_obj: POINTER; n_cluster_id: INTEGER): IEIFFEL_CLUSTER_PROPERTIES_INTERFACE is
			-- Retrieve a clusters properties by its ID.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_INTEGER): EIF_REFERENCE"
		end

	ccom_change_cluster_name (cpp_obj: POINTER; bstr_name: STRING; bstr_new_name: STRING) is
			-- Change a clusters name.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT)"
		end

	ccom_add_cluster (cpp_obj: POINTER; bstr_name: STRING; bstr_parent_name: STRING; bstr_path: STRING) is
			-- Add a cluster to system clusters.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT,EIF_OBJECT)"
		end

	ccom_remove_cluster (cpp_obj: POINTER; bstr_name: STRING) is
			-- Remove a cluster from system clusters.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT)"
		end

	ccom_store (cpp_obj: POINTER) is
			-- Persist current changes to disk
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"]()"
		end

	ccom_is_cluster_name_available (cpp_obj: POINTER; bstr_name: STRING): BOOLEAN is
			-- Determins if 'bstrName' is available as a cluster name
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"](EIF_OBJECT): EIF_BOOLEAN"
		end
	...
	ccom_delete_ieiffel_system_clusters_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_system_clusters_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"]():EIF_POINTER"
		end

	ccom_last_error_code (cpp_obj: POINTER): INTEGER is
			-- Last error code
		external
			"C++ [ecom_EiffelComCompiler::IEiffelSystemClusters_impl_proxy %"ecom_EiffelComCompiler_IEiffelSystemClusters_impl_proxy.h%"]():EIF_INTEGER"
		end
