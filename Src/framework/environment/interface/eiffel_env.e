...
feature -- Access
	...
	product_name: attached STRING_8
			-- Name of the product.
		once
	...
	product_version_name: attached STRING_8
	...
	environment_info: attached STRING_8
...
feature {NONE} -- Access
	...
	required_environment_variables: attached ARRAYED_LIST [TUPLE [var: STRING_8; is_directory: BOOLEAN]]
...
feature -- IL environment
	...
	default_il_environment: attached IL_ENVIRONMENT
...
feature -- Directories (top-level)
	...
	install_path: attached DIRECTORY_NAME
	...
	docs_path: attached DIRECTORY_NAME
	...
	dotnet_path: attached DIRECTORY_NAME
	...
	library_path: attached DIRECTORY_NAME
			-- Eiffel library path
		require
			is_valid_environment: is_valid_environment
		once
	...
	precomp_path: attached DIRECTORY_NAME
			-- Eiffel precomp path
		require
			is_valid_environment: is_valid_environment
		once
	...
	precomp_platform_path (a_is_dotnet: BOOLEAN): attached DIRECTORY_NAME
	...
	application_path: attached DIRECTORY_NAME
...
feature  -- Directories (dotnet)
	...
	assemblies_path: attached DIRECTORY_NAME
...
feature -- Directories (distribution)
	...
	bitmaps_path: attached DIRECTORY_NAME
	...
	borland_path: attached DIRECTORY_NAME
	...
	built_ins_path (a_is_platform_neutral, a_is_dotnet: BOOLEAN): attached DIRECTORY_NAME
	...
	config_path: attached DIRECTORY_NAME
	...
	generation_templates_path: attached DIRECTORY_NAME
	...
	eifinit_path: attached DIRECTORY_NAME
	...
	filter_path: attached DIRECTORY_NAME
	...
	help_path: attached DIRECTORY_NAME
	...
	error_path: attached DIRECTORY_NAME
	...
	default_templates_path: attached DIRECTORY_NAME
	...
	metrics_path: attached DIRECTORY_NAME
	...
	profile_path: attached DIRECTORY_NAME
	...
	templates_path: attached DIRECTORY_NAME
	...
	template_default_path: attached DIRECTORY_NAME
	...
	bin_path: attached DIRECTORY_NAME
	...
	runtime_include_path: attached DIRECTORY_NAME
	...
	runtime_lib_path: attached DIRECTORY_NAME
	...
	wizards_path: attached DIRECTORY_NAME
	...
	new_project_wizards_path: attached DIRECTORY_NAME
			-- Location of new project wizards.
		require
			is_valid_environment: is_valid_environment
		once
	...
	precompilation_wizard_resources_path: attached DIRECTORY_NAME
	...
	tools_path: attached DIRECTORY_NAME
	...
	testing_tool_path: attached DIRECTORY_NAME
	...
	auto_test_path: attached DIRECTORY_NAME
...
feature -- Directories (top-level user)
	...
	user_application_files_path: attached DIRECTORY_NAME
	...
	user_files_path: attached DIRECTORY_NAME
		...
		local
			...
			l_dir: attached STRING_8
			l_directory: attached DIRECTORY
		once
...
feature -- Directories (user)
	...
	user_settings_path: attached DIRECTORY_NAME
	...
	user_project_settings_path: attached DIRECTORY_NAME
	...
	user_docking_path: attached DIRECTORY_NAME
			-- Path to user code template, to merge with the ones from the installation.
		require
			is_valid_environment: is_valid_environment
			is_user_files_supported: is_user_files_supported
	...
	user_session_path, session_data_path: attached DIRECTORY_NAME
			-- Path to user code template, to merge with the ones from the installation.
		require
			is_valid_environment: is_valid_environment
			is_user_files_supported: is_user_files_supported
	...
	user_studio_path: attached DIRECTORY_NAME
	...
	user_templates_path: attached DIRECTORY_NAME
				-- Path to user code template, to merge with the ones from the installation.
		require
			is_valid_environment: is_valid_environment
			is_user_files_supported: is_user_files_supported
...
feature -- Directories (other)
	...
	tmp_directory: attached DIRECTORY_NAME
...
feature -- Files
	...
	default_config_file_name: attached FILE_NAME
	...
	predefined_metrics_file: attached FILE_NAME
	...
	compiler_configuration: attached FILE_NAME
	...
	msil_culture_name: attached FILE_NAME
	...
	libraries_config_name: attached FILE_NAME
	...
	precompiles_config_name: attached FILE_NAME
...
feature -- Files (user)
	...
	user_docking_file_name (a_file_name: STRING): attached FILE_NAME
	...
	user_docking_standard_file_name (a_window_id: NATURAL_32): attached FILE_NAME
			-- Path of standard docking layout.
		require
			is_valid_environment: is_valid_environment
			is_user_files_supported: is_user_files_supported
	...
	user_docking_debug_file_name (a_window_id: NATURAL_32): attached FILE_NAME
			-- Path of standard docking layout.
		require
			is_valid_environment: is_valid_environment
			is_user_files_supported: is_user_files_supported
...
feature -- Obsolete
	...
	eiffel_home: attached DIRECTORY_NAME
...
feature -- Directories (platform independent)
	...
	shared_path: attached DIRECTORY_NAME
	...
	shared_application_path: attached DIRECTORY_NAME
	...
	lib_path: attached DIRECTORY_NAME
	...
	lib_application_path: attached DIRECTORY_NAME
...
feature -- Files (commands)
	...
	estudio_command_name: attached FILE_NAME
	...
	ec_command_name: attached FILE_NAME
			-- Absolute path to `ec'.
		require
			is_valid_environment: is_valid_environment
		once
	...
	freeze_command_name: attached FILE_NAME
		require
			is_valid_environment: is_valid_environment
		once
			create Result.make_from_string (bin_path)
	...
	emake_command_name: attached FILE_NAME
	...
	quick_finalize_command_name: attached FILE_NAME
	...
	x2c_command_name: attached FILE_NAME
	...
	prelink_command_name: attached FILE_NAME
		require
			is_valid_environment: is_valid_environment
		once
			if is_unix_layout then
	...
	ecdbgd_command_name: attached FILE_NAME
	...
	compile_library_command_name: attached FILE_NAME
	...
	precompilation_wizard_command_name: attached FILE_NAME
...
feature -- Executable names
	...
	estudio_name: attached STRING_8
	...
	finish_freezing_script: attached STRING_8
	...
	quick_finalize_name: attached STRING_8 = "quick_finalize"
			-- Name of estudio command

	x2c_name: attached STRING_8 = "x2c"
			-- Complete path to `x2c'.

	emake_name: attached STRING_8 = "emake"
			-- Name of emake command.

	prelink_name: attached STRING_8 = "prelink"
			-- Name of estudio command.

	ecdbg_name: attached STRING_8 = "ecdbgd"
			-- Name of console line debugger command.

feature {NONE} -- Configuration of layout

	unix_layout_base_path: attached DIRECTORY_NAME
	...
	unix_layout_share_path: attached DIRECTORY_NAME
	...
	unix_layout_lib_dir: attached STRING_8
	...
	unix_layout_locale_dir: attached STRING_8
	...
	unix_layout_platform: attached STRING_8 = "unix";
...
feature -- File constants
	...
	default_config_file: attached STRING_8 = "default.ecf"
			-- Default ECF file name

	default_project_location_for_windows: attached STRING_8
...
feature -- Directory constants (platform)
	...
	dotnet_name: attached STRING = "dotnet"
			-- .NET folder name.

	neutral_name: attached STRING_8 = "neutral"
			-- Neutral platform folder name.

	classic_name: attached STRING_8 = "classic"
			-- Classic Eiffel folder name.

	windows_name: attached STRING_8 = "windows"
			-- Windows generic platform folder name.

	unix_name: attached STRING_8 = "unix"
			-- Unix generic platform folder name.

	wkbench_suffix: attached STRING_8 = "_wkbench"
...
feature -- Directory constants (top-level)
	...
	docs_name: attached STRING = "docs"
			-- Documentation folder name.

	library_name: attached STRING = "library"
			-- Library folder name.

	precomp_name: attached STRING = "precomp"
			-- Precompile library location

feature -- Directory constants (dotnet)

	assemblies_name: attached STRING_8 = "assemblies"
			-- .NET assembly cache folder name.

feature -- Directory constants (distribution)

	bin_name: attached STRING_8 = "bin"
			-- Binary folder name

	bitmaps_name: attached STRING_8 = "bitmaps"
			-- Bitmpa folder name.

	borland_name: attached STRING_8 = "BCC55"
			-- Borland C compiler folder name.

	built_ins_name: attached STRING_8 = "built_ins"
			-- Built-in code classes folder name.

	defaults_name: attached STRING_8 = "defaults"
			-- Default templates folder name.

	errors_name: attached STRING_8 = "errors"
			-- Error file descriptions folder name.

	etc_name: attached STRING_8 = "etc"
			-- Etc library folder name

	filters_name: attached STRING_8 = "filters"
			-- Documentation filters folder name.

	help_name: attached STRING_8 = "help"
			-- Help files folder name.

	include_name: attached STRING_8 = "include"
			-- External include folder name

	lang_name: attached STRING_8 = "lang"
			-- Language folder name.

	lib_name: attached STRING_8 = "lib"
			-- External library folder name

	metrics_name: attached STRING_8 = "metrics"
			-- Metrics folder name.

	mo_files_name: attached STRING_8 = "mo_files"
			-- Language MO files folder name.

	profiler_name: attached STRING_8 = "profiler"
			-- Profiler folder name.

	templates_name: attached STRING_8 = "templates"
			-- Code templates folder name.

	spec_name: attached STRING_8 = "spec"
			-- Specific folder name

	wizards_name: attached STRING_8 = "wizards"
			-- Wizards folder name

feature -- Directory constants (user)

	docking_name: attached STRING_8 = "docking"
			-- User docking data folder name.

	projects_name: attached STRING_8 = "projects"
			-- Eiffel user projects folder name

	settings_name: attached STRING_8 = "settings"
			-- User settings folder name.

	session_name: attached STRING_8 = "session"
			-- User session data folder name.

	eiffel_software_name: attached STRING_8 = "Eiffel Software"
			-- Company folder name

feature -- File constants (user)

	docking_debug_file: attached STRING_8 = "debug"
			-- Debugger layout docking file name

	docking_standard_file: attached STRING_8 = "standard"
			-- Editor layout docking file name

	docking_file_extension: attached STRING_8 = "dck"

	eis_storage_file: attached STRING_8 = "eis_storage"
...
feature -- Preferences
	...
	general_preferences: attached FILE_NAME
	...
	platform_preferences: attached FILE_NAME
