/*-----------------------------------------------------------
Implemented `_ExportClause' Interface.
-----------------------------------------------------------*/

#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__EXPORTCLAUSE_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__EXPORTCLAUSE_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
class _ExportClause_impl_proxy;
}
...
{
public:
	_ExportClause_impl_proxy (IUnknown * a_pointer);
	virtual ~_ExportClause_impl_proxy ();
