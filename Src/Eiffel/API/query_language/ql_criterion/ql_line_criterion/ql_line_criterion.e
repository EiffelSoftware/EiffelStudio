...
feature -- Access
	...
	domain_generator (a_enable_fill_domain: BOOLEAN; a_apply_current: BOOLEAN): QL_LINE_DOMAIN_GENERATOR is
	...
	intrinsic_domain: QL_LINE_DOMAIN is
...
feature -- Logic operations
	...
	infix "and" (other: QL_LINE_CRITERION): QL_LINE_CRITERION is
			-- Boolean conjunction with `other'
		do
			create {QL_LINE_AND_CRITERION}Result.make (Current, other)
		end

	prefix "not": QL_LINE_CRITERION is
			-- Negation
		do
			create {QL_LINE_NOT_CRITERION}Result.make (Current)
		end

	infix "or" (other: QL_LINE_CRITERION): QL_LINE_CRITERION is
...
feature -- Access
	...
	compiled_criterion: QL_LINE_CRITERION is
