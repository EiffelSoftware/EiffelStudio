...
create
	make_activatedservicetypeentry,
	make_activatedservicetypeentry_1

feature {NONE} -- Initialization

	frozen make_activatedservicetypeentry (type_name: STRING; assembly_name: STRING) is
		external
			"IL creator signature (System.String, System.String) use System.Runtime.Remoting.ActivatedServiceTypeEntry"
		end

	frozen make_activatedservicetypeentry_1 (type: SYSTEM_TYPE) is
		external
