...
feature {NONE} -- initialization
	...
	make_basic (a_window: detachable WEL_WINDOW; a_text, a_title: READABLE_STRING_GENERAL; a_style,a_language,a_sublanguage: INTEGER)
	...
	make_by_id (a_window: detachable WEL_WINDOW; a_text, a_title: READABLE_STRING_GENERAL; a_style, an_id, a_language, a_sublanguage: INTEGER)
			-- create a MSGBOXPARAMS structure
