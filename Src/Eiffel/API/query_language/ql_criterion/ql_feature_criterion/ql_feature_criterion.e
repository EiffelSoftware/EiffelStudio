...
feature -- Access
	...
	domain_generator (a_enable_fill_domain: BOOLEAN; a_apply_current: BOOLEAN): QL_FEATURE_DOMAIN_GENERATOR
...
feature -- Logic operations
	...
	conjuncted alias "and" (other: QL_FEATURE_CRITERION): QL_FEATURE_CRITERION
			-- Boolean conjunction with `other'
		do
			create {QL_FEATURE_AND_CRITERION}Result.make (Current, other)
		end

	negated alias "not": QL_FEATURE_CRITERION
			-- Negation
		do
			create {QL_FEATURE_NOT_CRITERION}Result.make (Current)
		end

	disjuncted alias "or" (other: QL_FEATURE_CRITERION): QL_FEATURE_CRITERION
...
feature -- Access
	...
	compiled_criterion: QL_FEATURE_CRITERION
