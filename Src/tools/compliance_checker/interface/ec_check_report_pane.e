...
feature {NONE} -- Agent Handlers
	...
	on_resize_grid_output (a_x: INTEGER; a_y: INTEGER; a_width: INTEGER; a_height: INTEGER)
...
feature {NONE} -- Compliance Checking
	...
	on_type_report_added (a_type: EC_REPORT_TYPE)
...
feature {NONE} -- Report Row Building
	...
	add_type_report_row (a_report_type: EC_REPORT_TYPE)
	...
	add_report_member_to_row (a_row: EV_GRID_ROW; a_report_member: EC_REPORT_MEMBER)
	...
	alt_row_background_color: EV_COLOR
			-- Alternative row background color.
		once
	...
	bad_row_background_color: EV_COLOR
			-- Alternative row background color.
		once
	...
	bad_alt_row_background_color: EV_COLOR
			-- Alternative row background color.
		once
...
feature {NONE} -- Formatting
	...
	format_clip_type (a_type: EC_CHECKED_TYPE): STRING
	...
	format_clip_member (a_member: EC_CHECKED_MEMBER): STRING
	...
	illegaly_cls_compliant_string: STRING = "Illegal: "
	compliant_string: STRING = "CLS-Compliant"
	non_compliant_string: STRING = "Not CLS-Compliant: "
	eiffel_compliant_string: STRING = "Eiffel-Compliant"
	non_eiffel_compliant_string: STRING = "Not Eiffel-Compliant: "
	marked_string: STRING = "Marked with ClsCompliantAttribute"
	not_marked_string: STRING = "Not marked with ClsCompliantAttribute"
