...
class
	ECD_ROUTINE_EXPRESSION_FACTORY
...
feature {ECD_CONSUMER_FACTORY} -- Visitor features.
	...
	generate_routine_invoke_expression (a_source: SYSTEM_DLL_CODE_METHOD_INVOKE_EXPRESSION) is
		...
		local
			a_routine_invoke_expression: ECD_ROUTINE_INVOKE_EXPRESSION
		do
	...
	generate_routine_reference_expression (a_source: SYSTEM_DLL_CODE_METHOD_REFERENCE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_routine_reference_expression: ECD_ROUTINE_REFERENCE_EXPRESSION
		do
...
feature {NONE} -- Implementation
	...
	initialize_generate_routine_invoke_expression (a_source: SYSTEM_DLL_CODE_METHOD_INVOKE_EXPRESSION; a_routine_invoke_expression: ECD_ROUTINE_INVOKE_EXPRESSION) is
		...
		local
			...
			a_routine: ECD_ROUTINE_REFERENCE_EXPRESSION
		do
	...
	generate_arguments (a_source: SYSTEM_DLL_CODE_METHOD_INVOKE_EXPRESSION; a_routine_invoke_expression: ECD_ROUTINE_INVOKE_EXPRESSION) is
	...
	initialize_generate_routine_reference_expression (a_source: SYSTEM_DLL_CODE_METHOD_REFERENCE_EXPRESSION; a_routine_reference_expression: ECD_ROUTINE_REFERENCE_EXPRESSION) is
...
end -- class ECD_ROUTINE_EXPRESSION_FACTORY
