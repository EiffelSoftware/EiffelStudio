...
-----------------------------------------------------------*/
{
	...
	{
		tmp_new_callback = eif_protect (grt_ce_ISE.ccom_ce_pointed_interface_238 (new_callback));
		new_callback->AddRef ();
	}
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_old_callback = eif_protect (grt_ce_ISE.ccom_ce_pointed_interface_238 (old_callback));
		old_callback->AddRef ();
	}
