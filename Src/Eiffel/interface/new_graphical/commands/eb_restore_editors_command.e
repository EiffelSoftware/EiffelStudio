...
feature -- Query
	...
	menu_name: STRING_GENERAL
			-- Menu name
		do
			Result := interface_names.m_Restore_Editors
		end
...
feature -- Command
	...
	execute
			-- Execute
		do
			develop_window.docking_manager.restore_minimized_editors
		end
...
end -- class EB_RESTORE_EDITORS_COMMAND
