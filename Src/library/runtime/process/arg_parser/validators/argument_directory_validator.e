...
feature {NONE} -- Internationalization
	...
	e_invalid_directory: IMMUTABLE_STRING_32
		once
			create Result.make_from_string_general ("The specified directory is invalid.")
		end

	e_directory_does_not_exist: IMMUTABLE_STRING_32
		once
			create Result.make_from_string_general ("The specified directory does not exist.")
		end
