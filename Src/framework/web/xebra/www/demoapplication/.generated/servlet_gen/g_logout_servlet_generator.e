	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 7 row: 2 of file: ./logout.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 7 row: 2 of file: ./logout.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 7 row: 1 of file: ./logout.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 7 row: 1 of file: ./logout.xeb"
			...
			stack.put (temp)
				-- line: 3 row: 6 of file: ./logout.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 3 row: 6 of file: ./logout.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 4 row: 1 of file: ./logout.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 4 row: 1 of file: ./logout.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "controller"
				-- line: 4 row: 6 of file: ./logout.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 6 of file: ./logout.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 5 row: 1 of file: ./logout.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 5 row: 1 of file: ./logout.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "p"
			stack.put (temp)
				-- line: 4 row: 49 of file: ./logout.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 49 of file: ./logout.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " You have successfully been logged out. ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 5 row: 4 of file: ./logout.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 4 of file: ./logout.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N  ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
