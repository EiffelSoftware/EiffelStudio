...
feature {NONE} -- Initialization
	...
	frozen make (ret: ANY; out_args: ARRAY [ANY]; out_args_count: INTEGER; call_ctx: SYSTEM_RUNTIME_REMOTING_MESSAGING_LOGICALCALLCONTEXT; mcm: SYSTEM_RUNTIME_REMOTING_MESSAGING_IMETHODCALLMESSAGE) is
		external
...
feature -- Basic Operations
	...
	frozen get_arg (arg_num: INTEGER): ANY is
		external
	...
	frozen get_out_arg (arg_num: INTEGER): ANY is
		external
			"IL signature (System.Int32): System.Object use System.Runtime.Remoting.Messaging.ReturnMessage"
		alias
			"GetOutArg"
