deferred class CORBA_UNIONDEF_SKEL
...
feature { NONE }
    ...
    dispatcher : DICTIONARY [COURIER, STRING] is
        ...
        do
            ...
            result.put (cour, "_get_discriminator_type")
            create cour.make (void, void, 41)
            result.put (cour, "_get_discriminator_type_def")
            create cour.make (void, void, 42)
            result.put (cour, "_set_discriminator_type_def")
