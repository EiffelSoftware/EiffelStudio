...
class
	IAX_WIN_AMBIENT_DISPATCH_IMPL_STUB
...
feature {NONE}  -- Externals
	...
	ccom_create_item (eif_object: IAX_WIN_AMBIENT_DISPATCH_IMPL_STUB): POINTER is
			-- Initialize `item'
		external
			"C++ [new ecom_control_library::IAxWinAmbientDispatch_impl_stub %"ecom_control_library_IAxWinAmbientDispatch_impl_stub_s.h%"](EIF_OBJECT)"
		end

end -- IAX_WIN_AMBIENT_DISPATCH_IMPL_STUB
