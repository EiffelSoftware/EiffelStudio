...
deferred class INTEGER_COMPOSITE_ELEMENT
...
------------------------------------------------------
    ...
    add_component (elemnt : INTEGER) is
...
------------------------------------------------------
    ...
    component_at (index : INTEGER) : INTEGER is
...
------------------------------------------------------
feature { INTEGER_COMPOSITE_ELEMENT }

    components : INDEXED_LIST [INTEGER]

end -- class INTEGER_COMPOSITE_ELEMENT
