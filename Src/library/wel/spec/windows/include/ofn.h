...
#define cwel_open_file_name_set_lpstrfile(_ptr_, _value_) (((OPENFILENAME *) _ptr_)->lpstrFile = (LPSTR) (_value_))
#define cwel_open_file_name_set_nmaxfile(_ptr_, _value_) (((OPENFILENAME *) _ptr_)->nMaxFile = (DWORD) (_value_))
#define cwel_open_file_name_set_lpstrfiletitle(_ptr_, _value_) (((OPENFILENAME *) _ptr_)->lpstrFileTitle = (LPSTR) (_value_))
#define cwel_open_file_name_set_nmaxfiletitle(_ptr_, _value_) (((OPENFILENAME *) _ptr_)->nMaxFileTitle = (DWORD) (_value_))
#define cwel_open_file_name_set_lpstrinitialdir(_ptr_, _value_) (((OPENFILENAME *) _ptr_)->lpstrInitialDir = (LPCSTR) (_value_))
#define cwel_open_file_name_set_lpstrtitle(_ptr_, _value_) (((OPENFILENAME *) _ptr_)->lpstrTitle = (LPCSTR) (_value_))
...
#define cwel_open_file_name_set_lpstrdefext(_ptr_, _value_) (((OPENFILENAME *) _ptr_)->lpstrDefExt = (LPCSTR) (_value_))
...
// #define cwel_open_file_name_set_lptemplatename(_ptr_, _value_) (((OPENFILENAME *) _ptr_)->lpTemplateName = (LPCSTR) (_value_))
