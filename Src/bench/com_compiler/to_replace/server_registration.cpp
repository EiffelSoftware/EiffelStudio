...
const REG_DATA reg_entries[] = 
{
	...
	{
		__TEXT("CLSID\\{AABB3C81-5B4C-47DF-A683-1FD716E975C6}"),
		0,
		__TEXT("CEiffelCompletionInfo Class"),
		TRUE
	},
	{
		__TEXT("AppID\\{AABB3C81-5B4C-47DF-A683-1FD716E975C6}"),
		0,
	...
	},
	{
		__TEXT("AppID\\ISE"),
		__TEXT("AppID"),
		__TEXT("{AABB3C81-5B4C-47DF-A683-1FD716E975C6}"),
		TRUE
	},
	{
		__TEXT("CLSID\\{AABB3C81-5B4C-47DF-A683-1FD716E975C6}\\LocalServer32"),
		0,
		file_name,
		TRUE
	},
	...
	{
		__TEXT("CLSID\\{AABB3C81-5B4C-47DF-A683-1FD716E975C6}\\ProgID"),
		0,
		__TEXT("eiffel_compiler.CEiffelCompletionInfo.1"),
		TRUE
	},
	{
		__TEXT("CLSID\\{AABB3C81-5B4C-47DF-A683-1FD716E975C6}\\VersionIndependentProgID"),
		0,
	...
	-----------------------------------------------------------*/
{
	...
	if (!(CEiffelCompletionInfo_cls_object.IsInitialized))
		...
		hr = CoRegisterClassObject (CLSID_CEiffelCompletionInfo_, static_cast<IClassFactory*>(&CEiffelCompletionInfo_cls_object), CLSCTX_LOCAL_SERVER, REGCLS_MULTIPLEUSE, &dwRegister_CEiffelCompletionInfo);
	if (FAILED (hr))
	{
		com_eraise (f.c_format_message (hr), HRESULT_CODE (hr));
	}
