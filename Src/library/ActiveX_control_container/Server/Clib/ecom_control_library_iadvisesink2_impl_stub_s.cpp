...
#include "ecom_control_library_IAdviseSink2_impl_stub_s.h"
...
ecom_control_library::IAdviseSink2_impl_stub::IAdviseSink2_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IAdviseSink2_impl_stub::~IAdviseSink2_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::RemoteOnDataChange(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc, /* [in] */ ecom_control_library::wireASYNC_STGMEDIUM * p_stgmed )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::RemoteOnViewChange(  /* [in] */ ULONG dw_aspect, /* [in] */ LONG lindex )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::RemoteOnRename(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::RemoteOnSave( void )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::RemoteOnClose( void )
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::RemoteOnLinkSrcChange(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
-----------------------------------------------------------*/
{
	...
	EIF_PROCEDURE eiffel_procedure = 0;
	eiffel_procedure = eif_procedure ("remote_on_link_src_change", type_id);
...
STDMETHODIMP_(ULONG) ecom_control_library::IAdviseSink2_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IAdviseSink2_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IAdviseSink2_impl_stub::QueryInterface( REFIID riid, void ** ppv )
...
-----------------------------------------------------------*/
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<ecom_control_library::IAdviseSink2*>(this);
	else if (riid == IID_IAdviseSink2_)
		*ppv = static_cast<ecom_control_library::IAdviseSink2*>(this);
