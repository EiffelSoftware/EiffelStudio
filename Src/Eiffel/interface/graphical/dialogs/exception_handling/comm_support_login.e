...
feature {NONE} -- Query
	...
	post_string_for_login (a_view_state: STRING_GENERAL; a_event_validation: STRING_GENERAL; a_user: STRING_GENERAL; a_pass: STRING_GENERAL): STRING_32
		...
		do
			...
			Result.append_string_general ("__EVENTTARGET=")
			Result.append_character ('&')
			Result.append_string_general ("__EVENTARGUMENT=")
			Result.append_character ('&')
			Result.append_string_general ("__VIEWSTATE=")
			Result.append_string_general (a_view_state)
			Result.append_character ('&')
			Result.append_string_general ("ctl00%%24ctl00%%24default_main_content%%24main_content%%24display_username=")
			Result.append_character ('&')
			Result.append_string_general ("ctl00%%24ctl00%%24default_main_content%%24main_content%%24register_username=")
			Result.append_string_general (a_user)
			Result.append_character ('&')
			Result.append_string_general ("ctl00%%24ctl00%%24default_main_content%%24main_content%%24display_password=")
			Result.append_character ('&')
			Result.append_string_general ("ctl00%%24ctl00%%24default_main_content%%24main_content%%24register_password=")
			Result.append_string_general (encoding_url (a_pass))
			Result.append_character ('&')
			Result.append_string_general ("ctl00%%24ctl00%%24default_main_content%%24main_content%%24login_button=Login")
			Result.append_character ('&')
			Result.append_string_general ("__EVENTVALIDATION=")
			Result.append_string_general (a_event_validation)
		ensure
			result_attached: Result /= Void
			not_result_is_empty: not Result.is_empty
		end
