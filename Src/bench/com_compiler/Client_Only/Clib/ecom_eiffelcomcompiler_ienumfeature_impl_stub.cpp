...
#include "ecom_EiffelComCompiler_IEnumFeature_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ieiffel_feature_descriptor = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_56 (pp_ieiffel_feature_descriptor, NULL));
		if (*pp_ieiffel_feature_descriptor != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_56 (((tmp_pp_ieiffel_feature_descriptor != NULL) ? eif_wean (tmp_pp_ieiffel_feature_descriptor) : NULL), pp_ieiffel_feature_descriptor);
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ienum_feature = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_59 (pp_ienum_feature, NULL));
		if (*pp_ienum_feature != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_59 (((tmp_pp_ienum_feature != NULL) ? eif_wean (tmp_pp_ienum_feature) : NULL), pp_ienum_feature);
