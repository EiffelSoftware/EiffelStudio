...
-----------------------------------------------------------*/
{
	...
	hr = p_IPersistStreamInit->IPersist_GetClassID(p_class_id);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
	...
	hr = p_IPersistStreamInit->IPersistStreamInit_IsDirty ();
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IPersistStreamInit_impl_proxy::ccom_load(  /* [in] */ ecom_control_library::IStream * pstm )
...
void ecom_control_library::IPersistStreamInit_impl_proxy::ccom_save(  /* [in] */ ecom_control_library::IStream * pstm,  /* [in] */ EIF_INTEGER f_clear_dirty )
...
void ecom_control_library::IPersistStreamInit_impl_proxy::ccom_get_size_max(  /* [out] */ ecom_control_library::_ULARGE_INTEGER * pcb_size )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IPersistStreamInit->IPersistStreamInit_GetSizeMax(pcb_size);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
	...
	hr = p_IPersistStreamInit->IPersistStreamInit_InitNew ();
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
