indexing
	description: "Representation of line basic scope of a metric"
...
feature -- Access
	...
	calculate_function: FUNCTION [ANY, TUPLE [QL_LINE], DOUBLE]
	...
	domain_generator: QL_LINE_DOMAIN_GENERATOR
			-- Domain generator used to calculate metric

feature{NONE} -- Implementation

	evaluate_item (a_item: QL_LINE) is
...
invariant
	scope_valid: scope.is_equal (line_scope)
