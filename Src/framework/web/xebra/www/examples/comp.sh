...
ec -experiment -config .generated/servlet_gen/servlet_gen.ecf -target servlet_gen -c_compile -stop -project_path .generated/servlet_gen

echo Execute servlet_gen
.generated/servlet_gen/EIFGENs/servlet_gen/W_code/servlet_gen -o .

echo COMPILE webapp
ec -experiment -config $MY_WAPP.ecf -target $MY_WAPP -c_compile -stop -project_path .
