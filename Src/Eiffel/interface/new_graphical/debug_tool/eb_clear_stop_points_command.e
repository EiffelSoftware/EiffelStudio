	...
	execute
		...
		do
			...
			if bpm.has_breakpoint then
				create l_question.make_standard (warning_messages.w_clear_breakpoints, "", create {ES_BOOLEAN_PREFERENCE_SETTING}.make (preferences.dialog_data.confirm_clear_breakpoints_preference, True))
