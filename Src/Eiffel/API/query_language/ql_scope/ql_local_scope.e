...
feature -- Access
	...
	path_domain_generator (a_item: QL_LOCAL; a_path: READABLE_STRING_GENERAL): QL_DOMAIN_GENERATOR
			-- Domain generator for current scope
		do
...
feature -- Metric support
	...
	basic_scope (a_calculate_function: FUNCTION [QL_LOCAL, DOUBLE]; a_criterion: QL_LOCAL_CRITERION): QL_METRIC_LOCAL_BASIC_SCOPE_INFO
