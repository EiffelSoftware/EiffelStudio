note
	description: "Tool descriptor for {ES_EWEASEL_CONVERTION_TOOLPANEL}."
...
class
	ES_EWEASEL_CONVERSION_TOOL

inherit
	ES_TOOL [ES_EWEASEL_CONVERSION_TOOL_PANEL]
...
feature -- Access
	...
	title: STRING_32
		...
		do
			Result := "Eweasel Conversion Tool"
		end

feature {NONE} -- Factory

	create_tool: ES_EWEASEL_CONVERSION_TOOL_PANEL
