indexing
	description: "Eiffel Class Enumeration.  Help file: "
...
feature -- Status Report
	...
	next_user_precondition (rgelt: CELL [IEIFFEL_CLASS_DESCRIPTOR_INTERFACE]; pcelt_fetched: INTEGER_REF): BOOLEAN is
	...
	clone1_user_precondition (ppenum: CELL [IENUM_CLASS_INTERFACE]): BOOLEAN is
	...
	ith_item_user_precondition (an_index: INTEGER; rgelt: CELL [IEIFFEL_CLASS_DESCRIPTOR_INTERFACE]): BOOLEAN is
...
feature -- Basic Operations
	...
	clone1 (ppenum: CELL [IENUM_CLASS_INTERFACE]) is
			-- No description available.
			-- `ppenum' [out].  
		require
