...
if [ -n "$CFLAGS" ]; then
	...
	ccflags='-pipe -fno-common -fPIC -std=c99'
fi
ccldflags=''
if [ -n "$CPP" ]; then
	cpp=$CPP
...
if [ -n "$CPPFLAGS" ]; then
	...
	cppflags='-pipe -fno-common -fPIC -std=c++11'
fi
cpp_stuff='42'
defvoidused='15'
#Check value for next 4
...
voidflags='15'
#Check value for next 1
warning_level='-Wall -Wextra -Wno-unused-parameter -pedantic'
wkoptimize="-O0"
...
sharedlibs='-lm'
mtsharedlibs="$sharedlibs -lpthread -lstdc++"
