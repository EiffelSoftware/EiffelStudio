...
feature -- Button texts
	...
	b_Exec_replay_left: STRING_GENERAL is	do Result := locale.translation("Previous")	end
	b_Exec_replay_right: STRING_GENERAL is	do Result := locale.translation("Next")	end
...
feature -- Accelerator, focus label and menu name
	...
	m_Exec_replay_back: STRING_GENERAL is	do Result := locale.translation("Replay Execution: Previous Stack")	end
	m_Exec_replay_forth: STRING_GENERAL is	do Result := locale.translation("Replay Execution: Next Stack")	end
	m_Exec_replay_left: STRING_GENERAL is	do Result := locale.translation("Replay Execution: Previous Step")	end
	m_Exec_replay_right: STRING_GENERAL is	do Result := locale.translation("Replay Execution: Next Step")	end
...
feature -- Label texts
	...
	l_others: STRING_GENERAL is					do Result := locale.translation ("Others") end
	...
	l_profile: STRING_GENERAL is			do Result := locale.translation("profile")	end
	...
	l_resource_not_found (a_resource: STRING_GENERAL): STRING_GENERAL is	do Result := locale.formatted_string (locale.translation("The following resource is not found:%N$1"), [a_resource])	end
	...
	l_system_uuid_name_not_match (a_uuid, a_name: STRING_GENERAL): STRING_GENERAL is
		do
	...
	l_target_uuid_name_not_match (a_uuid, a_name: STRING_GENERAL): STRING_GENERAL is
		do
	...
	l_unknown_attribute_name (a_name: STRING_GENERAL): STRING_GENERAL is
		do
			Result := locale.formatted_string (locale.translation ("Unknown attribute name:%N$1"), [a_name])
		end
	l_unknown_format (a_format: STRING_GENERAL): STRING_GENERAL is
		do
	...
	l_unknown_protocol_name (a_content: STRING_GENERAL): STRING_GENERAL is
		do
	...
	l_invalid_uuid (a_uuid: STRING_GENERAL): STRING_GENERAL is
		do
...
feature -- Title part
	...
	t_code_template_evaluator: STRING_GENERAL is		do Result := locale.translation ("Code Template Evaluator") end
		...
		-- Contract tool
	t_contract_save_to_class: STRING_GENERAL 			do Result := locale.translation ("Save modifications to the associated class") end
	t_contract_add_contract: STRING_GENERAL				do Result := locale.translation ("Add a new contract") end
	t_contract_remove_selected: STRING_GENERAL			do Result := locale.translation ("Remove selected contract") end
	t_contract_edit_selected: STRING_GENERAL 			do Result := locale.translation ("Edit selected contract") end
	t_contract_move_selected_up: STRING_GENERAL 		do Result := locale.translation ("Move selected contract up") end
	t_contract_move_selected_down: STRING_GENERAL 		do Result := locale.translation ("Move selected contract down") end
	t_contract_refresh: STRING_GENERAL 					do Result := locale.translation ("Refresh the current contracts to include any unsaved, undetected editor changes") end
	t_contract_select_mode: STRING_GENERAL 				do Result := locale.translation ("Select the type of contracts to edit") end
	t_contract_show_all_lines: STRING_GENERAL 			do Result := locale.translation ("Show/hide the hidden contract place holders for inherited contracts") end
...
feature -- Description text, no translation (for the editor).
	...
	e_Exec_replay_back: STRING_GENERAL is	do Result := locale.translation("Replay previous execution stack")	end
	e_Exec_replay_forth: STRING_GENERAL is	do Result := locale.translation("Replay next execution stack")	end
	e_Exec_replay_left: STRING_GENERAL is	do Result := locale.translation("Replay previous execution step")	end
	e_Exec_replay_right: STRING_GENERAL is	do Result := locale.translation("Replay next execution step")	end
