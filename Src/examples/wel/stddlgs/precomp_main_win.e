...
feature {NONE} -- Implementation
	...
	main_menu: WEL_MENU is
		...
		once
			...
			file_popupmenu.append_string("Choose &file...", Cmd_choose_file)
			file_popupmenu.append_string("Choose f&ont...", Cmd_choose_font)
			file_popupmenu.append_string("Choose &color...", Cmd_choose_color)
			file_popupmenu.append_separator
			file_popupmenu.append_string("&Print...", Cmd_print_dialog)
			file_popupmenu.append_separator
			file_popupmenu.append_string("E&xit", Cmd_exit)
