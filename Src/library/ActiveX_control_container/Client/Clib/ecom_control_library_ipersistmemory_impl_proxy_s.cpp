...
-----------------------------------------------------------*/
{
	...
	hr = p_IPersistMemory->IPersist_GetClassID(p_class_id);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IPersistMemory_impl_proxy::ccom_remote_load(  /* [in] */ EIF_OBJECT p_mem,  /* [in] */ EIF_INTEGER cb_size )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IPersistMemory->RemoteLoad(tmp_p_mem,tmp_cb_size);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IPersistMemory_impl_proxy::ccom_remote_save(  /* [out] */ EIF_OBJECT p_mem,  /* [in] */ EIF_INTEGER f_clear_dirty,  /* [in] */ EIF_INTEGER cb_size )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IPersistMemory->RemoteSave(tmp_p_mem,tmp_f_clear_dirty,tmp_cb_size);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
