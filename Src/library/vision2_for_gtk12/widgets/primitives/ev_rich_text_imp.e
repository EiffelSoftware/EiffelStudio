...
feature -- Status Report
	...
	internal_paragraph_format, paragraph_format (caret_index: INTEGER): EV_PARAGRAPH_FORMAT
	...
	internal_paragraph_format_contiguous, paragraph_format_contiguous (start_line, end_line: INTEGER): BOOLEAN
			-- Is paragraph formatting from line `start_line' to `end_line' contiguous?
		do
		end

	modify_paragraph (start_line, end_line: INTEGER; format: EV_PARAGRAPH_FORMAT; applicable_attributes: EV_PARAGRAPH_FORMAT_RANGE_INFORMATION)
	...
	paragraph_format_range_information (start_line, end_line: INTEGER): EV_PARAGRAPH_FORMAT_RANGE_INFORMATION
	...
	formatting_contiguous (start_index, end_index: INTEGER): BOOLEAN
			-- Is formatting from caret position `start_index' to `end_index' contiguous?
		do
		end
		
	formatting_range_information (start_index, end_index: INTEGER): EV_CHARACTER_FORMAT_RANGE_INFORMATION
...
feature -- Status report
	...
	character_format (character_index: INTEGER): EV_CHARACTER_FORMAT
...
feature -- Status setting
	...
	buffered_append (a_text: STRING; format: EV_CHARACTER_FORMAT)
