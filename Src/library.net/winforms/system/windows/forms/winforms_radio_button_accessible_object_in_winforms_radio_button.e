...
external class
	WINFORMS_RADIO_BUTTON_ACCESSIBLE_OBJECT_IN_WINFORMS_RADIO_BUTTON
...
create
	make_winforms_radio_button_accessible_object_in_winforms_radio_button

feature {NONE} -- Initialization

	frozen make_winforms_radio_button_accessible_object_in_winforms_radio_button (owner: WINFORMS_RADIO_BUTTON) is
		external
...
end -- class WINFORMS_RADIO_BUTTON_ACCESSIBLE_OBJECT_IN_WINFORMS_RADIO_BUTTON
