...
feature -- Status Repport
	...
	has_arguments (a_list_of_arguments: LINKED_LIST [ECD_EXPRESSION]): BOOLEAN is
		...
		local
			stop: BOOLEAN
			a_param: ECD_PARAMETER_DECLARATION_EXPRESSION
		do
...
end -- class ECD_CREATION_ROUTINE
