deferred class CORBA_VALUEMEMBERDEF_SKEL
...
feature { NONE }
    ...
    dispatcher : DICTIONARY [COURIER, STRING] is
        ...
        do
            ...
            result.put (cour, "_get_type_def")
            create cour.make (void, void, 16)
            result.put (cour, "_set_type_def")
            create cour.make (void, void, 17)
            result.put (cour, "_get_access")
            create cour.make (void, void, 18)
            result.put (cour, "_set_access")
        end

end -- class CORBA_VALUEMEMBERDEF_SKEL
