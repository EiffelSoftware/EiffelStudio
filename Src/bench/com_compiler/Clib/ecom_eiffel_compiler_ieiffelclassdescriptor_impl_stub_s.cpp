...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_features = grt_ec_Eif_compiler.ccom_ec_pointed_interface_41 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_features = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_clients = grt_ec_Eif_compiler.ccom_ec_pointed_interface_24 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_clients = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_suppliers = grt_ec_Eif_compiler.ccom_ec_pointed_interface_24 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_suppliers = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_ancestors = grt_ec_Eif_compiler.ccom_ec_pointed_interface_24 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_ancestors = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_descendants = grt_ec_Eif_compiler.ccom_ec_pointed_interface_24 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
