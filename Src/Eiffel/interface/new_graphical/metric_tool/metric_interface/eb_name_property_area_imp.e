...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			create l_ev_cell_1
			create case_sensitive_checkbox
			...
			extend (name_text)
			extend (option_frame)
			option_frame.extend (l_ev_vertical_box_1)
			l_ev_vertical_box_1.extend (l_ev_horizontal_box_1)
			l_ev_horizontal_box_1.extend (l_ev_cell_1)
			l_ev_horizontal_box_1.extend (case_sensitive_checkbox)
			l_ev_vertical_box_1.extend (l_ev_horizontal_box_2)
			l_ev_horizontal_box_2.extend (l_ev_cell_2)
			l_ev_horizontal_box_2.extend (regular_expr_checkbox)
			...
			l_ev_horizontal_box_1.disable_item_expand (case_sensitive_checkbox)
			l_ev_cell_1.set_minimum_width (5)
			case_sensitive_checkbox.set_text ("Case sensitive")
...
feature -- Access
	...
	case_sensitive_checkbox, regular_expr_checkbox: EV_CHECK_BUTTON
	name_lbl: EV_LABEL
...
end -- class EB_NAME_PROPERTY_AREA_IMP
