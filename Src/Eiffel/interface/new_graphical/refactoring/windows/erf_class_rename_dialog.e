...
feature {NONE} -- Initialization
	...
	initialize
		...
		do
			...
			allow_duplicate_button.set_tooltip (interface_names.f_allow_duplicate_class_name)
...
feature -- Status report
	...
	is_duplicate_allowed: BOOLEAN
			-- Rename file?
		do
			Result := allow_duplicate_button.is_selected
		end
...
feature -- Element change
	...
	enable_duplicate
			-- Enable `allow_duplicate_button'.
		do
			allow_duplicate_button.enable_select
		end

	disable_duplicate
			-- Disable `allow_duplicate_button'.
		do
			allow_duplicate_button.disable_select
		end
...
feature {NONE} -- Implementation
	...
	rename_file_button, allow_duplicate_button: EV_CHECK_BUTTON
