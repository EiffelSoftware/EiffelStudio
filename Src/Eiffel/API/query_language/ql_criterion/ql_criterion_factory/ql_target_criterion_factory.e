...
feature{NONE} -- New criterion
	...
	new_false_criterion: QL_TARGET_FALSE_CRI is
			-- New {QL_TARGET_FALSE_CRI} criterion.
		do
			create Result
		ensure
	...
	new_is_compiled_criterion: QL_TARGET_IS_COMPILED_CRI is
			-- New {QL_TARGET_IS_COMPILED_CRI} criterion.
		do
			create Result
		ensure
			result_attached: Result /= Void
	...
	new_true_criterion: QL_TARGET_TRUE_CRI is
			-- New {QL_TARGET_TRUE_CRI} criterion.
		do
			create Result
		ensure
			result_attached: Result /= Void
