...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_FORMALSIGNATURETYPE_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_FORMALSIGNATURETYPE_H__
#ifdef __cplusplus
extern "C" {
...
public:
	FormalSignatureType ();
	FormalSignatureType (IUnknown * a_pointer);
	virtual ~FormalSignatureType ();
