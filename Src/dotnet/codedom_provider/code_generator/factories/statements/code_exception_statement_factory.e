...
feature {CODE_CONSUMER_FACTORY} -- Visitor features.
	...
	generate_try_catch_finally_statement (a_source: SYSTEM_DLL_CODE_TRY_CATCH_FINALLY_STATEMENT) is
		...
		local
			a_try_catch_statement: CODE_TRY_CATCH_FINALLY_STATEMENT
		do
...
feature {NONE} -- Implementation
	...
	initialize_try_catch_finally_statement (a_source: SYSTEM_DLL_CODE_TRY_CATCH_FINALLY_STATEMENT; a_try_catch_statement: CODE_TRY_CATCH_FINALLY_STATEMENT) is
		...
		local
			a_local_variable: CODE_VARIABLE_DECLARATION_STATEMENT
	...
	generate_try_statements (a_source: SYSTEM_DLL_CODE_TRY_CATCH_FINALLY_STATEMENT; a_try_catch_statement: CODE_TRY_CATCH_FINALLY_STATEMENT) is
	...
	generate_finally_statements (a_source: SYSTEM_DLL_CODE_TRY_CATCH_FINALLY_STATEMENT; a_try_catch_statement: CODE_TRY_CATCH_FINALLY_STATEMENT) is
			-- | Call in loop `generate_statement_from_dom'.
	...
	generate_catch_clauses (a_source: SYSTEM_DLL_CODE_TRY_CATCH_FINALLY_STATEMENT; a_try_catch_statement: CODE_TRY_CATCH_FINALLY_STATEMENT) is
	...
	generate_catch_statements (a_source: SYSTEM_DLL_CODE_CATCH_CLAUSE; a_try_catch_statement: CODE_TRY_CATCH_FINALLY_STATEMENT) is
			-- | Call in loop `generate_statement_from_dom'.
