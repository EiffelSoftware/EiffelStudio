...
feature {ECD_CONSUMER_FACTORY} -- Visitor features.
	...
	generate_attach_event_statement (a_source: SYSTEM_DLL_CODE_ATTACH_EVENT_STATEMENT) is
			-- | Create instance of `ECD_ATTACH_EVENT_STATEMENT'.
		...
		local
			l_attach_event_statement: ECD_ATTACH_EVENT_STATEMENT
		do
	...
	generate_remove_event_statement (a_source: SYSTEM_DLL_CODE_REMOVE_EVENT_STATEMENT) is
			-- | Create instance of `ECD_REMOVE_EVENT_STATEMENT'.
		...
		require
			non_void_source: a_source /= Void
		local
			a_remove_event_statement: ECD_REMOVE_EVENT_STATEMENT
		do
...
feature {NONE} -- Implementation
	...
	initialize_attach_event_statement (a_source: SYSTEM_DLL_CODE_ATTACH_EVENT_STATEMENT; an_attach_event_statement: ECD_ATTACH_EVENT_STATEMENT) is
	...
	initialize_remove_event_statement (a_source: SYSTEM_DLL_CODE_REMOVE_EVENT_STATEMENT; a_remove_event_statement: ECD_REMOVE_EVENT_STATEMENT) is
			-- | Set `attach_event', `listener'
			-- Generate Eiffel code from `a_source'.
		require
			non_void_source: a_source /= Void
		...
		local
			l_event: ECD_EVENT_REFERENCE_EXPRESSION
		do
			code_dom_generator.generate_expression_from_dom (a_source.event)
...
end -- class ECD_EVENT_STATEMENT_FACTORY
