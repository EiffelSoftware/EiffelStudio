...
#ifndef __ECOM_CONTROL_LIBRARY_IOLEINPLACEFRAME_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IOLEINPLACEFRAME_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
{
class IOleInPlaceFrame_impl_stub;
}
...
namespace ecom_control_library
{
class IOleInPlaceFrame_impl_stub : public ecom_control_library::IOleInPlaceFrame
{
public:
  IOleInPlaceFrame_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IOleInPlaceFrame_impl_stub ();
