...
#include "ecom_EiffelComCompiler_IEnumEiffelClass_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ieiffel_class_descriptor = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_53 (pp_ieiffel_class_descriptor, NULL));
		if (*pp_ieiffel_class_descriptor != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_53 (((tmp_pp_ieiffel_class_descriptor != NULL) ? eif_wean (tmp_pp_ieiffel_class_descriptor) : NULL), pp_ieiffel_class_descriptor);
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ienum_eiffel_class = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_39 (pp_ienum_eiffel_class, NULL));
		if (*pp_ienum_eiffel_class != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_39 (((tmp_pp_ienum_eiffel_class != NULL) ? eif_wean (tmp_pp_ienum_eiffel_class) : NULL), pp_ienum_eiffel_class);
