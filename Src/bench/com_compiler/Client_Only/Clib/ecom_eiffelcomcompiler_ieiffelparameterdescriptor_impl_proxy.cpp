...
#include "ecom_EiffelComCompiler_IEiffelParameterDescriptor_impl_proxy.h"
...
ecom_EiffelComCompiler::IEiffelParameterDescriptor_impl_proxy::IEiffelParameterDescriptor_impl_proxy( IUnknown * a_pointer )
{
	HRESULT hr, hr2;
...
ecom_EiffelComCompiler::IEiffelParameterDescriptor_impl_proxy::~IEiffelParameterDescriptor_impl_proxy()
{
	p_unknown->Release ();
...
EIF_REFERENCE ecom_EiffelComCompiler::IEiffelParameterDescriptor_impl_proxy::ccom_name(  )
...
EIF_REFERENCE ecom_EiffelComCompiler::IEiffelParameterDescriptor_impl_proxy::ccom_display(  )
...
EIF_POINTER ecom_EiffelComCompiler::IEiffelParameterDescriptor_impl_proxy::ccom_item()
