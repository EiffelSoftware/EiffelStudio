note
	description: "Summary description for {ESA_REPORT_TEMPLATE_INSPECTOR}."
	date: "$Date$"
	revision: "$Revision$"

class
	ESA_REPORT_CATEGORY_TEMPLATE_INSPECTOR
...
feature -- Internal data
	...
	internal_data (fn: STRING; obj: ESA_REPORT_CATEGORY): detachable CELL [detachable ANY]
		local
			l_fn: STRING
		do
			if obj /= Void then
