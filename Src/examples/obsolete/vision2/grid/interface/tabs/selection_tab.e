...
feature {NONE} -- Implementation
	...
	selected_items_button_selected
	...
	clear_selection_button_selected
			-- Called by `select_actions' of `clear_selection_button'.
		do
			grid.remove_selection
		end

	finder_motion (an_item: EV_GRID_ITEM)
			--
		do
	...
	item_x_position_changed (a_value: INTEGER)
	...
	item_y_position_changed (a_value: INTEGER)
