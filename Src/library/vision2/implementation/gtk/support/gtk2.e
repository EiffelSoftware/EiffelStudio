...
feature -- Externals
	...
	frozen g_main_context_pending (a_context: POINTER): BOOLEAN
		external
	...
	frozen g_main_context_iteration (a_context: POINTER; may_block: BOOLEAN): BOOLEAN
		external
	...
	frozen gdk_pango_context_get_for_screen (a_screen: POINTER): POINTER
		external
			"C signature (GdkScreen*): PangoContext* use <gtk/gtk.h>"
		end

	frozen pango_layout_new (a_pango_context: POINTER): POINTER
		external
	...
	frozen gdk_pango_renderer_new (a_screen: POINTER): POINTER
		external
			"C inline use <gtk/gtk.h>"
		alias
			"[
	...
	frozen pango_matrix_concat (a_matrix, a_new_matrix: POINTER)
		external
			"C inline use <gtk/gtk.h>"
		alias
			"[
	...
	frozen c_gtk_requisition_struct_allocate: POINTER
		external
			"C [macro <gtk/gtk.h>]"
		alias
	...
	frozen gtk_container_get_focus_chain (a_container: POINTER; a_focus_chain: TYPED_POINTER [POINTER])
		external
			"C inline use <gtk/gtk.h>"
		alias
	...
	frozen gtk_icon_theme_has_icon (icon_theme, icon_name: POINTER): BOOLEAN
		external
	...
	frozen gtk_window_group_add_window (a_group, a_window: POINTER)
		external
			"C signature (GtkWindowGroup*, GtkWindow*) use <gtk/gtk.h>"
		end

	frozen gtk_window_group_remove_window (a_group, a_window: POINTER)
		external
			"C signature (GtkWindowGroup*, GtkWindow*) use <gtk/gtk.h>"
		end

	frozen gtk_button_set_label (tool_button, a_text: POINTER)
		external
			"C signature (GtkButton*, gchar*) use <gtk/gtk.h>"
		end

	frozen gtk_button_get_label (tool_button: POINTER): POINTER
		external
			"C signature (GtkButton*): gchar* use <gtk/gtk.h>"
		end
	...
	frozen gtk_window_set_resizable (a_window: POINTER; a_resize: BOOLEAN)
		external
			"C signature (GtkWindow*, gboolean) use <gtk/gtk.h>"
		end

	frozen gtk_window_get_resizable (a_window: POINTER): BOOLEAN
		external
			"C signature (GtkWindow*): gboolean use <gtk/gtk.h>"
		end
	...
	frozen gdk_keymap_lookup_key (a_keymap, a_key: POINTER): NATURAL_32
		external
			"C signature (GdkKeymap*, GdkKeymapKey*): guint use <gtk/gtk.h>"
		end

	frozen gdk_keyval_convert_case (a_keyval: NATURAL_32; a_lower, a_upper: TYPED_POINTER [NATURAL_32])
		external
	...
	frozen gtk_widget_class_find_style_property (a_widget_class, a_property_name: POINTER): POINTER
		external
			"C signature (GtkWidgetClass*, gchar*): GParamSpec* use <gtk/gtk.h>"
		end

	frozen gtk_widget_get_class (a_widget: POINTER): POINTER
		external
			"C macro use <gtk/gtk.h>"
		alias
	...
	frozen gtk_toolbar_unset_style (a_toolbar: POINTER)
		external
	...
	frozen gtk_tool_button_set_label_widget (tool_button, label_widget: POINTER)
		external
			"C signature (GtkToolButton*, GtkWidget*) use <gtk/gtk.h>"
		end
	...
	frozen signal_emit_by_name (a_object: POINTER; a_name: POINTER)
		external
			"C macro use <gtk/gtk.h>"
		alias
	...
	frozen gtk_text_buffer_begin_user_action (a_text_buffer: POINTER)
		external
			"C signature (GtkTextBuffer*) use <gtk/gtk.h>"
		end

	frozen gtk_text_buffer_end_user_action (a_text_buffer: POINTER)
		external
			"C signature (GtkTextBuffer*) use <gtk/gtk.h>"
		end
	...
	frozen gtk_text_iter_ends_line (a_iter: POINTER): BOOLEAN
		external
			"C signature (GtkTextIter*): gboolean use <gtk/gtk.h>"
		end

	frozen gtk_text_iter_starts_line (a_iter: POINTER): BOOLEAN
		external
			"C signature (GtkTextIter*): gboolean use <gtk/gtk.h>"
		end
	...
	frozen gtk_text_view_get_editable (a_text_view: POINTER): BOOLEAN
		external
			"C signature (GtkTextView*): gboolean use <gtk/gtk.h>"
		end

	frozen gtk_text_view_get_line_yrange (a_text_view: POINTER; a_text_iter: POINTER; a_y: POINTER; a_height: POINTER)
		external
	...
	frozen gtk_text_buffer_remove_all_tags (a_buffer: POINTER; a_start: POINTER; a_end: POINTER)
		external
			"C signature (GtkTextBuffer*, GtkTextIter*, GtkTextIter*) use <gtk/gtk.h>"
		end
	...
	frozen gtk_dialog_set_has_separator (a_dialog: POINTER; a_setting: BOOLEAN)
		external
