...
inherit
	...
	EV_CUSTOM_EVENT_HANDLER [STRING]
...
feature -- remove command association

	remove_ok_commands is
			-- Empty the list of commands to be executed when
			-- "OK" button is pressed.
		do
			remove_all_commands ("Cmd_ok")
		end
	...
	remove_cancel_commands is
		...
		do
			remove_all_commands ("Cmd_cancel")
		end
...
feature {NONE} -- Implementation
	...
	position_composants is
		...
		do
			...
			vbox.set_spacing (5)
			hbox.set_child_expandable (vbox, False)
			create_keys (vbox)
