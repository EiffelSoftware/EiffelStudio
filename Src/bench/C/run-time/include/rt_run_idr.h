...
extern void ridr_multi_float (EIF_REAL *obj, size_t num);
extern void widr_multi_float (EIF_REAL *obj, size_t num);
extern void ridr_multi_double (EIF_DOUBLE *obj, size_t num);
extern void widr_multi_double (EIF_DOUBLE *obj, size_t num);
