...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClusterProperties * *)grt_ec_ISE_c.ccom_ec_pointed_cell_187 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_187 ((ecom_eiffel_compiler::IEiffelClusterProperties * *)tmp_rgelt, rgelt);
...
grt_ce_ISE_c.ccom_free_memory_pointed_190 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumClusterProp * *)grt_ec_ISE_c.ccom_ec_pointed_cell_184 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_184 ((ecom_eiffel_compiler::IEnumClusterProp * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_184 (tmp_ppenum);
