...
class
	ARGUMENT_SWITCH_FILE_OR_DIRECTORY_VALIDATOR
	...
	validate_value (a_value: STRING) is
		...
		do
			if not retried then
				...
				reason := "The specified file or directory name is invalid."
			end
		rescue
			retried := True
			retry
...
end -- class {ARGUMENT_SWITCH_FILE_OR_DIRECTORY_VALIDATOR}
