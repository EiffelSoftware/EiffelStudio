	...
	process_info is
		...
		do
			...
			if eifp_document.successful then
				...
				eiffel_files.add_file (system_status.current_project_settings.project_location + "\" + system_status.current_project_settings.constants_class_name.as_lower + ".e", True)
				eiffel_files.add_file (system_status.current_project_settings.project_location + "\" + system_status.current_project_settings.constants_class_name.as_lower +  Class_implementation_extension.as_lower + ".e", True)
			end
