...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			scrollable_area.set_item_width (1)
...
feature {NONE} -- Implementation
	...
	track_movement (a_x, a_y: INTEGER; a_x_tilt, a_y_tilt, a_pressure: DOUBLE; a_screen_x, a_screen_y: INTEGER)
			-- Called by `pointer_motion_actions' of `drawing_area'.
		deferred
		end
	
	button_pressed (a_x, a_y, a_button: INTEGER; a_x_tilt, a_y_tilt, a_pressure: DOUBLE; a_screen_x, a_screen_y: INTEGER)
			-- Called by `pointer_button_press_actions' of `drawing_area'.
		deferred
		end
	
	button_released (a_x, a_y, a_button: INTEGER; a_x_tilt, a_y_tilt, a_pressure: DOUBLE; a_screen_x, a_screen_y: INTEGER)
			-- Called by `pointer_button_release_actions' of `drawing_area'.
		deferred
		end
	
	update_pixmap_size (a_x, a_y, a_width, a_height: INTEGER)
