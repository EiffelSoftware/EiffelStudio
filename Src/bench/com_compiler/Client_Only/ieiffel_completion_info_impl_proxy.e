...
feature {NONE}  -- Externals
	...
	ccom_add_local (cpp_obj: POINTER; bstr_name: STRING; bstr_type: STRING) is
			-- Add a local variable used for solving member completion list
		external
			"C++ [ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT)"
		end
	...
	ccom_target_features (cpp_obj: POINTER; bstr_target: STRING; bstr_feature_name: STRING; bstr_file_name: STRING; pvar_names: POINTER; pvar_signatures: POINTER; pvar_image_indexes: POINTER) is
			-- Features accessible from target.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT,EIF_OBJECT,VARIANT *,VARIANT *,VARIANT *)"
		end
	...
	ccom_target_feature (cpp_obj: POINTER; bstr_target: STRING; bstr_feature_name: STRING; bstr_file_name: STRING): IEIFFEL_FEATURE_DESCRIPTOR_INTERFACE is
			-- Feature information
		external
			"C++ [ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT,EIF_OBJECT): EIF_REFERENCE"
		end

	ccom_flush_completion_features (cpp_obj: POINTER; bstr_file_name: STRING) is
			-- Flush temporary completion features for a specific file
		external
			"C++ [ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy.h%"](EIF_OBJECT)"
		end
	...
	ccom_initialize_feature (cpp_obj: POINTER; bstr_name: STRING; var_arguments: POINTER; var_argument_types: POINTER; bstr_return_type: STRING; ul_feature_type: INTEGER; bstr_file_name: STRING) is
			-- Initialize a feature for completion without compiltation
		external
			"C++ [ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy.h%"](EIF_OBJECT,VARIANT *,VARIANT *,EIF_OBJECT,EIF_INTEGER,EIF_OBJECT)"
		end

	ccom_delete_ieiffel_completion_info_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_completion_info_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy %"ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy.h%"]():EIF_POINTER"
		end
