...
-----------------------------------------------------------*/
{
	...
	grt_ce_ISE_c.ccom_free_memory_pointed_106 (tmp_return_value);
...
-----------------------------------------------------------*/
{
	...
	EIF_REFERENCE eiffel_result = eif_protect ((EIF_REFERENCE)grt_ce_ISE_c.ccom_ce_pointed_interface_78 (ret_value));
	return eif_wean (eiffel_result);
};
/*----------------------------------------------------------------------------------------------------------------------*/
...
-----------------------------------------------------------*/
{
	...
	tmp_file_path = (BSTR *)grt_ec_ISE_c.ccom_ec_pointed_cell_81 (eif_access (file_path), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_81 ((BSTR *)tmp_file_path, file_path);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_line_number, line_number);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_81 (tmp_file_path);
grt_ce_ISE_c.ccom_free_memory_pointed_82 (tmp_line_number);
