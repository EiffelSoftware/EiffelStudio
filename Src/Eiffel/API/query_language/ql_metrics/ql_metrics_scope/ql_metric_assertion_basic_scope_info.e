indexing
	description: "Representation of assertion basic scope of a metric"
...
feature -- Access
	...
	calculate_function: FUNCTION [ANY, TUPLE [QL_ASSERTION], DOUBLE]
	...
	domain_generator: QL_ASSERTION_DOMAIN_GENERATOR
			-- Domain generator used to calculate metric

feature{NONE} -- Implementation

	evaluate_item (a_item: QL_ASSERTION) is
...
invariant
	scope_valid: scope.is_equal (assertion_scope)
