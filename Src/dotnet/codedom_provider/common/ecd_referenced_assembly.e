...
feature {NONE} -- Initialization
	...
	make (an_assembly: ASSEMBLY) is
		...
		do
			...
			assembly_prefix := (create {ECD_ASSEMBLY_PREFIX_FACTORY}).assembly_prefix (assembly.get_name.name)
		ensure
			assembly_prefix_set: assembly_prefix.is_equal ((create {ECD_ASSEMBLY_PREFIX_FACTORY}).assembly_prefix (assembly.get_name.name))
...
end -- Class ECD_REFERENCED_ASSEMBLY