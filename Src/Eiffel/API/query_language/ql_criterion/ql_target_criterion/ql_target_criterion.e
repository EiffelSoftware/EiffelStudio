...
feature -- Access
	...
	domain_generator (a_enable_fill_domain: BOOLEAN; a_apply_current: BOOLEAN): QL_TARGET_DOMAIN_GENERATOR
...
feature -- Logic operations
	...
	conjuncted alias "and" (other: QL_TARGET_CRITERION): QL_TARGET_CRITERION
			-- Boolean conjunction with `other'
		do
			create {QL_TARGET_AND_CRITERION}Result.make (Current, other)
		end

	negated alias "not": QL_TARGET_CRITERION
			-- Negation
		do
			create {QL_TARGET_NOT_CRITERION}Result.make (Current)
		end

	disjuncted alias "or" (other: QL_TARGET_CRITERION): QL_TARGET_CRITERION
...
feature -- Access
	...
	compiled_criterion: QL_TARGET_CRITERION
