...
feature {NONE} -- {EB_SHARED_PIXMAP_FACTORY} Implementation
	...
	pixmap_lookup: HASH_TABLE [TUPLE [INTEGER, INTEGER], STRING] is
		...
		once
			...
			Result.put ([1, 5], "icon_new_feature")	
			Result.put ([1, 6], "icon_toggle_signature")
			Result.put ([1, 7], "icon_toggle_assigner")
			Result.put ([1, 8], "icon_toggle_alias")
			Result.put ([1, 9], "icon_down_triangle")
