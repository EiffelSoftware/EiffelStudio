...
feature -- Access
	...
	Generated_iid_file_name: STRING_32 = "$ecom_iid_temp.c"
			-- Midl generated iid file name

	Generated_header_file_name: STRING = "$ecom_header_temp.h"
			-- Midl generated header file name

	Generated_dlldata_file_name: STRING_32 = "$ecom_data_temp.c"
			-- Midl generated dlldata file name

	Generated_ps_file_name: STRING_32 = "$ecom_ps_temp.c"
