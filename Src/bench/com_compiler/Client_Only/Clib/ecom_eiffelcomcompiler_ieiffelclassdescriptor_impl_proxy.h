...
#ifndef __ECOM_EIFFELCOMCOMPILER_IEIFFELCLASSDESCRIPTOR_IMPL_PROXY_H__
#define __ECOM_EIFFELCOMCOMPILER_IEIFFELCLASSDESCRIPTOR_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_EiffelComCompiler::IEiffelClassDescriptor * p_IEiffelClassDescriptor;
