...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			l_ev_horizontal_box_3.extend (index_filename_text)
			...
			l_ev_horizontal_box_10.extend (filter_combo)
			...
			l_ev_horizontal_box_12.extend (l_ev_cell_2)
			l_ev_horizontal_box_12.extend (okay_button)
			...
			l_ev_horizontal_box_12.disable_item_expand (okay_button)
