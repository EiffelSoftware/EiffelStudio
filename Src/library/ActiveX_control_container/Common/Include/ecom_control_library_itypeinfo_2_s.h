...
public:
  ...
  -----------------------------------------------------------*/
  virtual STDMETHODIMP GetTypeAttr(  /* [out] */ ecom_control_library::tagTYPEATTR * * pp_type_attr, /* [out] */ ecom_control_library::DWORD1 * p_dummy ) = 0;
  ...
  No description available.
  -----------------------------------------------------------*/
  virtual STDMETHODIMP GetFuncDesc(  /* [in] */ UINT a_index, /* [out] */ ecom_control_library::tagFUNCDESC * * pp_func_desc, /* [out] */ ecom_control_library::DWORD1 * p_dummy ) = 0;


  /*-----------------------------------------------------------
  No description available.
  -----------------------------------------------------------*/
  virtual STDMETHODIMP GetVarDesc(  /* [in] */ UINT a_index, /* [out] */ ecom_control_library::tagVARDESC * * pp_var_desc, /* [out] */ ecom_control_library::DWORD1 * p_dummy ) = 0;


  /*-----------------------------------------------------------
  No description available.
  -----------------------------------------------------------*/
  virtual STDMETHODIMP GetNames(  /* [in] */ LONG memid, /* [out] */ BSTR * rg_bstr_names, /* [in] */ UINT c_max_names, /* [out] */ UINT * pc_names ) = 0;
  ...
  No description available.
  -----------------------------------------------------------*/
  virtual STDMETHODIMP GetDocumentation(  /* [in] */ LONG memid, /* [in] */ ULONG ref_ptr_flags, /* [out] */ BSTR * p_bstr_name, /* [out] */ BSTR * p_bstr_doc_string, /* [out] */ ULONG * pdw_help_context, /* [out] */ BSTR * p_bstr_help_file ) = 0;


  /*-----------------------------------------------------------
  No description available.
  -----------------------------------------------------------*/
  virtual STDMETHODIMP GetDllEntry(  /* [in] */ LONG memid, /* [in] */ long invkind, /* [in] */ ULONG ref_ptr_flags, /* [out] */ BSTR * p_bstr_dll_name, /* [out] */ BSTR * p_bstr_name, /* [out] */ USHORT * pw_ordinal ) = 0;
  ...
  No description available.
  -----------------------------------------------------------*/
  virtual STDMETHODIMP CreateInstance(  /* [in] */ GUID * riid, /* [out] */ IUnknown * * ppv_obj ) = 0;
  ...
  No description available.
  -----------------------------------------------------------*/
  virtual STDMETHODIMP GetContainingTypeLib(  /* [out] */ ecom_control_library::ITypeLib_2 * * pp_tlib, /* [out] */ UINT * p_index ) = 0;
