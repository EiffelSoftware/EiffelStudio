...
PLATFORM=VC-WIN64A
CC=cl
CFLAG= /MD /Ox /W3 /Gs0 /GF /Gy /nologo -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 -DOPENSSL_SYSNAME_WIN32 -DOPENSSL_SYSNAME_WINNT -DUNICODE -D_UNICODE -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE /Fdout32 -DOPENSSL_NO_CAMELLIA -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_KRB5 -DOPENSSL_NO_DYNAMIC_ENGINE    
APP_CFLAG=
LIB_CFLAG=
SHLIB_CFLAG=
...
# be added
EX_LIBS=wsock32.lib gdi32.lib advapi32.lib user32.lib bufferoverflowu.lib
...
CRYPTOOBJ=$(OBJ_D)\cryptlib.obj \
	...
	$(OBJ_D)\ec2_smpl.obj $(OBJ_D)\ec2_mult.obj $(OBJ_D)\ech_lib.obj \
	...
	$(OBJ_D)\x_exten.obj $(OBJ_D)\asn1_gen.obj $(OBJ_D)\asn1_par.obj \
	...
	$(OBJ_D)\pem_pkey.obj $(OBJ_D)\x509_def.obj $(OBJ_D)\x509_d2.obj \
	...
	$(OBJ_D)\v3_addr.obj $(OBJ_D)\conf_err.obj $(OBJ_D)\conf_lib.obj \
	...
	$(OBJ_D)\eng_padlock.obj $(OBJ_D)\ocsp_asn.obj $(OBJ_D)\ocsp_ext.obj \
	...
	$(OBJ_D)\krb5_asn.obj $(OBJ_D)\str_err.obj $(OBJ_D)\str_lib.obj \
	$(OBJ_D)\str_meth.obj $(OBJ_D)\str_mem.obj $(OBJ_D)\pqueue.obj \
