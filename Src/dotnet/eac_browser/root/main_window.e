...
feature {NONE} -- Menu actions
	...
	ok_print (a_print_dialog: EV_PRINT_DIALOG)
		...
		do
			if
				attached (create {SESSION}).current_assembly as l_current_assembly and
				attached (create {SESSION}).current_type as l_current_type
			then
	...
	on_find_eiffel_feature
		...
		do
			create find_eiffel_feature_dlg.make (Current)
