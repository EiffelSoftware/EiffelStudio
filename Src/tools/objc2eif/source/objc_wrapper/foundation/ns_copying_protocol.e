...
--			end
--			result_pointer := objc_copy_with_zone_ (item, a_zone__item)
...
--	objc_copy_with_zone_ (an_item: POINTER; a_zone: UNSUPPORTED_TYPE): POINTER
--			-- Auto generated Objective-C wrapper.
--		external
--			"C inline use <Foundation/Foundation.h>"
--		alias
--			"[
--				return (EIF_POINTER)[(id <NSCopying>)$an_item copyWithZone:];
--			 ]"
--		end
