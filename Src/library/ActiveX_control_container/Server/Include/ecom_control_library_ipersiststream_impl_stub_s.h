...
#ifndef __ECOM_CONTROL_LIBRARY_IPERSISTSTREAM_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IPERSISTSTREAM_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
{
class IPersistStream_impl_stub;
}
...
namespace ecom_control_library
{
class IPersistStream_impl_stub : public ecom_control_library::IPersistStream
{
public:
  IPersistStream_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IPersistStream_impl_stub ();
