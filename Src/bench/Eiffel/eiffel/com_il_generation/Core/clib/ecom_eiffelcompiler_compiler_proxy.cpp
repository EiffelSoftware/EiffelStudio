...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->set_console_application ();
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->set_window_application ();
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_set_version(  /* [in] */ EIF_INTEGER build,  /* [in] */ EIF_INTEGER major,  /* [in] */ EIF_INTEGER minor,  /* [in] */ EIF_INTEGER revision )
...
-----------------------------------------------------------*/
{
	...
	LONG tmp_build = 0;
	tmp_build = (LONG)build;
	LONG tmp_major = 0;
	tmp_major = (LONG)major;
	LONG tmp_minor = 0;
	tmp_minor = (LONG)minor;
	LONG tmp_revision = 0;
	tmp_revision = (LONG)revision;
	
	hr = p_COMPILER_PROXY_I->set_version(tmp_build,tmp_major,tmp_minor,tmp_revision);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_set_verifiability(  /* [in] */ EIF_BOOLEAN v )
...
-----------------------------------------------------------*/
{
	...
	VARIANT_BOOL tmp_v = 0;
	tmp_v = (VARIANT_BOOL)rt_ec.ccom_ec_boolean (v);
	
	hr = p_COMPILER_PROXY_I->set_verifiability(tmp_v);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_set_cls_compliant(  /* [in] */ EIF_BOOLEAN v )
...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->set_cls_compliant(tmp_v);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_set_any_type_id(  /* [in] */ EIF_INTEGER v )
...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->set_any_type_id(tmp_v);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_generate_none_type_class_mapping(  /* [in] */ EIF_INTEGER type_id )
...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->generate_none_type_class_mapping(tmp_type_id);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_generate_eiffel_type_info_type_class_mapping(  /* [in] */ EIF_INTEGER type_id )
...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->generate_eiffel_type_info_type_class_mapping(tmp_type_id);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_set_implementation_class()
...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->set_implementation_class ();
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_generate_type_feature(  /* [in] */ EIF_INTEGER feature_id )
...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->generate_type_feature(tmp_feature_id);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_EiffelCompiler::COMPILER_PROXY::ccom_generate_once_result_address()
...
-----------------------------------------------------------*/
{
	...
	hr = p_COMPILER_PROXY_I->generate_once_result_address ();
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
