indexing
	description: "Docking manager command"
	date: "$Date$"
	revision: "$Revision$"
...
feature -- Commands
	...
	set_main_area_background_color (a_color: EV_COLOR) is
		...
		do
			 internal_docking_manager.query.inner_container_main.set_background_color (a_color)
		ensure
			set: internal_docking_manager.query.inner_container_main.background_color.is_equal (a_color)
		end
