...
external class
	SYSTEM_DLL_DATE_TIME_CONVERTER
...
create
	make_system_dll_date_time_converter

feature {NONE} -- Initialization

	frozen make_system_dll_date_time_converter is
		external
...
end -- class SYSTEM_DLL_DATE_TIME_CONVERTER
