...
feature {NONE} -- Testing
	...
	test_natural_16
		...
		do
			...
			check_boolean ("bit_not - 1", n16.bit_not = {NATURAL_16} 0xF0)
			check_boolean ("bit_not - 2", n16_ref.bit_not = {NATURAL_16} 0xF0)
	...
	test_natural_32
		...
		do
			...
			n32_ref := n32
			l_n32_ref := l_n32
			check_boolean ("& - 1", n32 & l_n16 = {NATURAL_32} 0x00)
			check_boolean ("& - 2", n32_ref & l_n32_ref = {NATURAL_32} 0x00)
			check_boolean ("| - 1", n32 | l_n16 = {NATURAL_32} 0xFF)
			check_boolean ("| - 2", n32_ref | l_n32_ref = {NATURAL_32} 0xFF)
			check_boolean ("xor - 1", n32.bit_xor (l_n16) = {NATURAL_32} 0xFF)
			check_boolean ("xor - 2", n32_ref.bit_xor (l_n32_ref) = {NATURAL_32} 0xFF)
			check_boolean ("bit_not - 1", n32.bit_not = {NATURAL_32} 0xF0)
			check_boolean ("bit_not - 2", n32_ref.bit_not = {NATURAL_32} 0xF0)
	...
	test_natural_64
		...
		do
			...
			n64_ref := n64
			l_n64_ref := l_n64
			check_boolean ("& - 1", n64 & l_n16 = {NATURAL_64} 0x00)
			check_boolean ("& - 2", n64_ref & l_n64_ref = {NATURAL_64} 0x00)
			check_boolean ("| - 1", n64 | l_n16 = {NATURAL_64} 0xFF)
			check_boolean ("| - 2", n64_ref | l_n64_ref = {NATURAL_64} 0xFF)
			check_boolean ("xor - 1", n64.bit_xor (l_n16) = {NATURAL_64} 0xFF)
			check_boolean ("xor - 2", n64_ref.bit_xor (l_n64_ref) = {NATURAL_64} 0xFF)
			check_boolean ("bit_not - 1", n64.bit_not = {NATURAL_64} 0xF0)
			check_boolean ("bit_not - 2", n64_ref.bit_not = {NATURAL_64} 0xF0)
