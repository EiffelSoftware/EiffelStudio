...
#include "ecom_EiffelComCompiler_IEiffelCompletionInfo_impl_proxy_s.h"
...
ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy::IEiffelCompletionInfo_impl_proxy( IUnknown * a_pointer )
{
	HRESULT hr, hr2;
...
ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy::~IEiffelCompletionInfo_impl_proxy()
{
	p_unknown->Release ();
...
EIF_INTEGER ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy::ccom_last_error_code()
...
EIF_REFERENCE ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy::ccom_last_source_of_exception()
...
EIF_REFERENCE ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy::ccom_last_error_description()
...
EIF_REFERENCE ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy::ccom_last_error_help_file()
...
EIF_POINTER ecom_EiffelComCompiler::IEiffelCompletionInfo_impl_proxy::ccom_item()
