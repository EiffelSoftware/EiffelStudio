          ...
          <form class="form-horizontal well" data-rel="register" id="registerHere" method='POST' action='{$host/}/register' itemprop="create">
            <fieldset>
              ...
              <div class="form-group">
                <label class="control-label col-xs-3 col-sm-3 col-md-3" itemprop="first_name" >First Name</label>
              ...
              <div class="form-group">
                <label class="control-label col-xs-3 col-sm-3 col-md-3" itemprop="last_name">Last Name</label>
                 <div class="col-xs-9 col-sm-9 col-md-9">
              ...
              <div class="form-group">
                <label class="control-label col-xs-3 col-sm-3 col-md-3" itemprop="email">Email</label>
                 <div class="col-xs-9 col-sm-9 col-md-9">
              ...
              <div class="form-group">
                <label class="control-label col-xs-3 col-sm-3 col-md-3" itemprop="user_name">User Name</label>
                 <div class="col-xs-9 col-sm-9 col-md-9">
              ...
              <div class="form-group">
                <label class="control-label col-xs-3 col-sm-3 col-md-3" itemprop="password">Password</label>
                 <div class="col-xs-9 col-sm-9 col-md-9">
              ...
              <div class="form-group">
                <label class="control-label col-xs-3 col-sm-3 col-md-3" itemprop="check_password">Re-type Password</label>
                 <div class="col-xs-9 col-sm-9 col-md-9">
               ...
               <div class="form-group">
                 <label class="control-label col-xs-3 col-sm-3 col-md-3" for="input01">Choose a security question</label>
                 <div class="col-xs-9 col-sm-9 col-md-9">
              ...
              <div class="form-group">
                <label class="control-label col-xs-3 col-sm-3 col-md-3" itemprop="answer">Answer security question</label>
                <div class="col-xs-9 col-sm-9 col-md-9">
