...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__NAMEDSIGNATURETYPE_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__NAMEDSIGNATURETYPE_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
class _NamedSignatureType_impl_proxy;
}
...
{
public:
	_NamedSignatureType_impl_proxy (IUnknown * a_pointer);
	virtual ~_NamedSignatureType_impl_proxy ();
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_ISE_Reflection_EiffelComponents::_NamedSignatureType * p__NamedSignatureType;
