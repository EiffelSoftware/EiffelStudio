...
feature {NONE} -- NSDatePickerCell Externals
	...
	objc_date_picker_style (an_item: POINTER): NATURAL_64
		...
		alias
			"[
				return [(NSDatePickerCell *)$an_item datePickerStyle];
			 ]"
		end
	...
	objc_set_date_picker_style_ (an_item: POINTER; a_new_style: NATURAL_64)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setDatePickerStyle:$a_new_style];
			 ]"
		end
	...
	objc_draws_background (an_item: POINTER): BOOLEAN
		...
		alias
			"[
				return [(NSDatePickerCell *)$an_item drawsBackground];
			 ]"
		end
	...
	objc_set_draws_background_ (an_item: POINTER; a_flag: BOOLEAN)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setDrawsBackground:$a_flag];
			 ]"
		end
	...
	objc_background_color (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item backgroundColor];
			 ]"
		end
	...
	objc_set_background_color_ (an_item: POINTER; a_color: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setBackgroundColor:$a_color];
			 ]"
		end
	...
	objc_text_color (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item textColor];
			 ]"
		end
	...
	objc_set_text_color_ (an_item: POINTER; a_color: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setTextColor:$a_color];
			 ]"
		end
	...
	objc_date_picker_mode (an_item: POINTER): NATURAL_64
		...
		alias
			"[
				return [(NSDatePickerCell *)$an_item datePickerMode];
			 ]"
		end
	...
	objc_set_date_picker_mode_ (an_item: POINTER; a_new_mode: NATURAL_64)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setDatePickerMode:$a_new_mode];
			 ]"
		end
	...
	objc_date_picker_elements (an_item: POINTER): NATURAL_64
		...
		alias
			"[
				return [(NSDatePickerCell *)$an_item datePickerElements];
			 ]"
		end
	...
	objc_set_date_picker_elements_ (an_item: POINTER; a_element_flags: NATURAL_64)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setDatePickerElements:$a_element_flags];
			 ]"
		end
	...
	objc_calendar (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item calendar];
			 ]"
		end
	...
	objc_set_calendar_ (an_item: POINTER; a_new_calendar: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setCalendar:$a_new_calendar];
			 ]"
		end
	...
	objc_locale (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item locale];
			 ]"
		end
	...
	objc_set_locale_ (an_item: POINTER; a_new_locale: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setLocale:$a_new_locale];
			 ]"
		end
	...
	objc_time_zone (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item timeZone];
			 ]"
		end
	...
	objc_set_time_zone_ (an_item: POINTER; a_new_time_zone: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setTimeZone:$a_new_time_zone];
			 ]"
		end
	...
	objc_date_value (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item dateValue];
			 ]"
		end
	...
	objc_set_date_value_ (an_item: POINTER; a_new_start_date: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setDateValue:$a_new_start_date];
			 ]"
		end
	...
	objc_time_interval (an_item: POINTER): REAL_64
		...
		alias
			"[
				return [(NSDatePickerCell *)$an_item timeInterval];
			 ]"
		end
	...
	objc_set_time_interval_ (an_item: POINTER; a_new_time_interval: REAL_64)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setTimeInterval:$a_new_time_interval];
			 ]"
		end
	...
	objc_min_date (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item minDate];
			 ]"
		end
	...
	objc_set_min_date_ (an_item: POINTER; a_date: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setMinDate:$a_date];
			 ]"
		end
	...
	objc_max_date (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item maxDate];
			 ]"
		end
	...
	objc_set_max_date_ (an_item: POINTER; a_date: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setMaxDate:$a_date];
			 ]"
		end
	...
	objc_delegate (an_item: POINTER): POINTER
		...
		alias
			"[
				return (EIF_POINTER)[(NSDatePickerCell *)$an_item delegate];
			 ]"
		end
	...
	objc_set_delegate_ (an_item: POINTER; an_object: POINTER)
		...
		alias
			"[
				[(NSDatePickerCell *)$an_item setDelegate:$an_object];
			 ]"
		end
