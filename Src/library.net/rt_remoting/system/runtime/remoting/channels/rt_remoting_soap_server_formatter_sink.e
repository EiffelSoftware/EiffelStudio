...
external class
	RT_REMOTING_SOAP_SERVER_FORMATTER_SINK
...
feature {NONE} -- Initialization
	...
	frozen make (protocol: RT_REMOTING_PROTOCOL_IN_RT_REMOTING_SOAP_SERVER_FORMATTER_SINK; next_sink: ISERVER_CHANNEL_SINK; receiver: ICHANNEL_RECEIVER) is
		external
...
feature -- Basic Operations
	...
	frozen process_message (sink_stack: ISERVER_CHANNEL_SINK_STACK; request_msg: IMESSAGE; request_headers: ITRANSPORT_HEADERS; request_stream: SYSTEM_STREAM; response_msg: IMESSAGE; response_headers: ITRANSPORT_HEADERS; response_stream: SYSTEM_STREAM): SERVER_PROCESSING is
		external
			"IL signature (System.Runtime.Remoting.Channels.IServerChannelSinkStack, System.Runtime.Remoting.Messaging.IMessage, System.Runtime.Remoting.Channels.ITransportHeaders, System.IO.Stream, System.Runtime.Remoting.Messaging.IMessage&, System.Runtime.Remoting.Channels.ITransportHeaders&, System.IO.Stream&): System.Runtime.Remoting.Channels.ServerProcessing use System.Runtime.Remoting.Channels.SoapServerFormatterSink"
		alias
			"ProcessMessage"
		end
...
end -- class RT_REMOTING_SOAP_SERVER_FORMATTER_SINK
