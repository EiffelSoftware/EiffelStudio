...
#include "ecom_control_library_IOleCache2_impl_stub_s.h"
...
ecom_control_library::IOleCache2_impl_stub::IOleCache2_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IOleCache2_impl_stub::~IOleCache2_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IOleCache2_impl_stub::Cache(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc, /* [in] */ ULONG advf, /* [out] */ ULONG * pdw_connection )
...
STDMETHODIMP ecom_control_library::IOleCache2_impl_stub::Uncache(  /* [in] */ ULONG dw_connection )
...
STDMETHODIMP ecom_control_library::IOleCache2_impl_stub::EnumCache(  /* [out] */ ecom_control_library::IEnumSTATDATA * * ppenum_statdata )
...
STDMETHODIMP ecom_control_library::IOleCache2_impl_stub::InitCache(  /* [in] */ ecom_control_library::IDataObject * p_data_object )
...
STDMETHODIMP ecom_control_library::IOleCache2_impl_stub::SetData(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc, /* [in] */ ecom_control_library::wireSTGMEDIUM * pmedium, /* [in] */ LONG f_release )
...
STDMETHODIMP ecom_control_library::IOleCache2_impl_stub::RemoteUpdateCache(  /* [in] */ ecom_control_library::IDataObject * p_data_object, /* [in] */ ULONG grf_updf, /* [in] */ LONG p_reserved )
...
-----------------------------------------------------------*/
{
	...
	EIF_INTEGER tmp_grf_updf = (EIF_INTEGER)grf_updf;
	EIF_INTEGER tmp_p_reserved = (EIF_INTEGER)p_reserved;
	
	EIF_PROCEDURE eiffel_procedure = 0;
	eiffel_procedure = eif_procedure ("remote_update_cache", type_id);

	(FUNCTION_CAST (void, (EIF_REFERENCE, EIF_REFERENCE, EIF_INTEGER, EIF_INTEGER))eiffel_procedure) (eif_access (eiffel_object), ((tmp_p_data_object != NULL) ? eif_access (tmp_p_data_object) : NULL), (EIF_INTEGER)tmp_grf_updf, (EIF_INTEGER)tmp_p_reserved);
	if (tmp_p_data_object != NULL)
		eif_wean (tmp_p_data_object);
...
STDMETHODIMP ecom_control_library::IOleCache2_impl_stub::DiscardCache(  /* [in] */ ULONG dw_discard_options )
...
-----------------------------------------------------------*/
{
	...
	EIF_INTEGER tmp_dw_discard_options = (EIF_INTEGER)dw_discard_options;
	
	EIF_PROCEDURE eiffel_procedure = 0;
	eiffel_procedure = eif_procedure ("discard_cache", type_id);

	(FUNCTION_CAST (void, (EIF_REFERENCE, EIF_INTEGER))eiffel_procedure) (eif_access (eiffel_object), (EIF_INTEGER)tmp_dw_discard_options);
...
STDMETHODIMP_(ULONG) ecom_control_library::IOleCache2_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IOleCache2_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IOleCache2_impl_stub::QueryInterface( REFIID riid, void ** ppv )
...
-----------------------------------------------------------*/
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<ecom_control_library::IOleCache2*>(this);
	else if (riid == IID_IOleCache2_)
		*ppv = static_cast<ecom_control_library::IOleCache2*>(this);
