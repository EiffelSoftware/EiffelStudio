...
feature {NONE}  -- Externals
	...
	ccom_set_cluster_path (cpp_obj: POINTER; path: STRING) is
			-- Full path to cluster.
		external
			"C++ [ecom_eiffel_compiler::IEiffelClusterProperties_impl_proxy %"ecom_eiffel_compiler_IEiffelClusterProperties_impl_proxy.h%"](EIF_OBJECT)"
		end

	ccom_override (cpp_obj: POINTER): BOOLEAN is
			-- Should this cluster classes take priority over other classes with same name?
		external
			"C++ [ecom_eiffel_compiler::IEiffelClusterProperties_impl_proxy %"ecom_eiffel_compiler_IEiffelClusterProperties_impl_proxy.h%"](): EIF_BOOLEAN"
		end
	...
	ccom_set_assertions (cpp_obj: POINTER; evaluate_check: BOOLEAN; evaluate_require: BOOLEAN; evaluate_ensure: BOOLEAN; evaluate_loop: BOOLEAN; evaluate_invariant: BOOLEAN) is
			-- Set assertions for cluster.
		external
			"C++ [ecom_eiffel_compiler::IEiffelClusterProperties_impl_proxy %"ecom_eiffel_compiler_IEiffelClusterProperties_impl_proxy.h%"](EIF_BOOLEAN,EIF_BOOLEAN,EIF_BOOLEAN,EIF_BOOLEAN,EIF_BOOLEAN)"
		end
	...
	ccom_cluster_id (cpp_obj: POINTER): INTEGER is
			-- Cluster identifier.
		external
			"C++ [ecom_eiffel_compiler::IEiffelClusterProperties_impl_proxy %"ecom_eiffel_compiler_IEiffelClusterProperties_impl_proxy.h%"](): EIF_INTEGER"
		end
	...
	ccom_delete_ieiffel_cluster_properties_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_eiffel_compiler::IEiffelClusterProperties_impl_proxy %"ecom_eiffel_compiler_IEiffelClusterProperties_impl_proxy.h%"]()"
		end

	ccom_create_ieiffel_cluster_properties_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_eiffel_compiler::IEiffelClusterProperties_impl_proxy %"ecom_eiffel_compiler_IEiffelClusterProperties_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_eiffel_compiler::IEiffelClusterProperties_impl_proxy %"ecom_eiffel_compiler_IEiffelClusterProperties_impl_proxy.h%"]():EIF_POINTER"
		end
