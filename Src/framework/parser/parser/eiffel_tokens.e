...
feature -- Token codes
	...
	TE_SOME: INTEGER = 370
	TE_STRING: INTEGER = 371
	TE_EMPTY_STRING: INTEGER = 372
	TE_VERBATIM_STRING: INTEGER = 373
	TE_EMPTY_VERBATIM_STRING: INTEGER = 374
	TE_STR_LT: INTEGER = 375
	TE_STR_LE: INTEGER = 376
	TE_STR_GT: INTEGER = 377
	TE_STR_GE: INTEGER = 378
	TE_STR_MINUS: INTEGER = 379
	TE_STR_PLUS: INTEGER = 380
	TE_STR_STAR: INTEGER = 381
	TE_STR_SLASH: INTEGER = 382
	TE_STR_MOD: INTEGER = 383
	TE_STR_DIV: INTEGER = 384
	TE_STR_POWER: INTEGER = 385
	TE_STR_AND: INTEGER = 386
	TE_STR_AND_THEN: INTEGER = 387
	TE_STR_IMPLIES: INTEGER = 388
	TE_STR_OR: INTEGER = 389
	TE_STR_OR_ELSE: INTEGER = 390
	TE_STR_XOR: INTEGER = 391
	TE_STR_NOT: INTEGER = 392
	TE_STR_FREE: INTEGER = 393
	TE_STR_BRACKET: INTEGER = 394
