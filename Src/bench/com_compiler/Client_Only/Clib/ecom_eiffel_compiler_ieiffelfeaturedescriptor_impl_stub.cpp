...
-----------------------------------------------------------*/
{
	...
	if (file_path != NULL)
	{
		tmp_file_path = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_76 (file_path, NULL));
	}
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_76 (((tmp_file_path != NULL) ? eif_wean (tmp_file_path) : NULL), file_path);
