...
#ifndef __ECOM_CORE_ICORE_H__
#define __ECOM_CORE_ICORE_H__
#ifdef __cplusplus
extern "C" {


#ifndef __ecom_Core_ICore_FWD_DEFINED__
#define __ecom_Core_ICore_FWD_DEFINED__
namespace ecom_Core
{
class ICore;
}
...
#ifdef __cplusplus
extern "C" {
#ifndef __ecom_Core_ICore_INTERFACE_DEFINED__
#define __ecom_Core_ICore_INTERFACE_DEFINED__
namespace ecom_Core
{
...
public:
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP EndModuleGeneration( void ) = 0;
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateClassMappings(  /* [in] */ BSTR class_name1, /* [in] */ LONG type_id, /* [in] */ BSTR source_file_name ) = 0;


	/*-----------------------------------------------------------
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateArrayClassMappings(  /* [in] */ BSTR class_name1, /* [in] */ BSTR element_type_name, /* [in] */ LONG type_id ) = 0;


	/*-----------------------------------------------------------
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateClassHeader(  /* [in] */ VARIANT_BOOL is_interface, /* [in] */ VARIANT_BOOL deferred1, /* [in] */ VARIANT_BOOL expanded1, /* [in] */ VARIANT_BOOL is_external, /* [in] */ LONG type_id ) = 0;
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP EndFeaturesList( void ) = 0;
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateFeatureNature(  /* [in] */ VARIANT_BOOL redefined, /* [in] */ VARIANT_BOOL deferred1, /* [in] */ VARIANT_BOOL frozen1, /* [in] */ VARIANT_BOOL is_attribute ) = 0;


	/*-----------------------------------------------------------
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateFeatureIdentification(  /* [in] */ BSTR name, /* [in] */ LONG feature_id, /* [in] */ SAFEARRAY *  routine_ids, /* [in] */ VARIANT_BOOL in_current_class, /* [in] */ LONG written_type_id ) = 0;
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP CheckRenaming( void ) = 0;


	/*-----------------------------------------------------------
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP CheckRenamingAndRedefinition( void ) = 0;
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateFeatureIL(  /* [in] */ LONG feature_id ) = 0;
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateAttributeAssignment(  /* [in] */ LONG feature_id ) = 0;
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateSlash( void ) = 0;
	...
	No description available.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP GenerateUPlus( void ) = 0;
