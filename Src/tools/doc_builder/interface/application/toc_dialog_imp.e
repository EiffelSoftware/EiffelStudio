...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			l_ev_horizontal_box_2.extend (index_filename_text)
			...
			l_ev_horizontal_box_4.extend (index_root_check)
			l_ev_vertical_box_2.extend (l_ev_horizontal_box_5)
			l_ev_horizontal_box_5.extend (include_empty_dirs_check)
			l_ev_vertical_box_2.extend (l_ev_horizontal_box_6)
			l_ev_horizontal_box_6.extend (include_no_index_check)
			l_ev_vertical_box_2.extend (l_ev_horizontal_box_7)
			l_ev_horizontal_box_7.extend (include_skipped_sub_dirs_check)
			l_ev_vertical_box_2.extend (l_ev_horizontal_box_8)
			l_ev_horizontal_box_8.extend (order_alphabetical_check)
			l_ev_vertical_box_2.extend (l_ev_horizontal_box_9)
			l_ev_horizontal_box_9.extend (l_ev_label_5)
			l_ev_horizontal_box_9.extend (filter_combo)
			...
			l_ev_horizontal_box_11.extend (l_ev_cell_2)
			l_ev_horizontal_box_11.extend (okay_button)
			...
			l_ev_label_1.set_text ("To sort the currently loaded Table of Contents simply choose from the%Noptions listed below and click 'Sort'")
			...
			l_ev_label_5.set_text ("Document Filter")
			...
			combo_studio_filter.set_text ("EiffelStudio Filtered")
			combo_envision_filter.set_text ("ENViSioN! Filtered")
			l_ev_horizontal_box_11.set_padding_width (5)
			l_ev_horizontal_box_11.set_border_width (2)
			l_ev_horizontal_box_11.disable_item_expand (okay_button)
...
feature -- Access
	...
	l_ev_horizontal_box_9, l_ev_horizontal_box_10, l_ev_horizontal_box_11: EV_HORIZONTAL_BOX
