note
	description: "Command to increase editor font zoom factor"
...
feature {NONE} -- Initialization
	...
	init_accelerator
		...
		do
			create l_preference
			l_shortcut := l_preference.preferences.editor_data.shortcuts.item ("zoom_in")
...
feature -- Query
	...
	menu_name: STRING_GENERAL
			-- Menu name
		do
			Result := interface_names.m_zoom_in
		end
...
end -- class EB_EDITOR_FONT_ZOOM_IN_COMMAND
