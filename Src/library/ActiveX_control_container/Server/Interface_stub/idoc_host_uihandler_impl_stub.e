...
feature {NONE}  -- Externals
	...
	ccom_create_item (eif_object: IDOC_HOST_UIHANDLER_IMPL_STUB): POINTER is
			-- Initialize `item'
		external
			"C++ [new ecom_control_library::IDocHostUIHandler_impl_stub %"ecom_control_library_IDocHostUIHandler_impl_stub_s.h%"](EIF_OBJECT)"
		end

end -- IDOC_HOST_UIHANDLER_IMPL_STUB
