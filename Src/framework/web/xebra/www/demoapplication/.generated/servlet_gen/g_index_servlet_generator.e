...
feature-- Implementation
	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			...
			stack.put (temp)
				-- line: 4 row: 6 of file: ./index.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 6 of file: ./index.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			temp.tag_id := "content"
			stack.remove
				-- line: 5 row: 6 of file: ./index.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 6 of file: ./index.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			temp.tag_id := "p"
			stack.put (temp)
				-- line: 5 row: 43 of file: ./index.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 43 of file: ./index.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Welcome to Xebra Demo Application!")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 6 row: 6 of file: ./index.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 6 of file: ./index.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N    ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			temp.tag_id := "p"
			stack.put (temp)
				-- line: 6 row: 43 of file: ./index.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 43 of file: ./index.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Login with fabio/123 or admin/123.")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 7 row: 4 of file: ./index.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 7 row: 4 of file: ./index.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N  ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
