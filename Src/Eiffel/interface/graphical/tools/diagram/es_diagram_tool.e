indexing
	description: "[
		Tool descriptor for EiffelStudio's diagram (BON) tool.
	]"
...
feature -- Access
	...
	icon: EV_PIXEL_BUFFER
		...
		do
			Result := stock_pixmaps.tool_diagram_icon_buffer
		end
	...
	icon_pixmap: EV_PIXMAP
			...
			-- Note: Do not call `tool.icon' as it will create the tool unnecessarly!
		do
			Result := stock_pixmaps.tool_diagram_icon
		end
	...
	title: STRING_32
		...
		do
			Result := interface_names.l_tab_diagram
		end
	...
	shortcut_preference_name: STRING_32
		...
		do
			Result := "show_diagram_tool"
		end

feature {NONE} -- Factory

	create_tool: ES_DIAGRAM_TOOL_PANEL
