...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			disable_item_expand (enable_pinning)
			disable_item_expand (l_ev_label_5)
			disable_item_expand (max_count)
			...
			enable_pinning.select_actions.extend (agent on_enable_pinning_select)
			max_count.change_actions.extend (agent on_max_count_change)
...
feature -- Access
	...
	command_name, max_count: EV_TEXT_FIELD
	enable_pinning: EV_CHECK_BUTTON
...
feature {NONE} -- Implementation
	...
	on_enable_pinning_select
			-- Called by `select_actions' of `enable_pinning'.
		deferred
		end
