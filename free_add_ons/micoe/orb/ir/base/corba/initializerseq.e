...
feature
    ...
    get_value (index : INTEGER) : CORBA_INITIALIZER is
    ...
    set_value (value : CORBA_INITIALIZER; index : INTEGER) is
...
feature { ANY }
    ...
    type_name : STRING is
        ...
        do
            result := "InitializerSeq"
        end

end -- class CORBA_INITIALIZERSEQ
