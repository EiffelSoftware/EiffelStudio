...
feature {NONE} -- Initialization
	...
	frozen make_cryptostream (stream: SYSTEM_IO_STREAM; transform: SYSTEM_SECURITY_CRYPTOGRAPHY_ICRYPTOTRANSFORM; mode: SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAMMODE) is
		external
