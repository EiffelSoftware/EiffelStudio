	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 32 row: 2 of file: ./default.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 32 row: 2 of file: ./default.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 32 row: 1 of file: ./default.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 32 row: 1 of file: ./default.xeb"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 30 row: 1 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 6 row: 1 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 5 row: 55 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "h1"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 5 row: 50 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Eiffel Software Support")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
			stack.remove
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 10 row: 1 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "p"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 9 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/The Eiffel Software Support web site, your one stop destination for information and %N%/9/%/9/support on Eiffel products and technologies.%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 10 row: 3 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 10 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 11 row: 1 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "h2"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 10 row: 23 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Assisted support")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 11 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 20 row: 1 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "p"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 12 row: 4 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 12 row: 44 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("href", "protected/default.xeb")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			stack.put (temp)
				-- line: 12 row: 40 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 12 row: 40 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "View")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 13 row: 4 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 13 row: 4 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " and %N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 13 row: 58 of file: ./default.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 13 row: 58 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("href", "protected/problem_report_form.xeb")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			stack.put (temp)
				-- line: 13 row: 54 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 13 row: 54 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 15 row: 13 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " %N%/9/%/9/problem and bug reports to the Eiffel Software Team through this web site. Customers with a higher %N%/9/%/9/priority ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 15 row: 79 of file: ./default.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 15 row: 79 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("href", "http://www.eiffel.com/services/support/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 15 row: 75 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Support Plan")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 17 row: 12 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 17 row: 12 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " receive faster %N%/9/%/9/response times and problem resolution.  Additional support options include email, phone, %N%/9/%/9/fax and ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 17 row: 93 of file: ./default.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 17 row: 93 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("href", "http://www.eiffel.com/services/training/index.html")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 17 row: 89 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "training courses")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 19 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " %N%/9/%/9/from an Eiffel Software professional.%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 20 row: 3 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 20 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 21 row: 1 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "h2"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 20 row: 19 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Self-support")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 21 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 29 row: 1 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "p"
			stack.put (temp)
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 23 row: 4 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/Learn more about Eiffel Technologies from various online resources. Browse our full %N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 23 row: 61 of file: ./default.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 23 row: 61 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("href", "http://docs.eiffel.com")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 23 row: 57 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "online documentation")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 24 row: 4 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 24 row: 4 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " and %N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 24 row: 77 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("href", "http://www.eiffel.com/search/search.html")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			stack.put (temp)
				-- line: 24 row: 73 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 24 row: 73 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "technical archives")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 26 row: 4 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 26 row: 4 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", ", purchase %N%/9/%/9/educational and reference material, or join the%N%/9/%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 26 row: 82 of file: ./default.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 26 row: 82 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("href", "http://groups.yahoo.com/group/eiffel_software/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "a"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 26 row: 78 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Eiffel User Group")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 28 row: 3 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 28 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", " to discuss%N%/9/%/9/issues and get help.%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 29 row: 3 of file: ./default.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 29 row: 3 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			...
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 30 row: 2 of file: ./default.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
