...
feature -- Access
	...
	comments: LINKED_LIST [ECDP_COMMENT]
			-- Feature comments
...
feature -- Status Report
	...
	ready: BOOLEAN is
		...
		do
			Result := Precursor {ECDP_NAMED_ENTITY} and comments /= Void and not type_feature.is_empty
		end
...
feature -- Basic Operations
	...
	add_comment (a_comment: ECDP_COMMENT) is
...
feature {ECDP_GENERATED_TYPE} -- Code Generation
