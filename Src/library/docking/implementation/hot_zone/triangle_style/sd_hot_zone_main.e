...
--			caller_state_not_void: caller
		...
		do
			...
			if top_rectangle.has_x_y (a_screen_x, a_screen_y) then
				...
				caller.content.state.set_direction ({SD_DOCKING_MANAGER}.dock_top)
			...
			if bottom_rectangle.has_x_y (a_screen_x, a_screen_y) then
				...
				caller.content.state.set_direction ({SD_DOCKING_MANAGER}.dock_bottom)
			...
			if left_rectangle.has_x_y (a_screen_x, a_screen_y) then
				...
				caller.content.state.set_direction ({SD_DOCKING_MANAGER}.dock_left)
			...
			if right_rectangle.has_x_y (a_screen_x, a_screen_y) then
				...
				caller.content.state.set_direction ({SD_DOCKING_MANAGER}.dock_right)
			...
			if not Result and  l_floating_zone = Void then
				...
				caller.content.state.float_window (a_screen_x, a_screen_y)
...
--				internal_shared.feedback.clear_screen
				...
				internal_shared.feedback.draw_transparency_rectangle (a_screen_x, a_screen_y, internal_shared.default_floating_window_width, internal_shared.default_floating_window_height)
