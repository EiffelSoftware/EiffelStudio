...
feature {NONE}  -- Externals
	...
	ccom_name (cpp_obj: POINTER): STRING is
			-- Cluster name.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelClusterDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClusterDescriptor_impl_proxy_s.h%"](): EIF_REFERENCE"
		end
	...
	ccom_class_count (cpp_obj: POINTER): INTEGER is
			-- Number of classes in cluster.
		external
			"C++ [ecom_EiffelComCompiler::IEiffelClusterDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClusterDescriptor_impl_proxy_s.h%"](): EIF_INTEGER"
		end
	...
	ccom_is_override_cluster (cpp_obj: POINTER): BOOLEAN is
			-- Should this cluster classes take priority over other classes with same name?
		external
			"C++ [ecom_EiffelComCompiler::IEiffelClusterDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClusterDescriptor_impl_proxy_s.h%"](): EIF_BOOLEAN"
		end
	...
	ccom_delete_ieiffel_cluster_descriptor_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_EiffelComCompiler::IEiffelClusterDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClusterDescriptor_impl_proxy_s.h%"]()"
		end

	ccom_create_ieiffel_cluster_descriptor_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_EiffelComCompiler::IEiffelClusterDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClusterDescriptor_impl_proxy_s.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_EiffelComCompiler::IEiffelClusterDescriptor_impl_proxy %"ecom_EiffelComCompiler_IEiffelClusterDescriptor_impl_proxy_s.h%"]():EIF_POINTER"
		end
