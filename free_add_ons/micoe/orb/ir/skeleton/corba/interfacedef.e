deferred class CORBA_INTERFACEDEF_SKEL
...
feature { NONE }
    ...
    dispatcher : DICTIONARY [COURIER, STRING] is
        ...
        do
            ...
            result.put (cour, "describe_interface")
            ...
            result.put (cour, "_get_base_interfaces")
            create cour.make (void, void, 45)
            result.put (cour, "_set_base_interfaces")
...
end -- class CORBA_INTERFACEDEF_SKEL
