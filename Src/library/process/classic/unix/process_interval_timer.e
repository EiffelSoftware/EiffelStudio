...
inherit
	...
	PROCESS_INTERVAL_TIMER_SERVER_ACCESS
		export
			{NONE} all
		redefine
			is_equal
...
feature {PROCESS_INTERVAL_TIMER_SERVER} -- Initialization
...
feature {PROCESS_INTERVAL_TIMER_SERVER} -- Implementation
...
end -- class PROCESS_INTERVAL_TIMER
