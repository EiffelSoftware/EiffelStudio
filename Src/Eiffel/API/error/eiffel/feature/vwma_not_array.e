note
	description: "Manifest array explicit type is not an array type."
	legal: "See notice at end of class."
	status: "See notice at end of class."
	date: "$Date$"
	revision: "$Revision$"

class VWMA_NOT_ARRAY
...
feature -- Output
	...
	trace_single_line (t: TEXT_FORMATTER)
			-- <Precursor>
		do
			format_elements (t, locale.translation_in_context ("Manifest array type {1} is not an array type.", "compiler.error"),
