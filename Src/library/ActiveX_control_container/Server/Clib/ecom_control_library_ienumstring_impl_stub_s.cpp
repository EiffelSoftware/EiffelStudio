...
#include "ecom_control_library_IEnumString_impl_stub_s.h"
static int return_hr_value;

static const IID IID_IEnumString_ = {0x00000101,0x0000,0x0000,{0xc0,0x00,0x00,0x00,0x00,0x00,0x00,0x46}};

#ifdef __cplusplus
extern "C" {
#endif

ecom_control_library::IEnumString_impl_stub::IEnumString_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IEnumString_impl_stub::~IEnumString_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IEnumString_impl_stub::RemoteNext(  /* [in] */ ULONG celt, /* [out] */ LPWSTR * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_control_interfaces2.ccom_ce_pointed_cell_103 (rgelt, NULL));
	}
	...
	grt_ec_control_interfaces2.ccom_ec_pointed_cell_103 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_control_library::IEnumString_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_control_library::IEnumString_impl_stub::Reset( void )
...
STDMETHODIMP ecom_control_library::IEnumString_impl_stub::Clone(  /* [out] */ ecom_control_library::IEnumString * * ppenum )
...
STDMETHODIMP_(ULONG) ecom_control_library::IEnumString_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IEnumString_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IEnumString_impl_stub::QueryInterface( REFIID riid, void ** ppv )
...
-----------------------------------------------------------*/
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<ecom_control_library::IEnumString*>(this);
	else if (riid == IID_IEnumString_)
		*ppv = static_cast<ecom_control_library::IEnumString*>(this);
	else
