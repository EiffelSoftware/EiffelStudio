...
feature -- Status Report
	...
	next_user_precondition (celt: INTEGER; rgelt: ARRAY [STRING]; pcelt_fetched: INTEGER_REF): BOOLEAN
	...
	clone1_user_precondition (ppenum: CELL [IENUM_STRING_INTERFACE]): BOOLEAN
