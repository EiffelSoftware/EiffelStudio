...
--				current_row.insert_subrow (counter)
	...
	pointer_double_press_received_on_grid (an_x, a_y, button: INTEGER; grid_item: EV_GRID_ITEM)
			--
		local
	...
	layout_procedure (an_item: EV_GRID_LABEL_ITEM; layout: EV_GRID_LABEL_ITEM_LAYOUT)
			--
		do
...
--			grid.pointer_double_press_actions.force_extend (agent expand_first)
	...
	add_item (a_column, a_row: INTEGER): EV_GRID_ITEM
			--
		do
	...
	compute_item2 (a_column, a_row: INTEGER): EV_GRID_ITEM
			--
		do
	...
	add_subrow (r: EV_GRID_ROW; i: INTEGER)
		local
		do
			r.insert_subrow (i)
	...
	layout_called (an_item: EV_GRID_LABEL_ITEM; label_item_layout: EV_GRID_LABEL_ITEM_LAYOUT)
			--
		do
			ii := ii + 1
...
--					parent_row.add_subrow (new_row)
	...
	item_drop_actions (a_item: EV_GRID_LABEL_ITEM; a_pebble: STRING)
	...
	item_double_pressed (an_x, a_y, a_button: INTEGER; an_item: EV_GRID_ITEM)
			--
		do
			if an_item /= Void then
				an_item.activate
	...
	item_selection_changed (an_item: EV_GRID_ITEM)
			--
		local
			an_x: INTEGER
			a_y: INTEGER
	...
	post_draw_event (a_drawable: EV_DRAWABLE; an_item: EV_GRID_ITEM; a_column_index, a_row_index: INTEGER)
			--
		local
