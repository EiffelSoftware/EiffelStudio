...
feature {NONE} -- Initialization
	...
	frozen make_file_load_exception_4 (message: SYSTEM_STRING; file_name: SYSTEM_STRING; inner: EXCEPTION) is
		external
	...
	frozen make_file_load_exception_2 (message: SYSTEM_STRING; inner: EXCEPTION) is
		external
			"IL creator signature (System.String, System.Exception) use System.IO.FileLoadException"
		end

	frozen make_file_load_exception_1 (message: SYSTEM_STRING) is
		external
			"IL creator signature (System.String) use System.IO.FileLoadException"
		end

	frozen make_file_load_exception_3 (message: SYSTEM_STRING; file_name: SYSTEM_STRING) is
		external
