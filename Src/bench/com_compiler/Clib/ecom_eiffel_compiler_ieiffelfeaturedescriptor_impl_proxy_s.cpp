...
-----------------------------------------------------------*/
{
	...
	tmp_file_path = (BSTR *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_68 (eif_access (file_path), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_68 ((BSTR *)tmp_file_path, file_path);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_line_number, line_number);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_68 (tmp_file_path);
grt_ce_Eif_compiler.ccom_free_memory_pointed_69 (tmp_line_number);
...
-----------------------------------------------------------*/
{
	...
	EIF_REFERENCE eiffel_result = eif_protect ((EIF_REFERENCE)grt_ce_Eif_compiler.ccom_ce_pointed_interface_39 (ret_value));
	return eif_wean (eiffel_result);
};
/*----------------------------------------------------------------------------------------------------------------------*/
