...
extern void notify_rqst(EIF_PSTREAM, int, rt_uint_ptr, rt_uint_ptr); /* Send notification to ewb */
...
extern void dnotify(int, rt_uint_ptr, rt_uint_ptr);		/* Send Notification */
