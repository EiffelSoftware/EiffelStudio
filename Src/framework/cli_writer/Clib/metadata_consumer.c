...
MIDL_DEFINE_GUID(CLSID, CLSID_EiffelSoftware_MetadataConsumer_Interop_COM_CACHE_MANAGER,0xE1FFE1AC,0xC5BD,0x492B,0x92,0x4A,0x8D,0xBC,0x9D,0x21,0x12,0xF5);
