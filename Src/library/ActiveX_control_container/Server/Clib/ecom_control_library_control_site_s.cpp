...
STDMETHODIMP ecom_control_library::control_site::CreateControl(  /* [in] */ LPWSTR lp_trics_data, /* [in] */ ecom_control_library::wireHWND h_wnd, /* [in] */ ecom_control_library::IStream * p_stream )
...
STDMETHODIMP ecom_control_library::control_site::CreateControlEx(  /* [in] */ LPWSTR lp_trics_data, /* [in] */ ecom_control_library::wireHWND h_wnd, /* [in] */ ecom_control_library::IStream * p_stream, /* [out] */ IUnknown * * ppunk, /* [in] */ GUID * riid_advise, /* [in] */ IUnknown * punk_advise )
...
STDMETHODIMP ecom_control_library::control_site::AttachControl(  /* [in] */ IUnknown * p_unk_control, /* [in] */ ecom_control_library::wireHWND h_wnd )
...
STDMETHODIMP ecom_control_library::control_site::QueryControl(  /* [in] */ GUID * riid, /* [out] */ void * * ppv_object )
...
STDMETHODIMP ecom_control_library::control_site::SetExternalDispatch(  /* [in] */ IDispatch * p_disp )
...
STDMETHODIMP ecom_control_library::control_site::SetExternalUIHandler(  /* [in] */ ecom_control_library::IDocHostUIHandlerDispatch * p_disp )
...
STDMETHODIMP ecom_control_library::control_site::GetSite(  /* [in] */ GUID * riid, /* [out] */ void * * ppv_site )
...
STDMETHODIMP ecom_control_library::control_site::RemoteOnDataChange(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc, /* [in] */ ecom_control_library::wireASYNC_STGMEDIUM * p_stgmed )
...
STDMETHODIMP ecom_control_library::control_site::RemoteOnViewChange(  /* [in] */ ULONG dw_aspect, /* [in] */ LONG lindex )
...
STDMETHODIMP ecom_control_library::control_site::RemoteOnRename(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
STDMETHODIMP ecom_control_library::control_site::RemoteOnSave( void )
...
STDMETHODIMP ecom_control_library::control_site::RemoteOnClose( void )
...
STDMETHODIMP ecom_control_library::control_site::GetClassInfo( ITypeInfo ** ppti )
...
-----------------------------------------------------------*/
{
	...
	if (SUCCEEDED (hr))
	{
		hr = ptl->GetTypeInfoOfGuid (CLSID_control_site_, ppti);
		ptl->Release ();
	}
	return hr;
};
...
STDMETHODIMP ecom_control_library::control_site::GetGUID( DWORD dwKind, GUID * pguid )
