...
cd "%EIFFEL_SRC%\Eiffel\eiffel\com_il_generation\Core\run-time" && call "%ISE_EIFFEL%\studio\spec\%ISE_PLATFORM%\bin\compile_library"
cd "%EIFFEL_SRC%\framework\auto_test\Clib"                      && call "%ISE_EIFFEL%\studio\spec\%ISE_PLATFORM%\bin\compile_library"
...
cd "%EIFFEL_SRC%\library\mysql\Clib"                            && call "%ISE_EIFFEL%\studio\spec\%ISE_PLATFORM%\bin\compile_library"
cd "%EIFFEL_SRC%\library\net\Clib"                              && call "%ISE_EIFFEL%\studio\spec\%ISE_PLATFORM%\bin\compile_library"
cd "%EIFFEL_SRC%\library\store\dbms\rdbms\mysql\Clib"           && call "%ISE_EIFFEL%\studio\spec\%ISE_PLATFORM%\bin\compile_library"
