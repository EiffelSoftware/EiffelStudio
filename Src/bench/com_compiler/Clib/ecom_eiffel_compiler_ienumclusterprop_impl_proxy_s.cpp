...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClusterProperties * *)grt_ec_ISE.ccom_ec_pointed_cell_133 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_133 ((ecom_eiffel_compiler::IEiffelClusterProperties * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_133 (tmp_rgelt);
grt_ce_ISE.ccom_free_memory_pointed_135 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumClusterProp * *)grt_ec_ISE.ccom_ec_pointed_cell_130 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_130 ((ecom_eiffel_compiler::IEnumClusterProp * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_130 (tmp_ppenum);
