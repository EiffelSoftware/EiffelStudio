...
#ifndef __ECOM_EIFFELCOMCOMPILER_IENUMPARAMETER_IMPL_STUB_S_H__
#define __ECOM_EIFFELCOMCOMPILER_IENUMPARAMETER_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
public:
	...
	-----------------------------------------------------------*/
	STDMETHODIMP Next(  /* [out] */ ecom_EiffelComCompiler::IEiffelParameterDescriptor * * rgelt, /* [out] */ ULONG * pcelt_fetched );
	...
	No description available.
	-----------------------------------------------------------*/
	STDMETHODIMP Clone(  /* [out] */ ecom_EiffelComCompiler::IEnumParameter * * ppenum );


	/*-----------------------------------------------------------
	No description available.
	-----------------------------------------------------------*/
	STDMETHODIMP ith_item(  /* [in] */ ULONG an_index, /* [out] */ ecom_EiffelComCompiler::IEiffelParameterDescriptor * * rgelt );
