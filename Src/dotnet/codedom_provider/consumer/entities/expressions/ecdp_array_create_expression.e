...
feature -- Access
	...
	size: ECDP_EXPRESSION
			-- Array size
	
	initializers: LINKED_LIST [ECDP_EXPRESSION]
			-- Array initializers
...
feature -- Status Setting
	...
	add_initializer (an_initializer: ECDP_EXPRESSION) is
...
end -- class ECDP_ARRAY_CREATE_EXPRESSION
