...
public:
	...
	Include paths.
	-----------------------------------------------------------*/
	STDMETHODIMP include_paths(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumIncludePaths * * return_value );
	...
	Object files.
	-----------------------------------------------------------*/
	STDMETHODIMP object_files(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumObjectFiles * * return_value );
