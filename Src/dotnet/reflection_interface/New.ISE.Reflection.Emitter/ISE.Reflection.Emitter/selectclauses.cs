/*
*
* Select clause of an Eiffel class. Used by the Eiffel writter to generate Eiffel code.
*
*/
...
public class SelectClauses
{
	...
	// Is feature `Name' from `parentClass' Selectd?
	...
	virtual internal String SelectFeature( String className, int index )
	{
