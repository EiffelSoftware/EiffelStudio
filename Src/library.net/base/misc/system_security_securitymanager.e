...
feature -- Basic Operations
	...
	frozen load_policy_level_from_file (path: STRING; type: INTEGER): SYSTEM_SECURITY_POLICY_POLICYLEVEL is
			...
			-- AppDomain = 3
		require
			valid_policy_level_type: type = 0 or type = 1 or type = 2 or type = 3
		external
			"IL static signature (System.String, enum System.Security.PolicyLevelType): System.Security.Policy.PolicyLevel use System.Security.SecurityManager"
		alias
	...
	frozen load_policy_level_from_string (str: STRING; type: INTEGER): SYSTEM_SECURITY_POLICY_POLICYLEVEL is
			-- Valid values for `type' are:
			-- User = 0
			-- Machine = 1
			-- Enterprise = 2
