...
feature -- Metric support
	...
	basic_scope (a_calculate_function: FUNCTION [QL_CLASS, DOUBLE];
	                  a_criterion: QL_CLASS_CRITERION): QL_METRIC_CLASS_BASIC_SCOPE_INFO
...
feature -- Access
	...
	path_domain_generator (a_item: QL_CLASS; a_path: READABLE_STRING_GENERAL): QL_DOMAIN_GENERATOR
			-- Domain generator for current scope
		local
	...
	empty_domain: QL_CLASS_DOMAIN
			-- An empty domain whose scope is class
		do
			create Result.make
		end

	delayed_domain: QL_DELAYED_CLASS_DOMAIN
