...
:: Default values
set ISE_MAJOR_MINOR_LATEST=20.11
set ISE_BUILD_LATEST=105048

set ISE_MAJOR_MINOR_NIGHTLY=20.11
set ISE_BUILD_NIGHTLY=105048

set ISE_MAJOR_MINOR_BETA=20.11
set ISE_BUILD_BETA=105048
