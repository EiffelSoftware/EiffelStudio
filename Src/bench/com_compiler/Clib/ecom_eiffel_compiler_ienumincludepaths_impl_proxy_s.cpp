...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_197 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_197 ((BSTR *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_197 (tmp_rgelt);
grt_ce_ISE.ccom_free_memory_pointed_198 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumIncludePaths * *)grt_ec_ISE.ccom_ec_pointed_cell_193 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_193 ((ecom_eiffel_compiler::IEnumIncludePaths * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_193 (tmp_ppenum);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE.ccom_ec_pointed_cell_199 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_199 ((BSTR *)tmp_rgelt, rgelt);
	
	grt_ce_ISE.ccom_free_memory_pointed_199 (tmp_rgelt);
