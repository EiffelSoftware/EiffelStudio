...
doc:		<summary> Mark the private queues generated by thiis processor. </summary>
...
doc:		<param name="self" type="processor*"> The processor to be shut down. Must not be NULL. </param>
doc:		<thread_safety> Not safe. </thread_safety>
doc:		<synchronization> Only call during GC. </synchronization>
doc:	</routine>
*/
