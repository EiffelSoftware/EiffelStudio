indexing
	description: "Objects that represent advanced target sections."
...
feature -- Access
	...
	name: STRING is
			-- Name of the section.
		once
			Result := conf_interface_names.section_advanced
		end

	icon: EV_PIXMAP is
			-- Icon of the section.
		once
			Result := conf_pixmaps.project_settings_advanced_icon
		end
...
feature {NONE} -- Implementation
	...
	create_select_actions: EV_NOTIFY_ACTION_SEQUENCE is
		...
		do
			create Result
			Result.extend (agent configuration_window.show_properties_target_advanced (target))
		end
