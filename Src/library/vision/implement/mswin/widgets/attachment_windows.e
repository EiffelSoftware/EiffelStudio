...
feature -- Status setting
	...
	attach_left (w: WIDGET_WINDOWS; pos: INTEGER; relative: BOOLEAN) is
	...
	attach_right (w: WIDGET_WINDOWS; pos: INTEGER; relative: BOOLEAN) is
	...
	attach_top (w: WIDGET_WINDOWS; pos: INTEGER; relative: BOOLEAN) is
	...
	attach_bottom (w: WIDGET_WINDOWS; pos: INTEGER; relative: BOOLEAN) is
	...
	height (f: FORM_WINDOWS) : INTEGER is
	...
	width (f: FORM_WINDOWS) : INTEGER is
	...
	process_left (form: FORM_WINDOWS) is
	...
	process_top (form: FORM_WINDOWS) is
	...
	process_right_widget_no_left (form: FORM_WINDOWS) is
	...
	process_right_widget_left_form (form: FORM_WINDOWS) is
	...
	process_right_form_no_left (form: FORM_WINDOWS) is
	...
	process_right_form_left_form (form: FORM_WINDOWS) is
	...
	process_right_form_left_widget (form: FORM_WINDOWS) is
	...
	process_bottom_widget_no_top (form: FORM_WINDOWS) is
	...
	process_bottom_widget_top_form (form: FORM_WINDOWS) is
	...
	process_bottom_form_no_top (form: FORM_WINDOWS) is
	...
	process_bottom_form_top_form (form: FORM_WINDOWS) is
	...
	process_bottom_form_top_widget (form: FORM_WINDOWS) is
