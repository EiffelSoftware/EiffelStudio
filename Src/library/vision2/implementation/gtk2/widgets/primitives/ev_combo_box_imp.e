...
feature {EV_NEW_LIST_ITEM_IMP} -- Implementation
...
feature {NONE} -- Implementation
	...
	add_to_container (v: like item; v_imp: EV_NEW_LIST_ITEM_IMP) is
			-- Add `v' to container.
		local
			a_cs: C_STRING
		do
	...
	triggering_item: EV_NEW_LIST_ITEM_IMP
	...
	launch_select_actions is
			-- 
		local
			a_triggering_item: EV_NEW_LIST_ITEM_IMP
		do
