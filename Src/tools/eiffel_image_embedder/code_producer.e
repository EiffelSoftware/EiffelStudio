...
feature -- Commands
	...
	build_top_code (class_name: STRING): STRING
		...
		do
			...
			Result.append ("%Tdescription: %"Pixel buffer that replaces original image file.%%" + new_line)
			Result.append ("%T%T%%The original version of this class has been generated by Image Eiffel Code.%"" + new_line)
			Result.append (new_line)
