...
#ifndef __ECOM_CONTROL_LIBRARY_IADVISESINK2_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IADVISESINK2_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_control_library
{
class IAdviseSink2_impl_stub : public ecom_control_library::IAdviseSink2
{
public:
  IAdviseSink2_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IAdviseSink2_impl_stub ();
  ...
  No description available.
  -----------------------------------------------------------*/
  STDMETHODIMP RemoteOnLinkSrcChange(  /* [in] */ ecom_control_library::IMoniker * pmk );
