indexing
	description: "[
		A command to navigate to the next warning in the warnings and warnings tool list {ES_ERRORS_AND_WARNINGS_TOOL}
	]"
...
feature -- Access
	...
	pixel_buffer: EV_PIXEL_BUFFER
		...
		once
			Result := pixmaps.icon_pixmaps.errors_and_warnings_next_warning_icon_buffer
		end

	menu_name: STRING_GENERAL
			-- Name as it appears in the menu (with '&' symbol).
		do
			Result := interface_names.m_go_to_next_warning
		end
	...
	description: STRING_GENERAL
			...
			-- "customize" dialog.
		do
			Result := interface_names.l_go_to_next_warning
		end

	tooltip: STRING_GENERAL
			-- Tooltip for the toolbar button.
		do
			Result := interface_names.f_go_to_next_warning
		end
...
feature -- Execution
	...
	execute
		...
		do
			tool_commander.go_to_next_warning (True)
		end
