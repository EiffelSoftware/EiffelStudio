...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClusterDescriptor * *)grt_ec_ISE.ccom_ec_pointed_cell_34 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_34 ((ecom_eiffel_compiler::IEiffelClusterDescriptor * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE.ccom_free_memory_pointed_34 (tmp_rgelt);
grt_ce_ISE.ccom_free_memory_pointed_95 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumCluster * *)grt_ec_ISE.ccom_ec_pointed_cell_30 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_30 ((ecom_eiffel_compiler::IEnumCluster * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_30 (tmp_ppenum);
