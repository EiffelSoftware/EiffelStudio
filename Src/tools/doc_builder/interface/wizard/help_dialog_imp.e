...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			l_ev_vertical_box_2.extend (toc_header_box)
			toc_header_box.extend (l_ev_label_6)
			toc_header_box.extend (l_ev_horizontal_separator_3)
			l_ev_vertical_box_2.extend (l_ev_vertical_box_4)
			l_ev_vertical_box_4.extend (toc_combo)
			...
			l_ev_horizontal_box_7.extend (back_but)
			l_ev_horizontal_box_7.extend (next)
			l_ev_horizontal_box_7.extend (cancel_but)
			...
			l_ev_vertical_box_2.disable_item_expand (toc_header_box)
			...
			toc_header_box.set_padding_width (padding_width)
			toc_header_box.set_border_width (border_width)
			toc_header_box.disable_item_expand (l_ev_label_6)
			...
			l_ev_horizontal_box_7.disable_item_expand (back_but)
			l_ev_horizontal_box_7.disable_item_expand (next)
			l_ev_horizontal_box_7.disable_item_expand (cancel_but)
...
feature -- Access
	...
	l_ev_horizontal_box_5, l_ev_horizontal_box_6, toc_header_box, l_ev_horizontal_box_7: EV_HORIZONTAL_BOX
