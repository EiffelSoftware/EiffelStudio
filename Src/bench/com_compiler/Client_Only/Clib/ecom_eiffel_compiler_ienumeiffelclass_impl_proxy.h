...
#ifndef __ECOM_EIFFEL_COMPILER_IENUMEIFFELCLASS_IMPL_PROXY_H__
#define __ECOM_EIFFEL_COMPILER_IENUMEIFFELCLASS_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_eiffel_compiler::IEnumEiffelClass * p_IEnumEiffelClass;
