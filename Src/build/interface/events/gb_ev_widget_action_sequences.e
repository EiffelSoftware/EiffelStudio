...
feature -- Access
	...
	connect_event_output_agent (widget: EV_WIDGET; action_sequence: STRING; adding: BOOLEAN; string_handler: ORDERED_STRING_HANDLER)
		...
		do
			if action_sequence.same_string ("pointer_motion_actions") then
				if adding then
			...
			elseif action_sequence.same_string ("pointer_button_press_actions") then
				if adding then
			...
			elseif action_sequence.same_string ("pointer_double_press_actions") then
				if adding then
					pointer_press_sequence ?= new_instance_of (dynamic_type_from_string ("GB_EV_POINTER_BUTTON_ACTION_SEQUENCE"))
			...
			elseif action_sequence.same_string ("pointer_button_release_actions") then
				if adding then
					pointer_press_sequence ?= new_instance_of (dynamic_type_from_string ("GB_EV_POINTER_BUTTON_ACTION_SEQUENCE"))
			...
			elseif action_sequence.same_string ("pointer_enter_actions") then
				if adding then
			...
			elseif action_sequence.same_string ("pointer_leave_actions") then
				if adding then
					notify_sequence ?= new_instance_of (dynamic_type_from_string ("GB_EV_NOTIFY_ACTION_SEQUENCE"))
			...
			elseif action_sequence.same_string ("key_press_actions") then
				if adding then
			...
			elseif action_sequence.same_string ("key_press_string_actions") then
				if adding then
			...
			elseif action_sequence.same_string ("key_release_actions") then
				if adding then
					key_sequence ?= new_instance_of (dynamic_type_from_string ("GB_EV_KEY_ACTION_SEQUENCE"))
			...
			elseif action_sequence.same_string ("focus_in_actions") then
				if adding then
					notify_sequence ?= new_instance_of (dynamic_type_from_string ("GB_EV_NOTIFY_ACTION_SEQUENCE"))
			...
			elseif action_sequence.same_string ("focus_out_actions") then
				if adding then
					notify_sequence ?= new_instance_of (dynamic_type_from_string ("GB_EV_NOTIFY_ACTION_SEQUENCE"))
			...
			elseif action_sequence.same_string ("resize_actions") then
				if adding then
