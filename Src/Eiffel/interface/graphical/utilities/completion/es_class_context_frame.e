...
feature {ES_CLASS_CONTEXT_FRAME} -- Access

	parent: ?ES_CLASS_CONTEXT_FRAME
...
feature {NONE} -- Query
	...
	parsed_string_local_declarations: !HASH_TABLE [!TYPE_AS, !STRING_32]
		...
		do
			...
			l_local_string.append ({ES_EIFFEL_KEYWORD_CONSTANTS}.local_keyword)
...
feature -- Extension
	...
	add_local_string (a_name: !STRING_32; a_type_name: !STRING_32)
		...
		require
			...
			a_type_name_is_single_word: a_type_name.occurrences (' ') = 0 and then a_type_name.occurrences ('%T') = 0
		do
