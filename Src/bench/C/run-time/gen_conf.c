...
/*
doc:	<attribute name="eif_par_table" return_type="struct eif_par_types **" export="public">
...
doc:	</attribute>
doc:	<attribute name="eif_par_table_size" return_type="int" export="public">
doc:		<summary>Size of `eif_par_table' table.</summary>
doc:		<thread_safety>Safe</thread_safety>
doc:		<synchronization>None since initialized during runtime initialization.</synchronization>
doc:	</attribute>
doc:	<attribute name="eif_par_table2" return_type="struct eif_par_types **" export="public">
...
doc:		<synchronization>None since initialized during runtime initialization.</synchronization>
doc:	</attribute>
doc:	<attribute name="eif_par_table2_size" return_type="int" export="public">
doc:		<summary>Size of `eif_par_table2' table.</summary>
doc:		<thread_safety>Safe</thread_safety>
doc:		<synchronization>None since initialized during runtime initialization.</synchronization>
doc:	</attribute>
*/
rt_public struct eif_par_types **eif_par_table = NULL;
rt_public int    eif_par_table_size = 0;
rt_public struct eif_par_types **eif_par_table2 = NULL;
...
doc:		<synchronization>None</synchronization>
doc:		<fixme>Because return static array if `eif_gen_cid' is not under the control of the runtime, it is necessary to have only one thread at the time accessing this. As this is only used in `store.c' and `traverse.c', maybe having a mutex around storing is maybe enough.</fixme>
doc:	</attribute>
*/
