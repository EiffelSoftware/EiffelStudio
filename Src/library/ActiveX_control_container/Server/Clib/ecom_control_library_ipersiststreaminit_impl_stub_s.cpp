...
#include "ecom_control_library_IPersistStreamInit_impl_stub_s.h"
...
ecom_control_library::IPersistStreamInit_impl_stub::IPersistStreamInit_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IPersistStreamInit_impl_stub::~IPersistStreamInit_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IPersistStreamInit_impl_stub::IPersist_GetClassID(  /* [out] */ GUID * p_class_id )
...
STDMETHODIMP ecom_control_library::IPersistStreamInit_impl_stub::IPersistStreamInit_IsDirty( void )
...
STDMETHODIMP ecom_control_library::IPersistStreamInit_impl_stub::Load(  /* [in] */ ecom_control_library::IStream * pstm )
...
STDMETHODIMP ecom_control_library::IPersistStreamInit_impl_stub::Save(  /* [in] */ ecom_control_library::IStream * pstm, /* [in] */ LONG f_clear_dirty )
...
STDMETHODIMP ecom_control_library::IPersistStreamInit_impl_stub::IPersistStreamInit_GetSizeMax(  /* [out] */ ecom_control_library::_ULARGE_INTEGER * pcb_size )
...
STDMETHODIMP ecom_control_library::IPersistStreamInit_impl_stub::IPersistStreamInit_InitNew( void )
...
STDMETHODIMP_(ULONG) ecom_control_library::IPersistStreamInit_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IPersistStreamInit_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IPersistStreamInit_impl_stub::QueryInterface( REFIID riid, void ** ppv )
...
-----------------------------------------------------------*/
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<ecom_control_library::IPersistStreamInit*>(this);
	else if (riid == IID_IPersistStreamInit_)
		*ppv = static_cast<ecom_control_library::IPersistStreamInit*>(this);
