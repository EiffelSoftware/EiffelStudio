...
external class
	SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENTRESTRICTION

inherit
	SYSTEM_XML_SCHEMA_XMLSCHEMACONTENT

create
	make_xmlschemacomplexcontentrestriction

feature {NONE} -- Initialization

	frozen make_xmlschemacomplexcontentrestriction is
		external
...
end -- class SYSTEM_XML_SCHEMA_XMLSCHEMACOMPLEXCONTENTRESTRICTION
