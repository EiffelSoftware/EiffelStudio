...
feature {NONE}  -- Initialization
	...
	make_from_pointer (cpp_obj: POINTER) is
			-- Make from pointer
		do
			initializer := ccom_create_ienum_cluster_prop_impl_proxy_from_pointer(cpp_obj)
...
feature {NONE}  -- Implementation
	...
	delete_wrapper is
			-- Delete wrapper
		do
			ccom_delete_ienum_cluster_prop_impl_proxy(initializer)
		end
...
feature {NONE}  -- Externals
	...
	ccom_last_error_description (cpp_obj: POINTER): STRING is
			-- Last error description
		external
			"C++ [ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy_s.h%"]():EIF_REFERENCE"
		end
