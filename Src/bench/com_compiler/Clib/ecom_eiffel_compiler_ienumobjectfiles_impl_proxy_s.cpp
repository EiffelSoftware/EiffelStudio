...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumObjectFiles * *)grt_ec_ISE.ccom_ec_pointed_cell_170 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_170 ((ecom_eiffel_compiler::IEnumObjectFiles * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_170 (tmp_ppenum);
