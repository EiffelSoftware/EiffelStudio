...
feature -- Basic Operations
	...
	frozen create_specific_culture (name: STRING): SYSTEM_GLOBALIZATION_CULTUREINFO is
		external
	...
	frozen get_cultures (types: SYSTEM_GLOBALIZATION_CULTURETYPES): ARRAY [SYSTEM_GLOBALIZATION_CULTUREINFO] is
		external
