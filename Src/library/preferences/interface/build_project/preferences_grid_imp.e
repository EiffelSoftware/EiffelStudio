indexing
	description: "[
		...
		You should not modify this code by hand, as it will be re-generated every time
		 ...
		 Modified by hand for i18n issue.
		 	]"
...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			l_ev_label_1.set_text (l_filter)
			view_toggle_button.set_text (l_flat_view)
			view_toggle_button.set_tooltip (l_tree_or_flat_view)
			...
			l_ev_label_2.set_text (l_description)
			...
			restore_button.set_text (l_restore_defaults)
			close_button.set_text (l_close)
			close_button.set_minimum_width (80)
			set_title (l_display_window)
