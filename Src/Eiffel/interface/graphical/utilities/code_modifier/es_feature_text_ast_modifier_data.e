...
feature -- Status report
	...
	is_ast_available: BOOLEAN
		...
		do
			Result := Precursor {ES_CLASS_TEXT_AST_MODIFIER_DATA} and then attached ast_feature
		ensure then
			ast_feature_attached: Result implies attached ast_feature
		end
...
feature {ES_CLASS_TEXT_MODIFIER} -- Basic operations
	...
	reset
		...
		do
			...
			ast_feature_reset: not attached ast_feature
		end
