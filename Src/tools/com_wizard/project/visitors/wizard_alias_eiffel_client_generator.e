note
	description: "Alias eiffel client generator"
...
class
	WIZARD_ALIAS_EIFFEL_CLIENT_GENERATOR
inherit
...
feature -- Access
	...
	generate (a_descriptor: WIZARD_ALIAS_DESCRIPTOR)
			-- Generated eiffel client for alias.
		do
	...
	create_file_name (a_factory: WIZARD_FILE_NAME_FACTORY)
			-- Create file name.
		do
			a_factory.process_alias_eiffel_client
		end
...
end -- class WIZARD_ALIAS_EIFFEL_CLIENT_GENERATOR
