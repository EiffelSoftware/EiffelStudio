...
feature {NONE}  -- Externals
	...
	ccom_next (cpp_obj: POINTER; pp_ieiffel_cluster_properties: CELL [IEIFFEL_CLUSTER_PROPERTIES_INTERFACE]; pul_fetched: INTEGER_REF) is
			-- No description available.
		external
			"C++ [ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h%"](EIF_OBJECT,EIF_OBJECT)"
		end

	ccom_skip (cpp_obj: POINTER; ul_count: INTEGER) is
			-- No description available.
		external
			"C++ [ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h%"](EIF_INTEGER)"
		end

	ccom_reset (cpp_obj: POINTER) is
			-- No description available.
		external
			"C++ [ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h%"]()"
		end

	ccom_clone1 (cpp_obj: POINTER; pp_ienum_cluster_prop: CELL [IENUM_CLUSTER_PROP_INTERFACE]) is
			-- No description available.
		external
			"C++ [ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h%"](EIF_OBJECT)"
		end
	...
	ccom_ith_item (cpp_obj: POINTER; ul_index: INTEGER; pp_ieiffel_cluster_properties: CELL [IEIFFEL_CLUSTER_PROPERTIES_INTERFACE]) is
			-- No description available.
		external
			"C++ [ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h%"](EIF_INTEGER,EIF_OBJECT)"
		end
	...
	ccom_delete_ienum_cluster_prop_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h%"]()"
		end

	ccom_create_ienum_cluster_prop_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_EiffelComCompiler::IEnumClusterProp_impl_proxy %"ecom_EiffelComCompiler_IEnumClusterProp_impl_proxy.h%"]():EIF_POINTER"
		end
