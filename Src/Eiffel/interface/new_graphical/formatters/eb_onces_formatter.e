...
feature -- Properties
	...
	symbol: ARRAY [EV_PIXMAP] is
		...
		once
			...
			Result.put (pixmaps.icon_pixmaps.class_features_once_icon, 1)
			Result.put (pixmaps.icon_pixmaps.class_features_once_icon, 2)
		end

	pixel_buffer: EV_PIXEL_BUFFER is
			-- Graphical representation of the command.
		once
			Result := pixmaps.icon_pixmaps.class_features_once_icon_buffer
		end
...
feature {NONE} -- Properties
	...
	command_name: STRING_GENERAL is
			-- Name of the command.
		do
			Result := Interface_names.string_general_to_lower (interface_names.l_Onces)
		end
