...
feature {NONE} -- Initialization
	...
	default_create is
		local
			g: expanded STORABLE_C55 [STRING]
			gg: expanded STORABLE_E55 [expanded STORABLE_C55 [STRING]]
		do
			int := 32
			int_8 := 8
			int_16 := 16
			...
			create arr_gen.make_filled (g, 1, 5)
			create arr_gen_gen.make_filled (gg, 1, 5)
			create h_gen
			create h_none
			t_int := [int]
			t_int_8 := [int_8]
...
feature -- Access
	...
	gen_gen: expanded STORABLE_E55 [expanded STORABLE_C55 [INTEGER]]
	...
	arr_gen_gen: ARRAY [expanded STORABLE_E55 [expanded STORABLE_C55 [STRING]]]
	...
	t_gen_gen: TUPLE [expanded STORABLE_E55 [expanded STORABLE_C55 [INTEGER]]]
