...
-- wrapper for struct: struct HISideBinding

class HISIDE_BINDING_STRUCT_EXTERNAL
...
feature {NONE} -- Implementation
	...
	get_toview_external (an_item: POINTER): POINTER is
		...
		alias
			"ewg_struct_macro_struct_HISideBinding_member_get_toView"
		end
	...
	set_toview_external (an_item: POINTER; a_value: POINTER) is
		...
		external
			"C [macro <ewg_carbon_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_HISideBinding_member_set_toView"
		ensure
	...
	get_kind_external (an_item: POINTER): INTEGER is
		...
		external
			"C [macro <ewg_carbon_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_HISideBinding_member_get_kind"
		end
	...
	set_kind_external (an_item: POINTER; a_value: INTEGER) is
		...
		external
			"C [macro <ewg_carbon_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_HISideBinding_member_set_kind"
		ensure
	...
	get_offset_external (an_item: POINTER): REAL is
		...
		external
			"C [macro <ewg_carbon_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_HISideBinding_member_get_offset"
		end
	...
	set_offset_external (an_item: POINTER; a_value: REAL) is
		...
		external
			"C [macro <ewg_carbon_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_HISideBinding_member_set_offset"
		ensure
