...
feature -- Basic Operations
	...
	next (celt: INTEGER; rgelt: ARRAY [STRING]; pcelt_fetched: INTEGER_REF)
	...
	clone1 (ppenum: CELL [IENUM_STRING_INTERFACE])
			-- No description available.
			-- `ppenum' [out].  
		do
...
feature {NONE}  -- Externals
	...
	ccom_next (cpp_obj: POINTER; celt: INTEGER; rgelt: ARRAY [STRING]; pcelt_fetched: INTEGER_REF)
			-- No description available.
		external
