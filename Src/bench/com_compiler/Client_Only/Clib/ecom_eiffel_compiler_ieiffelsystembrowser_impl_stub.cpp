...
-----------------------------------------------------------*/
{
	...
	if (tmp_value != NULL)
	{
		...
		*some_classes = grt_ec_ISE_c.ccom_ec_pointed_interface_31 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_classes = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*some_clusters = grt_ec_ISE_c.ccom_ec_pointed_interface_35 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*some_clusters = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*return_value = grt_ec_ISE_c.ccom_ec_pointed_interface_39 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*return_value = NULL;
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*return_value = grt_ec_ISE_c.ccom_ec_pointed_interface_42 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
		*return_value = NULL;
