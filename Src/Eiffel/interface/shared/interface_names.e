...
feature -- Label texts
	...
	l_delayed_scope: STRING is "Delayed"
	l_metric_ready: STRING is "Ready"
	...
	l_metric_archive_tab: STRING is "Metric Archive"
	...
	l_metric_save: STRING is "Save"
	l_metric_new: STRING is "New metric"
	l_metric_remove: STRING is "Remove current selected metric"
	l_metric_export: STRING is "Export definition of current metric"
	l_metric_and: STRING is "and"
	l_metric_or: STRING is "or"
	l_metric_not: STRING is "not"
	l_metric_domain_item_invalid: STRING is "Item invalid in current system"
	l_metric_invalid_domain_item: STRING is "invalid domain item"
	l_metric_group: STRING is "Group"
	l_metrics: STRING is "Metrics"
	...
	l_metric_valid: STRING is "Metric is valid"
	l_metric_remove_metric: STRING is "Remove metric "
	l_metric_save_metric: STRING is "Current metric has been modified, save it?"
	l_metric_discard_remove_prompt: STRING is "Do not ask me again and always remove selected metric"
	l_metric_discard_save_prompt: STRING is "Do not ask me again and always save modified metric"
	l_metric_name_cannot_be_empty: STRING is "Metric name is empty."
	l_metric_with_name: STRING is "Metric with name"
	l_metric_exists: STRING is "already exists."
	l_metric_not_saved: STRING is "Note: Metric is not saved."
	l_metric_select_archive: STRING is "Select a metric archive file"
	l_metric_no_metric_selected: STRING is "No metric is selected"
	l_metric_is_not_valid: STRINg is "is not valid"
	l_metric: STRING is "Selected metric"
	l_ok: STRING is "OK"
	l_metric_selected_file_not_exists: STRING is "Specified file doesn't exist"
	l_metric_selected_archive_not_valid: STRING is "Mmetric archive in specified file is not valid"
	l_metric_type: STRING is "type"
	l_metric_value_of_reference: STRING is "Reference value"
	l_metric_value_of_current: STRING is "Current value"
	l_metric_difference: STRING is "Difference"
