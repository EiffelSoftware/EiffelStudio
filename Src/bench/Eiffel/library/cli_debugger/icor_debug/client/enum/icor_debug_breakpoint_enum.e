...
class
	ICOR_DEBUG_BREAKPOINT_ENUM

inherit
	ICOR_DEBUG_ENUM_WITH_NEXT [ICOR_DEBUG_BREAKPOINT]
...
--
--	next (a_celt: INTEGER): ARRAY [ICOR_DEBUG_BREAKPOINT] is
--		require
...
feature {NONE} -- Implementation
	...
	cpp_next (obj: POINTER; a_celt: INTEGER; a_p: POINTER; a_pceltfetched: POINTER): INTEGER is
		external
			"[
				C++ ICorDebugBreakpointEnum signature(ULONG,ICorDebugBreakpoint**, ULONG*): EIF_INTEGER 
				use "cli_headers.h"
			]"
		alias
			"Next"
...
end -- class ICOR_DEBUG_BREAKPOINT_ENUM
