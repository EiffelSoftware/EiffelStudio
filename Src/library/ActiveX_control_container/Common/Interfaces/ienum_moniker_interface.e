...
feature -- Status Report
	...
	next_user_precondition (celt: INTEGER; rgelt: ARRAY [IMONIKER_INTERFACE]; pcelt_fetched: INTEGER_REF): BOOLEAN is
	...
	clone1_user_precondition (ppenum: CELL [IENUM_MONIKER_INTERFACE]): BOOLEAN is
