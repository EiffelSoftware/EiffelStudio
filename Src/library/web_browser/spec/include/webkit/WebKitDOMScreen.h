...
#define WEBKIT_DOM_SCREEN_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_SCREEN, WebKitDOMScreenClass)
#define WEBKIT_DOM_IS_SCREEN(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_SCREEN))
#define WEBKIT_DOM_IS_SCREEN_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_SCREEN))
