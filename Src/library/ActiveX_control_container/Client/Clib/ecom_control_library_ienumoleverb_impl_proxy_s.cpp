...
void ecom_control_library::IEnumOLEVERB_impl_proxy::ccom_remote_next(  /* [in] */ EIF_INTEGER celt,  /* [out] */ ecom_control_library::tagOLEVERB * rgelt,  /* [out] */ EIF_OBJECT pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IEnumOLEVERB->RemoteNext(tmp_celt,rgelt,tmp_pcelt_fetched);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
	...
	ecom_control_library::IEnumOLEVERB * * tmp_ppenum = 0;
	tmp_ppenum = (ecom_control_library::IEnumOLEVERB * *)grt_ec_control_interfaces2.ccom_ec_pointed_cell_180 (eif_access (ppenum), NULL);
	...
	grt_ce_control_interfaces2.ccom_ce_pointed_cell_180 ((ecom_control_library::IEnumOLEVERB * *)tmp_ppenum, ppenum);
