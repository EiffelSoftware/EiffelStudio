...
feature -- Basic operations
	...
	sort (a_data: attached separate DATA)
			--	Sort `a_data'.
		local
			l_left_quicksorter: attached separate QUICKSORTER
			l_right_quicksorter: attached separate QUICKSORTER
			l_left_data: attached separate DATA
			l_right_data: attached separate DATA
			l_result_data_items: attached ARRAY[INTEGER]
...
feature {NONE} -- Implementation
	...
	recursive_sort (a_data: attached separate DATA; a_quicksorter: attached separate QUICKSORTER)
			-- Sort `a_data' with `a_quicksorter'.
		do
			a_quicksorter.sort (a_data)
		end

	swap_data_items (a_data: attached separate DATA; a_position_1: INTEGER; a_position_2: INTEGER)
	...
	import_data_items (a_input_data: attached separate DATA; a_output_data: attached ARRAY[INTEGER]; a_left_position: INTEGER)
