...
external class
	STANDARDVALUESCOLLECTION_IN_SYSTEM_COMPONENTMODEL_TYPECONVERTER
...
feature {NONE} -- Initialization
	...
	frozen make (values: SYSTEM_COLLECTIONS_ICOLLECTION) is
		external
...
end -- class STANDARDVALUESCOLLECTION_IN_SYSTEM_COMPONENTMODEL_TYPECONVERTER
