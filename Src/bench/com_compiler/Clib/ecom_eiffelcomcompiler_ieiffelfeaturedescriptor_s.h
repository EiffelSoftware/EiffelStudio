...
#ifndef __ECOM_EIFFELCOMCOMPILER_IEIFFELFEATUREDESCRIPTOR_S_H__
#define __ECOM_EIFFELCOMCOMPILER_IEIFFELFEATUREDESCRIPTOR_S_H__
#ifdef __cplusplus
extern "C" {
...
public:
	...
	Feature parameters.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP parameters(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumParameter * * params ) = 0;
	...
	-----------------------------------------------------------*/
	virtual STDMETHODIMP all_callers(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumFeature * * some_callers ) = 0;
	...
	-----------------------------------------------------------*/
	virtual STDMETHODIMP local_callers(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumFeature * * some_callers ) = 0;
	...
	-----------------------------------------------------------*/
	virtual STDMETHODIMP descendant_callers(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumFeature * * some_callers ) = 0;
	...
	-----------------------------------------------------------*/
	virtual STDMETHODIMP implementers(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumFeature * * some_implementers ) = 0;
	...
	-----------------------------------------------------------*/
	virtual STDMETHODIMP ancestor_versions(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumFeature * * some_implementers ) = 0;
	...
	-----------------------------------------------------------*/
	virtual STDMETHODIMP descendant_versions(  /* [out, retval] */ ecom_EiffelComCompiler::IEnumFeature * * some_implementers ) = 0;
