...
class
	ECD_EVENT_REFERENCE_EXPRESSION
...
feature -- Access
	...
	code: STRING is
			...
			-- In fact the `event_name' will be generate in the ECD_ATTACH_EVENT_STATEMENT or in the ECD_REMOVE_EVENT_STATEMENT
...
end -- class ECD_EVENT_REFERENCE_EXPRESSION
