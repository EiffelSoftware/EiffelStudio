...
#include "ecom_EiffelComCompiler_IEnumParameter_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ieiffel_parameter_descriptor = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_121 (pp_ieiffel_parameter_descriptor, NULL));
		if (*pp_ieiffel_parameter_descriptor != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_121 (((tmp_pp_ieiffel_parameter_descriptor != NULL) ? eif_wean (tmp_pp_ieiffel_parameter_descriptor) : NULL), pp_ieiffel_parameter_descriptor);
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ienum_parameter = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_94 (pp_ienum_parameter, NULL));
		if (*pp_ienum_parameter != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_94 (((tmp_pp_ienum_parameter != NULL) ? eif_wean (tmp_pp_ienum_parameter) : NULL), pp_ienum_parameter);
