...
#define cwel_choose_font_set_lptemplatename(_ptr_, _value_) (((CHOOSEFONT *) _ptr_)->lpTemplateName = (LPCSTR) (_value_))
#define cwel_choose_font_set_hinstance(_ptr_, _value_) (((CHOOSEFONT *) _ptr_)->hInstance = (HANDLE) (_value_))
#define cwel_choose_font_set_lpszstyle(_ptr_, _value_) (((CHOOSEFONT *) _ptr_)->lpszStyle = (LPSTR) (_value_))
