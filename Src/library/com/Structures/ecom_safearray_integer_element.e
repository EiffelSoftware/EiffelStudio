indexing
	description: "Integer element of SAFEARRAY"
	status: "See notice at end of class"
	date: "$Date$"
	revision: "$Revision$"

class
	ECOM_SAFEARRAY_INTEGER_ELEMENT
...
feature -- Access
	...
	value: INTEGER is
			-- Value of element
		do
			Result := ccom_safearray_el_int_value (item)
		end
...
feature -- Measurement
		...
		do
			Result := c_size_of_integer
		end

feature {NONE} -- Implementation

	c_size_of_integer: INTEGER is
		external 
	...
	ccom_safearray_el_int_value (a_ptr: POINTER): INTEGER is
		external
			"C [macro %"E_safearray_element.h%"](EIF_POINTER): EIF_INTEGER"
		end

end -- class ECOM_SAFEARRAY_INTEGER_ELEMENT
