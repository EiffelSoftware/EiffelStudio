...
feature -- Access
	...
	get_current_state: INTEGER is
		external
			"IL deferred signature (): enum System.Runtime.Remoting.Lifetime.LeaseState use System.Runtime.Remoting.Lifetime.ILease"
		alias
			"get_CurrentState"
		ensure
			valid_lease_state: Result = 0 or Result = 1 or Result = 2 or Result = 3 or Result = 4
		end
...
feature -- Basic Operations
	...
	renew (renewalTime: SYSTEM_TIMESPAN): SYSTEM_TIMESPAN is
		external
	...
	register_i_sponsor_time_span (obj: SYSTEM_RUNTIME_REMOTING_LIFETIME_ISPONSOR; renewalTime: SYSTEM_TIMESPAN) is
		external
