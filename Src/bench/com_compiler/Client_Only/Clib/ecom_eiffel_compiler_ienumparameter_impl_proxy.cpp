...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelParameterDescriptor * *)grt_ec_ISE_c.ccom_ec_pointed_cell_118 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_118 ((ecom_eiffel_compiler::IEiffelParameterDescriptor * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_118 (tmp_rgelt);
grt_ce_ISE_c.ccom_free_memory_pointed_119 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumParameter * *)grt_ec_ISE_c.ccom_ec_pointed_cell_88 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_88 ((ecom_eiffel_compiler::IEnumParameter * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_88 (tmp_ppenum);
