note
	description: "Internal representation of classes NATURAL_nn."
...
feature {NONE} -- Initialization
	...
	initialize_actual_type
		...
		do
			inspect size
			when 8 then actual_type := natural_8_type
			when 16 then actual_type := natural_16_type
			when 32 then actual_type := natural_32_type
			when 64 then actual_type := natural_64_type
			end
		end
