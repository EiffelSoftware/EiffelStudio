...
feature{NONE} -- Initialization
	...
	make is
		...
		do
			...
			agent_table.put (agent new_proper_ancestor_is_criterion, c_proper_ancestor_is)
			agent_table.put (agent new_parent_is_criterion, c_parent_is)
			agent_table.put (agent new_indirect_parent_is_criterion, c_indirect_parent_is)
			agent_table.put (agent new_descendant_is_criterion, c_descendant_is)
			agent_table.put (agent new_proper_descendant_is_criterion, c_proper_descendant_is)
			agent_table.put (agent new_heir_is_criterion, c_heir_is)
			agent_table.put (agent new_indirect_heir_is_criterion, c_indirect_heir_is)
			agent_table.put (agent new_supplier_criterion, c_supplier_is)
			agent_table.put (agent new_indirect_supplier_criterion, c_indirect_supplier_is)
			agent_table.put (agent new_client_criterion, c_client_is)
			agent_table.put (agent new_indirect_client_criterion, c_indirect_client_is)
