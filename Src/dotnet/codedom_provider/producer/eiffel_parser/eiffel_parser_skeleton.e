...
feature {NONE} -- Actions
	...
	new_declaration_body (args: EIFFEL_LIST [TYPE_DEC_AS]; type: EIFFEL_TYPE; content: CONTENT_AS): BODY_AS is
	...
	new_parent_clause (n: PAIR [ID_AS, CLICK_AST]; g: EIFFEL_LIST [EIFFEL_TYPE];
...
feature {NONE} -- Type factory
	...
	new_class_type (ci: PAIR [ID_AS, CLICK_AST]; generics: EIFFEL_LIST [EIFFEL_TYPE]): EIFFEL_TYPE is
	...
	new_expanded_type (ci: PAIR [ID_AS, CLICK_AST]; generics: EIFFEL_LIST [EIFFEL_TYPE]): EXP_TYPE_AS is
	...
	new_separate_type (ci: PAIR [ID_AS, CLICK_AST]; generics: EIFFEL_LIST [EIFFEL_TYPE]): SEPARATE_TYPE_AS is
