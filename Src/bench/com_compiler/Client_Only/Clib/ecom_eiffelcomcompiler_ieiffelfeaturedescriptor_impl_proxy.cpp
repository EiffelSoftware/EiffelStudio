...
#include "ecom_EiffelComCompiler_IEiffelFeatureDescriptor_impl_proxy.h"
...
-----------------------------------------------------------*/
{
	...
	EIF_OBJECT eiffel_result = eif_protect ((EIF_REFERENCE)grt_ce_ISE_c.ccom_ce_pointed_interface_93 (ret_value));
	return eif_wean (eiffel_result);
};
/*----------------------------------------------------------------------------------------------------------------------*/
...
-----------------------------------------------------------*/
{
	...
	tmp_pbstr_path = (BSTR *)grt_ec_ISE_c.ccom_ec_pointed_cell_96 (eif_access (pbstr_path), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_96 ((BSTR *)tmp_pbstr_path, pbstr_path);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pul_line, pul_line);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_96 (tmp_pbstr_path);
grt_ce_ISE_c.ccom_free_memory_pointed_97 (tmp_pul_line);
