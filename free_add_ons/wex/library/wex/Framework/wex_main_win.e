...
feature {COMMAND_CMD}
	...
	main_menu: WEL_MENU is
			-- Window's menu
		once
			!! Result.make_by_id (Id_main_frame)
		ensure
	...
	update_status_window_cmd: UPDATE_STATUS_WINDOW_CMD  is
			-- redefine this feature to customize menu and toolbar commands
		once
			!! Result
		end
...
feature {NONE} -- Implementation
	...
	make_tool_bar is
		do
			!! tool_bar.make_by_menu_id (Current, Id_main_frame)
		end

	Id_main_frame: INTEGER is
	...
	Title: STRING is "WEX - Application Frame Works"
