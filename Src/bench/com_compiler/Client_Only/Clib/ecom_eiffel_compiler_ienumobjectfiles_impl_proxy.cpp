...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE_c.ccom_ec_pointed_cell_202 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_202 ((BSTR *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_202 (tmp_rgelt);
grt_ce_ISE_c.ccom_free_memory_pointed_203 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumObjectFiles * *)grt_ec_ISE_c.ccom_ec_pointed_cell_197 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_197 ((ecom_eiffel_compiler::IEnumObjectFiles * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_197 (tmp_ppenum);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_ISE_c.ccom_ec_pointed_cell_204 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE_c.ccom_ce_pointed_cell_204 ((BSTR *)tmp_rgelt, rgelt);
	
	grt_ce_ISE_c.ccom_free_memory_pointed_204 (tmp_rgelt);
