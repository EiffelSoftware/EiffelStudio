...
feature -- Access
	...
	Case_17_bis: STRING is "Class STRING must have an attribute of type integer named `internal_hash_code'"
	...
	Case_20: STRING is "Class NATIVE_ARRAY must have one formal generic parameter"

	Case_21: STRING is "Class NATIVE_ARRAY must have exactly one creation procedure `make'"

	Case_22: STRING is "Class NATIVE_ARRAY must have a feature `item (INTEGER): Generic #1'"
	
	Case_23: STRING is "Class NATIVE_ARRAY must have a feature `infix %"@%" (INTEGER): Generic #1'"
