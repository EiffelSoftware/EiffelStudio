...
void ecom_control_library::IOleObject_impl_proxy::ccom_set_client_site(  /* [in] */ ecom_control_library::IOleClientSite * p_client_site )
...
-----------------------------------------------------------*/
{
	...
	ecom_control_library::IOleClientSite * * tmp_pp_client_site = 0;
	tmp_pp_client_site = (ecom_control_library::IOleClientSite * *)grt_ec_control_interfaces2.ccom_ec_pointed_cell_245 (eif_access (pp_client_site), NULL);
	...
	grt_ce_control_interfaces2.ccom_ce_pointed_cell_245 ((ecom_control_library::IOleClientSite * *)tmp_pp_client_site, pp_client_site);
...
void ecom_control_library::IOleObject_impl_proxy::ccom_set_moniker(  /* [in] */ EIF_INTEGER dw_which_moniker,  /* [in] */ ecom_control_library::IMoniker * pmk )
...
void ecom_control_library::IOleObject_impl_proxy::ccom_init_from_data(  /* [in] */ ecom_control_library::IDataObject * p_data_object,  /* [in] */ EIF_INTEGER f_creation,  /* [in] */ EIF_INTEGER dw_reserved )
...
-----------------------------------------------------------*/
{
	...
	ULONG tmp_dw_reserved = 0;
	tmp_dw_reserved = (ULONG)dw_reserved;
	ecom_control_library::IDataObject * * tmp_pp_data_object = 0;
	tmp_pp_data_object = (ecom_control_library::IDataObject * *)grt_ec_control_interfaces2.ccom_ec_pointed_cell_246 (eif_access (pp_data_object), NULL);
	...
	grt_ce_control_interfaces2.ccom_ce_pointed_cell_246 ((ecom_control_library::IDataObject * *)tmp_pp_data_object, pp_data_object);
...
void ecom_control_library::IOleObject_impl_proxy::ccom_do_verb(  /* [in] */ EIF_INTEGER i_verb,  /* [in] */ ecom_control_library::tagMSG * lpmsg,  /* [in] */ ecom_control_library::IOleClientSite * p_active_site,  /* [in] */ EIF_INTEGER lindex,  /* [in] */ EIF_POINTER hwnd_parent,  /* [in] */ ecom_control_library::tagRECT * lprc_pos_rect )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IOleObject->DoVerb(tmp_i_verb,lpmsg,p_active_site,tmp_lindex,tmp_hwnd_parent,lprc_pos_rect);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
	...
	ecom_control_library::IEnumOLEVERB * * tmp_pp_enum_ole_verb = 0;
	tmp_pp_enum_ole_verb = (ecom_control_library::IEnumOLEVERB * *)grt_ec_control_interfaces2.ccom_ec_pointed_cell_180 (eif_access (pp_enum_ole_verb), NULL);
	...
	grt_ce_control_interfaces2.ccom_ce_pointed_cell_180 ((ecom_control_library::IEnumOLEVERB * *)tmp_pp_enum_ole_verb, pp_enum_ole_verb);
...
-----------------------------------------------------------*/
{
	...
	hr = p_IOleObject->SetExtent(tmp_dw_draw_aspect,psizel);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
-----------------------------------------------------------*/
{
	...
	hr = p_IOleObject->GetExtent(tmp_dw_draw_aspect,psizel);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IOleObject_impl_proxy::ccom_advise(  /* [in] */ ecom_control_library::IAdviseSink * p_adv_sink,  /* [out] */ EIF_OBJECT pdw_connection )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IOleObject->SetColorScheme(p_logpal);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
