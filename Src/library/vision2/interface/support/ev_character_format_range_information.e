...
feature -- Creation
	...
	make_with_values (family, weight, shape, height, a_color, a_background_color, striked_out, underlined, vertical_offset: BOOLEAN) is
		...
		do
			...
			effects_vertical_offset := vertical_offset
		end
