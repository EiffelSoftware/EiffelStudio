...
--	new_end_tag_checker: XML_END_TAG_CHECKER
...
--	new_unicode_validation: XML_UNICODE_VALIDATION_FILTER
...
--		end
	...
	new_stop_on_error: XML_STOP_ON_ERROR_FILTER
...
--	new_shared_strings: XML_SHARED_STRINGS_FILTER
...
--		end
	...
	new_tree_builder: XML_CALLBACKS_TO_TREE_FILTER
			-- New tree construction filter
		obsolete "See tree cluster, e.g. XML_TREE_CALLBACKS_PIPE"
		do
			create Result.make_null
		ensure
