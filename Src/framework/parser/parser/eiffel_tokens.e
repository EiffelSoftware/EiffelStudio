...
feature -- Token codes
	...
	TE_INFIX: INTEGER = 323
	TE_CREATION: INTEGER = 324
	TE_PRECURSOR: INTEGER = 325
	TE_PREFIX: INTEGER = 326
	TE_AGENT: INTEGER = 327
	TE_ALIAS: INTEGER = 328
	TE_ALL: INTEGER = 329
	TE_AS: INTEGER = 330
	TE_CHECK: INTEGER = 331
	TE_CLASS: INTEGER = 332
	TE_CONVERT: INTEGER = 333
	TE_CREATE: INTEGER = 334
	TE_DEBUG: INTEGER = 335
	TE_DO: INTEGER = 336
	TE_ELSE: INTEGER = 337
	TE_ELSEIF: INTEGER = 338
	TE_ENSURE: INTEGER = 339
	TE_EXPANDED: INTEGER = 340
	TE_EXPORT: INTEGER = 341
	TE_EXTERNAL: INTEGER = 342
	TE_FEATURE: INTEGER = 343
	TE_FROM: INTEGER = 344
	TE_IF: INTEGER = 345
	TE_INHERIT: INTEGER = 346
	TE_INSPECT: INTEGER = 347
	TE_INVARIANT: INTEGER = 348
	TE_LIKE: INTEGER = 349
	TE_LOCAL: INTEGER = 350
	TE_LOOP: INTEGER = 351
	TE_OBSOLETE: INTEGER = 352
	TE_ONCE: INTEGER = 353
	TE_ONCE_STRING: INTEGER = 354
	TE_REDEFINE: INTEGER = 355
	TE_REFERENCE: INTEGER = 356
	TE_RENAME: INTEGER = 357
	TE_REQUIRE: INTEGER = 358
	TE_RESCUE: INTEGER = 359
	TE_SELECT: INTEGER = 360
	TE_SEPARATE: INTEGER = 361
	TE_THEN: INTEGER = 362
	TE_UNDEFINE: INTEGER = 363
	TE_UNTIL: INTEGER = 364
	TE_VARIANT: INTEGER = 365
	TE_WHEN: INTEGER = 366
	TE_ACROSS: INTEGER = 367
	TE_ASSIGN: INTEGER = 368
	TE_ATTRIBUTE: INTEGER = 369
	TE_ATTACHED: INTEGER = 370
	TE_DETACHABLE: INTEGER = 371
	TE_INDEXING: INTEGER = 372
	TE_IS: INTEGER = 373
	TE_NOTE: INTEGER = 374
	TE_SOME: INTEGER = 375
	TE_STRING: INTEGER = 376
	TE_EMPTY_STRING: INTEGER = 377
	TE_VERBATIM_STRING: INTEGER = 378
	TE_EMPTY_VERBATIM_STRING: INTEGER = 379
	TE_STR_LT: INTEGER = 380
	TE_STR_LE: INTEGER = 381
	TE_STR_GT: INTEGER = 382
	TE_STR_GE: INTEGER = 383
	TE_STR_MINUS: INTEGER = 384
	TE_STR_PLUS: INTEGER = 385
	TE_STR_STAR: INTEGER = 386
	TE_STR_SLASH: INTEGER = 387
	TE_STR_MOD: INTEGER = 388
	TE_STR_DIV: INTEGER = 389
	TE_STR_POWER: INTEGER = 390
	TE_STR_AND: INTEGER = 391
	TE_STR_AND_THEN: INTEGER = 392
	TE_STR_IMPLIES: INTEGER = 393
	TE_STR_OR: INTEGER = 394
	TE_STR_OR_ELSE: INTEGER = 395
	TE_STR_XOR: INTEGER = 396
	TE_STR_NOT: INTEGER = 397
	TE_STR_FREE: INTEGER = 398
	TE_STR_BRACKET: INTEGER = 399
	TE_STR_PARENTHESES: INTEGER = 400
