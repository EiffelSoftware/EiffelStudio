...
feature  -- Creation
	...
	make (tests: LIST [NAMED_EIFFEL_TEST]) is
...
feature -- Properties	
	...
	all_tests: LIST [NAMED_EIFFEL_TEST];
			-- List of all tests
	
	tests_matching_one_keyword (keys: LIST [STRING]): LIST [NAMED_EIFFEL_TEST] is
		...
		do
			from
				create {LINKED_LIST [NAMED_EIFFEL_TEST]} Result.make;
				all_tests.start;
			until
				all_tests.after
			loop
	...
	tests_matching_all_keywords (keys: LIST [STRING]): LIST [NAMED_EIFFEL_TEST] is
			-- List of all tests whose keyword list contains
