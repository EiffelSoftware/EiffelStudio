...
external class
	WEB_TABLE_CELL_CONTROL_BUILDER
...
create
	make_web_table_cell_control_builder

feature {NONE} -- Initialization

	frozen make_web_table_cell_control_builder is
		external
...
end -- class WEB_TABLE_CELL_CONTROL_BUILDER
