...
#include "ecom_EiffelComCompiler_IEnumObjectFiles_impl_stub_s.h"
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumObjectFiles_impl_stub::Next(  /* [out] */ BSTR * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_228 (rgelt, NULL));
	}
	...
	grt_ec_ISE.ccom_ec_pointed_cell_228 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumObjectFiles_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumObjectFiles_impl_stub::Clone(  /* [out] */ ecom_EiffelComCompiler::IEnumObjectFiles * * ppenum )
...
-----------------------------------------------------------*/
{
	...
	if (ppenum != NULL)
	{
		tmp_ppenum = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_223 (ppenum, NULL));
		if (*ppenum != NULL)
			(*ppenum)->AddRef ();
	}
	...
	if (*ppenum != NULL)
		(*ppenum)->Release ();
	grt_ec_ISE.ccom_ec_pointed_cell_223 (((tmp_ppenum != NULL) ? eif_wean (tmp_ppenum) : NULL), ppenum);
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumObjectFiles_impl_stub::ith_item(  /* [in] */ ULONG an_index, /* [out] */ BSTR * rgelt )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_230 (rgelt, NULL));
	}
	...
	if (*rgelt != NULL)
		rt_ce.free_memory_bstr (*rgelt);
	grt_ec_ISE.ccom_ec_pointed_cell_230 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumObjectFiles_impl_stub::count(  /* [out, retval] */ ULONG * return_value )
