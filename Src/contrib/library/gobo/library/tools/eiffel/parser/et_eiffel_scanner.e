	...
	yy_nxt_template_1 (an_array: ARRAY [INTEGER])
		do
			yy_array_subcopy (an_array, <<
			  ...
			  166,  167,  101,  101,  124,  407,  125,  168,  167,   84,
			  ...
			  164,  168,  167,  133,  133,  133,  133,  133,   81,   81,
			   ...
			   88,  140,  141,  171,  142,  221,  181,  182,  181,  124,
			  ...
			  157,  179,  158,  159,  156,  160,  340,  158,  159,  162,
			  ...
			  397,  397,  397,  278,  279,  285,   84,  285,  262,  269,
	...
	yy_nxt_template_2 (an_array: ARRAY [INTEGER])
		do
			yy_array_subcopy (an_array, <<
			  ...
			  266,  423,  262,  329,  329,  115,  374,  274,  371,  371,
			  ...
			  345,  345,  345,  345,  345,  345,  374,  423,  423,  374,
	...
	yy_nxt_template_3 (an_array: ARRAY [INTEGER])
		do
			yy_array_subcopy (an_array, <<
			  ...
			  186,  186,  423,  423,  186,  186,  186,  186,  186,  186,
	...
	yy_chk_template_1 (an_array: ARRAY [INTEGER])
		do
			yy_array_subcopy (an_array, <<
			   ...
			   78,   78,   37,   37,   49,  406,   49,   80,   80,   31,
			  ...
			  386,   52,   52,  122,   73,   73,   73,   52,   73,   75,
			   ...
			   87,  139,  139,   86,  139,  222,   89,   89,   89,  285,
			  ...
			  157,  175,  157,  159,  159,  159,  341,  159,  160,  160,
			  ...
			  412,  412,  412,  216,  216,  291,  233,  289,  204,  210,
	...
	yy_chk_template_2 (an_array: ARRAY [INTEGER])
		do
			yy_array_subcopy (an_array, <<
			  ...
			  329,    0,  323,  329,  329,  280,  322,  339,  370,  370,
			  ...
			  345,  345,  345,  345,  345,  345,  401,    0,    0,  403,
		...
		once
			Result := yy_fixed_array (<<
			 ...
			 2783,  951,  613,  616,  631,  553,  320,  620,  674,  638,
			  ...
			  735,  649,  947,  653,  375,  705,  920, 2783,  918,  415,
			 ...
			 1317, 2783,  340,  342,  326,  705,  314, 2783,  250,    0,
			  254,  247, 1334,  238, 1468, 1326,  854, 2783,  240,  224,
	...
	yy_def_template: SPECIAL [INTEGER]
		...
		once
			Result := yy_fixed_array (<<
			  ...
			  423,  423,  423,  423,  451,  423,  423,  423,  423,  460,
			  ...
			  490,  490,  423,  423,  362,  423,  491,  423,  423,  499,
	...
	yy_accept_template: SPECIAL [INTEGER]
		...
		once
			Result := yy_fixed_array (<<
			  ...
			  465,  465,  465,  465,  465,  465,  466,  467,  468,  468,
