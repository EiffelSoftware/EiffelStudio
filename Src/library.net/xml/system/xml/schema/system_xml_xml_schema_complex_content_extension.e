...
external class
	SYSTEM_XML_XML_SCHEMA_COMPLEX_CONTENT_EXTENSION

inherit
	SYSTEM_XML_XML_SCHEMA_CONTENT

create
	make_system_xml_xml_schema_complex_content_extension

feature {NONE} -- Initialization

	frozen make_system_xml_xml_schema_complex_content_extension is
		external
...
end -- class SYSTEM_XML_XML_SCHEMA_COMPLEX_CONTENT_EXTENSION
