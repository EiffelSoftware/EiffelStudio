...
feature {NONE} -- Implementation
	...
	c_initialize (ap, ver: POINTER): INTEGER is
		...
		external
			"C++ EiffelSoftware_MetadataConsumer_COM_CACHE_MANAGER signature (BSTR):EIF_INTEGER use %"metadata_consumer.h%""
		alias
			"initialize"
		end
	...
	c_initialize_with_path (ap:POINTER; ap2, ver: POINTER): INTEGER is
		...
		external
			"C++ EiffelSoftware_MetadataConsumer_COM_CACHE_MANAGER signature (BSTR, BSTR):EIF_INTEGER use %"metadata_consumer.h%""
		alias
	...
	c_is_successful (ap:POINTER; aret_val: POINTER): INTEGER is
		...
		external
			"C++ EiffelSoftware_MetadataConsumer_COM_CACHE_MANAGER signature (VARIANT_BOOL*):EIF_INTEGER use %"metadata_consumer.h%""
		alias
			"is_successful"
		end
	...
	c_last_error_message (ap:POINTER; aret_val: POINTER): INTEGER is
			-- last error message of a failed operation
		external
			"C++ EiffelSoftware_MetadataConsumer_COM_CACHE_MANAGER signature (LPWSTR*):EIF_INTEGER use %"metadata_consumer.h%""
		alias
			"last_error_message"
		end
	...
	c_consume_assembly (ap, a_name, a_version, a_culture, a_key: POINTER): INTEGER is
			...
			-- "`a_name', Version=`a_version', Culture=`a_culture', PublicKeyToken=`a_key'"
		external
			"C++ EiffelSoftware_MetadataConsumer_COM_CACHE_MANAGER signature (BSTR, BSTR, BSTR, BSTR): EIF_INTEGER use %"metadata_consumer.h%""
		alias
			"consume_assembly"
		end
	...
	c_relative_folder_name (ap, a_name, a_version, a_culture, a_key: POINTER; aret_val:POINTER): INTEGER is
		...
		external
			"C++ EiffelSoftware_MetadataConsumer_COM_CACHE_MANAGER signature (BSTR, BSTR, BSTR, BSTR, BSTR*): EIF_INTEGER use %"metadata_consumer.h%""
		alias
