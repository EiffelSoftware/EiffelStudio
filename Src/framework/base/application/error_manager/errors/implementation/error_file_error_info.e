note
	description: "A file-based error to report and warning at a specific line number."
...
feature {NONE} -- Initialization
	...
	make (a_file_name: like file_name; a_line_number: like line_number; a_context: like context)
			-- Initializes a file error with a file name and line number.
			--
			-- `a_file_name': The path to the file where the error is present.
			-- `a_line_number': The line number where the error is present.
...
end -- class {ERROR_FILE_ERROR_INFO}
