...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			metric_name_text.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			...
			type_lbl.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			type_lbl.set_text ("Type:")
			l_ev_cell_3.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			l_ev_cell_3.set_minimum_width (2)
			type_pixmap.set_minimum_width (16)
			type_pixmap.set_minimum_height (16)
			type_name_text.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			type_name_text.set_text ("Compilation")
			type_name_text.align_text_left
			l_ev_cell_4.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			...
			l_ev_cell_5.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			l_ev_cell_5.set_minimum_width (2)
			unit_pixmap.set_minimum_width (16)
			unit_pixmap.set_minimum_height (16)
			unit_name_text.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			unit_name_text.set_text ("Ratio")
			unit_name_text.align_text_left
			l_ev_cell_6.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			l_ev_cell_6.set_minimum_width (10)
			value_lbl.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			value_lbl.set_text ("Value:")
			value_lbl.align_text_left
			value_text.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			value_text.align_text_left
			l_ev_cell_7.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			input_area.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			input_area.set_padding (3)
			input_lbl.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			...
			result_grid_holder.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
			result_grid_holder.set_padding (3)
			result_grid_holder.disable_item_expand (result_lable)
			result_lable.set_background_color (create {EV_COLOR}.make_with_8_bit_rgb (237, 233, 227))
