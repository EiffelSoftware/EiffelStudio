...
echo .
tlbimp /out:ISE.ComCompilerWrapper.dll /namespace:ISE.ComCompilerWrapper /asmversion:5.2.0.0 /keyfile:"%EIFFEL_SRC%\dotnet\helpers\isekey.snk" cec.exe /nologo
gacutil -if ISE.ComCompilerWrapper.dll /nologo
echo ### Workbench Version Created ###
cd ..\F_CODE
echo ### Creating Finalized Version ###
echo .
tlbimp /out:ISE.Final.ComCompilerWrapper.dll /namespace:ISE.ComCompilerWrapper /asmversion:5.2.0.0 /keyfile:"%EIFFEL_SRC%\dotnet\helpers\isekey.snk" cec.exe /nologo
