...
#ifndef __ECOM_EIFFELCOMCOMPILER_IEIFFELHTMLDOCGENERATOR_S_H__
#define __ECOM_EIFFELCOMCOMPILER_IEIFFELHTMLDOCGENERATOR_S_H__
#ifdef __cplusplus
extern "C" {
...
#ifndef __ecom_EiffelComCompiler_IEiffelHTMLDocEvents_FWD_DEFINED__
#define __ecom_EiffelComCompiler_IEiffelHTMLDocEvents_FWD_DEFINED__
namespace ecom_EiffelComCompiler
{
...
#ifdef __cplusplus
extern "C" {
#ifndef __ecom_EiffelComCompiler_IEiffelHTMLDocGenerator_INTERFACE_DEFINED__
#define __ecom_EiffelComCompiler_IEiffelHTMLDocGenerator_INTERFACE_DEFINED__
namespace ecom_EiffelComCompiler
{
...
public:
	...
	-----------------------------------------------------------*/
	virtual STDMETHODIMP add_status_callback(  /* [in] */ ecom_EiffelComCompiler::IEiffelHTMLDocEvents * new_callback ) = 0;


	/*-----------------------------------------------------------
	Remove a callback interface.
	-----------------------------------------------------------*/
	virtual STDMETHODIMP remove_status_callback(  /* [in] */ ecom_EiffelComCompiler::IEiffelHTMLDocEvents * old_callback ) = 0;
