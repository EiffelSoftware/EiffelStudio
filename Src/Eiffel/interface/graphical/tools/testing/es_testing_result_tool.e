indexing
	description: "[
						Testing tool result panel {ES_TESTING_RESULT_TOOL_PANEL} shim class
...
class
	ES_TESTING_RESULT_TOOL

inherit
	ES_TOOL [ES_TESTING_RESULT_TOOL_PANEL]
...
feature -- Access
	...
	title: STRING_32
		...
		do
			Result := interface_names.to_testing_result_tool
		end
	...
	shortcut_preference_name: STRING_32
		...
		do
			Result := "show_testing_result_tool"
		end

feature {NONE} -- Factory

	create_tool: ES_TESTING_RESULT_TOOL_PANEL
