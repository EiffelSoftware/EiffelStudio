...
void ecom_control_library::IAdviseSink2_impl_proxy::ccom_remote_on_data_change(  /* [in] */ ecom_control_library::tagFORMATETC * p_formatetc,  /* [in] */ EIF_OBJECT p_stgmed )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IAdviseSink2->RemoteOnDataChange(p_formatetc,tmp_p_stgmed);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSink2_impl_proxy::ccom_remote_on_view_change(  /* [in] */ EIF_INTEGER dw_aspect,  /* [in] */ EIF_INTEGER lindex )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IAdviseSink2->RemoteOnViewChange(tmp_dw_aspect,tmp_lindex);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSink2_impl_proxy::ccom_remote_on_rename(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IAdviseSink2->RemoteOnRename(pmk);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSink2_impl_proxy::ccom_remote_on_save()
...
-----------------------------------------------------------*/
{
	...
	hr = p_IAdviseSink2->RemoteOnSave ();
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSink2_impl_proxy::ccom_remote_on_close()
...
-----------------------------------------------------------*/
{
	...
	hr = p_IAdviseSink2->RemoteOnClose ();
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
...
void ecom_control_library::IAdviseSink2_impl_proxy::ccom_remote_on_link_src_change(  /* [in] */ ecom_control_library::IMoniker * pmk )
...
-----------------------------------------------------------*/
{
	...
	hr = p_IAdviseSink2->RemoteOnLinkSrcChange(pmk);
	if (FAILED (hr))
	{
		if ((HRESULT_FACILITY (hr)  ==  FACILITY_ITF) && (HRESULT_CODE (hr) > 1024) && (HRESULT_CODE (hr) < 1053))
			com_eraise (rt_ec.ccom_ec_lpstr (eename(HRESULT_CODE (hr) - 1024), NULL),HRESULT_CODE (hr) - 1024);
