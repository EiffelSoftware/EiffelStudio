...
feature {NONE} -- Creation
	...
	make (parent, target: CONF_TARGET; parent_value, target_value, capability: READABLE_STRING_GENERAL)
		...
		do
			text := conf_interface_names.e_incompatible_target_capability (capability, parent_value, parent.name, parent.system.name, target_value, target.name, target.system.name)
		end
