...
create
	make_web_day_render_event_handler

feature {NONE} -- Initialization

	frozen make_web_day_render_event_handler (object: SYSTEM_OBJECT; method: POINTER) is
		external
			"IL creator signature (System.Object, System.IntPtr) use System.Web.UI.WebControls.DayRenderEventHandler"
		end

feature -- Basic Operations

	begin_invoke (sender: SYSTEM_OBJECT; e: WEB_DAY_RENDER_EVENT_ARGS; callback: ASYNC_CALLBACK; object: SYSTEM_OBJECT): IASYNC_RESULT is
		external
	...
	invoke (sender: SYSTEM_OBJECT; e: WEB_DAY_RENDER_EVENT_ARGS) is
		external
...
end -- class WEB_DAY_RENDER_EVENT_HANDLER
