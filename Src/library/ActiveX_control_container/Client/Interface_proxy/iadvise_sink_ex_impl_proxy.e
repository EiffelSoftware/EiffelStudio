indexing
	description: "Implemented `IAdviseSinkEx' Interface."
	Note: "Automatically generated by the EiffelCOM Wizard."

class
	IADVISE_SINK_EX_IMPL_PROXY
...
feature {NONE}  -- Initialization
	...
	make_from_pointer (cpp_obj: POINTER) is
			-- Make from pointer
		do
			initializer := ccom_create_iadvise_sink_ex_impl_proxy_from_pointer(cpp_obj)
...
feature {NONE}  -- Implementation
	...
	delete_wrapper is
			-- Delete wrapper
		do
			ccom_delete_iadvise_sink_ex_impl_proxy(initializer)
		end
...
feature {NONE}  -- Externals
	...
	ccom_delete_iadvise_sink_ex_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_control_library::IAdviseSinkEx_impl_proxy %"ecom_control_library_IAdviseSinkEx_impl_proxy_s.h%"]()"
		end

	ccom_create_iadvise_sink_ex_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_control_library::IAdviseSinkEx_impl_proxy %"ecom_control_library_IAdviseSinkEx_impl_proxy_s.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_control_library::IAdviseSinkEx_impl_proxy %"ecom_control_library_IAdviseSinkEx_impl_proxy_s.h%"]():EIF_POINTER"
		end

end -- IADVISE_SINK_EX_IMPL_PROXY
