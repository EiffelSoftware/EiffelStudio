...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClusterDescriptor * *)grt_ec_ISE.ccom_ec_pointed_cell_37 (eif_access (rgelt), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_37 ((ecom_eiffel_compiler::IEiffelClusterDescriptor * *)tmp_rgelt, rgelt);
...
grt_ce_ISE.ccom_free_memory_pointed_99 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumCluster * *)grt_ec_ISE.ccom_ec_pointed_cell_33 (eif_access (ppenum), NULL);
	...
	grt_ce_ISE.ccom_ce_pointed_cell_33 ((ecom_eiffel_compiler::IEnumCluster * *)tmp_ppenum, ppenum);
	
	grt_ce_ISE.ccom_free_memory_pointed_33 (tmp_ppenum);
