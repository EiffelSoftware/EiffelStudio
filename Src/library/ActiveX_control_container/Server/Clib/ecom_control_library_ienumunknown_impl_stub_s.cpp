...
STDMETHODIMP ecom_control_library::IEnumUnknown_impl_stub::RemoteNext(  /* [in] */ ULONG celt, /* [out] */ IUnknown * * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
STDMETHODIMP ecom_control_library::IEnumUnknown_impl_stub::Clone(  /* [out] */ ecom_control_library::IEnumUnknown * * ppenum )
...
-----------------------------------------------------------*/
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<ecom_control_library::IEnumUnknown*>(this);
