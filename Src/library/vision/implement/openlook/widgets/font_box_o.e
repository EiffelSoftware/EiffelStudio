	...
	add_apply_action (a_command: COMMAND; argument: ANY) is
		...
		do
			if (apply_actions = Void) then
				!! apply_actions.make (font_box_apply_button (data), Oactivate, widget_oui)
			end;
	...
	add_cancel_action (a_command: COMMAND; argument: ANY) is
		...
		do
			if (cancel_actions = Void) then
				!! cancel_actions.make (font_box_cancel_button (data), Oactivate, widget_oui)
			end;
	...
	add_ok_action (a_command: COMMAND; argument: ANY) is
		...
		do
			if (ok_actions = Void) then
				!! ok_actions.make (font_box_ok_button (data), Oactivate, widget_oui)
			end;
