...
#include "ecom_EiffelComCompiler_IEiffelSystemClusters_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		EIF_OBJECT tmp_object = eif_protect (tmp_value);
		*pp_ieiffel_cluster_properties = grt_ec_ISE_c.ccom_ec_pointed_interface_186 (eif_access (tmp_object));
		eif_wean (tmp_object);
	}
	else
