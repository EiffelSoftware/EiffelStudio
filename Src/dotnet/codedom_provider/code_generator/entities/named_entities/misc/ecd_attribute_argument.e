...
feature -- Access
	...
	code: STRING is
			...
			-- | Result := "["`name'", `value']"
		local
			feature_arguments: LINKED_LIST [ECD_EXPRESSION]
...
feature -- Status Setting
	...
	set_value (a_value: ECD_EXPRESSION) is
...
end -- class ECD_ATTRIBUTE_ARGUMENT
