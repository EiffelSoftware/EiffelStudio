...
feature {NONE}  -- Externals
	...
	ccom_remote_on_data_change (cpp_obj: POINTER; p_formatetc: POINTER; p_stgmed: CELL [WIRE_ASYNC_STGMEDIUM_ALIAS]) is
			-- No description available.
		external
			"C++ [ecom_control_library::IAdviseSink_impl_proxy %"ecom_control_library_IAdviseSink_impl_proxy_s.h%"](ecom_control_library::tagFORMATETC *,EIF_OBJECT)"
		end
	...
	ccom_remote_on_rename (cpp_obj: POINTER; pmk: POINTER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IAdviseSink_impl_proxy %"ecom_control_library_IAdviseSink_impl_proxy_s.h%"](ecom_control_library::IMoniker *)"
		end
