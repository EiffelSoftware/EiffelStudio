...
feature -- Initialization
	...
	make (a_creator: WIZARD_PROPERTY_DESCRIPTOR_FACTORY)
			-- Initialize
		require
...
feature -- Status Report
	...
	is_equal_property (other: WIZARD_PROPERTY_DESCRIPTOR): BOOLEAN
			--
		require
...
feature {WIZARD_PROPERTY_DESCRIPTOR_FACTORY} -- Basic operations
	...
	set_is_read_only (a_bool: BOOLEAN)
...
feature {NONE} -- Implementation
	...
	setter_feature_name (a_name: STRING): STRING
	...
	ref_setter_feature_name (a_name: STRING): STRING
	...
	has_name_or_accessors (a_list: LIST [STRING]; a_name: STRING): BOOLEAN
