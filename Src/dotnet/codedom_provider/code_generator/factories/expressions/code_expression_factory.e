...
feature {CODE_CONSUMER_FACTORY} -- Visitor features.
	...
	generate_binary_operator_expression (a_source: SYSTEM_DLL_CODE_BINARY_OPERATOR_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_binary_operator_expression: CODE_BINARY_OPERATOR_EXPRESSION
		do
	...
	generate_cast_expression (a_source: SYSTEM_DLL_CODE_CAST_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_cast_expression: CODE_CAST_EXPRESSION
		do
	...
	generate_direction_expression (a_source: SYSTEM_DLL_CODE_DIRECTION_EXPRESSION) is
			-- | Create instance of `CODE_DIRECTION_EXPRESSION'.
			-- | And initialize this instance with `a_source' -> Call `initialize_'
			-- | Set `last_expression'.
			-- | NOT SUPPORTED YET !!
		...
		require
			non_void_source: a_source /= Void
		local
			a_direction_expression: CODE_DIRECTION_EXPRESSION
		do
	...
	generate_event_reference_expression (a_source: SYSTEM_DLL_CODE_EVENT_REFERENCE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			an_event_reference_expression: CODE_EVENT_REFERENCE_EXPRESSION
		do
	...
	generate_attribute_reference_expression (a_source: SYSTEM_DLL_CODE_FIELD_REFERENCE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			an_attribute_reference_expression: CODE_ATTRIBUTE_REFERENCE_EXPRESSION
		do
	...
	generate_indexer_expression (a_source: SYSTEM_DLL_CODE_INDEXER_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			an_indexer_expression: CODE_INDEXER_EXPRESSION
		do
	...
	generate_object_create_expression (a_source: SYSTEM_DLL_CODE_OBJECT_CREATE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			an_object_create_expression: CODE_OBJECT_CREATE_EXPRESSION
		do
	...
	generate_primitive_expression (a_source: SYSTEM_DLL_CODE_PRIMITIVE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_primitive_expression: CODE_PRIMITIVE_EXPRESSION
		do
	...
	generate_snippet_expression (a_source: SYSTEM_DLL_CODE_SNIPPET_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_snippet_expression: CODE_SNIPPET_EXPRESSION
		do
	...
	generate_type_of_expression (a_source: SYSTEM_DLL_CODE_TYPE_OF_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_type_of_expression: CODE_TYPE_OF_EXPRESSION
		do
	...
	generate_type_reference_expression (a_source: SYSTEM_DLL_CODE_TYPE_REFERENCE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_type_reference_expression: CODE_TYPE_REFERENCE_EXPRESSION
		do
	...
	generate_variable_reference_expression (a_source: SYSTEM_DLL_CODE_VARIABLE_REFERENCE_EXPRESSION) is
		...
		require
			non_void_source: a_source /= Void
		local
			a_variable_reference_expression: CODE_VARIABLE_REFERENCE_EXPRESSION
		do
...
feature {NONE} -- Implementation
	...
	initialize_base_reference_expression (a_source: SYSTEM_DLL_CODE_BASE_REFERENCE_EXPRESSION; a_base_reference_expression: CODE_BASE_REFERENCE_EXPRESSION) is
			-- Generate Eiffel code from `a_source'.
		require
			non_void_source: a_source /= Void
			non_void_last_expression: last_expression /= Void
	...
	initialize_binary_operator_expression (a_source: SYSTEM_DLL_CODE_BINARY_OPERATOR_EXPRESSION; a_binary_operator_expression: CODE_BINARY_OPERATOR_EXPRESSION) is
	...
	initialize_cast_expression (a_source: SYSTEM_DLL_CODE_CAST_EXPRESSION; a_cast_expression : CODE_CAST_EXPRESSION) is
		...
		local
			...
			l_local_variable: CODE_VARIABLE_DECLARATION_STATEMENT
	...
	initialize_direction_expression (a_source: SYSTEM_DLL_CODE_DIRECTION_EXPRESSION; a_direction_expression: CODE_DIRECTION_EXPRESSION) is
	...
	initialize_event_reference_expression (a_source: SYSTEM_DLL_CODE_EVENT_REFERENCE_EXPRESSION; an_event_reference_expression: CODE_EVENT_REFERENCE_EXPRESSION) is
	...
	initialize_attribute_reference_expression (a_source: SYSTEM_DLL_CODE_FIELD_REFERENCE_EXPRESSION; an_attribute_reference_expression: CODE_ATTRIBUTE_REFERENCE_EXPRESSION) is
		...
		do
			...
			if target /= Void then
				...
				Event_manager.raise_event (feature {CODE_EVENTS_IDS}.Missing_target_object, ["attribute reference expression"])
			end
			
			if current_namespace /= Void then
				an_attribute_reference_expression.set_current_namespace (current_namespace.name)
			else
				Event_manager.raise_event (feature {CODE_EVENTS_IDS}.Missing_current_namespace, ["attribute reference expression"])
			end
			if current_type /= Void then
				an_attribute_reference_expression.set_current_class (current_type.name)
			else
				Event_manager.raise_event (feature {CODE_EVENTS_IDS}.Missing_current_type, ["attribute reference expression"])
			end
		ensure
			attribute_reference_expression_ready: an_attribute_reference_expression.ready
		end

	initialize_indexer_expression (a_source: SYSTEM_DLL_CODE_INDEXER_EXPRESSION; an_indexer_expression: CODE_INDEXER_EXPRESSION) is
		...
		do
			if current_type /= Void then
				...
				Event_manager.raise_event (feature {CODE_EVENTS_IDS}.Missing_current_type, ["indexer expression"])
			end
		end

	initialize_object_create_expression (a_source: SYSTEM_DLL_CODE_OBJECT_CREATE_EXPRESSION; an_object_create_expression: CODE_OBJECT_CREATE_EXPRESSION) is
	...
	generate_creation_arguments (a_source: SYSTEM_DLL_CODE_OBJECT_CREATE_EXPRESSION; an_object_create_expression: CODE_OBJECT_CREATE_EXPRESSION) is
	...
	initialize_primitive_expression (a_source: SYSTEM_DLL_CODE_PRIMITIVE_EXPRESSION; a_primitive_expression: CODE_PRIMITIVE_EXPRESSION) is
			-- | Set `value'.
	...
	initialize_snippet_expression (a_source: SYSTEM_DLL_CODE_SNIPPET_EXPRESSION; a_snippet_expression: CODE_SNIPPET_EXPRESSION) is
			-- | Set `value'.
	...
	initialize_type_of_expression (a_source: SYSTEM_DLL_CODE_TYPE_OF_EXPRESSION; a_type_of_expression: CODE_TYPE_OF_EXPRESSION) is
			-- | NOT SUPPORTED YET !!
		...
		local			
			a_type_name: STRING
		do
			Event_manager.raise_event (feature {CODE_EVENTS_IDS}.Not_implemented, ["typeof expression"])
	...
	initialize_type_reference_expression (a_source: SYSTEM_DLL_CODE_TYPE_REFERENCE_EXPRESSION; a_type_reference_expression: CODE_TYPE_REFERENCE_EXPRESSION) is
	...
	initialize_variable_reference_expression (a_source: SYSTEM_DLL_CODE_VARIABLE_REFERENCE_EXPRESSION; a_variable_reference_expression: CODE_VARIABLE_REFERENCE_EXPRESSION) is
			-- | Set `variable_name'.
