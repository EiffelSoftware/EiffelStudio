...
feature {NONE} -- Creation
	...
	make_with_other_loop_as (t: TEST)
	...
	make_with_other_some_as (t: TEST)
			-- Iterate over `t' with an iterative form of a loop.
		do
			a := t
	...
	make_with_other_loop_is (t: TEST)
			-- Iterate over `t' with an iterative form of a loop.
		do
			a := t
	...
	make_with_other_some_is (t: TEST)
			-- Iterate over `t' with an iterative form of a loop.
		do
			a := t
