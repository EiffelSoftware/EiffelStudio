...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pbstr_object_file = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_227 (pbstr_object_file, NULL));
	}
	...
	grt_ec_ISE.ccom_ec_pointed_cell_227 (((tmp_pbstr_object_file != NULL) ? eif_wean (tmp_pbstr_object_file) : NULL), pbstr_object_file);
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ienum_object_files = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_222 (pp_ienum_object_files, NULL));
		if (*pp_ienum_object_files != NULL)
	...
	grt_ec_ISE.ccom_ec_pointed_cell_222 (((tmp_pp_ienum_object_files != NULL) ? eif_wean (tmp_pp_ienum_object_files) : NULL), pp_ienum_object_files);
...
-----------------------------------------------------------*/
{
	...
	if (pbstr_object_file != NULL)
	{
		tmp_pbstr_object_file = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_229 (pbstr_object_file, NULL));
	}
	...
	if (*pbstr_object_file != NULL)
		rt_ce.free_memory_bstr (*pbstr_object_file);
	grt_ec_ISE.ccom_ec_pointed_cell_229 (((tmp_pbstr_object_file != NULL) ? eif_wean (tmp_pbstr_object_file) : NULL), pbstr_object_file);
