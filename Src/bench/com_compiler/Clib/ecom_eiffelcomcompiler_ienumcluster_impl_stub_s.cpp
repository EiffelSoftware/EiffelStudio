...
STDMETHODIMP ecom_EiffelComCompiler::IEnumCluster_impl_stub::Next(  /* [out] */ ecom_EiffelComCompiler::IEiffelClusterDescriptor * * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_51 (rgelt, NULL));
		if (*rgelt != NULL)
			(*rgelt)->AddRef ();
	}
	...
	if (*rgelt != NULL)
		(*rgelt)->Release ();
	grt_ec_ISE.ccom_ec_pointed_cell_51 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumCluster_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumCluster_impl_stub::Clone(  /* [out] */ ecom_EiffelComCompiler::IEnumCluster * * ppenum )
...
-----------------------------------------------------------*/
{
	...
	if (ppenum != NULL)
	{
		tmp_ppenum = eif_protect (grt_ce_ISE.ccom_ce_pointed_cell_44 (ppenum, NULL));
		if (*ppenum != NULL)
			(*ppenum)->AddRef ();
	}
	...
	if (*ppenum != NULL)
		(*ppenum)->Release ();
	grt_ec_ISE.ccom_ec_pointed_cell_44 (((tmp_ppenum != NULL) ? eif_wean (tmp_ppenum) : NULL), ppenum);
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumCluster_impl_stub::ith_item(  /* [in] */ ULONG an_index, /* [out] */ ecom_EiffelComCompiler::IEiffelClusterDescriptor * * rgelt )
...
STDMETHODIMP ecom_EiffelComCompiler::IEnumCluster_impl_stub::count(  /* [out, retval] */ ULONG * return_value )
