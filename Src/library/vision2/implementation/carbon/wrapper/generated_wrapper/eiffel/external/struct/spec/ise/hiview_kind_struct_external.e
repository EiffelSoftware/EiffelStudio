...
-- wrapper for struct: struct HIViewKind

class HIVIEW_KIND_STRUCT_EXTERNAL
...
feature {NONE} -- Implementation
	...
	get_signature_external (an_item: POINTER): INTEGER is
		...
		alias
			"ewg_struct_macro_struct_HIViewKind_member_get_signature"
		end
	...
	set_signature_external (an_item: POINTER; a_value: INTEGER) is
		...
		external
			"C [macro <ewg_carbon_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_HIViewKind_member_set_signature"
		ensure
	...
	get_kind_external (an_item: POINTER): INTEGER is
		...
		external
			"C [macro <ewg_carbon_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_HIViewKind_member_get_kind"
		end
	...
	set_kind_external (an_item: POINTER; a_value: INTEGER) is
		...
		external
			"C [macro <ewg_carbon_struct_c_glue_code.h>]"
		alias
			"ewg_struct_macro_struct_HIViewKind_member_set_kind"
		ensure
