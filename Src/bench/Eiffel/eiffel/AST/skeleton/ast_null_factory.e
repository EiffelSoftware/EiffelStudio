...
inherit
	AST_FACTORY
		redefine
			...
			new_instr_call_as, new_interval_as, new_invariant_as, new_like_id_as,
			new_like_current_as, new_location_as, new_loop_as, new_nested_as, new_nested_expr_as,
			new_none_type_as, new_once_as, new_operand_as, new_paran_as, new_parent_as,
