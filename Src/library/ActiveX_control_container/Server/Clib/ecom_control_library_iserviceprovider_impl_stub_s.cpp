...
STDMETHODIMP ecom_control_library::IServiceProvider_impl_stub::RemoteQueryService(  /* [in] */ GUID * guid_service, /* [in] */ GUID * riid, /* [out] */ IUnknown * * ppv_object )
...
-----------------------------------------------------------*/
{
	...
	eiffel_procedure = eif_procedure ("remote_query_service", type_id);
