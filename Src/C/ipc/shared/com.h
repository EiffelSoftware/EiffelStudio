...
#ifdef EIF_WINDOWS
extern int recv_packet(EIF_PSTREAM s, Request *rqst, BOOL reset);/* Receive data from client */	
#else
...
extern void unregister_packet_functions (EIF_PSTREAM sp);
extern void register_packet_functions (EIF_PSTREAM sp, void(*p_send_fct)(EIF_PSTREAM, Request*) , 
#ifdef EIF_WINDOWS
