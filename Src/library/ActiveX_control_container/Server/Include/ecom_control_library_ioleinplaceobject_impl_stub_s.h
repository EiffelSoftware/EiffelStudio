...
#ifndef __ECOM_CONTROL_LIBRARY_IOLEINPLACEOBJECT_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IOLEINPLACEOBJECT_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
{
class IOleInPlaceObject_impl_stub;
}
...
namespace ecom_control_library
{
class IOleInPlaceObject_impl_stub : public ecom_control_library::IOleInPlaceObject
{
public:
  IOleInPlaceObject_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IOleInPlaceObject_impl_stub ();
