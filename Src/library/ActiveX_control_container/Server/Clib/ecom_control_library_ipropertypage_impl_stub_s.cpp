...
#include "ecom_control_library_IPropertyPage_impl_stub_s.h"
...
ecom_control_library::IPropertyPage_impl_stub::IPropertyPage_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IPropertyPage_impl_stub::~IPropertyPage_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::SetPageSite(  /* [in] */ ecom_control_library::IPropertyPageSite * p_page_site )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::Activate(  /* [in] */ ecom_control_library::wireHWND hwnd_parent, /* [in] */ ecom_control_library::tagRECT * p_rect, /* [in] */ LONG b_modal )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::Deactivate( void )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::GetPageInfo(  /* [out] */ ecom_control_library::tagPROPPAGEINFO * p_page_info )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::SetObjects(  /* [in] */ ULONG c_objects, /* [in] */ IUnknown * * ppunk )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::Show(  /* [in] */ UINT n_cmd_show )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::Move(  /* [in] */ ecom_control_library::tagRECT * p_rect )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::IsPageDirty( void )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::Apply( void )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::Help(  /* [in] */ LPWSTR psz_help_dir )
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::TranslateAccelerator(  /* [in] */ ecom_control_library::tagMSG * p_msg )
...
STDMETHODIMP_(ULONG) ecom_control_library::IPropertyPage_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IPropertyPage_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IPropertyPage_impl_stub::QueryInterface( REFIID riid, void ** ppv )
