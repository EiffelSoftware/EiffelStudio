...
<div class="row">
   <div class="col-lg-12">
     ...
     <div class="col-md-4">
       <label class="control-label" for="input01" itemprop="priority"  data-original-title="<small><p>How soon the solution is required. Accepted values include:</p>
            <UL>
     ...
     <div class="col-md-4">
       <label class="control-label" for="input01" itemprop="severity" data-original-title="<small><p>The severity of the problem. Accepted values include:</p>
                <UL>
 ...
 ">Severity</label>
    ...
    <div class="row">
       <div class="col-md-4">
       <label class="control-label" for="input01" itemprop="status" data-original-title="<small><p>The status of a problem can be one of the following:</p>
      <ul>
               ...
               {foreach from="$reports" item="item"}
                 <form  class="form-inline well" action="{$host/}/reports/{$item.number/}" id="reports_{$item.number/}" method="POST" itemprop="update">
                  ...
                  <tr>
                       ...
                       <td itemprop="priority"><img src="{$host/}/images/priority_{$item.priority.synopsis/}.gif" class="img-rounded" data-original-title="{$item.priority.synopsis/}"></td>
                       <td itemprop="severity"><img src="{$host/}/images/severity_{$item.severity.synopsis/}.gif" class="img-rounded" data-original-title="{$item.severity.synopsis/}"></td>
