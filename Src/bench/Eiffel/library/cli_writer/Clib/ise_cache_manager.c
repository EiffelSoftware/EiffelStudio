...
MIDL_DEFINE_GUID(IID, IID_ISE_Cache_COM_ASSEMBLY_INFORMATION,0xE1FFE1B6,0x5067,0x499A,0x9A,0x25,0xE6,0xDD,0xA9,0x07,0x6E,0x77);


MIDL_DEFINE_GUID(CLSID, CLSID_ISE_Cache_Impl_COM_ISE_CACHE_MANAGER,0xE1FFE16A,0xFB59,0x4F0C,0x9D,0x85,0xAD,0xDD,0x93,0x66,0xE3,0x59);
