...
feature -- NSPrintPanel
	...
	print_panel: detachable NS_PRINT_PANEL
		...
		do
			...
			result_pointer := objc_print_panel (l_objc_class.item)
...
feature {NONE} -- NSPrintPanel Externals
	...
	objc_print_panel (a_class_object: POINTER): POINTER
			-- Auto generated Objective-C wrapper.
		external
			"C inline use <AppKit/AppKit.h>"
		alias
			"[
				return (EIF_POINTER)[(Class)$a_class_object printPanel];
			 ]"
		end
