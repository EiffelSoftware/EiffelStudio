...
feature {TAG_BASED_TREE_NODE_CONTAINER} -- Acccess
	...
	descending_tags: detachable DS_HASH_TABLE [NATURAL, STRING]
...
feature {NONE} -- Access
	...
	cached_children: detachable DS_HASH_TABLE [like child_for_token, STRING]
			-- Children having `tag' as prefix

	cached_items: detachable DS_HASH_SET [G]
			-- Items tagged with `tag'
