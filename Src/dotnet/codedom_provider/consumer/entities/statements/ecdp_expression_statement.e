...
feature -- Access
	...
	code: STRING is
			-- | Result := "`expression'"
			-- | OR		:= "[dummy := ]expression" if typeof `expression' is ECDP_ROUTINE_INVOKE_EXPRESSION
			-- Eiffel code of expression statement
		local
			routine_invoke_exp: ECDP_ROUTINE_INVOKE_EXPRESSION
...
end -- class ECDP_EXPRESSION_STATEMENT
