...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__PARENT_IMPL_PROXY_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS__PARENT_IMPL_PROXY_H__
#ifdef __cplusplus
extern "C" {
...
{
public:
	_Parent_impl_proxy (IUnknown * a_pointer);
	virtual ~_Parent_impl_proxy ();
