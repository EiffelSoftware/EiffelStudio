indexing
	description: "Implemented `IViewObject2' Interface."
	Note: "Automatically generated by the EiffelCOM Wizard."

class
	IVIEW_OBJECT2_IMPL_PROXY
...
feature {NONE}  -- Initialization
	...
	make_from_pointer (cpp_obj: POINTER) is
			-- Make from pointer
		do
			initializer := ccom_create_iview_object2_impl_proxy_from_pointer(cpp_obj)
...
feature {NONE}  -- Implementation
	...
	delete_wrapper is
			-- Delete wrapper
		do
			ccom_delete_iview_object2_impl_proxy(initializer)
		end
...
feature {NONE}  -- Externals
	...
	ccom_draw (cpp_obj: POINTER; dw_draw_aspect: INTEGER; lindex: INTEGER; pv_aspect: INTEGER; ptd: POINTER; hdc_target_dev: INTEGER; hdc_draw: INTEGER; lprc_bounds: POINTER; lprc_wbounds: POINTER; p_continue: POINTER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_INTEGER,EIF_INTEGER,EIF_INTEGER,ecom_control_library::tagDVTARGETDEVICE *,EIF_INTEGER,EIF_INTEGER,ecom_control_library::_RECTL *,ecom_control_library::_RECTL *,ecom_control_library::IContinue *)"
		end
	...
	ccom_get_color_set (cpp_obj: POINTER; dw_draw_aspect: INTEGER; lindex: INTEGER; pv_aspect: INTEGER; ptd: POINTER; hic_target_dev: INTEGER; pp_color_set: CELL [TAG_LOGPALETTE_RECORD]) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_INTEGER,EIF_INTEGER,EIF_INTEGER,ecom_control_library::tagDVTARGETDEVICE *,EIF_INTEGER,EIF_OBJECT)"
		end

	ccom_freeze (cpp_obj: POINTER; dw_draw_aspect: INTEGER; lindex: INTEGER; pv_aspect: INTEGER; pdw_freeze: INTEGER_REF) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_INTEGER,EIF_INTEGER,EIF_INTEGER,EIF_OBJECT)"
		end

	ccom_unfreeze (cpp_obj: POINTER; dw_freeze: INTEGER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_INTEGER)"
		end

	ccom_set_advise (cpp_obj: POINTER; aspects: INTEGER; advf: INTEGER; p_adv_sink: POINTER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_INTEGER,EIF_INTEGER,ecom_control_library::IAdviseSink *)"
		end

	ccom_get_advise (cpp_obj: POINTER; p_aspects: INTEGER_REF; p_advf: INTEGER_REF; pp_adv_sink: CELL [IADVISE_SINK_INTERFACE]) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_OBJECT,EIF_OBJECT,EIF_OBJECT)"
		end

	ccom_get_extent (cpp_obj: POINTER; dw_draw_aspect: INTEGER; lindex: INTEGER; ptd: POINTER; lpsizel: POINTER) is
			-- No description available.
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](EIF_INTEGER,EIF_INTEGER,ecom_control_library::tagDVTARGETDEVICE *,ecom_control_library::tagSIZEL *)"
		end

	ccom_delete_iview_object2_impl_proxy (a_pointer: POINTER) is
			-- Release resource
		external
			"C++ [delete ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"]()"
		end

	ccom_create_iview_object2_impl_proxy_from_pointer (a_pointer: POINTER): POINTER is
			-- Create from pointer
		external
			"C++ [new ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"](IUnknown *)"
		end

	ccom_item (cpp_obj: POINTER): POINTER is
			-- Item
		external
			"C++ [ecom_control_library::IViewObject2_impl_proxy %"ecom_control_library_IViewObject2_impl_proxy_s.h%"]():EIF_POINTER"
		end

end -- IVIEW_OBJECT2_IMPL_PROXY
