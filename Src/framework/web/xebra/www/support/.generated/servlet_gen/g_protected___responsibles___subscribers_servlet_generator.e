...
class
	G_PROTECTED___RESPONSIBLES___SUBSCRIBERS_SERVLET_GENERATOR
	...
	root_tag: XTAG_TAG_SERIALIZER
		...
		do
			create stack.make (10)
				-- line: 13 row: 2 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTAINER_TAG} temp.make
			temp.debug_information := "line: 13 row: 2 of file: ./protected/responsibles/subscribers.xeb"
			l_root_tag := temp
			temp.current_controller_id := "controller_1"
			temp.tag_id := "html"
			stack.put (temp)
				-- line: 13 row: 1 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_PAGE_NOOP_TAG} temp.make
			temp.debug_information := "line: 13 row: 1 of file: ./protected/responsibles/subscribers.xeb"
			...
			temp.tag_id := "declare_region"
			stack.put (temp)
				-- line: 3 row: 3 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 3 row: 3 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 4 row: 1 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 4 row: 1 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "title_box")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
				-- line: 3 row: 54 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 3 row: 54 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "h1"
			stack.put (temp)
				-- line: 3 row: 49 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 3 row: 49 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "Categories Subscribers")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
			stack.remove
				-- line: 4 row: 3 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 4 row: 3 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 7 row: 1 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 7 row: 1 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "p"
			stack.put (temp)
				-- line: 6 row: 3 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 6 row: 3 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/%/9/%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 7 row: 3 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 7 row: 3 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 11 row: 1 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 11 row: 1 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("id", "main_div")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "div"
			stack.put (temp)
				-- line: 8 row: 4 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 8 row: 4 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/ ")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
				-- line: 10 row: 1 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_HTML_TAG} temp.make
			temp.debug_information := "line: 10 row: 1 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.current_controller_id := "controller_1"
			temp.tag_id := "Columns"
			stack.put (temp)
				-- line: 9 row: 3 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 9 row: 3 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 10 row: 3 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 10 row: 3 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N%/9/")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
			stack.remove
				-- line: 11 row: 2 of file: ./protected/responsibles/subscribers.xeb
			create {XTAG_XEB_CONTENT_TAG} temp.make
			temp.debug_information := "line: 11 row: 2 of file: ./protected/responsibles/subscribers.xeb"
			stack.item.add_to_body (temp)
			temp.put_value_attribute("text", "%N")
			temp.current_controller_id := "controller_1"
			temp.tag_id := "content"
