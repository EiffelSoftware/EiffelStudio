...
<p>This is a notice that an invoice has been generated from <a href="{$site_url/}">{unless isempty="$business_name"}{$business_name/}{/unless}{if isempty="$business_name"}{$site_url/}{/if}</a>.</p>
