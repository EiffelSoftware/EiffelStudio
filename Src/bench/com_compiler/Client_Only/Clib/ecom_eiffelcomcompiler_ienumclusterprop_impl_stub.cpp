...
#include "ecom_EiffelComCompiler_IEnumClusterProp_impl_stub.h"
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ieiffel_cluster_properties = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_187 (pp_ieiffel_cluster_properties, NULL));
		if (*pp_ieiffel_cluster_properties != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_187 (((tmp_pp_ieiffel_cluster_properties != NULL) ? eif_wean (tmp_pp_ieiffel_cluster_properties) : NULL), pp_ieiffel_cluster_properties);
...
-----------------------------------------------------------*/
{
	...
	{
		tmp_pp_ienum_cluster_prop = eif_protect (grt_ce_ISE_c.ccom_ce_pointed_cell_183 (pp_ienum_cluster_prop, NULL));
		if (*pp_ienum_cluster_prop != NULL)
	...
	grt_ec_ISE_c.ccom_ec_pointed_cell_183 (((tmp_pp_ienum_cluster_prop != NULL) ? eif_wean (tmp_pp_ienum_cluster_prop) : NULL), pp_ienum_cluster_prop);
