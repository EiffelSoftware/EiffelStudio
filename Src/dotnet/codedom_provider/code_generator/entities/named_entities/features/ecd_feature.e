...
feature -- Access
	...
	comments: LINKED_LIST [ECD_COMMENT]
			-- Feature comments
...
feature -- Status Report
	...
	ready: BOOLEAN is
		...
		do
			Result := Precursor {ECD_NAMED_ENTITY} and comments /= Void and not type_feature.is_empty
		end
...
feature -- Basic Operations
	...
	add_comment (a_comment: ECD_COMMENT) is
...
feature {ECD_GENERATED_TYPE} -- Code Generation
