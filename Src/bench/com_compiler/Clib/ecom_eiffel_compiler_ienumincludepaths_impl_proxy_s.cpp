...
grt_ce_Eif_compiler.ccom_free_memory_pointed_172 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumIncludePaths * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_167 (eif_access (ppenum), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_167 ((ecom_eiffel_compiler::IEnumIncludePaths * *)tmp_ppenum, ppenum);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_167 (tmp_ppenum);
...
-----------------------------------------------------------*/
{
	...
	BSTR * tmp_rgelt = 0;
	tmp_rgelt = (BSTR *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_173 (eif_access (rgelt), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_173 ((BSTR *)tmp_rgelt, rgelt);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_173 (tmp_rgelt);
