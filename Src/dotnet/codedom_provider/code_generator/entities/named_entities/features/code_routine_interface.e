...
feature -- Access
	...
	arguments: LINKED_LIST [CODE_PARAMETER_DECLARATION_EXPRESSION]
			-- Routine arguments

	locals: LINKED_LIST [CODE_VARIABLE_DECLARATION_STATEMENT]
			-- Routine local variables

	statements: LINKED_LIST [CODE_STATEMENT]
			-- Routine statements
...
feature -- Status Report
	...
	ready: BOOLEAN is
		...
		do
			Result := Precursor {CODE_FEATURE} and arguments /= Void and locals /= Void and statements /= Void
		end
...
feature -- Basic Operations
	...
	add_argument (an_argument: CODE_PARAMETER_DECLARATION_EXPRESSION) is
...
end -- class CODE_ROUTINE_INTEFACE
