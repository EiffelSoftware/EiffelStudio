...
#include "ecom_control_library_IEnumOleUndoUnits_impl_stub_s.h"
...
ecom_control_library::IEnumOleUndoUnits_impl_stub::IEnumOleUndoUnits_impl_stub( EIF_OBJECT eif_obj )
{
	ref_count = 0;
...
ecom_control_library::IEnumOleUndoUnits_impl_stub::~IEnumOleUndoUnits_impl_stub()
{
...
STDMETHODIMP ecom_control_library::IEnumOleUndoUnits_impl_stub::RemoteNext(  /* [in] */ ULONG celt, /* [out] */ ecom_control_library::IOleUndoUnit * * rgelt, /* [out] */ ULONG * pcelt_fetched )
...
-----------------------------------------------------------*/
{
	...
	if (rgelt != NULL)
	{
		tmp_rgelt = eif_protect (grt_ce_control_interfaces2.ccom_ce_pointed_cell_160 (rgelt, NULL));
		if (*rgelt != NULL)
			(*rgelt)->AddRef ();
	}
	...
	if (*rgelt != NULL)
		(*rgelt)->Release ();
	grt_ec_control_interfaces2.ccom_ec_pointed_cell_160 (((tmp_rgelt != NULL) ? eif_wean (tmp_rgelt) : NULL), rgelt);
	if (*rgelt != NULL)
		(*rgelt)->AddRef ();
...
STDMETHODIMP ecom_control_library::IEnumOleUndoUnits_impl_stub::Skip(  /* [in] */ ULONG celt )
...
STDMETHODIMP ecom_control_library::IEnumOleUndoUnits_impl_stub::Reset( void )
...
STDMETHODIMP ecom_control_library::IEnumOleUndoUnits_impl_stub::Clone(  /* [out] */ ecom_control_library::IEnumOleUndoUnits * * ppenum )
...
STDMETHODIMP_(ULONG) ecom_control_library::IEnumOleUndoUnits_impl_stub::Release()
...
STDMETHODIMP_(ULONG) ecom_control_library::IEnumOleUndoUnits_impl_stub::AddRef()
...
STDMETHODIMP ecom_control_library::IEnumOleUndoUnits_impl_stub::QueryInterface( REFIID riid, void ** ppv )
...
-----------------------------------------------------------*/
{
	if (riid == IID_IUnknown)
		*ppv = static_cast<ecom_control_library::IEnumOleUndoUnits*>(this);
	else if (riid == IID_IEnumOleUndoUnits_)
		*ppv = static_cast<ecom_control_library::IEnumOleUndoUnits*>(this);
	else
