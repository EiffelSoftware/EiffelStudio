...
inherit
	ES_TOOL [ES_FAVORITES_TOOL_PANEL]
...
feature -- Access
	...
	shortcut_preference_name: STRING_32
		...
		do
			Result := "show_favorites_tool"
		end

feature {NONE} -- Factory

	create_tool: ES_FAVORITES_TOOL_PANEL
			-- Creates the tool for first use on the development `window'
		do
			create Result.make (window, Current, window.favorites_manager)
		end
