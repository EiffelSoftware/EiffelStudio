indexing
	description: "Command that lock tools docking mechanism."
...
feature -- Query
	...
	menu_name: STRING_GENERAL is
			-- Menu name
		do
			Result := interface_names.m_lock_docking
		end

	is_selected: BOOLEAN is
			-- Redefine
		do
			Result := develop_window.docking_manager.is_locked
		end
...
end -- class EB_LOCK_DOCKING_COMMAND
