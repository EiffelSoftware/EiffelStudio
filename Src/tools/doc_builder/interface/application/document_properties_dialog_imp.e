...
feature {NONE}-- Initialization
	...
	initialize is
		...
		do
			...
			l_ev_horizontal_box_3.extend (location_label)
			...
			l_ev_horizontal_box_5.extend (output_combo)
			l_ev_vertical_box_1.extend (l_ev_horizontal_box_6)
			l_ev_horizontal_box_6.extend (l_ev_label_6)
			l_ev_horizontal_box_6.extend (l_ev_horizontal_separator_3)
			l_ev_vertical_box_1.extend (l_ev_horizontal_box_7)
			l_ev_horizontal_box_7.extend (l_ev_vertical_box_2)
			l_ev_vertical_box_2.extend (hide_toc_check)
			l_ev_vertical_box_1.extend (l_ev_horizontal_box_8)
			l_ev_horizontal_box_8.extend (l_ev_label_7)
			l_ev_horizontal_box_8.extend (toc_title_text)
			l_ev_vertical_box_1.extend (l_ev_horizontal_box_9)
			l_ev_horizontal_box_9.extend (l_ev_vertical_box_3)
			l_ev_vertical_box_3.extend (override_12_check)
			...
			l_ev_label_1.set_text ("General")
			l_ev_label_1.align_text_left
			l_ev_horizontal_box_2.set_padding_width (padding_width)
			l_ev_horizontal_box_2.set_border_width (inner_border_width)
			...
			l_ev_label_4.set_text ("Transformation")
			...
			l_ev_label_5.set_text ("Output Type ")
			...
			l_ev_label_6.set_text ("Help Generation")
			...
			hide_toc_check.set_text ("Exclude from TOC")
			hide_toc_check.set_tooltip ("Hide document in TOC (will be generated as part of TOC but not visible)")
			l_ev_horizontal_box_8.set_padding_width (padding_width)
			l_ev_horizontal_box_8.set_border_width (inner_border_width)
			l_ev_horizontal_box_8.disable_item_expand (l_ev_label_7)
			l_ev_label_7.set_text ("Table of Contents Title")
			...
			l_ev_label_11.disable_sensitive
			l_ev_label_11.set_text ("Location")
...
feature -- Access
	...
	l_ev_label_1, l_ev_label_2, l_ev_label_3, location_label, l_ev_label_4, l_ev_label_5, 
	l_ev_label_6, l_ev_label_7, l_ev_label_8, l_ev_label_9, l_ev_label_10, l_ev_label_11: EV_LABEL
	l_ev_horizontal_separator_1, l_ev_horizontal_separator_2, l_ev_horizontal_separator_3: EV_HORIZONTAL_SEPARATOR
	name_text, toc_title_text, toc_12_title_text, toc_12_location_text, toc_20_title_text, 
	toc_20_location_text: EV_TEXT_FIELD
	output_combo: EV_COMBO_BOX
	hide_toc_check, override_12_check, override_20_check: EV_CHECK_BUTTON
