/*
	description: "Declaration of server routines."
	date:		"$Date$"
	revision:	"$Revision$"
...
#include "eif_cecil.h"		/* Needed for EIF_OBJECT. */
...
extern char *dview(EIF_OBJECT root);	/* Computes debugger's view on objects */
