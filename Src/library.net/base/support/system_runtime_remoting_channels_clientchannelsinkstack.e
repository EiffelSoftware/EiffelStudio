...
feature {NONE} -- Initialization
	...
	frozen make_1 (reply_sink: SYSTEM_RUNTIME_REMOTING_MESSAGING_IMESSAGESINK) is
		external
...
feature -- Basic Operations
	...
	frozen push (sink: SYSTEM_RUNTIME_REMOTING_CHANNELS_ICLIENTCHANNELSINK; state: ANY) is
		external
	...
	frozen pop (sink: SYSTEM_RUNTIME_REMOTING_CHANNELS_ICLIENTCHANNELSINK): ANY is
		external
