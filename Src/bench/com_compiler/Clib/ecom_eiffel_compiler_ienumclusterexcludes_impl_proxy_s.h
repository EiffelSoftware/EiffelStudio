...
#ifndef __ECOM_EIFFEL_COMPILER_IENUMCLUSTEREXCLUDES_IMPL_PROXY_S_H__
#define __ECOM_EIFFEL_COMPILER_IENUMCLUSTEREXCLUDES_IMPL_PROXY_S_H__
#ifdef __cplusplus
extern "C" {
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_eiffel_compiler::IEnumClusterExcludes * p_IEnumClusterExcludes;
