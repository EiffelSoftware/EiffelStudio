...
#define EIF_THR_VALID_ERRCODE(errcode)		(errcode!=-1)
...
#define EIF_MUTEX_VALID_ERRCODE(errcode)	(1)
...
#define	EIF_TSD_VALID_ERRCODE(errcode)	(!errcode)
...
#define EIF_THR_VALID_ERRCODE(errcode)		(!errcode)
...
#define EIF_MUTEX_VALID_ERRCODE(errcode)	!(errcode)
...
#define EIF_TSD_GET(key,val,errcode)	errcode=thr_getspecific((key),&(val))
