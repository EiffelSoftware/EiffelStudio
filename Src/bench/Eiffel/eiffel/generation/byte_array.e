...
feature {NONE} -- Initialization
	...
	make is
		...
		do
			basic_make (Chunk)
			position := 0
			create forward_marks.make
			create forward_marks2.make
			create forward_marks3.make
			create forward_marks4.make
			create backward_marks.make
			create sep_backward_marks.make
		end
