...
external class
	WINFORMS_CONTROL_COLLECTION_IN_WINFORMS_FORM
...
create
	make_winforms_control_collection_in_winforms_form

feature {NONE} -- Initialization

	frozen make_winforms_control_collection_in_winforms_form (owner: WINFORMS_FORM) is
		external
...
end -- class WINFORMS_CONTROL_COLLECTION_IN_WINFORMS_FORM
