...
class
	IOLE_IN_PLACE_SITE_WINDOWLESS_IMPL_STUB
...
feature {NONE}  -- Externals
	...
	ccom_create_item (eif_object: IOLE_IN_PLACE_SITE_WINDOWLESS_IMPL_STUB): POINTER is
			-- Initialize `item'
		external
			"C++ [new ecom_control_library::IOleInPlaceSiteWindowless_impl_stub %"ecom_control_library_IOleInPlaceSiteWindowless_impl_stub_s.h%"](EIF_OBJECT)"
		end

end -- IOLE_IN_PLACE_SITE_WINDOWLESS_IMPL_STUB
