indexing
	description	: "Command to switch to `create client-supplier links' mode."
	date		: "$Date$"
	revision	: "$Revision$"

class
	EB_CREATE_SUPPLIER_COMMAND
...
feature {NONE} -- Implementation
	...
	tooltip: STRING is
		...
		do
			Result := "Create new client-supplier links"
		end
...
end -- class EB_CREATE_SUPPLIER_COMMAND
