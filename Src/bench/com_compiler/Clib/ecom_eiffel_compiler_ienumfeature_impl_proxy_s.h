...
#ifndef __ECOM_EIFFEL_COMPILER_IENUMFEATURE_IMPL_PROXY_S_H__
#define __ECOM_EIFFEL_COMPILER_IENUMFEATURE_IMPL_PROXY_S_H__
#ifdef __cplusplus
extern "C" {
...
private:
	...
	Interface pointer
	-----------------------------------------------------------*/
	ecom_eiffel_compiler::IEnumFeature * p_IEnumFeature;
