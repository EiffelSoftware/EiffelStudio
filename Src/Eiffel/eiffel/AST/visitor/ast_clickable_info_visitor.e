...
feature {NONE} -- Implementation
	...
	process_precursor_as (l_as: PRECURSOR_AS) is
		do
			...
			last_class := Universe.safe_class_named (l_as.parent_base_class.class_name, reference_class.group)
		end
	...
	process_class_type_as (l_as: CLASS_TYPE_AS) is
		do
			...
			last_class := Universe.safe_class_named (l_as.class_name, reference_class.group)
		end
