...
#ifndef __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_INHERITANCECLAUSE_H__
#define __ECOM_ISE_REFLECTION_EIFFELCOMPONENTS_INHERITANCECLAUSE_H__
#ifdef __cplusplus
extern "C" {
...
{
public:
	InheritanceClause (IUnknown * a_pointer);
	virtual ~InheritanceClause ();
