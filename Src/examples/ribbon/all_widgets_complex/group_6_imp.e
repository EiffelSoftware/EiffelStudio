...
feature {NONE} -- Initialization
	...
	create_interface_objects
		...
		do
			...
			create button_combobox_1.make_with_command_list (<<{COMMAND_NAME_CONSTANTS}.button_combobox_1>>)

			create buttons.make (1)
			buttons.extend (combobox_1)
			buttons.extend (button_combobox_1)
...
feature -- Query
	...
	button_combobox_1: BUTTON_COMBOBOX_1
