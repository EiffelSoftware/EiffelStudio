indexing
	description: "Object that represents a class displayed in shortened form in class browser"
...
class
	EB_GRID_SHORTENED_CLASS_STYLE

inherit
	EB_GRID_CLASS_ITEM_STYLE
		redefine
			is_shortened_signature_style
		end

feature -- Style type

	is_shortened_signature_style: BOOLEAN is True
			-- Does current represent a shortened signature style?
