...
feature -- Criterion creation
	...
	criterion (a_name: STRING; a_argu: TUPLE): QL_QUANTITY_CRITERION is
...
feature{NONE} -- Implementation
	...
	creation_function: FUNCTION [ANY, TUPLE, QL_QUANTITY_CRITERION]
			-- Creation function type anchor

	true_criterion (a_argu: TUPLE): QL_QUANTITY_TRUE_CRI is
			-- True criterion
		do
			create Result
		ensure
	...
	false_criterion (a_argu: TUPLE): QL_QUANTITY_FALSE_CRI is
			-- True criterion
		do
			create Result
		ensure
	...
	and_criterion (a_argu: TUPLE): QL_QUANTITY_AND_CRITERION is
			-- Binary "and" criterion
		local
			l_left: QL_QUANTITY_CRITERION
			l_right: QL_QUANTITY_CRITERION
		do
	...
	or_criterion (a_argu: TUPLE): QL_QUANTITY_OR_CRITERION is
			-- Binary "and" criterion
		local
			l_left: QL_QUANTITY_CRITERION
			l_right: QL_QUANTITY_CRITERION
	...
	not_criterion (a_argu: TUPLE): QL_QUANTITY_NOT_CRITERION is
			-- Binary "and" criterion
		local
			l_cri: QL_QUANTITY_CRITERION
		do
	...
	is_compiled_criterion (a_argu: TUPLE): QL_QUANTITY_IS_COMPILED_CRI is
	...
	name_criterion (a_argu: TUPLE): QL_QUANTITY_NAME_IS_CRI is
	...
	eq_criterion (a_argu: TUPLE): QL_QUANTITY_EQ_CRI is
			-- Equality criterion
		local
			l_left: QL_QUANTITY_CRITERION
			l_right: QL_QUANTITY_CRITERION
	...
	ne_criterion (a_argu: TUPLE): QL_QUANTITY_NE_CRI is
			-- Equality criterion
		local
			l_left: QL_QUANTITY_CRITERION
			l_right: QL_QUANTITY_CRITERION
...
--	number_criterion (a_argu: TUPLE): QL_QUANTITY_NUM_CRI is
--			-- Number criterion
--		local
