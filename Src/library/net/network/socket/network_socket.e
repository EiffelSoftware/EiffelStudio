...
feature {NONE} -- Externals
	...
	c_set_sock_opt_timeo (a_fd, level: INTEGER; a_timeo_opt: INTEGER; a_timeout_nanoseconds: NATURAL_64)
	...
	c_get_sock_opt_timeo (a_fd, level: INTEGER; a_timeo_opt: INTEGER): NATURAL_64
