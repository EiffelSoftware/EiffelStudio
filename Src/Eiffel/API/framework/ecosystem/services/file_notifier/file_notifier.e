...
feature {NONE} -- Access
	...
	file_records: attached DS_HASH_TABLE [attached FILE_NOTIFIER_RECORD, STRING_32]
	...
	file_modified_callbacks: attached DS_HASH_TABLE [attached EVENT_TYPE [TUPLE [modification_type: NATURAL_8]], STRING_32]
...
--				file_records.item (file_name_key (a_file_name)).monitor_count = old file_records.item (file_name_key (a_file_name)).monitor_count + 1
	...
	check_modifications_with_callback (a_file_name: attached STRING_32; a_callback: attached PROCEDURE [ANY, TUPLE [modification_type: NATURAL_8]])
			-- <Precursor>
		local
			l_key: like file_name_key
			l_callbacks: like file_modified_callbacks
...
--				file_records.item (file_name_key (a_file_name)).monitor_count = old file_records.item (file_name_key (a_file_name)).monitor_count + 1
	...
	uncheck_modifications_with_callback (a_file_name: attached STRING_32; a_callback: attached PROCEDURE [ANY, TUPLE [modification_type: NATURAL_8]])
			-- <Precursor>
		local
			l_key: like file_name_key
			l_callbacks: like file_modified_callbacks
...
feature {NONE} -- Formatting
	...
	file_name_key (a_file_name: attached STRING_32): attached STRING_32
...
feature -- Event handlers
	...
	on_file_modified (a_file_name: attached STRING_32; a_type: NATURAL_8)
...
invariant
	file_records_contains_monitored_items: file_records.for_all (agent (a_record: attached FILE_NOTIFIER_RECORD): BOOLEAN
		do
