...
external class
	SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO
...
feature {NONE} -- Initialization
	...
	frozen make_2 (file_name: STRING; arguments: STRING) is
		external
...
feature -- Access
	...
	frozen get_working_directory: STRING is
		external
	...
	frozen get_environment_variables: SYSTEM_COLLECTIONS_SPECIALIZED_STRINGDICTIONARY is
		external
	...
	frozen get_verbs: ARRAY [STRING] is
		external
			"IL signature (): System.String[] use System.Diagnostics.ProcessStartInfo"
		alias
			"get_Verbs"
	...
	frozen get_arguments: STRING is
		external
			"IL signature (): System.String use System.Diagnostics.ProcessStartInfo"
		alias
			"get_Arguments"
	...
	frozen get_window_style: SYSTEM_DIAGNOSTICS_PROCESSWINDOWSTYLE is
		external
...
feature -- Element Change
	...
	frozen set_verb (value: STRING) is
		external
	...
	frozen set_working_directory (value: STRING) is
		external
			"IL signature (System.String): System.Void use System.Diagnostics.ProcessStartInfo"
		alias
	...
	frozen set_window_style (value: SYSTEM_DIAGNOSTICS_PROCESSWINDOWSTYLE) is
		external
	...
	frozen set_arguments (value: STRING) is
		external
			"IL signature (System.String): System.Void use System.Diagnostics.ProcessStartInfo"
		alias
			"set_Arguments"
...
end -- class SYSTEM_DIAGNOSTICS_PROCESSSTARTINFO
