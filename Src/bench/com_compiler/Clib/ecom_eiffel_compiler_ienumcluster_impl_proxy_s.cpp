...
-----------------------------------------------------------*/
{
	...
	tmp_rgelt = (ecom_eiffel_compiler::IEiffelClusterDescriptor * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_31 (eif_access (rgelt), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_31 ((ecom_eiffel_compiler::IEiffelClusterDescriptor * *)tmp_rgelt, rgelt);
	rt_ce.ccom_ce_pointed_unsigned_long ((ULONG *)tmp_pcelt_fetched, pcelt_fetched);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_31 (tmp_rgelt);
grt_ce_Eif_compiler.ccom_free_memory_pointed_92 (tmp_pcelt_fetched);
...
-----------------------------------------------------------*/
{
	...
	tmp_ppenum = (ecom_eiffel_compiler::IEnumCluster * *)grt_ec_Eif_compiler.ccom_ec_pointed_cell_27 (eif_access (ppenum), NULL);
	...
	grt_ce_Eif_compiler.ccom_ce_pointed_cell_27 ((ecom_eiffel_compiler::IEnumCluster * *)tmp_ppenum, ppenum);
	
	grt_ce_Eif_compiler.ccom_free_memory_pointed_27 (tmp_ppenum);
