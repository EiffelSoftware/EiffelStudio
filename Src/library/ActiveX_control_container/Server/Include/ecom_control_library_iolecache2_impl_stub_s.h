...
#ifndef __ECOM_CONTROL_LIBRARY_IOLECACHE2_IMPL_STUB_S_H__
#define __ECOM_CONTROL_LIBRARY_IOLECACHE2_IMPL_STUB_S_H__
#ifdef __cplusplus
extern "C" {
...
namespace ecom_control_library
{
class IOleCache2_impl_stub : public ecom_control_library::IOleCache2
{
public:
  IOleCache2_impl_stub (EIF_OBJECT eif_obj);
  virtual ~IOleCache2_impl_stub ();
  ...
  No description available.
  -----------------------------------------------------------*/
  STDMETHODIMP RemoteUpdateCache(  /* [in] */ ecom_control_library::IDataObject * p_data_object, /* [in] */ ULONG grf_updf, /* [in] */ LONG p_reserved );


  /*-----------------------------------------------------------
  No description available.
  -----------------------------------------------------------*/
  STDMETHODIMP DiscardCache(  /* [in] */ ULONG dw_discard_options );
