...
feature {NONE} -- Initialization
	...
	frozen make_1 (offset_lo: INTEGER; offset_hi: INTEGER; h_event: INTEGER; ar: IASYNC_RESULT) is
		external
...
feature -- Access
	...
	frozen get_async_result: IASYNC_RESULT is
		external
...
feature -- Element Change
	...
	frozen set_async_result (value: IASYNC_RESULT) is
		external
