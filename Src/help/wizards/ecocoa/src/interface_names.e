...
feature -- Title
	...
	t_new_cocoa_wizard: STRING_GENERAL	do Result := locale.translation ("New Cocoa Application Wizard") end
	t_welcome_to_the_wizard: STRING_GENERAL	do Result := locale.translation ("Welcome to the New Cocoa%NApplication Wizard") end
	t_completing_wizard: STRING_GENERAL	do Result := locale.translation ("Completing the New Cocoa%NApplication Wizard") end
	t_cocoa_application_appearance: STRING_GENERAL do Result := locale.translation ("Cocoa Application Appearance") end
